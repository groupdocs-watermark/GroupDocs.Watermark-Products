...
############################# Head ############################
head_title: "Marca d'água do documento C# Java Node.js | adicionar marca d'água"
...
metrics:
  ...
  items:
    ...
    - number: "800k"
      ...
      content: "GroupDocs.Watermark para .NET é uma biblioteca popular com mais de 800.000 downloads em NuGet."
