...
steps:
    enable: true
    title: "Get image watermarks from Pptx files using Node.js via Java"
    content: |
      ...
      1. Input the path of a Pptx file into the **Watermarker** constructor
