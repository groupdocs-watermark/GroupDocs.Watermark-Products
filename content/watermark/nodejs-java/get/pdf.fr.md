...
steps:
    enable: true
    title: "Obtenez des filigranes à partir de fichiers Pdf à l'aide de GroupDocs.Watermark"
    content: |
    ...
    code:
      ...
      content: |
        ...
        // Obtenez des filigranes d'image placés dans PDF
