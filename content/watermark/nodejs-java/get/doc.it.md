...
############################# Head ############################
head_title: "Recupera le filigrane dei documenti DOC senza sforzo"
head_description: "Recupera facilmente le filigrane dai documenti con GroupDocs.Watermark."

############################# Header ############################
title: "Ottieni filigrana da DOC documenti" 
description: "Recupera facilmente le filigrane usando GroupDocs.Watermark for Node.js via Java."
...
steps:
    enable: true
    title: "Ottieni filigrane dai file Doc utilizzando GroupDocs.Watermark"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** offre una soluzione completa per inserire filigrane nei formati di documenti aziendali più diffusi. Integrando la nostra libreria nelle tue applicazioni Node.js via Java, puoi dotarle di potenti funzionalità di ricerca in filigrana.
      ...
      1. **Watermarker** e fornisci il percorso del file Doc. Inoltre puoi usare un file salvato come flusso di byte. Questa azione essenzialmente carica il documento di destinazione per un'analisi completa della filigrana.
    ...
    code:
      ...
      content: |
        ...
        // Ottieni filigrane sulle immagini inserite in DOC
...
more_formats:
    enable: true
    title: "Semplifica il recupero della filigrana"
    exclude: "DOC"
    description: "Semplifica il recupero della filigrana in diversi formati di file con GroupDocs.Watermark for Node.js via Java."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
