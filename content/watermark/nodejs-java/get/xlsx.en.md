...
############################# Head ############################
head_title: "Get XLSX Document Watermark"
...
steps:
    enable: true
    title: "Get image watermarks from Xlsx files using Node.js via Java"
    content: |
      ...
      1. Input the path of a Xlsx file into the **Watermarker** constructor
