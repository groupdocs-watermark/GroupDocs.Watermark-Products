...
steps:
    enable: true
    title: "Obtenez des filigranes à partir de fichiers Doc à l'aide de GroupDocs.Watermark"
    content: |
    ...
    code:
      ...
      content: |
        ...
        // Obtenez des filigranes d'image placés dans DOC
