...
steps:
    enable: true
    title: "Ефективно отримуйте водяні знаки в Powerpoint файлах за допомогою GroupDocs.Watermark"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** спрощує процес пошуку водяних знаків, вбудованих у різні формати ділових документів. Плавно інтегруйте GroupDocs.Watermark у свої Node.js via Java програми, щоб надати їм надійні можливості виявлення водяних знаків.
      ...
      1. **Watermarker** і вкажіть шлях до файлу Powerpoint, файловий потік або байтовий потік як вхід. Ця дія завантажує документ для аналізу водяних знаків.
    ...
    code:
      ...
      content: |
        ...
        // Отримати текстовий список водяних знаків для POWERPOINT
