...
############################# Head ############################
head_title: "Get PPT Document Watermark"
...
steps:
    enable: true
    title: "Get image watermarks from Ppt files using Node.js via Java"
    content: |
      ...
      1. Input the path of a Ppt file into the **Watermarker** constructor
