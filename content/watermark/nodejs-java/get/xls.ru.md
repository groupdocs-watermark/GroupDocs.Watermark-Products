...
############################# Head ############################
head_title: "Легко извлекайте водяные знаки из любого документа XLS"
head_description: "Быстро получайте водяные знаки из электронных таблиц XLS с помощью GroupDocs.Watermark."

############################# Header ############################
title: "Получите доступ к водяным знакам из XLS электронных таблиц и получите их" 
description: "С легкостью извлекайте и получайте водяные знаки в документах XLS с помощью GroupDocs.Watermark for Node.js via Java."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Получите GroupDocs.Watermark for Node.js via Java бесплатно на NPM"
      link: "https://releases.groupdocs.com/watermark/nodejs-java/"
      
############################# About ############################
about:
    enable: true
    title: "Откройте для себя мощное управление водяными знаками с помощью GroupDocs.Watermark for Node.js via Java"
    link: "/watermark/nodejs-java/"
    link_title: "Узнайте больше"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       Революционизируйте управление водяными знаками в рабочем процессе Node.js via Java. GroupDocs.Watermark for Node.js via Java позволяет легко создавать, обновлять, извлекать (получать) и удалять водяные знаки в различных форматах файлов, упрощая обработку документов.

############################# Steps ############################
steps:
    enable: true
    title: "Получите водяные знаки из файлов Xls с помощью GroupDocs.Watermark"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** предлагает комплексное решение для размещения водяных знаков в популярных форматах деловых документов. Интегрировав нашу библиотеку в свои приложения Node.js via Java, вы можете снабдить их мощными возможностями поиска по водяным знакам.
      ...
      1. Чтобы получить доступ к функциям, предоставляемым GroupDocs.Watermark, создайте экземпляр класса **Watermarker** и укажите путь к файлу Xls. Также вы можете использовать файл, сохраненный в виде байтового потока. Это действие по существу загружает целевой документ для всестороннего анализа водяных знаков.
    ...
    code:
      ...
      content: |
        ...
        // Получить водяные знаки изображений, помещенные в XLS
...
more_formats:
    enable: true
    title: "Легко получайте водяные знаки из любого формата файла"
    exclude: "XLS"
    description: "Упростите извлечение (получение) водяных знаков во всех форматах файлов с помощью функции GroupDocs.Watermark for Node.js via Java."
    items: 
        # format loop 1
