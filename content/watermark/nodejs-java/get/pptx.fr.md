...
############################# Head ############################
head_title: "Découvrez Watermark Insights dans PPTX présentations"
head_description: "Découvrez des informations précieuses cachées dans les filigranes à l'aide de GroupDocs.Watermark for Node.js via Java."

############################# Header ############################
title: "Découvrez de précieuses informations sur les filigranes des présentations PPTX" 
description: "Débloquez des informations précieuses cachées dans les filigranes à l'aide de GroupDocs.Watermark for Node.js via Java."
...
header_actions:
  ...
  items:
    #  loop
    - title: "NPM forfait gratuit"
      link: "https://releases.groupdocs.com/watermark/nodejs-java/"
      
############################# About ############################
about:
    enable: true
    title: "Obtenir des informations GroupDocs.Watermark for Node.js via Java"
    link: "/watermark/nodejs-java/"
    link_title: "En savoir plus"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       Exploitez le potentiel de GroupDocs.Watermark for Node.js via Java en découvrant de précieuses informations cachées dans les filigranes de Node.js via Java. Extrayez et analysez facilement les filigranes de différents formats de fichiers.

############################# Steps ############################
steps:
    enable: true
    title: "Obtenir des filigranes à partir de Pptx fichiers à l'aide de GroupDocs.Watermark"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** propose une solution complète pour placer des filigranes dans les formats de documents commerciaux courants. En intégrant notre bibliothèque à vos Node.js via Java applications, vous pouvez les doter de puissantes fonctionnalités de recherche par filigrane.
      ...
      1. **Watermarker** et indiquez le chemin du fichier Pptx. Vous pouvez également utiliser un fichier enregistré en tant que flux d'octets. Cette action charge essentiellement le document cible pour une analyse complète des filigranes.
    ...
    code:
      ...
      content: |
        ...
        // Obtenir des filigranes d'image placés dans PPTX
...
more_formats:
    enable: true
    title: "Extraire des informations à partir de filigranes"
    exclude: "PPTX"
    description: "Extrayez des informations précieuses à partir de filigranes dans différents formats de fichiers avec GroupDocs.Watermark for Node.js via Java."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
