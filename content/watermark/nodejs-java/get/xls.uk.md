...
############################# Head ############################
head_title: "Легко отримуйте водяні знаки з будь-якого документа XLS"
head_description: "Швидко отримуйте водяні знаки зі своїх XLS електронних таблиць за допомогою GroupDocs.Watermark."

############################# Header ############################
title: "Доступ і отримання водяних знаків з XLS електронних таблиць" 
description: "Легко завантажуйте та отримуйте водяні знаки у ваших XLS документах за допомогою GroupDocs.Watermark for Node.js via Java."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Отримайте GroupDocs.Watermark for Node.js via Java безкоштовно на NPM"
      link: "https://releases.groupdocs.com/watermark/nodejs-java/"
      
############################# About ############################
about:
    enable: true
    title: "Розблокуйте потужне управління водяними знаками за допомогою GroupDocs.Watermark for Node.js via Java"
    link: "/watermark/nodejs-java/"
    link_title: "Дізнатися більше"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       Революціонізуйте керування водяними знаками у вашому робочому процесі Node.js via Java. GroupDocs.Watermark for Node.js via Java дає вам змогу без зусиль створювати, оновлювати, отримувати (отримувати) та видаляти водяні знаки у різних форматах файлів, спрощуючи обробку документів.

############################# Steps ############################
steps:
    enable: true
    title: "Отримайте водяні знаки з файлів Xls за допомогою GroupDocs.Watermark"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** пропонує комплексне рішення для розміщення водяних знаків у популярних форматах ділових документів. Інтегрувавши нашу бібліотеку у ваші програми Node.js via Java, ви можете оснастити їх потужними можливостями пошуку водяних знаків.
      ...
      1. Щоб отримати доступ до функцій, наданих GroupDocs.Watermark, створіть екземпляр класу **Watermarker** і вкажіть шлях до файлу Xls. Також ви можете використовувати файл, збережений як потік байтів. Ця дія по суті завантажує цільовий документ для комплексного аналізу водяних знаків.
    ...
    code:
      ...
      content: |
        ...
        // Отримати водяні знаки зображень у XLS
...
more_formats:
    enable: true
    title: "Легко отримуйте водяні знаки з будь-якого формату файлу"
    exclude: "XLS"
    description: "Спростіть пошук водяних знаків (get) у всіх форматах файлів за допомогою потужності GroupDocs.Watermark for Node.js via Java."
    items: 
        # format loop 1
