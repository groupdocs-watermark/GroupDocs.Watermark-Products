...
############################# Head ############################
head_title: "Extract Watermarks from DOCX Documents with Ease"
head_description: "Easily extract watermarks from your documents using GroupDocs.Watermark."

############################# Header ############################
title: "Access Watermarks in DOCX Files" 
description: "Retrieve watermarks from your DOCX documents effortlessly with GroupDocs.Watermark for Node.js via Java."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Download for Free on NPM"
      link: "https://releases.groupdocs.com/watermark/nodejs-java/"
      
############################# About ############################
about:
    enable: true
    title: "Discover GroupDocs.Watermark for Node.js via Java"
    link: "/watermark/nodejs-java/"
    link_title: "Learn more"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       Effortlessly manage watermarks within your Node.js via Java environment. GroupDocs.Watermark for Node.js via Java empowers you to perform various watermark operations like generating, updating, retrieving, and deleting watermarks across a wide range of file formats.
...
steps:
    ...
    code:
      ...
      content: |
        ...
        // Get image watermarks placed in DOCX
...
more_formats:
    enable: true
    title: "Streamline Watermark Extraction"
    exclude: "DOCX"
    description: "Simplify the process of extracting watermarks from different file formats using GroupDocs.Watermark for Node.js via Java."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
