...
############################# Head ############################
head_title: "Get Watermark for Presentations"
...
steps:
    enable: true
    title: "Get text watermarks list placed in Powerpoint documents via Node.js via Java"
    content: |
      ...
      1. Provide Powerpoint path for **Watermarker** counstructor
