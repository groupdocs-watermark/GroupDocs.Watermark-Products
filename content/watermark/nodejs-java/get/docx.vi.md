...
############################# Head ############################
head_title: "Trích xuất hình mờ từ DOCX tài liệu một cách dễ dàng"
head_description: "Dễ dàng trích xuất hình mờ từ tài liệu của bạn bằng GroupDocs.Watermark."

############################# Header ############################
title: "Truy cập hình mờ trong tập tin DOCX" 
description: "Truy xuất hình mờ từ tài liệu DOCX của bạn một cách dễ dàng với GroupDocs.Watermark for Node.js via Java."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Tải xuống miễn phí trên NPM"
      link: "https://releases.groupdocs.com/watermark/nodejs-java/"
      
############################# About ############################
about:
    enable: true
    title: "Khám phá GroupDocs.Watermark for Node.js via Java"
    link: "/watermark/nodejs-java/"
    link_title: "Tìm hiểu thêm"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       Dễ dàng quản lý hình mờ trong môi trường Node.js via Java của bạn. GroupDocs.Watermark for Node.js via Java cho phép bạn thực hiện các thao tác hình mờ khác nhau như tạo, cập nhật, truy xuất và xóa hình mờ trên nhiều định dạng tệp.

############################# Steps ############################
steps:
    enable: true
    title: "Nhận hình mờ từ các tệp Docx bằng cách sử dụng GroupDocs.Watermark"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** cung cấp giải pháp toàn diện để đặt hình mờ ở các định dạng tài liệu kinh doanh phổ biến. Bằng cách tích hợp thư viện của chúng tôi vào các ứng dụng Node.js via Java của bạn, bạn có thể trang bị cho chúng khả năng tìm kiếm hình mờ mạnh mẽ.
      ...
      1. Để truy cập các chức năng do GroupDocs.Watermark cung cấp, hãy khởi tạo lớp **Watermarker** và cung cấp đường dẫn tệp Docx. Ngoài ra, bạn có thể sử dụng tệp được lưu dưới dạng luồng byte. Hành động này về cơ bản sẽ tải tài liệu đích để phân tích hình mờ toàn diện.
    ...
    code:
      ...
      content: |
        ...
        // Lấy hình mờ được đặt trong DOCX
...
more_formats:
    enable: true
    title: "Hợp lý hóa việc trích xuất hình mờ"
    exclude: "DOCX"
    description: "Đơn giản hóa quá trình trích xuất hình mờ từ các định dạng tệp khác nhau bằng cách sử dụng GroupDocs.Watermark for Node.js via Java."
    items: 
        # format loop 1
        - name: "Hình mờ PDF"
          format: "PDF"
