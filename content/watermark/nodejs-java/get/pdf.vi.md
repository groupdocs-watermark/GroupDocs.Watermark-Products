...
############################# Head ############################
head_title: "Truy xuất hình mờ tài liệu PDF hiệu quả"
head_description: "Truy xuất hiệu quả hình mờ từ tài liệu với GroupDocs.Watermark for Node.js via Java."

############################# Header ############################
title: "Trích xuất hình mờ hợp lý từ PDF tài liệu" 
description: "Trích xuất hình mờ hiệu quả bằng cách sử dụng phương pháp sắp xếp hợp lý GroupDocs.Watermark for Node.js via Java."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Node.js via Java cung cấp một giải pháp liền mạch để quản lý hình mờ trên Node.js via Java. Đơn giản hóa quá trình trích xuất và thao tác hình mờ trên các định dạng tệp khác nhau.

############################# Steps ############################
steps:
    enable: true
    title: "Nhận hình mờ từ các tệp Pdf bằng cách sử dụng GroupDocs.Watermark"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** cung cấp giải pháp toàn diện để đặt hình mờ ở các định dạng tài liệu kinh doanh phổ biến. Bằng cách tích hợp thư viện của chúng tôi vào các ứng dụng Node.js via Java của bạn, bạn có thể trang bị cho chúng khả năng tìm kiếm hình mờ mạnh mẽ.
      ...
      1. Để truy cập các chức năng do GroupDocs.Watermark cung cấp, hãy khởi tạo lớp **Watermarker** và cung cấp đường dẫn tệp Pdf. Ngoài ra, bạn có thể sử dụng tệp được lưu dưới dạng luồng byte. Hành động này về cơ bản sẽ tải tài liệu đích để phân tích hình mờ toàn diện.
    ...
    code:
      ...
      content: |
        ...
        // Lấy hình mờ được đặt trong PDF
...
more_formats:
    enable: true
    title: "Hợp lý hóa việc xử lý hình mờ"
    exclude: "PDF"
    description: "Hợp lý hóa việc xử lý hình mờ trên các định dạng tệp khác nhau với GroupDocs.Watermark for Node.js via Java."
    items: 
        # format loop 1
        - name: "Hình mờ PDF"
          format: "PDF"
