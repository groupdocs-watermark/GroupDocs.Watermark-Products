...
############################# Head ############################
head_title: "Ottieni facilmente filigrane da qualsiasi documento XLS"
head_description: "Ottieni rapidamente filigrane dai tuoi fogli di calcolo XLS con GroupDocs.Watermark."

############################# Header ############################
title: "Accedi e ottieni filigrane da XLS fogli di calcolo" 
description: "Recupera e ottieni facilmente filigrane nei tuoi documenti XLS utilizzando GroupDocs.Watermark for Node.js via Java."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Ottieni GroupDocs.Watermark for Node.js via Java gratis su NPM"
      link: "https://releases.groupdocs.com/watermark/nodejs-java/"
      
############################# About ############################
about:
    enable: true
    title: "Sblocca una potente gestione delle filigrane con GroupDocs.Watermark for Node.js via Java"
...
steps:
    enable: true
    title: "Ottieni filigrane dai file Xls utilizzando GroupDocs.Watermark"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** offre una soluzione completa per inserire filigrane nei formati di documenti aziendali più diffusi. Integrando la nostra libreria nelle tue applicazioni Node.js via Java, puoi dotarle di potenti funzionalità di ricerca in filigrana.
      ...
      1. **Watermarker** e fornisci il percorso del file Xls. Inoltre puoi usare un file salvato come flusso di byte. Questa azione essenzialmente carica il documento di destinazione per un'analisi completa della filigrana.
    ...
    code:
      ...
      content: |
        ...
        // Ottieni filigrane sulle immagini inserite in XLS
...
more_formats:
    enable: true
    title: "Ottieni facilmente filigrane da qualsiasi formato di file"
    exclude: "XLS"
    description: "Semplifica il recupero delle filigrane (get) in tutti i tuoi formati di file con la potenza di GroupDocs.Watermark for Node.js via Java."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
