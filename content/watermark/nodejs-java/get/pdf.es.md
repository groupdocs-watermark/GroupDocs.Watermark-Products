...
############################# Head ############################
head_title: "Recuperación eficiente de marcas de agua de PDF documentos"
head_description: "Recupere de forma eficiente las marcas de agua de los documentos con GroupDocs.Watermark for Node.js via Java."

############################# Header ############################
title: "Extracción simplificada de marcas de agua de PDF documentos" 
description: "Extraiga marcas de agua de manera eficiente con un enfoque simplificado de GroupDocs.Watermark for Node.js via Java."
...
about:
    enable: true
    title: "Información básica GroupDocs.Watermark for Node.js via Java"
    link: "/watermark/nodejs-java/"
    link_title: "Obtenga más información"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       GroupDocs.Watermark for Node.js via Java proporciona una solución perfecta para gestionar las marcas de agua en Node.js via Java. Simplifique el proceso de extracción y manipulación de marcas de agua en varios formatos de archivo.

############################# Steps ############################
steps:
    enable: true
    title: "Obtenga marcas de agua de Pdf archivos con GroupDocs.Watermark"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** ofrece una solución integral para colocar marcas de agua en los formatos de documentos comerciales más populares. Al integrar nuestra biblioteca en sus Node.js via Java aplicaciones, puede equiparlas con potentes funciones de búsqueda de marcas de agua.
      ...
      1. **Watermarker** y proporcione la ruta del archivo Pdf. También puede usar el archivo guardado como flujo de bytes. Esta acción básicamente carga el documento de destino para un análisis exhaustivo de las marcas de agua.
    ...
    code:
      ...
      content: |
        ...
        // Consigue que las marcas de agua de las imágenes se coloquen en PDF
...
more_formats:
    enable: true
    title: "Optimice el manejo de marcas de agua"
    exclude: "PDF"
    description: "Optimice la gestión de marcas de agua en diferentes formatos de archivo con GroupDocs.Watermark for Node.js via Java."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
