...
############################# Head ############################
head_title: "Get XLS Document Watermark"
...
steps:
    enable: true
    title: "Get image watermarks from Xls files using Node.js via Java"
    content: |
      ...
      1. Input the path of a Xls file into the **Watermarker** constructor
