...
steps:
    enable: true
    title: "Obtenga marcas de agua de archivos Pptx usando GroupDocs.Watermark"
    content: |
    ...
    code:
      ...
      content: |
        ...
        // Obtener marcas de agua de imagen colocadas en PPTX
