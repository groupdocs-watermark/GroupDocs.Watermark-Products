...
############################# Head ############################
head_title: "DOCX 문서에서 손쉽게 워터마크 추출"
head_description: "GroupDocs.Watermark 를 사용하여 문서에서 워터마크를 쉽게 추출할 수 있습니다."

############################# Header ############################
title: "DOCX 개 파일의 워터마크에 액세스" 
description: "GroupDocs.Watermark for Node.js via Java 을 사용하여 DOCX 문서에서 워터마크를 손쉽게 검색할 수 있습니다."
...
about:
    enable: true
    title: "디스커버 GroupDocs.Watermark for Node.js via Java"
    link: "/watermark/nodejs-java/"
    link_title: "자세히 알아보기"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       Node.js via Java 환경에서 워터마크를 손쉽게 관리할 수 있습니다. GroupDocs.Watermark for Node.js via Java 을 사용하면 광범위한 파일 형식에서 워터마크 생성, 업데이트, 검색 및 삭제와 같은 다양한 워터마크 작업을 수행할 수 있습니다.

############################# Steps ############################
steps:
    enable: true
    title: "GroupDocs.Watermark 을(를) 사용하여 Docx 파일에서 워터마크 가져오기"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** 는 널리 사용되는 비즈니스 문서 형식에 워터마크를 배치하기 위한 포괄적인 솔루션을 제공합니다. 우리 라이브러리를 귀하의 Node.js via Java 애플리케이션에 통합함으로써 귀하는 강력한 워터마크 검색 기능을 갖출 수 있습니다.
      ...
      1. GroupDocs.Watermark 에서 제공하는 기능에 액세스하려면 **Watermarker** 클래스를 인스턴스화하고 Docx 파일 경로를 제공하세요. 또한 바이트 스트림으로 저장된 파일을 사용할 수 있습니다. 이 작업은 기본적으로 포괄적인 워터마크 분석을 위해 대상 문서를 로드합니다.
...
more_formats:
    ...
    title: "워터마크 추출 간소화"
    exclude: "DOCX"
    description: "GroupDocs.Watermark for Node.js via Java 를 사용하여 다양한 파일 형식에서 워터마크를 추출하는 프로세스를 간소화합니다."
    items: 
        # format loop 1
        - name: "워터마크 PDF"
          format: "PDF"
