...
steps:
    enable: true
    title: "GroupDocs.Watermark을(를) 사용하여 Docx 파일에서 워터마크 가져오기"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)**는 널리 사용되는 비즈니스 문서 형식에 워터마크를 배치하기 위한 포괄적인 솔루션을 제공합니다. 우리 라이브러리를 귀하의 Node.js via Java 애플리케이션에 통합함으로써 귀하는 강력한 워터마크 검색 기능을 갖출 수 있습니다.
      ...
      1. GroupDocs.Watermark에서 제공하는 기능에 액세스하려면 **Watermarker** 클래스를 인스턴스화하고 Docx 파일 경로를 제공하세요. 또한 바이트 스트림으로 저장된 파일을 사용할 수 있습니다. 이 작업은 기본적으로 포괄적인 워터마크 분석을 위해 대상 문서를 로드합니다.
