...
############################# Head ############################
head_title: "毫不费力地从任何 XLS 文档中获取水印"
head_description: "使用 GroupDocs.Watermark 快速从 XLS 电子表格中获取水印。"

############################# Header ############################
title: "从 XLS 电子表格访问并获取水印" 
description: "使用 GroupDocs.Watermark for Node.js via Java 轻松检索和获取您的 XLS 文档中的水印。"
...
header_actions:
  ...
  items:
    #  loop
    - title: "在 NPM 上免费获得 GroupDocs.Watermark for Node.js via Java"
      link: "https://releases.groupdocs.com/watermark/nodejs-java/"
      
############################# About ############################
about:
    enable: true
    title: "使用 GroupDocs.Watermark for Node.js via Java 解锁强大的水印管理"
    link: "/watermark/nodejs-java/"
    link_title: "了解更多"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       彻底改变您的 Node.js via Java 工作流程中的水印管理。GroupDocs.Watermark for Node.js via Java 使您能够毫不费力地生成、更新、检索（获取）和删除各种文件格式的水印，从而简化文档处理。

############################# Steps ############################
steps:
    enable: true
    title: "使用 GroupDocs.Watermark 从 Xls 文件获取水印"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** 提供了一个全面的解决方案，用于将水印放置在流行的商业文档格式中。通过将我们的库集成到您的 Node.js via Java 应用程序中，您可以为它们配备强大的水印搜索功能。
      ...
      1. 要访问 GroupDocs.Watermark 提供的功能，请实例化 **Watermarker** 类并提供 Xls 文件路径。您也可以使用保存为字节流的文件。此操作实质上加载目标文档以进行全面的水印分析。
...
more_formats:
    ...
    title: "轻松获取任何文件格式的水印"
    exclude: "XLS"
    description: "利用 GroupDocs.Watermark for Node.js via Java 的强大功能，简化所有文件格式的水印检索（获取）。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
