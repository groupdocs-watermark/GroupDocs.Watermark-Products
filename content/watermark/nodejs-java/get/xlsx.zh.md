...
############################# Head ############################
head_title: "高效的 XLSX 电子表格水印处理"
head_description: "使用 GroupDocs.Watermark for Node.js via Java 高效处理文档中的水印。"

############################# Header ############################
title: "XLSX 电子表格中的简化水印控制" 
description: "使用 GroupDocs.Watermark for Node.js via Java 简化方法有效地控制水印。"
...
about:
    ...
    content: |
       GroupDocs.Watermark for Node.js via Java 为管理 Node.js via Java 上的水印提供了简化的解决方案。简化各种文件格式的水印处理过程。

############################# Steps ############################
steps:
    enable: true
    title: "使用 GroupDocs.Watermark 从 Xlsx 文件获取水印"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** 提供了一个全面的解决方案，用于将水印放置在流行的商业文档格式中。通过将我们的库集成到您的 Node.js via Java 应用程序中，您可以为它们配备强大的水印搜索功能。
      ...
      1. 要访问 GroupDocs.Watermark 提供的功能，请实例化 **Watermarker** 类并提供 Xlsx 文件路径。您也可以使用保存为字节流的文件。此操作实质上加载目标文档以进行全面的水印分析。
...
more_formats:
    ...
    title: "简化水印控制"
    exclude: "XLSX"
    description: "使用 GroupDocs.Watermark for Node.js via Java 简化不同文件格式的水印控制。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
