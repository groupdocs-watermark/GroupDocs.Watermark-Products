...
############################# Head ############################
head_title: "轻松从 DOCX 个文档中提取水印"
head_description: "使用 GroupDocs.Watermark 轻松从文档中提取水印。"

############################# Header ############################
title: "访问 DOCX 个文件中的水印" 
description: "使用 GroupDocs.Watermark for Node.js via Java 轻松从 DOCX 文档中检索水印。"
...
about:
    enable: true
    title: "探索 GroupDocs.Watermark for Node.js via Java"
...
steps:
    enable: true
    title: "使用 GroupDocs.Watermark 从 Docx 个文件中获取水印"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)**为以流行的商业文档格式添加水印提供了全面的解决方案。通过将我们的库集成到您的 Node.js via Java 应用程序中，您可以为它们配备强大的水印搜索功能。
      ...
      1. **水印**类并提供 Docx 文件路径。也可以使用另存为字节流的文件。此操作实质上是加载目标文档以进行全面的水印分析。
...
more_formats:
    ...
    title: "简化水印提取"
    exclude: "DOCX"
    description: "使用 GroupDocs.Watermark for Node.js via Java 简化从不同文件格式提取水印的过程。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
