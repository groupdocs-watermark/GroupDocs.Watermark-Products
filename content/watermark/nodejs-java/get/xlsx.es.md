...
############################# Head ############################
head_title: "Manejo eficiente de XLSX hojas de cálculo y marcas de agua"
head_description: "Gestione de forma eficaz las marcas de agua en los documentos con GroupDocs.Watermark for Node.js via Java."

############################# Header ############################
title: "Control simplificado de marcas de agua en hojas de cálculo XLSX" 
description: "Tome el control de las marcas de agua de manera eficiente con el enfoque simplificado de GroupDocs.Watermark for Node.js via Java."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Node.js via Java proporciona una solución simplificada para gestionar las marcas de agua en Node.js via Java. Simplifique el proceso de gestión de marcas de agua en varios formatos de archivo.
...
more_formats:
    enable: true
    title: "Optimice el control de marcas de agua"
    exclude: "XLSX"
    description: "Optimice el control de marcas de agua en diferentes formatos de archivo con GroupDocs.Watermark for Node.js via Java."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
