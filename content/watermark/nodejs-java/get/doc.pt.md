...
############################# Head ############################
head_title: "Recupere marcas d'água de DOC documentos sem esforço"
head_description: "Recupere facilmente marcas d'água de documentos com GroupDocs.Watermark."

############################# Header ############################
title: "Obtenha marca d'água de DOC documentos" 
description: "Recupere marcas d'água sem esforço usando GroupDocs.Watermark for Node.js via Java."
...
about:
    ...
    content: |
       Gerencie marcas d'água sem esforço em Node.js via Java com os poderosos recursos de GroupDocs.Watermark for Node.js via Java. Simplifique as operações de marca d'água, como gerar, atualizar, obter e excluir em vários formatos de arquivo.

############################# Steps ############################
steps:
    enable: true
    title: "Obtenha marcas d'água de arquivos Doc usando GroupDocs.Watermark"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** oferece uma solução abrangente para colocar marcas d'água em formatos de documentos comerciais populares. Ao integrar nossa biblioteca em seus aplicativos Node.js via Java, você pode equipá-los com poderosos recursos de pesquisa de marca d'água.
      ...
      1. Para acessar as funcionalidades fornecidas por GroupDocs.Watermark, instancie a classe **Watermarker** e forneça o caminho do arquivo Doc. Além disso, você pode usar o arquivo salvo como fluxo de bytes. Esta ação essencialmente carrega o documento de destino para uma análise abrangente da marca d’água.
    ...
    code:
      ...
      content: |
        ...
        // Coloque marcas d'água de imagem em DOC
...
more_formats:
    enable: true
    title: "Simplifique a recuperação de marcas d'água"
    exclude: "DOC"
    description: "Simplifique a recuperação de marcas d'água em diferentes formatos de arquivo com GroupDocs.Watermark for Node.js via Java."
    items: 
        # format loop 1
