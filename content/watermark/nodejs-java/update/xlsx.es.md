...
############################# Head ############################
head_title: "Actualiza XLSX marcas de agua según tus necesidades"
head_description: "Personalice las marcas de agua según sus requisitos precisos con GroupDocs.Watermark for Node.js via Java. Potencie la lógica empresarial en sus aplicaciones."

############################# Header ############################
title: "Actualice las marcas de agua de las hojas de cálculo de XLSX según sus necesidades" 
description: "Personalice las marcas de agua sin esfuerzo con GroupDocs.Watermark for Node.js via Java. Proteja los documentos confidenciales de su empresa con diferentes marcas de agua. Ajuste las características de las marcas de agua, como el tamaño, la alineación, el ángulo de rotación y la posición, según sea necesario."
...
steps:
    enable: true
    title: "Edición dinámica de marcas de agua para XLSX en Node.js via Java"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** ofrece a Node.js via Java desarrolladores una potente API para editar marcas de agua en diversos XLSX documentos. Esta es una guía completa para agilizar tu flujo de trabajo:
      
      1. **Inicie el proceso:** Comience proporcionando su archivo XLSX como argumento para el constructor de la clase**Watermarker**. En función de sus requisitos, el archivo se puede obtener como una transmisión o desde una ubicación de disco local.
...
more_formats:
    enable: true
    title: "Actualizar marcas de agua colocadas en otros formatos"
    exclude: "XLSX"
    description: "Personalice las marcas de agua según sus necesidades en PDF, Word, Excel y más con GroupDocs.Watermark for Node.js via Java. Incluya nuestro producto en sus soluciones y obtenga valiosos beneficios."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
