...
############################# Head ############################
head_title: "Update RTF Document Watermark"
...
steps:
    enable: true
    title: "Update image watermarks in Rtf documents via Node.js via Java"
    content: |
      ...
      1. Get **Watermarker** instance providing path to Rtf document
