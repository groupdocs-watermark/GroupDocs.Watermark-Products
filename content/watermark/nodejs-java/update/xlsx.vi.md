...
############################# Head ############################
head_title: "Cập nhật hình mờ XLSX theo nhu cầu của bạn"
head_description: "Điều chỉnh hình mờ theo yêu cầu chính xác của bạn với GroupDocs.Watermark for Node.js via Java. Tăng cường logic kinh doanh trong ứng dụng của bạn."

############################# Header ############################
title: "Cập nhật hình mờ bảng tính XLSX theo nhu cầu của bạn" 
description: "Tùy chỉnh hình mờ dễ dàng với GroupDocs.Watermark for Node.js via Java. Bảo vệ các tài liệu nhạy cảm của công ty bạn với các hình mờ khác nhau. Điều chỉnh các tính năng hình mờ như kích thước, căn chỉnh, góc xoay và vị trí khi cần thiết."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Node.js via Java trao quyền cho các nhà phát triển điều chỉnh hình mờ theo nhu cầu cụ thể của họ. Với công cụ linh hoạt này, các nhà phát triển có thể dễ dàng tùy chỉnh và điều chỉnh hình mờ trong tài liệu theo yêu cầu chính xác ở các định dạng tệp khác nhau, bao gồm PDF, Microsoft Word, Excel, PowerPoint, Visio, email và định dạng hình ảnh. Các hệ điều hành chính và nền tảng phát triển được hỗ trợ.

############################# Steps ############################
steps:
    enable: true
    title: "Chỉnh sửa hình mờ động cho XLSX trong Node.js via Java"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** cung cấp cho Node.js via Java nhà phát triển một API mạnh mẽ để chỉnh sửa hình mờ trên XLSX tài liệu khác nhau. Dưới đây là hướng dẫn toàn diện để hợp lý hóa quy trình làm việc của bạn:
      
      1. **Bắt đầu quá trình:** Bắt đầu bằng cách cung cấp tệp XLSX của bạn dưới dạng đối số cho hàm tạo lớp **Watermarker**. Tùy thuộc vào yêu cầu của bạn, tệp có thể được lấy nguồn dưới dạng luồng hoặc từ vị trí đĩa cục bộ.
    ...
    code:
      ...
      content: |
        ...
        // Cập nhật hình ảnh XLSX watermark

        // Soạn Watermarker cho tập tin XLSX
...
more_formats:
    enable: true
    title: "Cập nhật hình mờ được đặt trong các định dạng khác"
    exclude: "XLSX"
    description: "Điều chỉnh hình mờ theo nhu cầu của bạn trong PDF, Word, Excel và hơn thế nữa với GroupDocs.Watermark for Node.js via Java. Bao gồm sản phẩm của chúng tôi vào các giải pháp của bạn và thu được những lợi ích có giá trị."
    items: 
        # format loop 1
        - name: "Hình mờ PDF"
          format: "PDF"
