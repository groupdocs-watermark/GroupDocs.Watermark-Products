...
steps:
    ...
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** equipa os desenvolvedores do Node.js via Java com uma API robusta para atualizar programaticamente marcas d'água em vários documentos do POWERPOINT. Este guia descreve o processo:
