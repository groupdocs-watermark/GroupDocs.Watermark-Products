...
############################# Head ############################
head_title: "Nâng cao hình mờ trong PDF tài liệu một cách dễ dàng"
head_description: "Dễ dàng cập nhật hình mờ trong PDF tài liệu với GroupDocs.Watermark for Node.js via Java API. Đảm bảo bảo mật tài liệu của bạn."

############################# Header ############################
title: "Cập nhật hình mờ tài liệu PDF một cách dễ dàng" 
description: "Nâng cao chất lượng hình mờ một cách dễ dàng bằng cách sử dụng PDF. Tăng cường bảo vệ tài liệu kinh doanh của bạn với một loạt các hình mờ. Tinh chỉnh các đặc điểm hình mờ như kích thước, căn chỉnh, góc xoay và vị trí khi cần thiết."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Node.js via Java cung cấp khả năng nâng cao để cập nhật hình mờ trong tài liệu một cách dễ dàng. Với công cụ này, các nhà phát triển có thể nâng cao sự xuất hiện và khả năng hiển thị hình mờ ở các định dạng tệp khác nhau, bao gồm PDF, Microsoft Word, Excel, PowerPoint, Visio, email và định dạng hình ảnh. Tất cả các hệ điều hành phổ biến và Node.js via Java phiên bản đều được hỗ trợ.

############################# Steps ############################
steps:
    enable: true
    title: "Chỉnh sửa hình mờ động cho PDF trong Node.js via Java"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** cung cấp cho Node.js via Java nhà phát triển một API mạnh mẽ để chỉnh sửa hình mờ trên PDF tài liệu khác nhau. Dưới đây là hướng dẫn toàn diện để hợp lý hóa quy trình làm việc của bạn:
      
      1. **Bắt đầu quá trình:** Bắt đầu bằng cách cung cấp tệp PDF của bạn dưới dạng đối số cho hàm tạo lớp **Watermarker**. Tùy thuộc vào yêu cầu của bạn, tệp có thể được lấy nguồn dưới dạng luồng hoặc từ vị trí đĩa cục bộ.
    ...
    code:
      ...
      content: |
        ...
        // Cập nhật hình ảnh PDF watermark

        // Soạn Watermarker cho tập tin PDF
...
more_formats:
    enable: true
    title: "Cập nhật hình mờ có sẵn cho nhiều định dạng"
    exclude: "PDF"
    description: "Dễ dàng tăng cường hình mờ ở PDF, Word, Excel và hơn thế nữa với GroupDocs.Watermark for Node.js via Java. Hơn 50 định dạng tệp được hỗ trợ."
    items: 
        # format loop 1
        - name: "Hình mờ PDF"
          format: "PDF"
