...
about:
    enable: true
    title: "GroupDocs.Watermark for Node.js via Java เอพีอี"
...
steps:
    enable: true
    title: "อัปเดตลายน้ำใน POWERPOINT ผ่าน Node.js via Java"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** ช่วยให้นักพัฒนา Node.js via Java มี API ที่มีประสิทธิภาพสำหรับการอัปเดตลายน้ำทางโปรแกรมภายในเอกสาร POWERPOINT ต่างๆ คู่มือนี้จะสรุปกระบวนการ:
      
      1. เริ่มต้นกระบวนการโดยระบุไฟล์ POWERPOINT ของคุณเป็นอาร์กิวเมนต์ให้กับตัวสร้างคลาส **Watermarker** ทั้งนี้ขึ้นอยู่กับความต้องการของคุณ ไฟล์สามารถจัดเตรียมเป็นสตรีมหรือการอ้างอิงไปยังตำแหน่งของดิสก์ในเครื่องได้
    ...
    code:
      ...
      content: |
        ...
        // อัปเดตลายน้ำข้อความ POWERPOINT

        // ระบุอินสแตนซ์ Watermarker สำหรับไฟล์ POWERPOINT
