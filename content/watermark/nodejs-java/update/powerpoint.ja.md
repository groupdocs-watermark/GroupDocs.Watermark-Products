...
steps:
    enable: true
    title: "POWERPOINT のウォーターマークを Node.js via Java 経由で更新"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** Node.js via Java の開発者に、さまざまな POWERPOINT ドキュメント内のウォーターマークをプログラムで更新するための堅牢な API を提供します。このガイドではプロセスの概要を説明します。
    ...
    code:
      ...
      content: |
        ...
        // POWERPOINT テキストウォーターマークを更新

        // POWERPOINT ファイルのウォーターマーカーインスタンスを提供
