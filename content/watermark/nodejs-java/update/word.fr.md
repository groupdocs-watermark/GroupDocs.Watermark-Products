...
steps:
    ...
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** équipe les développeurs Node.js via Java d'une API robuste pour mettre à jour par programmation les filigranes dans divers documents WORD. Ce guide décrit le processus :
