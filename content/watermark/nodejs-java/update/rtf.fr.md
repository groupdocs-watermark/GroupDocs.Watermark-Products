...
############################# Head ############################
head_title: "Mettez à jour les filigranes RTF sans effort"
head_description: "Personnalisez sans effort les filigranes dans RTF documents à l'aide de GroupDocs.Watermark for Node.js via Java. Intégrez notre solution à votre logique métier."

############################# Header ############################
title: "Mettez facilement à jour les filigranes dans les documents RTF" 
description: "Adaptez les filigranes à vos besoins précis avec GroupDocs.Watermark for Node.js via Java. Protégez vos documents d'entreprise à l'aide de divers filigranes. Modifiez sans effort les éléments du filigrane tels que la taille, l'alignement, l'angle de rotation et le placement."
...
steps:
    enable: true
    title: "Modification dynamique du filigrane pour RTF dans Node.js via Java"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** offre à Node.js via Java développeurs une API puissante pour modifier les filigranes sur divers RTF documents. Voici un guide complet pour rationaliser votre flux de travail :
    ...
    code:
      ...
      content: |
        ...
        // Composer un filigrane pour le fichier RTF
...
more_formats:
    enable: true
    title: "Mettre à jour les filigranes dans de nombreux formats de fichiers"
    exclude: "RTF"
    description: "Personnalisez sans effort les filigranes dans PDF, Word, Excel, et plus encore avec GroupDocs.Watermark for Node.js via Java. Perfectionnez votre logique commerciale."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
