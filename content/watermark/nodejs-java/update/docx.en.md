...
############################# Head ############################
head_title: "Update DOCX Document Watermark"
...
steps:
    enable: true
    title: "Update image watermarks in Docx documents via Node.js via Java"
    content: |
      ...
      1. Get **Watermarker** instance providing path to Docx document
