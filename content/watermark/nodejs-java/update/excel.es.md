...
steps:
    enable: true
    title: "Actualizar marcas de agua en EXCEL a través de Node.js via Java"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** equipa a los desarrolladores de Node.js via Java con una API sólida para actualizar mediante programación marcas de agua dentro de varios documentos EXCEL. Esta guía describe el proceso:
