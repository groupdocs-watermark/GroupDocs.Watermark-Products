...
############################# Head ############################
head_title: "Update XLS Document Watermark"
...
steps:
    enable: true
    title: "Update image watermarks in Xls documents via Node.js via Java"
    content: |
      ...
      1. Get **Watermarker** instance providing path to Xls document
