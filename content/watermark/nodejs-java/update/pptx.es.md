...
############################# Head ############################
head_title: "Actualice las marcas de agua en PPTX documentos sin problemas"
head_description: "Modifique sin problemas las marcas de agua en PPTX presentaciones a través de GroupDocs.Watermark for Node.js via Java. Incorpore nuestra biblioteca a sus aplicaciones."

############################# Header ############################
title: "Actualizar marcas de agua en PPTX presentaciones" 
description: "Modifique las marcas de agua con facilidad y eficacia con GroupDocs.Watermark for Node.js via Java. Mantenga sus documentos empresariales seguros con una selección de marcas de agua. Personalice fácilmente los atributos de las marcas de agua, como el tamaño, la alineación, el ángulo de rotación y la posición."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Descarga del paquete NPM"
      link: "https://releases.groupdocs.com/watermark/nodejs-java/"
      
############################# About ############################
about:
    enable: true
    title: "GroupDocs.Watermark for Node.js via Java Soluciones"
    link: "/watermark/nodejs-java/"
    link_title: "Obtenga más información"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       GroupDocs.Watermark for Node.js via Java permite modificar sin problemas las marcas de agua de los documentos. Con esta versátil herramienta, los desarrolladores pueden modificar y actualizar fácilmente las marcas de agua en varios formatos de archivo, incluidos los formatos PDF, Word, Excel, PowerPoint, Visio, de correo electrónico y de imagen de Microsoft. GroupDocs.Watermark for Node.js via Java se puede usar con todos los sistemas operativos populares.

############################# Steps ############################
steps:
    enable: true
    title: "Edición dinámica de marca de agua para PPTX en Node.js via Java"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/)** ofrece a los desarrolladores de Node.js via Java una potente API para editar marcas de agua en diversos documentos PPTX. Aquí encontrará una guía completa para optimizar su flujo de trabajo:
      
      1. **Inicie el proceso:** Comience proporcionando su archivo PPTX como argumento para el constructor de clase **Watermarker**. Dependiendo de sus requisitos, el archivo se puede obtener como una secuencia o desde una ubicación de disco local.
    ...
    code:
      ...
      content: |
        ...
        // Actualizar la marca de agua de la imagen PPTX

        // Redacte Watermarker para el archivo PPTX
...
more_formats:
    enable: true
    title: "Actualizar marcas de agua de formatos de archivo compatibles"
    exclude: "PPTX"
    description: "Modifica sin problemas las marcas de agua en PDF, Word, Excel y más con GroupDocs.Watermark for Node.js via Java. Potencie la marca de sus documentos."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
