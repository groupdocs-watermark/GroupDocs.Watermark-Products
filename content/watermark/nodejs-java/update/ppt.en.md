...
############################# Head ############################
head_title: "Update PPT Document Watermark"
...
steps:
    enable: true
    title: "Update image watermarks in Ppt documents via Node.js via Java"
    content: |
      ...
      1. Get **Watermarker** instance providing path to Ppt document
