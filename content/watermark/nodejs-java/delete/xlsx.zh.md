...
############################# Head ############################
head_title: "自动移除 XLSX 水印"
head_description: "通过 GroupDocs.Watermark 自动删除水印来简化 XLSX 文档工作流程。"

############################# Header ############################
title: "自动删除 XLSX 水印" 
description: "使用 GroupDocs.Watermark 设置自动化流程以高效删除水印。"
...
about:
    ...
    content: |
       对于重复的文档工作流程，GroupDocs.Watermark 提供自动删除水印的功能。开发人员可以集成此功能，通过在文件上传、转换或其他指定触发器时自动删除水印来简化文档处理。使用 GroupDocs.Watermark 自动删除水印，提高效率并减少手动干预。

############################# Steps ############################
steps:
    enable: true
    title: "通过 Node.js via Java 轻松删除 Xlsx 中的水印"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/nodejs-java/)** 简化了从业务文档中删除水印的过程。通过无缝集成我们的库并遵循以下简单步骤来提升您的 Node.js via Java 应用程序：
      ...
      1. 通过使用 Xlsx 文档实例化核心类 **Watermarker** 来启动该过程。我们的多功能 API 无缝处理文档，无论是作为流还是本地路径提供。
    ...
    code:
      ...
      content: |
        ...
        // 获取 Watermarker 并将 XLSX 路径作为参数传递
...
more_formats:
    ...
    title: "以多种格式自动删除"
    exclude: "XLSX"
    description: "使用 GroupDocs.Watermark 安排自动去除各种文档类型的水印。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
