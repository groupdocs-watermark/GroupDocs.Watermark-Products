...
############################# Head ############################
head_title: "Precise Watermarks Removal in XLS Spreadsheets"
head_description: "GroupDocs.Watermark offers granular control over deleting specific watermarks."

############################# Header ############################
title: "Target Specific XLS Watermarks" 
description: "Selectively remove unwanted watermarks while preserving desired ones with GroupDocs.Watermark."
...
about:
    ...
    content: |
       GroupDocs.Watermark empowers developers with the ability to target and delete specific watermarks within documents. This granular control ensures precise document editing, allowing you to remove outdated or irrelevant watermarks while maintaining crucial information. GroupDocs.Watermark integrates seamlessly with the .NET environment, streamlining watermark deletion for various file formats.
...
steps:
    ...
    code:
      ...
      content: |
        ...
        // Delete image watermark in XLS document

        // Get Watermarker passing XLS path as an argument
...
more_formats:
    enable: true
    title: "Precise Deletion Across Formats"
    exclude: "XLS"
    description: "Target specific watermarks in different document types with GroupDocs.Watermark."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
