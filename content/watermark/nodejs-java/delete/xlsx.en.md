...
head_description: "Streamline XLSX document workflows with GroupDocs.Watermark automated watermark deletion."
...
steps:
    enable: true
    title: "Effortlessly Delete Watermarks from Xlsx by Node.js via Java"
    content: |
