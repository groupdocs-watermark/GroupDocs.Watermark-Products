...
############################# Head ############################
head_title: "Delete RTF Document Watermark"
...
steps:
    enable: true
    title: "Delete image watermarks from Rtf files by Node.js via Java"
    content: |
      ...
      1. Construct **Watermarker** object passing Rtf path
