...
steps:
    ...
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/nodejs-java/)** simplifica o processo de remoção de marcas d'água de documentos comerciais. Eleve seu aplicativo Node.js via Java integrando perfeitamente nossa biblioteca e seguindo estas etapas simples:
      ...
      1. **Watermarker**, com o documento Ppt. Nossa API versátil processa documentos perfeitamente, sejam eles fornecidos como um fluxo ou um caminho local.
    ...
    code:
      ...
      content: |
        ...
        // Excluir marca d'água da imagem no documento PPT

        // Faça com que o Watermarker passe o caminho PPT como argumento
