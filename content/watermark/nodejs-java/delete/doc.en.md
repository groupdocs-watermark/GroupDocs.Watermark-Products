...
############################# Head ############################
head_title: "Delete DOC Document Watermark"
...
steps:
    enable: true
    title: "Delete image watermarks from Doc files by Node.js via Java"
    content: |
      ...
      1. Construct **Watermarker** object passing Doc path
