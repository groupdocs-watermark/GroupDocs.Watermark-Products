...
############################# Head ############################
head_title: "在 XLS 个电子表格中精确移除水印"
head_description: "GroupDocs.Watermark 提供对删除特定水印的精细控制。"

############################# Header ############################
title: "特定目标的 XLS 水印" 
description: "使用 GroupDocs.Watermark 有选择地移除不需要的水印，同时保留所需的水印。"
...
about:
    ...
    content: |
       GroupDocs.Watermark 使开发人员能够定位和删除文档中的特定水印。这种精细控制可确保精确的文档编辑，允许您在保留重要信息的同时删除过时或不相关的水印。GroupDocs.Watermark 与 .NET 环境无缝集成，简化了各种文件格式的水印删除过程。

############################# Steps ############################
steps:
    enable: true
    title: "通过 Node.js via Java 轻松删除 Xls 中的水印"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/nodejs-java/)** 简化了从业务文档中删除水印的过程。通过无缝集成我们的库并遵循以下简单步骤来提升您的 Node.js via Java 应用程序：
      ...
      1. 通过使用 Xls 文档实例化核心类 **Watermarker** 来启动该过程。我们的多功能 API 无缝处理文档，无论是作为流还是本地路径提供。
    ...
    code:
      ...
      content: |
        ...
        // 获取 Watermarker 并将 XLS 路径作为参数传递
...
more_formats:
    ...
    title: "跨格式精确删除"
    exclude: "XLS"
    description: "使用 GroupDocs.Watermark 瞄准不同文档类型中的特定水印。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
