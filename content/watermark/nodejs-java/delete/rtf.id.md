...
############################# Head ############################
head_title: "Menghapus Tanda Air dengan Mudah di RTF"
head_description: "Sederhanakan pengeditan dokumen dengan fitur penghapusan tanda air GroupDocs.Watermark."

############################# Header ############################
title: "Hapus RTF Watermark dengan Mudah" 
description: "Hapus tanda air yang tidak diinginkan dengan mudah dari dokumen Anda dengan GroupDocs.Watermark."
...
steps:
    enable: true
    title: "Hapus Watermark dengan mudah dari Rtf oleh Node.js via Java"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/nodejs-java/)** merampingkan proses penghapusan tanda air dari dokumen bisnis. Tingkatkan aplikasi Node.js via Java Anda dengan mengintegrasikan perpustakaan kami dengan mulus dan mengikuti langkah-langkah sederhana berikut:
      ...
      1. **Watermarker**, dengan dokumen Rtf. API serbaguna kami memproses dokumen dengan mulus, baik yang disediakan sebagai aliran atau jalur lokal.
    ...
    code:
      ...
      content: |
        ...
        // Dapatkan Watermarker yang melewati jalur RTF sebagai argumen
...
more_formats:
    enable: true
    title: "Hapus Watermark di Seluruh Format"
    exclude: "RTF"
    description: "Hapus tanda air dari berbagai jenis dokumen dengan GroupDocs.Watermark."
    items: 
        # format loop 1
        - name: "Tanda air PDF"
          format: "PDF"
