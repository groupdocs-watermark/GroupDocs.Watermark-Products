...
############################# Head ############################
head_title: "Supprimez sans effort les filigranes dans RTF"
head_description: "Simplifiez l'édition des documents grâce à la fonction de suppression des filigranes GroupDocs.Watermark."

############################# Header ############################
title: "Supprimez facilement RTF filigranes" 
description: "Supprimez sans effort les filigranes indésirables de vos documents avec GroupDocs.Watermark."
...
steps:
    enable: true
    title: "Supprimez sans effort les filigranes de Rtf par Node.js via Java"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/nodejs-java/)** rationalise le processus de suppression des filigranes des documents commerciaux. Améliorez votre application Node.js via Java en intégrant parfaitement notre bibliothèque et en suivant ces étapes simples :
      ...
      1. **Watermarker**, avec le document Rtf. Notre API polyvalente traite de manière fluide les documents, qu'ils soient fournis sous forme de flux ou de chemin local.
    ...
    code:
      ...
      content: |
        ...
        // Obtenir un filigrane en passant le chemin RTF comme argument
...
more_formats:
    enable: true
    title: "Supprimer les filigranes dans tous les formats"
    exclude: "RTF"
    description: "Supprimez les filigranes d'un large éventail de types de documents avec GroupDocs.Watermark."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
