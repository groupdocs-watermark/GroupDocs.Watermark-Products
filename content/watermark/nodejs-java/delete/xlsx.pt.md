...
steps:
    ...
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/nodejs-java/)** agiliza o processo de remoção de marcas d'água de documentos comerciais. Eleve seu aplicativo Node.js via Java integrando perfeitamente nossa biblioteca e seguindo estas etapas simples:
      ...
      1. Inicie o processo instanciando a classe principal, **Watermarker**, com o documento Xlsx. Nossa API versátil processa documentos perfeitamente, sejam eles fornecidos como um fluxo ou um caminho local.
    ...
    code:
      ...
      content: |
        ...
        // Excluir marca d'água de imagem no documento XLSX

        // Obtenha Watermarker passando o caminho XLSX como argumento
