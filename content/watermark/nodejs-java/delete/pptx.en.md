...
############################# Head ############################
head_title: "Delete PPTX Document Watermark"
...
steps:
    enable: true
    title: "Delete image watermarks from Pptx files by Node.js via Java"
    content: |
      ...
      1. Construct **Watermarker** object passing Pptx path
