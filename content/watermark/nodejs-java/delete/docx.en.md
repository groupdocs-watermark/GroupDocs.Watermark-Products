...
############################# Head ############################
head_title: "Delete DOCX Document Watermark"
...
steps:
    enable: true
    title: "Delete image watermarks from Docx files by Node.js via Java"
    content: |
      ...
      1. Construct **Watermarker** object passing Docx path
