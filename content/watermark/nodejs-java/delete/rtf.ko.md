...
############################# Head ############################
head_title: "RTF 에서 손쉽게 워터마크 제거"
head_description: "GroupDocs.Watermark 워터마크 삭제 기능으로 문서 편집을 간소화합니다."

############################# Header ############################
title: "RTF 개의 워터마크를 손쉽게 삭제" 
description: "GroupDocs.Watermark 를 사용하여 문서에서 원치 않는 워터마크를 손쉽게 제거할 수 있습니다."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Node.js via Java 는 .NET 환경을 사용하여 문서에서 워터마크를 삭제하기 위한 완벽한 솔루션을 제공합니다.개발자는 이 기능을 손쉽게 통합하여 PDF, Word, Excel 등을 비롯한 다양한 파일 형식에서 불필요하거나 오래된 워터마크를 제거할 수 있습니다.GroupDocs.Watermark 을 사용한 효율적인 워터마크 삭제로 문서 관리 프로세스를 개선하십시오.

############################# Steps ############################
steps:
    enable: true
    title: "Node.js via Java 의 Rtf 에서 워터마크를 손쉽게 삭제하세요."
    content: |
    ...
    code:
      ...
      content: |
        ...
        // RTF 경로를 인수로 전달하여 Watermarker 를 가져옵니다.
...
more_formats:
    enable: true
    title: "모든 형식의 워터마크 삭제"
    exclude: "RTF"
    description: "GroupDocs.Watermark 를 사용하여 다양한 문서 유형에서 워터마크를 제거합니다."
    items: 
        # format loop 1
        - name: "워터마크 PDF"
          format: "PDF"
