...
steps:
    ...
    content: |
      ...
      1. **Wasserzeichen einleiten:** Starten Sie die Dokumentverarbeitung mit der Klasse **Watermarker**, die unsere Hauptfunktionen bereitstellt. Instanziieren Sie es, indem Sie dem Konstruktor die Datei Word übergeben, die durch generierte Wasserzeichen gesichert werden soll.
    ...
    code:
      ...
      content: |
        ...
        // Textwasserzeichen für WORD generieren
        ...
        // Erhalten Sie das WORD-Ergebnis
