...
############################# Head ############################
head_title: "Créez des modèles de filigranes pour Word"
head_description: "Créez des modèles de filigrane alimentés par Node.js pour les fichiers Word, DOC et DOCX. Améliorez la sécurité des documents de manière fluide."

############################# Header ############################
title: "Création de modèles de filigrane personnalisés pour Word avec Node.js via Java" 
description: "Déployez des modèles de filigrane personnalisés avancés dans différents formats compatibles avec Word à l'aide de Node.js. Améliorez l'intégrité des documents et l'identité de l'entreprise avec un minimum d'effort."
...
steps:
    enable: true
    title: "Documents commerciaux sécurisés : générez des filigranes pour les formats Word"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/) :** Injectez notre API dans vos applications et générez des filigranes pour de nombreux formats de fichiers pris en charge.
      ...
      1. **Lancer le filigrane :** Démarrez le traitement des documents avec la classe **Watermarker** fournissant nos principales fonctionnalités. Instanciez-le en passant au constructeur le fichier Word qui est censé être sécurisé par des filigranes générés.
...
more_formats:
    enable: true
    title: "JavaScript Filigranes alimentés en Word"
    exclude: "WORD"
    description: "Notre boîte à outils Node.js fournit une plate-forme flexible pour automatiser l'intégration des filigranes dans Word documents. Personnalisez et appliquez des filigranes pour protéger vos documents et améliorer efficacement la présence de votre marque."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
