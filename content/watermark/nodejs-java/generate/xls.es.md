...
############################# Head ############################
head_title: "Crea marcas de agua en XLS con Node.js"
head_description: "Usa Node.js para generar marcas de agua en XLS archivos, lo que mejora la seguridad de tus Excel documentos."

############################# Header ############################
title: "Genere marcas de agua Node.js para archivos XLS" 
description: "Implemente marcas de agua sólidas en XLS hojas de cálculo con Node.js, diseñadas para proteger los datos financieros y personales en Excel."
...
steps:
    enable: true
    title: "Proteja los documentos empresariales: genere Xls marcas de agua"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/) :**: una potente solución de generación de marcas de agua para Node.js via Java.
      ...
      4. **Aplicación de marcas de agua y almacenamiento seguro**: incorpore sus marcas de agua mediante el método**Watermarker**. La biblioteca le permite agregar varias marcas de agua si es necesario para mejorar la protección. Se recomienda guardar el documento Xls modificado en una ubicación separada y segura para conservar el archivo original y proteger los documentos con marcas de agua.
...
more_formats:
    enable: true
    title: "Aplicación de marcas de agua a XLS con Node.js"
    exclude: "XLS"
    description: "Utilice Node.js para generar e integrar dinámicamente marcas de agua personalizadas en archivos XLS, a fin de proteger sus Excel datos de forma eficaz."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
