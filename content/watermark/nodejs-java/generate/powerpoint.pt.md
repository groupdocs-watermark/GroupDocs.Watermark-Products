...
steps:
    enable: true
    title: "Documentos comerciais seguros: gere marcas d'água para Powerpoint formatos"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/) :** Injete nossa API em seus aplicativos e gere marcas d'água para muitos formatos de arquivo compatíveis.
      ...
      1. **Iniciar marca d'água:** Inicie o processamento de documentos com a classe **Watermarker** que fornece nossos principais recursos. Instancie-o passando para o construtor o arquivo Powerpoint que deveria estar protegido pelas marcas d'água geradas.
    ...
    code:
      ...
      content: |
        ...
        // Gere marca d'água de texto para POWERPOINT
