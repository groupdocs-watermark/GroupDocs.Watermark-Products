...
############################# Head ############################
head_title: "Generate Watermarks on JPEG with Node.js"
...
steps:
    ...
    content: |
      ...
      4. **Watermark Application and Secure Storage**: Incorporate your watermarks using the **Watermarker's** method. The library allows you to add multiple watermarks if necessary for enhanced protection. It's recommended to save the modified Jpeg document to a separate, secure location to preserve the original file and safeguard your watermarked documents.
...
more_formats:
    enable: true
    title: "Add Secure Watermarks to JPEG with Node.js"
    exclude: "JPEG"
    description: "Implement Node.js to embed customizable, secure watermarks into JPEG images, protecting and marking digital content effectively."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
