...
steps:
    enable: true
    title: "Proteggi i documenti aziendali: genera filigrane per i formati Word"
    content: |
      ...
      1. **Avvia filigrana:** avvia l'elaborazione dei documenti con la classe **Watermarker** che fornisce le nostre funzionalità principali. Creane un'istanza passando al costruttore il file Word che dovrebbe essere protetto dalle filigrane generate.
    ...
    code:
      ...
      content: |
        ...
        // Genera filigrana di testo per WORD
