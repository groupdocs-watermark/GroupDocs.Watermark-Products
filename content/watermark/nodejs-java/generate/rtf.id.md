...
steps:
    enable: true
    title: "Lindungi Dokumen Bisnis: Hasilkan Rtf Watermark"
    content: |
    ...
    code:
      ...
      content: |
        ...
        // Hasilkan tanda air gambar untuk RTF
