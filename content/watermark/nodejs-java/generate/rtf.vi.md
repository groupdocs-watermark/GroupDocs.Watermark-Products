...
############################# Head ############################
head_title: "Nhúng hình mờ trong RTF với Node.js"
head_description: "Sử dụng Node.js để tích hợp hình mờ vào RTF tài liệu, bảo vệ nội dung một cách dễ dàng."

############################# Header ############################
title: "Tạo hình mờ cho RTF Tài liệu thông qua Node.js" 
description: "Triển khai Node.js để thêm hình mờ tùy chỉnh vào tệp RTF, lý tưởng để bảo mật MS Word và tài liệu văn bản chống lại việc sử dụng trái phép."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Node.js via Java trang bị cho các nhà phát triển Node.js khả năng tạo và quản lý hình mờ đặc biệt cho RTF tài liệu. API này cho phép nhúng chính xác hình mờ văn bản hoặc hình ảnh, tăng cường bảo mật tài liệu và bảo vệ bản quyền. Tùy chỉnh hình mờ để hiển thị hoặc vô hình dựa trên độ nhạy của thông tin, điều chỉnh độ mờ, kích thước và vị trí để đảm bảo chúng hòa quyện một cách tự nhiên với nội dung tài liệu. Hoàn hảo cho các tài liệu pháp lý, báo cáo công ty và bất kỳ tài liệu văn bản nhạy cảm nào, GroupDocs.Watermark hỗ trợ tùy chỉnh rộng rãi để đáp ứng các nhu cầu bảo mật cụ thể trong các môi trường Node.js khác nhau.
...
more_formats:
    enable: true
    title: "Bảo mật RTF tệp bằng hình mờ Node.js"
    exclude: "RTF"
    description: "Sử dụng Node.js để triển khai hình mờ động trong tệp RTF, đảm bảo cả bảo mật và tính toàn vẹn của nội dung văn bản của bạn."
    items: 
        # format loop 1
        - name: "Hình mờ PDF"
          format: "PDF"
