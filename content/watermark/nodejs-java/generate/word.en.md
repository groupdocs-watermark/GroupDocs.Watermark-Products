...
steps:
    enable: true
    title: "Generate Word text watermark by Node.js via Java"
    content: |
      Generate text watermarks with [GroupDocs.Watermark](https://products.groupdocs.com/watermark/nodejs-java/) and add watermarks to Word files using Node.js via Java applications.
      
      1. Generate **Watermarker** passing Word file path or stream
