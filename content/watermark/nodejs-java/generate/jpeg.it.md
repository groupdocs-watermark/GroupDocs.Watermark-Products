...
############################# Head ############################
head_title: "Genera filigrane su JPEG con Node.js"
head_description: "Crea filigrane sicure e invisibili per JPEG immagini utilizzando Node.js, salvaguardando i diritti d'autore."

############################# Header ############################
title: "Componi filigrane per JPEG tramite Node.js" 
description: "Utilizza Node.js per aggiungere filigrane robuste ai file JPEG, assicurando che le tue immagini siano protette dall'uso non autorizzato e dalla violazione del copyright."
...
more_formats:
    enable: true
    title: "Aggiungi filigrane sicure a JPEG con Node.js"
    exclude: "JPEG"
    description: "Implementa Node.js per incorporare filigrane sicure e personalizzabili in JPEG immagini, proteggendo e contrassegnando i contenuti digitali in modo efficace."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
