...
############################# Head ############################
head_title: "Sematkan Watermark di XLSX dengan Node.js"
head_description: "Manfaatkan Node.js untuk menghasilkan dan menerapkan tanda air di XLSX file, mengamankan dokumen Excel Anda."

############################# Header ############################
title: "Amankan XLSX Lembar dengan Node.js" 
description: "Gunakan Node.js API untuk membuat tanda air yang dapat disesuaikan untuk file XLSX, sempurna untuk meningkatkan integritas dokumen dan melindungi informasi sensitif."
...
steps:
    enable: true
    title: "Lindungi Dokumen Bisnis: Hasilkan Xlsx Watermark"
    content: |
    ...
    code:
      ...
      content: |
        ...
        // Hasilkan tanda air gambar untuk XLSX
...
more_formats:
    enable: true
    title: "Menerapkan Watermark di XLSX dengan Node.js"
    exclude: "XLSX"
    description: "Terapkan Node.js untuk menambahkan tanda air canggih dan aman secara efisien ke file XLSX, melindungi data profesional Excel Anda."
    items: 
        # format loop 1
        - name: "Tanda air PDF"
          format: "PDF"
