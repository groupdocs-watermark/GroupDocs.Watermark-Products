...
steps:
    enable: true
    title: "Lindungi Dokumen Bisnis: Hasilkan Tanda Air Xls"
    content: |
    ...
    code:
      ...
      content: |
        ...
        // Buat tanda air gambar untuk XLS
