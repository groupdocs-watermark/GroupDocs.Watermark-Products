...
############################# Head ############################
head_title: "Buat Watermark di XLS dengan Node.js"
head_description: "Gunakan Node.js untuk menghasilkan tanda air di XLS file, meningkatkan keamanan dokumen Excel Anda."

############################# Header ############################
title: "Hasilkan Watermark Node.js untuk File XLS" 
description: "Terapkan watermarking yang kuat di lembar bentang XLS dengan Node.js, dirancang untuk melindungi data keuangan dan pribadi di Excel."
...
steps:
    ...
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/) :** - Solusi Pembuatan Tanda Air yang Kuat untuk Node.js via Java.
      ...
      1. **Merampingkan Watermarking Aman di Aplikasi Node.js via Java Anda:** Kelas **Watermarker** bertindak sebagai komponen inti dari GroupDocs.Watermark API. Pustaka ini menyederhanakan pembuatan tanda air berbagai format dokumen, termasuk Xls. Untuk memulai, buat instance Watermarker sebelum memproses dokumen Anda. Berikan jalur file Xls atau objek aliran ke konstruktor selama inisialisasi.
    ...
    code:
      ...
      content: |
        ...
        // Hasilkan tanda air gambar untuk XLS
...
more_formats:
    enable: true
    title: "Menerapkan Watermark ke XLS dengan Node.js"
    exclude: "XLS"
    description: "Manfaatkan Node.js untuk secara dinamis menghasilkan dan mengintegrasikan tanda air khusus ke dalam file XLS, melindungi data Excel Anda secara efektif."
    items: 
        # format loop 1
        - name: "Tanda air PDF"
          format: "PDF"
