...
steps:
    enable: true
    title: "Generate Photo text watermark by Node.js via Java"
    content: |
      Generate text watermarks with [GroupDocs.Watermark](https://products.groupdocs.com/watermark/nodejs-java/) and add watermarks to Photo files using Node.js via Java applications.
      
      1. Generate **Watermarker** passing Photo file path or stream
