...
steps:
    enable: true
    title: "Proteja documentos comerciais: gere Xls marcas d'água"
    content: |
    ...
    code:
      ...
      content: |
        ...
        // Gere marca d'água de imagem para XLS
