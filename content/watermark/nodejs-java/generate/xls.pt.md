...
############################# Head ############################
head_title: "Crie marcas d'água em XLS com Node.js"
head_description: "Use o Node.js para gerar marcas d'água em XLS arquivos, aumentando a segurança de seus Excel documentos."

############################# Header ############################
title: "Gere marcas d'água Node.js para XLS arquivos" 
description: "Implemente marcas d'água robustas em XLS planilhas com o Node.js, adaptadas para proteger dados financeiros e pessoais em Excel."
...
steps:
    enable: true
    title: "Proteja documentos comerciais: gere marcas d'água Xls"
    content: |
      ...
      4. **Aplicação de marca d'água e armazenamento seguro**: incorpore suas marcas d'água usando o método **Watermarker**. A biblioteca permite adicionar várias marcas d'água, se necessário, para proteção aprimorada. É recomendado salvar o documento Xls modificado em um local separado e seguro para preservar o arquivo original e proteger seus documentos com marca d'água.
    ...
    code:
      ...
      content: |
        ...
        // Gerar marca d'água de imagem para XLS
...
more_formats:
    enable: true
    title: "Aplicando marcas d'água a XLS com Node.js"
    exclude: "XLS"
    description: "Utilize o Node.js para gerar e integrar dinamicamente marcas d'água personalizadas em XLS arquivos, protegendo seus Excel dados de forma eficaz."
    items: 
        # format loop 1
