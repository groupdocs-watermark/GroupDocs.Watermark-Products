...
steps:
    enable: true
    title: "Proteja documentos comerciais: gere Rtf marcas d'água"
    content: |
    ...
    code:
      ...
      content: |
        ...
        // Gere marca d'água de imagem para RTF
