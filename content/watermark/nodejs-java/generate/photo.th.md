...
############################# Head ############################
head_title: "รักษาความปลอดภัยภาพถ่ายด้วยลายน้ำขั้นสูงใน Node.js"
head_description: "เร่งกระบวนการทำลายน้ำภาพถ่ายของคุณด้วย Node.jsใช้โซลูชันการเข้ารหัสที่รวดเร็วและใช้งานง่าย"

############################# Header ############################
title: "ภาพถ่ายที่ปลอดภัยด้วยลายน้ำขั้นสูงใน Node.js via Java" 
description: "ปรับใช้กลยุทธ์การทำลายน้ำขั้นสูงในเวิร์กโฟลว์การประมวลผลภาพของคุณด้วย Node.jsชุดเครื่องมือของเรารองรับการปรับแต่งอย่างกว้างขวางสำหรับไฟล์ภาพ JPG, PNG และ WEBP"
...
steps:
    enable: true
    title: "เอกสารธุรกิจที่ปลอดภัย: สร้างลายน้ำสำหรับรูปแบบ Photo"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/) :** ฉีด API ของเราไปยังแอปพลิเคชันของคุณและสร้างลายน้ำสำหรับรูปแบบไฟล์ที่รองรับมากมาย
      ...
      1. **เริ่มทำลายน้ำ:** เริ่มการประมวลผลเอกสารด้วยคลาส**Watermarker** ที่มีคุณสมบัติหลักของเราสร้างอินสแตนซ์โดยส่งไฟล์ Photo ไปยังผู้สร้างซึ่งควรได้รับการรักษาความปลอดภัยโดยลายน้ำที่สร้างขึ้น
...
more_formats:
    enable: true
    title: "ลายน้ำป้องกันใน JavaScript สำหรับภาพถ่าย"
    exclude: "PHOTO"
    description: "เพิ่มความปลอดภัยของภาพถ่ายของคุณด้วยเทคนิคการทำลายน้ำขั้นสูงที่ปรับแต่งได้ใน Node.jsปกป้องรูปภาพของคุณในรูปแบบต่างๆ รวมถึง JPG, PNG และ WEBP โดยไม่สูญเสียคุณภาพ"
    items: 
        # format loop 1
        - name: "ลายน้ำ PDF"
          format: "PDF"
