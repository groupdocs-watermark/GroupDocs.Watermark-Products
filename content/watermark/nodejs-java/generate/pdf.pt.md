...
steps:
    enable: true
    title: "Proteja documentos comerciais: gere Pdf marcas d'água"
    content: |
    ...
    code:
      ...
      content: |
        ...
        // Gere marca d'água de imagem para PDF
