...
steps:
    enable: true
    title: "Documenti aziendali sicuri: genera filigrane per i formati Excel"
    content: |
      **[GroupDocs.Watermark for Node.js via Java](https://products.groupdocs.com/watermark/nodejs-java/) :** Inserisci la nostra API nelle tue applicazioni e genera filigrane per molti formati di file supportati.
      ...
      1. **Avvia filigrana:** Avvia l'elaborazione dei documenti con la classe **Watermarker** che fornisce le nostre funzionalità principali. Istanziatelo passando al costruttore il file Excel che dovrebbe essere protetto dalle filigrane generate.
    ...
    code:
      ...
      content: |
        ...
        // Genera una filigrana di testo per EXCEL
