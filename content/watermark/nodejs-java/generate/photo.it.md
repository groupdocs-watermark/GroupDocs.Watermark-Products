...
############################# Head ############################
head_title: "Proteggi le foto con filigrana avanzata in Node.js"
head_description: "Velocizza il processo di filigrana delle foto con Node.js. Implementa soluzioni di codifica rapide e facili da usare."

############################# Header ############################
title: "Proteggi le foto con filigrana avanzata in Node.js via Java" 
description: "Implementa strategie avanzate di filigrana nei tuoi flussi di lavoro di elaborazione delle foto con Node.js. Il nostro toolkit supporta un'ampia personalizzazione per i file di immagine JPG, PNG e WEBP."
...
about:
    ...
    content: |
       Con GroupDocs.Watermark for Node.js via Java, proteggere le tue foto con filigrane avanzate è semplice e flessibile. Questa API consente l'applicazione rapida di filigrane basate su testo o immagini personalizzabili in base all'estetica della foto sottostante. Supporta diversi formati di immagine e fornisce un controllo preciso sul posizionamento e sull'aspetto delle filigrane, il che aiuta a proteggerle dall'uso non autorizzato mantenendo l'integrità della foto.

############################# Steps ############################
steps:
    enable: true
    title: "Proteggi i documenti aziendali: genera filigrane per i formati Photo"
    content: |
      ...
      1. **Avvia filigrana:** avvia l'elaborazione dei documenti con la classe **Watermarker** che fornisce le nostre funzionalità principali. Creane un'istanza passando al costruttore il file Photo che dovrebbe essere protetto dalle filigrane generate.
    ...
    code:
      ...
      content: |
        ...
        // Genera filigrana di testo per PHOTO
...
more_formats:
    enable: true
    title: "Filigrana protettiva in JavaScript per foto"
    exclude: "PHOTO"
    description: "Migliora la sicurezza delle tue foto con tecniche di filigrana avanzate e personalizzabili in Node.js. Proteggi le tue foto in vari formati, tra cui JPG, PNG e WEBP, senza sacrificare la qualità."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
