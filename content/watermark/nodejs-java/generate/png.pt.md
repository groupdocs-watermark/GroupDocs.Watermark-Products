...
steps:
    enable: true
    title: "Proteja documentos comerciais: gere Png marcas d'água"
    content: |
    ...
    code:
      ...
      content: |
        ...
        // Gere marca d'água de imagem para PNG
