...
############################# Head ############################
head_title: "Bảo mật ảnh với Watermarking nâng cao trong Node.js"
head_description: "Tăng tốc quá trình đánh dấu hình ảnh của bạn với Node.js. Triển khai các giải pháp mã hóa nhanh chóng, dễ sử dụng."

############################# Header ############################
title: "Bảo mật ảnh với hình mờ nâng cao trong Node.js via Java" 
description: "Triển khai các chiến lược hình mờ nâng cao trong quy trình xử lý ảnh của bạn với Node.js. Bộ công cụ của chúng tôi hỗ trợ tùy chỉnh mở rộng cho các tệp hình ảnh JPG, PNG và WEBP."
...
about:
    ...
    content: |
       Với GroupDocs.Watermark for Node.js via Java, việc bảo vệ ảnh của bạn bằng hình mờ tiên tiến rất đơn giản và linh hoạt. API này cho phép ứng dụng nhanh chóng các hình mờ dựa trên văn bản hoặc hình ảnh có thể tùy chỉnh để phù hợp với tính thẩm mỹ của ảnh bên dưới. Nó hỗ trợ các định dạng hình ảnh đa dạng và cung cấp sự kiểm soát chính xác đối với vị trí và giao diện hình mờ, giúp bảo vệ chống lại việc sử dụng trái phép trong khi vẫn duy trì tính toàn vẹn của ảnh.

############################# Steps ############################
steps:
    enable: true
    title: "Tài liệu kinh doanh an toàn: Tạo hình mờ cho định dạng Photo"
    content: |
      ...
      1. **Bắt đầu tạo hình mờ:** Bắt đầu xử lý tài liệu với lớp **Watermarker** cung cấp các tính năng chính của chúng tôi. Khởi tạo nó bằng cách chuyển đến hàm tạo tệp Photo được cho là được bảo mật bằng hình mờ được tạo.
...
more_formats:
    enable: true
    title: "Chữ mờ bảo vệ trong JavaScript cho ảnh"
    exclude: "PHOTO"
    description: "Tăng cường bảo mật ảnh của bạn với các kỹ thuật tạo hình mờ nâng cao, có thể tùy chỉnh trong Node.js. Bảo vệ ảnh của bạn trên nhiều định dạng khác nhau, bao gồm JPG, PNG và WEBP, mà không làm giảm chất lượng."
    items: 
        # format loop 1
        - name: "Hình mờ PDF"
          format: "PDF"
