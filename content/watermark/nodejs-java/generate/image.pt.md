...
steps:
    enable: true
    title: "Documentos comerciais seguros: gere marcas d'água para formatos Image"
    content: |
      ...
      1. **Iniciar marca d'água:** Inicie o processamento do documento com a classe **Watermarker** que fornece nossos principais recursos. Instancie-o passando para o construtor o arquivo Image que deve ser protegido por marcas d'água geradas.
    ...
    code:
      ...
      content: |
        ...
        // Gerar marca d'água de texto para IMAGE
