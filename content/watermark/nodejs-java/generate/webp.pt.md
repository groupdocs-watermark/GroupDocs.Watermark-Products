...
############################# Head ############################
head_title: "Incorpore marcas d'água em WEBP com Node.js"
head_description: "Use o Node.js para aplicar marcas d'água avançadas em WEBP imagens, aprimorando a proteção e os direitos autorais."

############################# Header ############################
title: "Crie marcas d'água para WEBP imagens via Node.js" 
description: "Implemente o Node.js para gerar marcas d'água personalizadas e seguras para WEBP arquivos, ideais para criadores de conteúdo digital que desejam proteger seus recursos visuais."
...
steps:
    enable: true
    title: "Proteja documentos comerciais: gere Webp marcas d'água"
    content: |
    ...
    code:
      ...
      content: |
        ...
        // Gere marca d'água de imagem para WEBP
...
more_formats:
    enable: true
    title: "Proteja arquivos WEBP com marcas d'água Node.js"
    exclude: "WEBP"
    description: "Implante o Node.js para inserir marcas d'água robustas e personalizáveis em WEBP imagens, garantindo a proteção dos direitos autorais e da visibilidade da marca."
    items: 
        # format loop 1
