...
############################# Head ############################
head_title: "Remake Watermark for Presentations"
...
############################# Header ############################
title: "Remake Watermark for Document of MS Word formats with .NET" 
...
steps:
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Remake POWERPOINT text watermark
