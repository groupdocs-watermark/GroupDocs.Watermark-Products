...
############################# Head ############################
head_title: "Sematkan Watermark di XLSX dengan C #"
head_description: "Manfaatkan .NET C# untuk menghasilkan dan menerapkan tanda air di XLSX file, mengamankan Excel dokumen Anda."

############################# Header ############################
title: "Amankan XLSX Lembar dengan .NET C#" 
description: "Gunakan .NET C# untuk membuat tanda air yang dapat disesuaikan untuk file XLSX, sempurna untuk meningkatkan integritas dokumen dan melindungi informasi sensitif."
...
steps:
    ...
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/) :** Pustaka Watermarking Tingkat Lanjut untuk aplikasi .NET. Berdayakan solusi Anda dan amankan dokumen dengan tanda air tepat waktu.
      ...
      1. **Kelas Inti: Watermarker.** Kelas utama API kami adalah **Watermarker**. Anda perlu membuat instansiasinya sebelum pemrosesan dokumen. Jangan lupa untuk meneruskan file Xlsx ke konstruktor sebagai jalur atau objek aliran.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Hasilkan tanda air gambar dalam file XLSX
        ...
        using (Watermarker watermarker = new Watermarker("input.xlsx"))
        {
            ...
            // Simpan hasil XLSX yang ditandai dengan tanda air
...
more_formats:
    enable: true
    title: "Menerapkan Watermark di XLSX dengan C #"
    exclude: "XLSX"
    description: "Terapkan .NET C# untuk menambahkan tanda air canggih dan aman secara efisien ke file XLSX, melindungi data profesional Excel Anda."
    items: 
        # format loop 1
        - name: "Tanda air PDF"
          format: "PDF"
