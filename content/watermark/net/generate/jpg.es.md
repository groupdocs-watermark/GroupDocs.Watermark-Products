...
############################# Head ############################
head_title: "Marca de agua en C# para JPG imágenes"
head_description: "Integre marcas de agua en archivos JPG con .NET C# para proteger sus imágenes digitales de manera eficaz."

############################# Header ############################
title: "Proteja JPG imágenes con .NET C#" 
description: "Aplica .NET C# para crear marcas de agua sólidas para JPG imágenes, ideales para proteger los derechos de autor y evitar el uso no autorizado."
...
about:
    ...
    content: |
       GroupDocs.Watermark for .NET proporciona a los desarrolladores de .NET C# un marco avanzado para añadir marcas de agua a JPG imágenes. Esta API permite incrustar con precisión texto, logotipos y marcas de agua gráficas personalizables en cuanto a opacidad, posición y tamaño, lo que resulta perfecto para los medios digitales y la fotografía profesional. Mejore la seguridad de sus imágenes sin sacrificar la calidad, con funciones diseñadas para incrustar marcas de agua que impidan la piratería y, al mismo tiempo, mantengan la integridad de las ilustraciones originales. Apto para una amplia gama de aplicaciones, desde la protección fotográfica personal hasta el uso comercial en publicidad y medios de comunicación, GroupDocs.Watermark garantiza que sus recursos visuales estén marcados de forma exclusiva y protegidos legalmente.

############################# Steps ############################
steps:
    enable: true
    title: "Genere marcas de agua sin esfuerzo para documentos Jpg"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/):** Biblioteca avanzada de marcas de agua para aplicaciones .NET. Potencia tu solución y protege documentos con marcas de agua justo a tiempo.
      ...
      1. **Clase principal: Watermarker.** La clase principal de nuestra API es **Watermarker**. Debe crear una instancia antes de procesar el documento. No olvide pasar el archivo Jpg al constructor como una ruta o un objeto de secuencia.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Generar marca de agua de imagen en el archivo JPG
        ...
        using (Watermarker watermarker = new Watermarker("input.jpg"))
        {
            ...
            // Guardar el resultado JPG con marca de agua
...
more_formats:
    enable: true
    title: "Implemente marcas de agua en JPG con C#"
    exclude: "JPG"
    description: "Aproveche .NET C# para incrustar marcas de agua invisibles o visibles en archivos JPG, algo esencial para un contenido digital seguro y reconocible."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
