...
############################# Head ############################
head_title: "Adicione marcas d'água a WEBP com C#"
head_description: "Utilize .NET C# para gerar e incorporar dinamicamente marcas d'água em WEBP imagens, garantindo proteção abrangente."

############################# Header ############################
title: "Gere marcas d'água para WEBP com C#" 
description: "Crie e aplique marcas d'água personalizadas em WEBP arquivos usando .NET C#, perfeitas para artistas digitais e criadores de conteúdo que precisam proteger seu trabalho."
...
about:
    ...
    content: |
       O GroupDocs.Watermark for .NET fornece aos desenvolvedores os recursos para gerar, compor e adicionar marcas d'água sofisticadas às imagens WEBP via .NET C#. Essa API permite a personalização precisa de marcas d'água, incluindo texto, logotipos e assinaturas digitais. Personalize a opacidade, o tamanho e o posicionamento da sua marca d'água para obter uma integração perfeita sem comprometer a estética da imagem. Ideal para fotógrafos, designers gráficos e qualquer profissional envolvido na produção e distribuição de imagens digitais, o GroupDocs.Watermark garante que seus direitos autorais sejam incorporados com segurança aos seus arquivos WEBP. Compatível com todas as estruturas .NET modernas, ele aprimora a segurança da imagem com impacto mínimo na qualidade visual.
...
more_formats:
    enable: true
    title: "Protegendo WEBP imagens com .NET marcas d'água C#"
    exclude: "WEBP"
    description: "Incorpore marcas d'água avançadas e personalizáveis em WEBP imagens usando .NET C#, fornecendo proteção robusta e reconhecimento visual aos seus trabalhos criativos."
    items: 
        # format loop 1
