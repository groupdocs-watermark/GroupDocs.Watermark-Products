...
############################# Head ############################
head_title: "Marca de agua en C# para documentos de RTF"
head_description: "Incorpore .NET marcas de agua en C# en archivos RTF para mejorar la seguridad de sus Word documentos."

############################# Header ############################
title: "Proteja RTF con .NET marcas de agua en C#" 
description: "Utilice .NET C# para aplicar marcas de agua seguras y personalizables a RTF archivos, lo que resulta perfecto para mantener la integridad de los documentos en entornos de MS Word."
...
about:
    ...
    content: |
       GroupDocs.Watermark for .NET equipa a .NET desarrolladores de C# con herramientas sofisticadas para añadir marcas de agua a RTF documentos de forma eficaz. Esta API permite la integración de marcas de agua visibles y transparentes que se pueden personalizar en términos de fuente, color, tamaño y posición, garantizando que se integren perfectamente en el documento sin obstaculizar la legibilidad. Ideal para documentos legales, documentos de propiedad intelectual y comunicaciones confidenciales, GroupDocs.Watermark proporciona una protección esencial contra la copia y modificación no autorizadas. La herramienta está diseñada para ser compatible con todas las versiones de .NET, lo que facilita una solución segura y adaptable para la creación de marcas de agua en los documentos.

############################# Steps ############################
steps:
    enable: true
    title: "Genere marcas de agua sin esfuerzo para documentos Rtf"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/):** Biblioteca avanzada de marcas de agua para aplicaciones .NET. Potencia tu solución y protege documentos con marcas de agua justo a tiempo.
      ...
      1. **Clase principal: Watermarker.** La clase principal de nuestra API es **Watermarker**. Debe crear una instancia antes de procesar el documento. No olvide pasar el archivo Rtf al constructor como una ruta o un objeto de secuencia.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Generar marca de agua de imagen en el archivo RTF
        ...
        using (Watermarker watermarker = new Watermarker("input.rtf"))
        {
            ...
            // Guardar el resultado RTF con marca de agua
...
more_formats:
    enable: true
    title: "Implementación de marcas de agua en RTF con C#"
    exclude: "RTF"
    description: "Implemente .NET C# para crear marcas de agua sólidas y sutiles en RTF documentos, reforzando la seguridad y la autenticidad de sus Word archivos."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
