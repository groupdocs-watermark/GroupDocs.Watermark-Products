...
steps:
    enable: true
    title: "Menghasilkan Tanda Air dengan Mudah untuk Dokumen Jpeg"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/):** Pustaka Watermarking tingkat lanjut untuk aplikasi .NET. Berdayakan solusi Anda dan amankan dokumen dengan tanda air tepat pada waktunya.
      ...
      1. **Kelas Inti: Watermarker.** Kelas utama API kami adalah **Watermarker**. Anda perlu membuat instance sebelum pemrosesan dokumen. Jangan lupa meneruskan file Jpeg ke konstruktor sebagai jalur atau objek aliran.
    ...
    code:
      ...
      content: |
        ...
        using (Watermarker watermarker = new Watermarker("input.jpeg"))
        {
            ...
            // Simpan hasil JPEG yang diberi watermark
