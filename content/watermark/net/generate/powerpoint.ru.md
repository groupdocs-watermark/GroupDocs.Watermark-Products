...
steps:
    enable: true
    title: "Улучшите свои документы: создайте водяные знаки для Powerpoint с помощью .NET"
    content: |
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Сгенерировать текстовый водяной знак в файле POWERPOINT
