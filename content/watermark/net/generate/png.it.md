...
############################# Head ############################
head_title: "Proteggi PNG con .NET filigrane C#"
head_description: "Incorpora filigrane nei file PNG usando .NET C#, perfetto per il copyright e la sicurezza delle immagini."

############################# Header ############################
title: "Filigrana C# per file PNG" 
description: "Utilizza .NET C# per applicare filigrane avanzate a PNG immagini, salvaguardando efficacemente i contenuti artistici e digitali."
...
about:
    ...
    content: |
       GroupDocs.Watermark for .NET fornisce un toolkit specializzato in .NET C# per incorporare filigrane nei file PNG, rivolto ad artisti, designer e creatori di contenuti che hanno bisogno di proteggere le proprie risorse visive. Questa API consente l'aggiunta senza soluzione di continuità di filigrane trasparenti e opache che possono essere posizionate e ridimensionate in modo complesso per mantenere l'integrità dell'immagine originale garantendo al contempo la protezione legale. Le funzionalità includono filigrane personalizzate per testo e immagini, controllo preciso sull'opacità della filigrana e la possibilità di aggiungere filigrane multistrato per una maggiore sicurezza. Sia per uso personale che per portfolio professionali, GroupDocs.Watermark assicura che le PNG immagini siano protette dalla riproduzione e dall'uso non autorizzati e completamente supportate in ambienti .NET.

############################# Steps ############################
steps:
    enable: true
    title: "Genera facilmente filigrane per documenti Png"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/):** Libreria avanzata di filigrana per applicazioni .NET. Potenzia la tua soluzione e proteggi i documenti con filigrane appena in tempo.
      ...
      1. **Classe principale: Watermarker.** La classe principale della nostra API è **Watermarker**. È necessario crearne un'istanza prima dell'elaborazione del documento. Non dimenticare di passare il file Png al costruttore come percorso o oggetto stream.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Genera filigrana immagine nel file PNG
        ...
        using (Watermarker watermarker = new Watermarker("input.png"))
        {
            ...
            // Salva il risultato PNG con filigrana
...
more_formats:
    enable: true
    title: "Implementazione delle filigrane in PNG con C#"
    exclude: "PNG"
    description: "Utilizza .NET C# per creare filigrane discrete o in grassetto nelle PNG immagini, garantendo flessibilità estetica e una solida protezione del copyright."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
