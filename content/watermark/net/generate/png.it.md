...
steps:
    enable: true
    title: "Genera facilmente filigrane per Png documenti"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/) :** Libreria avanzata di filigrana per applicazioni .NET. Potenzia la tua soluzione e proteggi i documenti con filigrane appena in tempo.
      ...
      1. **Classe principale: Watermarker** La classe principale della nostra API è **Watermarker**. È necessario istanziarlo prima dell'elaborazione del documento. Non dimenticare di passare il file Png al costruttore come percorso o oggetto stream.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Genera filigrana dell'immagine nel file PNG
        ...
        using (Watermarker watermarker = new Watermarker("input.png"))
        {
            ...
            // Salva il risultato con filigrana PNG
