    ...
    code:
      ...
      content: |
        ...
        using (Watermarker watermarker = new Watermarker("input.xslx"))
        {
            ...
            // Speichern Sie das EXCEL-Ergebnis
