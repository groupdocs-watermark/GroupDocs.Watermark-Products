...
############################# Head ############################
head_title: "Вбудовуйте водяні знаки в XLSX за допомогою C #"
head_description: "Використовуйте .NET C# для створення та застосування водяних знаків у файлах XLSX, захищаючи ваші Excel документи."

############################# Header ############################
title: "Захистіть XLSX аркуші за допомогою .NET C #" 
description: "Використовуйте .NET C# для створення настроюваних водяних знаків для файлів XLSX, ідеально підходить для підвищення цілісності документів та захисту конфіденційної інформації."
...
steps:
    ...
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/) :** Розширена бібліотека водяних знаків для .NET програм. Розширюйте можливості свого рішення та захистіть документи за допомогою водяних знаків саме вчасно.
      ...
      1. **Основний клас: Watermarker.** Основним класом нашого API є **Watermarker**. Вам потрібно створити інстанцію перед обробкою документів. Не забудьте передати файл Xlsx конструктору як шлях або об'єкт потоку.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Створіть водяний знак зображення у файлі XLSX
        ...
        using (Watermarker watermarker = new Watermarker("input.xlsx"))
        {
            ...
            // Зберегти результат з водяним знаком XLSX
...
more_formats:
    enable: true
    title: "Реалізація водяних знаків у XLSX за допомогою C #"
    exclude: "XLSX"
    description: "Розгорніть .NET C#, щоб ефективно додавати розширені захищені водяні знаки до файлів XLSX, захищаючи ваші професійні Excel дані."
    items: 
        # format loop 1
