...
############################# Head ############################
head_title: "C# Watermarks for PowerPoint Files"
...
steps:
    enable: true
    title: "Effortlessly Generate Watermarks for Ppt Documents with GroupDocs.Watermark for .NET"
    content: |
...
more_formats:
    enable: true
    title: "Securing PPT Files with C# Watermarks"
    exclude: "PPT"
    description: "Embed advanced watermarks into PowerPoint documents using .NET C#, safeguarding your presentations from misuse and copyright infringement."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
