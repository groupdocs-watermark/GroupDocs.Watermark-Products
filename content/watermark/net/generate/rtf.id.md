...
############################# Head ############################
head_title: "C# Watermarking untuk RTF Dokumen"
head_description: "Masukkan tanda air .NET C# ke dalam file RTF untuk meningkatkan keamanan dokumen Word Anda."

############################# Header ############################
title: "Amankan RTF dengan .NET C# Watermark" 
description: "Gunakan .NET C# untuk menerapkan tanda air yang aman dan dapat disesuaikan ke file RTF, sempurna untuk menjaga integritas dokumen dalam lingkungan MS Word."
...
about:
    ...
    content: |
       GroupDocs.Watermark for .NET melengkapi .NET pengembang C# dengan alat canggih untuk menambahkan tanda air ke RTF dokumen secara efektif. API ini memungkinkan integrasi tanda air yang terlihat dan transparan yang dapat disesuaikan dalam hal font, warna, ukuran, dan posisi, memastikan mereka menyatu dengan mulus ke dalam dokumen tanpa menghalangi keterbacaan. Ideal untuk dokumen hukum, kertas kekayaan intelektual, dan komunikasi sensitif, GroupDocs.Watermark memberikan perlindungan penting terhadap penyalinan dan modifikasi yang tidak sah. Alat ini dirancang agar kompatibel dengan semua versi .NET, memfasilitasi solusi yang aman dan mudah beradaptasi untuk watermarking dokumen.
...
steps:
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Hasilkan tanda air gambar dalam file RTF
...
more_formats:
    enable: true
    title: "Menerapkan Watermark di RTF dengan C #"
    exclude: "RTF"
    description: "Terapkan .NET C# untuk membuat tanda air yang kuat dan halus di dokumen RTF, memperkuat keamanan dan keaslian file Word Anda."
    items: 
        # format loop 1
        - name: "Tanda air PDF"
          format: "PDF"
