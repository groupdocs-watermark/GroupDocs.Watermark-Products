...
steps:
    enable: true
    title: "Genere marcas de agua sin esfuerzo para Ppt documentos"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/) :** Biblioteca avanzada de marcas de agua para .NET aplicaciones. Potencie su solución y proteja los documentos con marcas de agua justo a tiempo.
      ...
      1. **Clase básica: Watermarker** La clase principal de nuestra API es **Watermarker**. Debes instanciarlo antes de procesar el documento. No olvide pasar el archivo Ppt al constructor como una ruta o un objeto de flujo.
    ...
    code:
      ...
      content: |
        ...
        using (Watermarker watermarker = new Watermarker("input.ppt"))
        {
            ...
            // Guardar el resultado con marca de agua PPT
