...
############################# Head ############################
head_title: "Création de fonctionnalités avancées de filigrane pour les présentations"
head_description: "Utilisez des techniques avancées pour créer des filigranes percutants pour les présentations. Assurez la sécurité du contenu de manière fluide."

############################# Header ############################
title: "Innovez vos présentations grâce à un filigrane avancé en C#" 
description: "Intégrez des filigranes de texte et d'image de pointe dans vos PowerPoint diapositives à l'aide de notre API C#. Parfait pour renforcer la sécurité et l'attrait professionnel des présentations."
...
about:
    ...
    content: |
       GroupDocs.Watermark for .NET est conçu pour faciliter l'insertion efficace de filigranes avancés dans PowerPoint présentations. Qu'il s'agisse d'informations confidentielles ou que vous cherchiez à améliorer l'image de marque de votre entreprise sur des diapositives, notre API propose des solutions de filigrane robustes qui peuvent être adaptées à des diapositives individuelles ou à des présentations complètes. Qu'il s'agisse de simples marques de texte ou de logos élaborés, personnalisez l'apparence et l'emplacement de votre filigrane pour l'intégrer parfaitement à la conception de vos diapositives tout en offrant un niveau de sécurité supplémentaire.

############################# Steps ############################
steps:
    enable: true
    title: "Améliorez vos documents : générez des filigranes pour Powerpoint à l'aide de .NET"
    content: |
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Générer un filigrane de texte dans le fichier POWERPOINT
        ...
        using (Watermarker watermarker = new Watermarker("input.pptx"))
        {
            ...
            // Enregistrer le résultat POWERPOINT
...
more_formats:
    enable: true
    title: "Protégez et personnalisez les présentations avec des filigranes dans C#"
    exclude: "POWERPOINT"
    description: "Utilisez notre boîte à outils C# pour appliquer rapidement des filigranes personnalisés qui préservent l'intégrité et l'esthétique de vos présentations PowerPoint. Idéal pour les environnements professionnels et éducatifs."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
