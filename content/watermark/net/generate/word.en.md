...
steps:
    enable: true
    title: "Generate text watermark for Word via .NET"
    content: |
      Use [GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/) to generate text watermarks and add them to Word files in .NET applications.
      
      1. Create **Watermarker** with Word file
