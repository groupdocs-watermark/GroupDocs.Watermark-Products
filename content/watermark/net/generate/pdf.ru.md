...
############################# Head ############################
head_title: "Водяные знаки C# для защищенных PDF документов"
head_description: "Используйте .NET C# для встраивания водяных знаков в PDF, защищая официальные документы и конфиденциальную информацию."

############################# Header ############################
title: "Повысьте безопасность PDF с помощью водяных знаков C#" 
description: "Внедрите .NET C# для нанесения водяных знаков на PDF документы, обеспечивая защиту юридических, финансовых и официальных документов."
...
about:
    ...
    content: |
       GroupDocs.Watermark for .NET предлагает .NET разработчикам C# мощный API для вставки водяных знаков в файлы PDF. Это важный инструмент защиты документов в корпоративном, юридическом и государственном секторах. Этот API поддерживает широкие возможности настройки водяных знаков, включая форматирование текста, интеграцию изображений и динамическое размещение для различных макетов документов. Будь то заключение конфиденциальных соглашений, защита авторских материалов или маркировка конфиденциальной информации, GroupDocs.Watermark гарантирует, что все PDF четко и профессионально передают право собственности. Дополнительные функции включают ротацию водяных знаков, контроль прозрачности и возможности многослойного распределения, совместимые со всеми современными фреймворками .NET.

############################# Steps ############################
steps:
    enable: true
    title: "Легко создавайте водяные знаки для Pdf документов"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/) :** Расширенная библиотека водяных знаков для .NET приложений. Расширьте возможности своего решения и своевременно защитите документы водяными знаками.
      ...
      1. **Основной класс: водяной маркер.** Основным классом нашего API является **Watermarker**. Перед обработкой документа необходимо создать его экземпляр. Не забудьте передать файл Pdf в конструктор в виде пути или объекта потока.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Сгенерировать водяной знак изображения в файле PDF
        ...
        using (Watermarker watermarker = new Watermarker("input.pdf"))
        {
            ...
            // Сохранить результат с водяным знаком PDF
...
more_formats:
    enable: true
    title: "Защита PDF файлов водяными знаками C# .NET"
    exclude: "PDF"
    description: "Используйте .NET C# для встраивания защищенных специализированных водяных знаков в PDF документы, что идеально подходит для защиты официальной и конфиденциальной информации."
    items: 
        # format loop 1
