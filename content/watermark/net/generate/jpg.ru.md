...
steps:
    enable: true
    title: "Легко создавайте водяные знаки для Jpg документов"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/) :** Расширенная библиотека водяных знаков для .NET приложений. Расширьте возможности своего решения и своевременно защитите документы водяными знаками.
      ...
      1. **Основной класс: водяной маркер.** Основным классом нашего API является **Watermarker**. Перед обработкой документа необходимо создать его экземпляр. Не забудьте передать файл Jpg в конструктор в виде пути или объекта потока.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Сгенерировать водяной знак изображения в файле JPG
        ...
        using (Watermarker watermarker = new Watermarker("input.jpg"))
        {
            ...
            // Сохранить результат с водяным знаком JPG
