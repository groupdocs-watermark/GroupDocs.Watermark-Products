...
############################# Head ############################
head_title: "Filigrana C# per documenti RTF"
head_description: "Incorpora filigrane .NET C# nei file RTF per migliorare la sicurezza dei tuoi documenti Word."

############################# Header ############################
title: "Proteggi RTF con .NET filigrane C#" 
description: "Usa .NET C# per applicare filigrane sicure e personalizzabili ai file RTF, perfette per mantenere l'integrità dei documenti all'interno di MS Word ambienti."
...
about:
    ...
    content: |
       GroupDocs.Watermark for .NET fornisce agli sviluppatori .NET C# strumenti sofisticati per aggiungere filigrane ai documenti RTF in modo efficace. Questa API consente l'integrazione di filigrane visibili e trasparenti che possono essere personalizzate in termini di carattere, colore, dimensione e posizione, assicurando che si integrino perfettamente nel documento senza ostacolare la leggibilità. Ideale per documenti legali, documenti sulla proprietà intellettuale e comunicazioni sensibili, GroupDocs.Watermark offre una protezione essenziale contro copie e modifiche non autorizzate. Lo strumento è progettato per essere compatibile con tutte le versioni di .NET, facilitando una soluzione sicura e adattabile per la filigrana dei documenti.

############################# Steps ############################
steps:
    enable: true
    title: "Genera facilmente filigrane per documenti Rtf"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/):** Libreria avanzata di filigrana per applicazioni .NET. Potenzia la tua soluzione e proteggi i documenti con filigrane appena in tempo.
      ...
      1. **Classe principale: Watermarker.** La classe principale della nostra API è **Watermarker**. È necessario crearne un'istanza prima dell'elaborazione del documento. Non dimenticare di passare il file Rtf al costruttore come percorso o oggetto stream.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Genera filigrana immagine nel file RTF
        ...
        using (Watermarker watermarker = new Watermarker("input.rtf"))
        {
            ...
            // Salva il risultato RTF con filigrana
...
more_formats:
    enable: true
    title: "Implementazione delle filigrane in RTF con C#"
    exclude: "RTF"
    description: "Usa .NET C# per creare filigrane robuste e discrete nei documenti RTF, rafforzando la sicurezza e l'autenticità dei tuoi file Word."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
