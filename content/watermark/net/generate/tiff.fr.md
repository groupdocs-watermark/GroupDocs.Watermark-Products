...
############################# Head ############################
head_title: "Générez TIFF filigranes avec C#"
head_description: "Composez et ajoutez des filigranes précis à TIFF images en utilisant .NET C#, afin de protéger votre contenu numérique."

############################# Header ############################
title: "Composez des filigranes pour TIFF en C#" 
description: "Générez des filigranes personnalisés et robustes dans TIFF fichiers à l'aide de .NET C#, ce qui est essentiel pour protéger et gérer les images numériques et d'archives."
...
about:
    ...
    content: |
       GroupDocs.Watermark for .NET fournit une boîte à outils C# .NET complète pour générer, composer et ajouter des filigranes aux fichiers TIFF. Cette solution répond aux besoins uniques des archives numériques et de la photographie professionnelle, où le maintien de la qualité de l'image et la protection des droits d'auteur sont primordiaux. Les utilisateurs peuvent personnaliser l'opacité, l'échelle et l'emplacement des filigranes pour s'assurer qu'ils sont parfaitement intégrés sans nuire à l'image. La possibilité de générer des filigranes textuels ou graphiques, associée à des fonctionnalités avancées telles que la superposition de filigranes et la mise en forme conditionnelle, font de GroupDocs.Watermark un outil indispensable pour tous ceux qui ont besoin de protéger leurs actifs visuels. Entièrement compatible avec les derniers environnements .NET, cette API améliore votre capacité à gérer et à sécuriser efficacement TIFF images.

############################# Steps ############################
steps:
    enable: true
    title: "Générez sans effort des filigranes pour les documents Tiff"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/) :** Bibliothèque de filigrane avancée pour les applications .NET. Renforcez votre solution et sécurisez les documents avec des filigranes juste à temps.
      ...
      1. **Classe principale : Watermarker.** La classe principale de notre API est **Watermarker**. Vous devez l'instancier avant le traitement du document. N'oubliez pas de transmettre le fichier Tiff au constructeur en tant que chemin ou objet flux.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Générer un filigrane d'image dans le fichier TIFF
        ...
        using (Watermarker watermarker = new Watermarker("input.tiff"))
        {
            ...
            // Enregistrer le résultat TIFF filigrané
...
more_formats:
    enable: true
    title: "Améliorer la sécurité TIFF avec des filigranes C#"
    exclude: "TIFF"
    description: "Utilisez .NET C# pour générer et intégrer des filigranes personnalisés dans les fichiers TIFF, ajoutant ainsi une couche de sécurité et de contrôle des droits d'auteur à vos images."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
