...
steps:
    enable: true
    title: "Generieren Sie mühelos Wasserzeichen für Docx-Dokumente"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/):** Erweiterte Wasserzeichenbibliothek für .NET-Anwendungen. Stärken Sie Ihre Lösung und sichern Sie Dokumente rechtzeitig mit Wasserzeichen.
      ...
      1. **Kernklasse: Watermarker.** Die Hauptklasse unserer API ist **Watermarker**. Sie müssen es vor der Dokumentverarbeitung instanziieren. Vergessen Sie nicht, die Datei Docx als Pfad oder Stream-Objekt an den Konstruktor zu übergeben.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Bildwasserzeichen in der Datei DOCX generieren
        ...
        using (Watermarker watermarker = new Watermarker("input.docx"))
        {
            ...
            // Mit Wasserzeichen versehenes DOCX-Ergebnis speichern
