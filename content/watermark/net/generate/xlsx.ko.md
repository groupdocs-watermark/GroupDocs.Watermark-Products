...
############################# Head ############################
head_title: "C #을 사용하여 XLSX 에 워터마크 삽입하기"
head_description: ".NET C #을 활용하여 XLSX 개의 파일에 워터마크를 생성하고 적용하여 Excel 개의 문서를 보호합니다."

############################# Header ############################
title: ".NET 개의 C #을 사용하여 XLSX 개의 시트를 보호합니다." 
description: ".NET C #을 사용하여 XLSX 개의 파일에 대해 사용자 지정 가능한 워터마크를 생성하면 문서 무결성을 높이고 중요한 정보를 보호하는 데 적합합니다."
...
steps:
    ...
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/):** .NET 애플리케이션용 고급 워터마킹 라이브러리입니다. 적시에 워터마크를 사용하여 솔루션을 강화하고 문서를 보호하세요.
      ...
      1. **핵심 클래스: Watermarker.** 우리 API의 주요 클래스는 **Watermarker** 입니다. 문서를 처리하기 전에 인스턴스화해야 합니다. Xlsx 파일을 생성자에 경로 또는 스트림 객체로 전달하는 것을 잊지 마세요.
...
more_formats:
    enable: true
    title: "C #을 사용하여 XLSX 에 워터마크 구현"
    exclude: "XLSX"
    description: ".NET C #을 배포하여 XLSX 파일에 고급 보안 워터마크를 효율적으로 추가하여 전문적인 Excel 개의 데이터를 보호하십시오."
    items: 
        # format loop 1
        - name: "워터마크 PDF"
          format: "PDF"
