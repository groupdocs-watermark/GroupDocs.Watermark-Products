...
############################# Head ############################
head_title: "Добавьте водяные знаки в WEBP с помощью C#"
head_description: "Используйте .NET C# для динамического создания и встраивания водяных знаков в WEBP изображений, обеспечивая комплексную защиту."

############################# Header ############################
title: "Сгенерируйте водяные знаки для WEBP с помощью C#" 
description: "Создавайте и применяйте собственные водяные знаки к WEBP файлам с помощью .NET C#. Это идеальный вариант для цифровых художников и создателей контента, которым необходимо защитить свою работу."
...
about:
    ...
    content: |
       GroupDocs.Watermark for .NET предоставляет разработчикам возможность создавать, составлять и добавлять сложные водяные знаки к изображениям WEBP с помощью .NET C#. Этот API позволяет точно настраивать водяные знаки, включая текст, логотипы и цифровые подписи. Настройте непрозрачность, размер и расположение водяного знака, чтобы добиться идеальной интеграции без ущерба для эстетики изображения. GroupDocs.Watermark идеально подходит фотографам, графическим дизайнерам и всем специалистам, занимающимся производством и распространением цифровых изображений. Он обеспечивает надежное встраивание ваших авторских прав в файлы WEBP. Совместимый со всеми современными фреймворками .NET, он повышает безопасность изображения при минимальном влиянии на качество изображения.

############################# Steps ############################
steps:
    enable: true
    title: "Легко создавайте водяные знаки для Webp документов"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/) :** Расширенная библиотека водяных знаков для .NET приложений. Расширьте возможности своего решения и своевременно защитите документы водяными знаками.
      ...
      1. **Основной класс: водяной маркер.** Основным классом нашего API является **Watermarker**. Перед обработкой документа необходимо создать его экземпляр. Не забудьте передать файл Webp в конструктор в виде пути или объекта потока.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Сгенерировать водяной знак изображения в файле WEBP
        ...
        using (Watermarker watermarker = new Watermarker("input.webp"))
        {
            ...
            // Сохранить результат с водяным знаком WEBP
...
more_formats:
    enable: true
    title: "Защита WEBP изображений с помощью .NET водяных знаков C#"
    exclude: "WEBP"
    description: "Встраивайте расширенные настраиваемые водяные знаки в WEBP изображения с помощью .NET C#, обеспечивая надежную защиту и визуальное оформление ваших творческих работ."
    items: 
        # format loop 1
