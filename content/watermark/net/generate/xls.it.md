...
############################# Head ############################
head_title: "Crea filigrane in XLS con C#"
head_description: "Usa .NET C# per aggiungere e gestire filigrane nei file XLS, migliorando la sicurezza dei tuoi documenti Excel."

############################# Header ############################
title: "Genera filigrane C# per i file XLS" 
description: "Implementa una solida filigrana nei fogli di calcolo XLS con .NET C#, su misura per proteggere i dati finanziari e personali in Excel."
...
steps:
    ...
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/):** Libreria avanzata di filigrana per applicazioni .NET. Potenzia la tua soluzione e proteggi i documenti con filigrane appena in tempo.
      ...
      1. **Classe principale: Watermarker.** La classe principale della nostra API è **Watermarker**. È necessario crearne un'istanza prima dell'elaborazione del documento. Non dimenticare di passare il file Xls al costruttore come percorso o oggetto stream.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Genera filigrana immagine nel file XLS
        ...
        using (Watermarker watermarker = new Watermarker("input.xls"))
        {
            ...
            // Salva il risultato XLS con filigrana
...
more_formats:
    enable: true
    title: "Applicazione di filigrane a XLS con C#"
    exclude: "XLS"
    description: "Utilizza .NET C# per generare e integrare dinamicamente filigrane personalizzate nei file XLS, salvaguardando efficacemente i tuoi dati Excel."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
