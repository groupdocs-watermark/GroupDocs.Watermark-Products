...
steps:
    enable: true
    title: "Png 개의 문서에 대한 워터마크를 손쉽게 생성"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/) :** .NET 애플리케이션을 위한 고급 워터마킹 라이브러리.솔루션을 강화하고 적시에 워터마크를 사용하여 문서를 보호하세요.
      ...
      1. **코어 클래스: 워터마커.** API의 기본 클래스는**워터마커**입니다.문서를 처리하기 전에 인스턴스화해야 합니다.Png 파일을 생성자에 경로 또는 스트림 객체로 전달하는 것을 잊지 마세요.
