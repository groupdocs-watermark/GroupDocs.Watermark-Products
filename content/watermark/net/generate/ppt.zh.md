...
############################# Head ############################
head_title: "PowerPoint 个文件的 C# 水印"
head_description: "使用 .NET C# 向 PowerPoint 文件应用动态水印，增强演示安全性。"

############################# Header ############################
title: "使用 .NET C# 水印保护 PPT" 
description: "利用 .NET C# 在 PowerPoint 演示文稿中插入可自定义的水印，非常适合保护商业和学术内容。"
...
more_formats:
    enable: true
    title: "使用 C# 水印保护 PPT 个文件"
    exclude: "PPT"
    description: "使用 .NET C# 将高级水印嵌入 PowerPoint 个文档，保护您的演示文稿免遭滥用和版权侵权。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
