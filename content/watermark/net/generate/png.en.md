...
############################# Header ############################
title: "C# Watermarking for PNG Files" 
description: "Utilize .NET C# to apply advanced watermarks to PNG images, safeguarding artistic and digital content effectively."
...
about:
    ...
    content: |
       GroupDocs.Watermark for .NET provides a specialized .NET C# toolkit for embedding watermarks in PNG files, catering to artists, designers, and content creators who need to protect their visual assets. This API allows for the seamless addition of both transparent and opaque watermarks that can be intricately positioned and scaled to maintain the original image's integrity while ensuring legal protection. Features include custom text and image watermarks, precise control over watermark opacity, and the ability to add multi-layer watermarks for enhanced security. Whether for personal use or professional portfolios, GroupDocs.Watermark ensures your PNG images are protected against unauthorized reproduction and use, fully supported on .NET environments.
...
steps:
    ...
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/):** Advanced Watermarking library for .NET applications. Empower your solution and secure documents with watermarks just in time.
      ...
      1. **Core Class: Watermarker.** The main class of our API is **Watermarker**. You need to instantiate it before document processing. Do not forget to pass the Png file to the constructor as a path or a stream object.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Generate image watermark in PNG file
...
more_formats:
    enable: true
    title: "Implementing Watermarks in PNG with C#"
    exclude: "PNG"
    description: "Deploy .NET C# to create discreet or bold watermarks in PNG images, ensuring both aesthetic flexibility and robust copyright protection."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
