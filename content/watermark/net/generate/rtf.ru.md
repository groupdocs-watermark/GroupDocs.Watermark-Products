...
############################# Head ############################
head_title: "Водяные знаки C# для RTF документов"
head_description: "Добавьте .NET водяные знаки C# в RTF файлы, чтобы повысить безопасность ваших Word документов."

############################# Header ############################
title: "Защитите RTF с помощью .NET водяных знаков C#" 
description: "Используйте .NET C# для нанесения безопасных настраиваемых водяных знаков на RTF файлы, что идеально подходит для сохранения целостности документов в средах MS Word."
...
about:
    ...
    content: |
       GroupDocs.Watermark for .NET предоставляет .NET разработчикам C# сложные инструменты для эффективного добавления водяных знаков в RTF документы. Этот API позволяет интегрировать как видимые, так и прозрачные водяные знаки, которые можно настраивать по шрифту, цвету, размеру и расположению, гарантируя, что они легко вписываются в документ и не мешают его удобочитаемости. GroupDocs.Watermark идеально подходит для юридических документов, документов об интеллектуальной собственности и конфиденциальных сообщений. Он обеспечивает необходимую защиту от несанкционированного копирования и модификации. Инструмент разработан для совместимости со всеми версиями .NET, что обеспечивает безопасное и адаптируемое решение для нанесения водяных знаков на документы.

############################# Steps ############################
steps:
    enable: true
    title: "Легко создавайте водяные знаки для Rtf документов"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/) :** Расширенная библиотека водяных знаков для .NET приложений. Расширьте возможности своего решения и своевременно защитите документы водяными знаками.
      ...
      1. **Основной класс: водяной маркер.** Основным классом нашего API является **Watermarker**. Перед обработкой документа необходимо создать его экземпляр. Не забудьте передать файл Rtf в конструктор в виде пути или объекта потока.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Сгенерировать водяной знак изображения в файле RTF
        ...
        using (Watermarker watermarker = new Watermarker("input.rtf"))
        {
            ...
            // Сохранить результат с водяным знаком RTF
...
more_formats:
    enable: true
    title: "Внедрение водяных знаков в RTF с помощью C#"
    exclude: "RTF"
    description: "Используйте .NET C#, чтобы создавать надежные и незаметные водяные знаки в RTF документах, повышая безопасность и аутентичность файлов Word."
    items: 
        # format loop 1
