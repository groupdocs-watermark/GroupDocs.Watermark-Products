...
############################# Head ############################
head_title: "Filigrane C# pour JPG images"
head_description: "Intégrez le filigrane dans JPG fichiers en utilisant .NET C# pour protéger efficacement vos images numériques."

############################# Header ############################
title: "Sécurisez JPG Images avec .NET C#" 
description: "Appliquez .NET C# pour créer des filigranes robustes pour JPG images, ce qui est idéal pour protéger les droits d'auteur et empêcher toute utilisation non autorisée."
...
about:
    ...
    content: |
       GroupDocs.Watermark for .NET fournit à .NET développeurs C# un cadre avancé pour ajouter des filigranes à JPG images. Cette API permet d'intégrer avec précision du texte, des logos et des filigranes graphiques dont l'opacité, la position et la taille sont personnalisables, ce qui est parfait pour les médias numériques et la photographie professionnelle. Améliorez la sécurité de vos images sans en sacrifier la qualité, grâce à des fonctionnalités conçues pour intégrer des filigranes qui découragent le piratage tout en préservant l'intégrité de l'illustration originale. Adapté à un large éventail d'applications, de la protection des photos personnelles à l'utilisation commerciale dans la publicité et les médias, GroupDocs.Watermark garantit que vos actifs visuels sont marqués de manière unique et protégés légalement.

############################# Steps ############################
steps:
    enable: true
    title: "Générez sans effort des filigranes pour les documents Jpg"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/) :** Bibliothèque de filigrane avancée pour les applications .NET. Renforcez votre solution et sécurisez les documents avec des filigranes juste à temps.
      ...
      1. **Classe principale : Watermarker.** La classe principale de notre API est **Watermarker**. Vous devez l'instancier avant le traitement du document. N'oubliez pas de transmettre le fichier Jpg au constructeur en tant que chemin ou objet flux.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Générer un filigrane d'image dans le fichier JPG
        ...
        using (Watermarker watermarker = new Watermarker("input.jpg"))
        {
            ...
            // Enregistrer le résultat JPG filigrané
...
more_formats:
    enable: true
    title: "Implémenter des filigranes dans JPG avec C#"
    exclude: "JPG"
    description: "Tirez parti de .NET C# pour intégrer des filigranes invisibles ou visibles dans les fichiers JPG, ce qui est essentiel pour un contenu numérique sécurisé et reconnaissable."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
