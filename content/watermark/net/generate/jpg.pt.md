...
############################# Head ############################
head_title: "Marca d'água C# para JPG imagens"
head_description: "Integre marcas d'água em JPG arquivos usando .NET C#, protegendo suas imagens digitais de forma eficaz."

############################# Header ############################
title: "Proteja JPG imagens com .NET C#" 
description: "Aplique .NET C# para criar marcas d'água robustas para JPG imagens, ideais para proteção de direitos autorais e prevenção de uso não autorizado."
...
about:
    ...
    content: |
       O GroupDocs.Watermark for .NET fornece aos .NET desenvolvedores de C# uma estrutura avançada para adicionar marcas d'água às JPG imagens. Essa API permite a incorporação precisa de texto, logotipos e marcas d'água gráficas que são personalizáveis em opacidade, posição e tamanho, perfeitas para mídia digital e fotografia profissional. Melhore a segurança de suas imagens sem sacrificar a qualidade, com recursos projetados para incorporar marcas d'água que impedem a pirataria e, ao mesmo tempo, mantêm a integridade da arte original. Adequado para uma ampla variedade de aplicações, desde proteção fotográfica pessoal até uso comercial em publicidade e mídia, o GroupDocs.Watermark garante que seus ativos visuais sejam marcados de forma exclusiva e protegidos legalmente.

############################# Steps ############################
steps:
    enable: true
    title: "Gere marcas d'água sem esforço para Jpg documentos"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/) :** Biblioteca avançada de marca d'água para .NET aplicativos. Fortaleça sua solução e proteja documentos com marcas d'água na hora certa.
      ...
      1. **Classe principal: Watermarker.** A classe principal da nossa API é **Watermarker**. Você precisa instanciá-lo antes do processamento do documento. Não se esqueça de passar o arquivo Jpg para o construtor como um caminho ou um objeto de fluxo.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Gere marca d'água de imagem no arquivo JPG
        ...
        using (Watermarker watermarker = new Watermarker("input.jpg"))
        {
            ...
            // Salvar resultado com marca d'água JPG
...
more_formats:
    enable: true
    title: "Implemente marcas d'água em JPG com C#"
    exclude: "JPG"
    description: "Aproveite o .NET C# para incorporar marcas d'água invisíveis ou visíveis em JPG arquivos, essenciais para conteúdo digital seguro e reconhecível."
    items: 
        # format loop 1
