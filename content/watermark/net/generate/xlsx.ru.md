...
############################# Head ############################
head_title: "Встраивайте водяные знаки в XLSX с помощью C#"
head_description: "Используйте .NET C# для создания и применения водяных знаков в файлах XLSX, защищая ваши Excel документы."

############################# Header ############################
title: "Защитите XLSX листов с помощью .NET C#" 
description: "Используйте .NET C# для создания настраиваемых водяных знаков для XLSX файлов, что идеально подходит для повышения целостности документов и защиты конфиденциальной информации."
...
steps:
    ...
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/) :** Расширенная библиотека водяных знаков для .NET приложений. Расширьте возможности своего решения и своевременно защитите документы водяными знаками.
      ...
      1. **Основной класс: водяной маркер.** Основным классом нашего API является **Watermarker**. Перед обработкой документа необходимо создать его экземпляр. Не забудьте передать файл Xlsx в конструктор в виде пути или объекта потока.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Сгенерировать водяной знак изображения в файле XLSX
        ...
        using (Watermarker watermarker = new Watermarker("input.xlsx"))
        {
            ...
            // Сохранить результат с водяным знаком XLSX
...
more_formats:
    enable: true
    title: "Внедрение водяных знаков в XLSX с помощью C#"
    exclude: "XLSX"
    description: "Разверните .NET C#, чтобы эффективно добавлять расширенные и безопасные водяные знаки к XLSX файлам, защищая ваши профессиональные Excel данные."
    items: 
        # format loop 1
