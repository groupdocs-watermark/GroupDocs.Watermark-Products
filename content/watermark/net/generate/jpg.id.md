...
############################# Head ############################
head_title: "C# Watermarking untuk JPG Gambar"
head_description: "Integrasikan watermarking ke dalam JPG file menggunakan .NET C #, menjaga gambar digital Anda secara efektif."

############################# Header ############################
title: "Amankan JPG Gambar dengan .NET C#" 
description: "Terapkan .NET C# untuk membuat tanda air yang kuat untuk gambar JPG, ideal untuk perlindungan hak cipta dan mencegah penggunaan yang tidak sah."
...
about:
    ...
    content: |
       GroupDocs.Watermark for .NET menyediakan .NET pengembang C# dengan kerangka kerja lanjutan untuk menambahkan tanda air ke gambar JPG. API ini memungkinkan penyematan teks, logo, dan tanda air grafis yang tepat yang dapat disesuaikan dalam opacity, posisi, dan ukuran, sempurna untuk media digital dan fotografi profesional. Tingkatkan keamanan gambar Anda tanpa mengorbankan kualitas, dengan fitur yang dirancang untuk menyematkan tanda air yang mencegah pembajakan sambil menjaga integritas karya seni asli. Cocokan untuk berbagai aplikasi mulai dari perlindungan foto pribadi hingga penggunaan komersial dalam iklan dan media, GroupDocs.Watermark memastikan bahwa aset visual Anda ditandai secara unik dan dilindungi secara hukum.

############################# Steps ############################
steps:
    enable: true
    title: "Menghasilkan Watermark dengan Mudah untuk Jpg Dokumen"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/) :** Pustaka Watermarking Tingkat Lanjut untuk aplikasi .NET. Berdayakan solusi Anda dan amankan dokumen dengan tanda air tepat waktu.
      ...
      1. **Kelas Inti: Watermarker.** Kelas utama API kami adalah **Watermarker**. Anda perlu membuat instansiasinya sebelum pemrosesan dokumen. Jangan lupa untuk meneruskan file Jpg ke konstruktor sebagai jalur atau objek aliran.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Hasilkan tanda air gambar dalam file JPG
        ...
        using (Watermarker watermarker = new Watermarker("input.jpg"))
        {
            ...
            // Simpan hasil JPG yang ditandai dengan tanda air
...
more_formats:
    enable: true
    title: "Terapkan Watermark di JPG dengan C #"
    exclude: "JPG"
    description: "Manfaatkan .NET C# untuk menyematkan tanda air yang tidak terlihat atau terlihat dalam file JPG, penting untuk konten digital yang aman dan dapat dikenali."
    items: 
        # format loop 1
        - name: "Tanda air PDF"
          format: "PDF"
