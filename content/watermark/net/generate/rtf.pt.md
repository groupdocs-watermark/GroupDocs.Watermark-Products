...
############################# Head ############################
head_title: "Marca d'água C# para documentos RTF"
head_description: "Incorpore .NET marcas d'água C# em RTF arquivos para aumentar a segurança de seus Word documentos."

############################# Header ############################
title: "Proteja RTF com .NET marcas d'água C#" 
description: "Use .NET C# para aplicar marcas d'água seguras e personalizáveis a RTF arquivos, perfeitas para manter a integridade do documento em MS Word ambientes."
...
about:
    ...
    content: |
       O GroupDocs.Watermark for .NET equipa .NET desenvolvedores de C# com ferramentas sofisticadas para adicionar marcas d'água a RTF documentos de forma eficaz. Essa API permite a integração de marcas d'água visíveis e transparentes que podem ser personalizadas em termos de fonte, cor, tamanho e posição, garantindo que elas se misturem perfeitamente ao documento sem obstruir a legibilidade. Ideal para documentos legais, documentos de propriedade intelectual e comunicações confidenciais, o GroupDocs.Watermark oferece proteção essencial contra cópias e modificações não autorizadas. A ferramenta foi projetada para ser compatível com todas as versões do .NET, facilitando uma solução segura e adaptável para marcas d'água de documentos.

############################# Steps ############################
steps:
    enable: true
    title: "Gere marcas d'água sem esforço para Rtf documentos"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/) :** Biblioteca avançada de marca d'água para .NET aplicativos. Fortaleça sua solução e proteja documentos com marcas d'água na hora certa.
      ...
      1. **Classe principal: Watermarker.** A classe principal da nossa API é **Watermarker**. Você precisa instanciá-lo antes do processamento do documento. Não se esqueça de passar o arquivo Rtf para o construtor como um caminho ou um objeto de fluxo.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Gere marca d'água de imagem no arquivo RTF
        ...
        using (Watermarker watermarker = new Watermarker("input.rtf"))
        {
            ...
            // Salvar resultado com marca d'água RTF
...
more_formats:
    enable: true
    title: "Implementando marcas d'água em RTF com C#"
    exclude: "RTF"
    description: "Implante .NET C# para criar marcas d'água robustas e sutis em RTF documentos, reforçando a segurança e a autenticidade de seus Word arquivos."
    items: 
        # format loop 1
