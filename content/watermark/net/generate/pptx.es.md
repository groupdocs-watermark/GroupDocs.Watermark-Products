...
############################# Head ############################
head_title: "Incrustar marcas de agua en PPTX con C#"
head_description: "Proteja sus PPTX presentaciones con marcas de agua aplicadas en C# .NET para proteger la propiedad intelectual."

############################# Header ############################
title: "Marca de agua avanzada en C# para PPTX" 
description: "Implemente .NET C# para crear marcas de agua sólidas en archivos PPTX, perfectas para mejorar la seguridad en presentaciones corporativas y educativas."
...
steps:
    enable: true
    title: "Genere marcas de agua sin esfuerzo para Pptx documentos"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/) :** Biblioteca avanzada de marcas de agua para .NET aplicaciones. Potencie su solución y proteja los documentos con marcas de agua justo a tiempo.
      ...
      1. **Clase básica: Watermarker** La clase principal de nuestra API es **Watermarker**. Debes instanciarlo antes de procesar el documento. No olvide pasar el archivo Pptx al constructor como una ruta o un objeto de flujo.
    ...
    code:
      ...
      content: |
        ...
        using (Watermarker watermarker = new Watermarker("input.pptx"))
        {
            ...
            // Guardar el resultado con marca de agua PPTX
...
more_formats:
    enable: true
    title: "Soluciones de marcas de agua de C# para archivos PPTX"
    exclude: "PPTX"
    description: "Aproveche .NET C# para aplicar marcas de agua discretas en archivos PPTX para proteger sus presentaciones de la distribución no autorizada."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
