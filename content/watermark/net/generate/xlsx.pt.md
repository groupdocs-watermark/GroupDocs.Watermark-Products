...
############################# Head ############################
head_title: "Incorpore marcas d'água em XLSX com C#"
head_description: "Aproveite o .NET C# para gerar e aplicar marcas d'água em XLSX arquivos, protegendo seus Excel documentos."

############################# Header ############################
title: "Proteja XLSX planilhas com .NET C#" 
description: "Use .NET C# para criar marcas d'água personalizáveis para XLSX arquivos, perfeitas para aprimorar a integridade do documento e proteger informações confidenciais."
...
steps:
    ...
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/) :** Biblioteca avançada de marca d'água para .NET aplicativos. Fortaleça sua solução e proteja documentos com marcas d'água na hora certa.
      ...
      1. **Classe principal: Watermarker.** A classe principal da nossa API é **Watermarker**. Você precisa instanciá-lo antes do processamento do documento. Não se esqueça de passar o arquivo Xlsx para o construtor como um caminho ou um objeto de fluxo.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Gere marca d'água de imagem no arquivo XLSX
        ...
        using (Watermarker watermarker = new Watermarker("input.xlsx"))
        {
            ...
            // Salvar resultado com marca d'água XLSX
...
more_formats:
    enable: true
    title: "Implementando marcas d'água em XLSX com C#"
    exclude: "XLSX"
    description: "Implante o .NET C# para adicionar com eficiência marcas d'água avançadas e seguras aos XLSX arquivos, protegendo seus Excel dados profissionais."
    items: 
        # format loop 1
