...
############################# Head ############################
head_title: "Marcas de agua de C# para documentos PDF seguros"
head_description: "Utilice .NET C# para incrustar marcas de agua en PDF y proteger los documentos oficiales y la información confidencial."

############################# Header ############################
title: "Mejore la seguridad de PDF con marcas de agua de C#" 
description: "Implemente .NET C# para aplicar marcas de agua en PDF documentos, garantizando la protección de los registros legales, financieros y oficiales."
...
about:
    ...
    content: |
       GroupDocs.Watermark for .NET ofrece a los desarrolladores de C# .NET una potente API para insertar marcas de agua en PDF archivos, una herramienta esencial para la seguridad de los documentos en los sectores corporativo, legal y gubernamental. Esta API admite amplias opciones de personalización de marcas de agua, como el formato del texto, la integración de imágenes y la colocación dinámica para adaptarse a varios diseños de documentos. Ya sea para garantizar acuerdos confidenciales, proteger material protegido por derechos de autor o marcar información confidencial, GroupDocs.Watermark garantiza que todos los PDF transmitan la propiedad de manera clara y profesional. Las funciones adicionales incluyen la rotación de marcas de agua, el control de la transparencia y la capacidad de estratificación, que son compatibles con todos los marcos .NET modernos.

############################# Steps ############################
steps:
    enable: true
    title: "Genere marcas de agua sin esfuerzo para documentos Pdf"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/):** Biblioteca avanzada de marcas de agua para aplicaciones .NET. Potencia tu solución y protege documentos con marcas de agua justo a tiempo.
      ...
      1. **Clase principal: Watermarker.** La clase principal de nuestra API es **Watermarker**. Debe crear una instancia antes de procesar el documento. No olvide pasar el archivo Pdf al constructor como una ruta o un objeto de secuencia.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Generar marca de agua de imagen en el archivo PDF
        ...
        using (Watermarker watermarker = new Watermarker("input.pdf"))
        {
            ...
            // Guardar el resultado PDF con marca de agua
...
more_formats:
    enable: true
    title: "Proteger PDF archivos con marcas de agua de C# .NET"
    exclude: "PDF"
    description: "Utilice .NET C# para incrustar marcas de agua seguras y personalizadas en PDF documentos, ideales para proteger la información oficial y confidencial."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
