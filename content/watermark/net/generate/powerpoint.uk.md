...
steps:
    enable: true
    title: "Покращуйте свої документи: Створіть водяні знаки для Powerpoint за допомогою .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** — це бібліотека, яка спрощує додавання водяних знаків до різних форматів бізнес-файлів для .NET розробників. Інтегруйте нашу бібліотеку у свою програму та без зусиль додайте водяні знаки за допомогою наступних кроків:
      ...
      1. **Почніть свою подорож з водяним знаком:** Почніть з ознайомлення з класом **Watermarker**, наріжним каменем нашого API. Щоб розпочати процес, переконайтеся, що ви створили його перед обробкою документів. Не забувайте про важливість надання файлу Powerpoint конструктору, будь то шлях чи об'єкт потоку.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Створіть текстовий водяний знак у файлі POWERPOINT
