...
############################# Head ############################
head_title: "Filigrane C# per documenti sicuri PDF"
head_description: "Utilizza .NET C# per incorporare filigrane in PDF, proteggendo documenti ufficiali e informazioni sensibili."

############################# Header ############################
title: "Migliora la sicurezza di PDF con le filigrane C#" 
description: "Implementa .NET C# per applicare filigrane nei documenti PDF, garantendo la protezione dei registri legali, finanziari e ufficiali."
...
about:
    ...
    content: |
       GroupDocs.Watermark for .NET offre agli sviluppatori .NET C# una potente API per inserire filigrane nei file PDF, uno strumento essenziale per la sicurezza dei documenti nei settori aziendale, legale e governativo. Questa API supporta opzioni complete di personalizzazione delle filigrane, tra cui la formattazione del testo, l'integrazione delle immagini e il posizionamento dinamico per adattarsi a vari layout di documenti. Che si tratti di garantire accordi riservati, proteggere il materiale protetto da copyright o contrassegnare informazioni proprietarie, GroupDocs.Watermark garantisce che tutti i PDF trasmetta la proprietà in modo chiaro e professionale. Le funzionalità aggiuntive includono la rotazione della filigrana, il controllo della trasparenza e le funzionalità di stratificazione, compatibili con tutti i moderni framework .NET.

############################# Steps ############################
steps:
    enable: true
    title: "Genera facilmente filigrane per documenti Pdf"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/):** Libreria avanzata di filigrana per applicazioni .NET. Potenzia la tua soluzione e proteggi i documenti con filigrane appena in tempo.
      ...
      1. **Classe principale: Watermarker.** La classe principale della nostra API è **Watermarker**. È necessario crearne un'istanza prima dell'elaborazione del documento. Non dimenticare di passare il file Pdf al costruttore come percorso o oggetto stream.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Genera filigrana immagine nel file PDF
        ...
        using (Watermarker watermarker = new Watermarker("input.pdf"))
        {
            ...
            // Salva il risultato PDF con filigrana
...
more_formats:
    enable: true
    title: "Protezione dei file PDF con filigrane C# .NET"
    exclude: "PDF"
    description: "Usa .NET C# per incorporare filigrane sicure e personalizzate nei documenti PDF, ideali per salvaguardare informazioni ufficiali e sensibili."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
