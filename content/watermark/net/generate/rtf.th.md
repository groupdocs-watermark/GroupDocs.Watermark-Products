...
############################# Head ############################
head_title: "เครื่องหมายน้ำ C # สำหรับเอกสาร RTF"
head_description: "รวมลายน้ำ .NET C # ลงในไฟล์ RTF เพื่อเพิ่มความปลอดภัยของเอกสาร Word ของคุณ"

############################# Header ############################
title: "รักษาความปลอดภัย RTF ด้วย .NET ลายน้ำ C #" 
description: "ใช้ .NET C # เพื่อใช้ลายน้ำที่ปลอดภัยและปรับแต่งได้กับไฟล์ RTF เหมาะสำหรับการรักษาความสมบูรณ์ของเอกสารภายในสภาพแวดล้อม MS Word"
...
about:
    ...
    content: |
       GroupDocs.Watermark for .NET จัดเตรียมเครื่องมือที่ซับซ้อนให้กับนักพัฒนา C# .NET เพื่อเพิ่มลายน้ำลงในเอกสาร RTF ได้อย่างมีประสิทธิภาพAPI นี้ช่วยให้สามารถรวมทั้งลายน้ำที่มองเห็นได้และโปร่งใสซึ่งสามารถปรับแต่งได้ในแง่ของแบบอักษรสีขนาดและตำแหน่ง เพื่อให้แน่ใจว่ามันผสมผสานเข้ากับเอกสารได้อย่างราบรื่นโดยไม่ขัดขวางความสามารถในการอ่านเหมาะสำหรับเอกสารทางกฎหมาย เอกสารทรัพย์สินทางปัญญา และการสื่อสารที่ละเอียดอ่อน GroupDocs.Watermark ให้การป้องกันที่จำเป็นต่อการคัดลอกและการแก้ไขโดยไม่ได้รับอนุญาตเครื่องมือนี้ออกแบบมาให้เข้ากันได้กับ .NET ทุกรุ่น ช่วยให้โซลูชันที่ปลอดภัยและปรับเปลี่ยนได้สำหรับการทำลายน้ำในเอกสาร

############################# Steps ############################
steps:
    enable: true
    title: "สร้างลายน้ำได้อย่างง่ายดายสำหรับเอกสาร Rtf"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/):** ไลบรารีลายน้ำขั้นสูงสำหรับแอปพลิเคชัน .NET เสริมศักยภาพให้กับโซลูชันของคุณและรักษาความปลอดภัยเอกสารด้วยลายน้ำได้ทันเวลา
      ...
      1. **คลาสหลัก: Watermarker** คลาสหลักของ API ของเราคือ **Watermarker** คุณต้องสร้างอินสแตนซ์ก่อนการประมวลผลเอกสาร อย่าลืมส่งไฟล์ Rtf ไปยังตัวสร้างเป็นเส้นทางหรือวัตถุสตรีม
...
more_formats:
    enable: true
    title: "การใช้ลายน้ำใน RTF ด้วย C#"
    exclude: "RTF"
    description: "ปรับใช้ .NET C# เพื่อสร้างลายน้ำที่แข็งแกร่งและละเอียดอ่อนในเอกสาร RTF เพื่อเสริมความปลอดภัยและความถูกต้องของไฟล์ Word ของคุณ"
    items: 
        # format loop 1
        - name: "ลายน้ำ PDF"
          format: "PDF"
