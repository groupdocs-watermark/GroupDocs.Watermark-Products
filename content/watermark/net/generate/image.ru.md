...
steps:
    enable: true
    title: "Улучшите свои документы: создайте водяные знаки для Image с помощью .NET"
    content: |
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Сгенерировать текстовый водяной знак в файле IMAGE
