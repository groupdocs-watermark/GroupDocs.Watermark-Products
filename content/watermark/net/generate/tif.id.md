...
steps:
    enable: true
    title: "Menghasilkan Watermark dengan Mudah untuk Tif Dokumen"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/) :** Pustaka Watermarking Tingkat Lanjut untuk aplikasi .NET. Berdayakan solusi Anda dan amankan dokumen dengan tanda air tepat waktu.
      ...
      1. **Kelas Inti: Watermarker.** Kelas utama API kami adalah **Watermarker**. Anda perlu membuat instansiasinya sebelum pemrosesan dokumen. Jangan lupa untuk meneruskan file Tif ke konstruktor sebagai jalur atau objek aliran.
    ...
    code:
      ...
      content: |
        ...
        using (Watermarker watermarker = new Watermarker("input.tif"))
        {
            ...
            // Simpan hasil TIF yang ditandai dengan tanda air
