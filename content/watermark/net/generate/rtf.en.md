...
############################# Head ############################
head_title: "C# Watermarking for RTF Documents"
head_description: "Incorporate .NET C# watermarks into RTF files to enhance the security of your Word documents."

############################# Header ############################
title: "Secure RTF with .NET C# Watermarks" 
description: "Use .NET C# to apply secure, customizable watermarks to RTF files, perfect for maintaining document integrity within MS Word environments."
...
steps:
    enable: true
    title: "Effortlessly Generate Watermarks for Rtf Documents with GroupDocs.Watermark for .NET"
    content: |
...
more_formats:
    enable: true
    title: "Implementing Watermarks in RTF with C#"
    exclude: "RTF"
    description: "Deploy .NET C# to create robust and subtle watermarks in RTF documents, reinforcing the security and authenticity of your Word files."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
