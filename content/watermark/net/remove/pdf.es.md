...
steps:
    enable: true
    title: "Elimine mediante programación las marcas de agua de Pdf documentos mediante .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** permite a .NET desarrolladores eliminar mediante programación las marcas de agua de varios Pdf documentos. Esta guía describe el proceso:
    ...
    code:
      ...
      content: |
        ...
        // Instanciar el documento Watermarker que pasa PDF
