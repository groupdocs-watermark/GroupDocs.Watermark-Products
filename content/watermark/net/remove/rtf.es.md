...
steps:
    enable: true
    title: "Elimine mediante programación las marcas de agua de Rtf documentos mediante .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** permite a .NET desarrolladores eliminar mediante programación las marcas de agua de varios Rtf documentos. Esta guía describe el proceso:
    ...
    code:
      ...
      content: |
        ...
        // Instanciar el documento Watermarker que pasa RTF
