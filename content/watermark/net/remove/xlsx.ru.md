...
steps:
    enable: true
    title: "Программно удалите водяные знаки из Xlsx документов с помощью .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** позволяет разработчикам .NET программно удалять водяные знаки из различных Xlsx документов. В этом руководстве описан процесс:
    ...
    code:
      ...
      content: |
        ...
        // Создайте экземпляр документа Watermarker, передав XLSX
