...
steps:
    enable: true
    title: "Elimine las marcas de agua de Word documentos con .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** simplifica la tarea de eliminar las marcas de agua de los documentos comerciales. Potencie su aplicación .NET integrando nuestra biblioteca y siguiendo estos sencillos pasos:
      ...
      1. **Watermarker**, con el documento Word. Nuestra API admite el procesamiento de los documentos proporcionados como una secuencia o una ruta local.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Eliminar la marca de agua de texto del documento Word

        // Proporcione una instancia de Watermarker para el documento fuente del documento Word
