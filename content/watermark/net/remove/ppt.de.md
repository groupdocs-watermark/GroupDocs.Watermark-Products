...
steps:
    enable: true
    title: "Programmgesteuertes Entfernen von Wasserzeichen aus Ppt Dokumenten mit .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** ermöglicht es .NET Entwicklern, Wasserzeichen programmgesteuert aus verschiedenen Ppt Dokumenten zu entfernen. In diesem Handbuch wird der Prozess beschrieben:
    ...
    code:
      ...
      content: |
        ...
        // Instantiieren Sie einen Wassermarker, der ein PPT Dokument übergibt
