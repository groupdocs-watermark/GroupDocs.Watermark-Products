...
steps:
    enable: true
    title: "Rimuovi a livello di codice le filigrane dai documenti Rtf utilizzando .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** consente agli sviluppatori di .NET di rimuovere a livello di codice le filigrane da vari documenti Rtf. Questa guida descrive il processo:
    ...
    code:
      ...
      content: |
        ...
        // Istanzia Watermarker passando il documento RTF
