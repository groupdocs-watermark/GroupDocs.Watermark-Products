...
steps:
    enable: true
    title: "Программно удалите водяные знаки из Pdf документов с помощью .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** позволяет разработчикам .NET программно удалять водяные знаки из различных Pdf документов. В этом руководстве описан процесс:
    ...
    code:
      ...
      content: |
        ...
        // Создайте экземпляр документа Watermarker, передав PDF
