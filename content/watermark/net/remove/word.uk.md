...
steps:
    enable: true
    title: "Видаліть водяні знаки з документів Word за допомогою .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** спрощує завдання видалення водяних знаків із ділових документів. Розширте можливості своєї програми .NET, інтегрувавши нашу бібліотеку, і виконайте ці прості кроки:
      ...
      1. Почніть із створення основного класу **Watermarker** за допомогою документа Word. Наш API підтримує обробку документів, наданих у вигляді потоку або локального шляху.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Видалити текстовий водяний знак із документа Word

        // Надайте екземпляр Watermarker для документа Word вихідний документ
