...
steps:
    enable: true
    title: "Удалите водяные знаки из Powerpoint документов с помощью .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** упрощает задачу удаления водяных знаков из деловых документов. Расширьте возможности своего приложения .NET, интегрировав нашу библиотеку, и выполните следующие простые шаги:
      ...
      1. **Watermarker** с документом Powerpoint. Наш API поддерживает обработку документов, предоставленных в виде потока или локального пути.
    ...
    code:
      ...
      content: |
        ...
        // Укажите экземпляр Watermarker для исходного документа Powerpoint
