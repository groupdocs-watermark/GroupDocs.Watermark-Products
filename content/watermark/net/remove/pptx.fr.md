...
steps:
    enable: true
    title: "Supprimez par programme les filigranes des documents Pptx à l'aide de .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** permet aux développeurs .NET de supprimer par programme les filigranes de divers documents Pptx. Ce guide décrit le processus :
    ...
    code:
      ...
      content: |
        ...
        // Instancier Watermarker en passant le document PPTX
