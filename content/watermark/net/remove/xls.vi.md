...
steps:
    enable: true
    title: "Xóa hình mờ theo chương trình từ Xls Tài liệu bằng cách sử dụng .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** trao quyền cho .NET nhà phát triển xóa hình mờ theo chương trình khỏi các tài liệu Xls khác nhau. Hướng dẫn này phác thảo quy trình:
    ...
    code:
      ...
      content: |
        ...
        // Thực hiện Watermarker đi qua tài liệu XLS
