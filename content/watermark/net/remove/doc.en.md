...
description: "Utilize the GroupDocs.Watermark for .NET C# API to effectively delete or edit out watermarks in DOC files, ideal for maintaining pristine document formatting."
...
more_formats:
    ...
    exclude: "DOC"
    description: "Discover the capabilities of the GroupDocs.Watermark for .NET C# API to manage and remove watermarks from DOC files, enhancing document security and presentation without compromising on quality."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
