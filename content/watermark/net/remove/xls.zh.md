...
############################# Head ############################
head_title: "清除 Excel XLS 电子表格中的水印"
head_description: "使用我们的 C# .NET API 高效清除 XLS 个文档中的水印，确保文件干净且外观专业。"

############################# Header ############################
title: "使用 C# .NET 移除 XLS 电子表格中的水印" 
description: "利用 GroupDocs.Watermark for .NET C# API 有效删除或编辑 XLS 文件中的水印，非常适合保持原始文档格式。"
...
about:
    ...
    content: |
       GroupDocs.Watermark for .NET C# 库为管理 XLS 文档中的水印提供了强大的工具。从简单的删除到复杂的编辑，该API使开发人员能够保持文档的美观性和完整性，满足业务、财务和数据分析的需求。
...
more_formats:
    enable: true
    title: "使用 .NET 管理带有清除水印的 XLS 文件"
    exclude: "XLS"
    description: "探索 GroupDocs.Watermark for .NET C# API 管理和删除 XLS 文件水印的功能，在不影响质量的前提下增强文档安全性和显示效果。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
