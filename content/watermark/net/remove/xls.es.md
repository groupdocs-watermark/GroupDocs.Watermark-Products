...
############################# Head ############################
head_title: "Eliminar las marcas de agua en las hojas de cálculo Excel XLS"
head_description: "Elimine eficazmente las marcas de agua de XLS documentos con nuestra API C# .NET, garantizando archivos limpios y de aspecto profesional."

############################# Header ############################
title: "Elimine la marca de agua en XLS hojas de cálculo con C# .NET" 
description: "Utilice la API GroupDocs.Watermark for .NET C# para eliminar o editar eficazmente las marcas de agua de los archivos XLS, lo que resulta ideal para mantener un formato de documento impecable."
...
more_formats:
    enable: true
    title: "Gestionar un archivo XLS con la eliminación de marcas de agua con .NET"
    exclude: "XLS"
    description: "Descubra las capacidades de la API GroupDocs.Watermark for .NET C# para administrar y eliminar las marcas de agua de XLS archivos, lo que mejora la seguridad y la presentación de los documentos sin comprometer la calidad."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
