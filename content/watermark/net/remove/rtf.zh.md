...
############################# Head ############################
head_title: "RTF 使用 C# .NET 去除水印"
head_description: "使用我们的 C# .NET API 高效移除 RTF 文档中的水印，确保文件干净且外观专业。"

############################# Header ############################
title: "管理 C# .NET 的 RTF 文档中的水印" 
description: "利用 GroupDocs.Watermark for .NET C# API 有效删除或编辑 RTF 文件中的水印，非常适合保持原始文档格式。"
...
about:
    ...
    content: |
       GroupDocs.Watermark for .NET C# 库为管理 RTF 文档中的水印提供了强大的工具。从简单的删除到复杂的编辑，该API使开发人员能够保持文档的美观性和完整性，满足商业、法律和学术需求。

############################# Steps ############################
steps:
    enable: true
    title: "使用 .NET 以编程方式从 Rtf 文档中删除水印"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** 使 .NET 开发人员能够以编程方式从各种 Rtf 文档中删除水印。本指南概述了该过程：
...
more_formats:
    enable: true
    title: "使用 .NET 掌握去除 RTF 文件水印的方法"
    exclude: "RTF"
    description: "探索 GroupDocs.Watermark for .NET C# API 管理和删除 RTF 文件水印的功能，在不影响质量的前提下增强文档安全性和显示效果。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
