...
steps:
    enable: true
    title: "Xóa hình mờ khỏi tài liệu Ppt theo chương trình bằng cách sử dụng .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** trao quyền cho các nhà phát triển .NET xóa hình mờ khỏi nhiều tài liệu Ppt khác nhau theo chương trình. Hướng dẫn này phác thảo quá trình:
    ...
    code:
      ...
      content: |
        ...
        // Khởi tạo Watermarker truyền tài liệu PPT
