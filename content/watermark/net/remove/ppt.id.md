...
steps:
    enable: true
    title: "Menghapus Tanda Air dari Dokumen Ppt secara terprogram menggunakan .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** memberdayakan pengembang .NET untuk menghapus tanda air dari berbagai dokumen Ppt secara terprogram. Panduan ini menguraikan prosesnya:
    ...
    code:
      ...
      content: |
        ...
        // Buat instance Watermarker yang meneruskan dokumen PPT
