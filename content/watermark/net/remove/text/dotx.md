...
############################# Head ############################
head_title: "Remove Watermark from DOTX in C#, ASP.NET, VB.NET"
head_description: ".NET library to find and remove watermark from DOTX document using smart search within C#, ASP.NET, VB.NET & .NET Core applications using GroupDocs.Watermark APIs for .NET."

############################# Header ############################
title: "Remove Watermark from DOTX in C# .NET"
description: "Use smart search to find & remove watermark from a DOTX document with text formatting from within C#, ASP.NET, VB.NET & .NET Core applications. Define a search criterion to search & delete the watermarks based on a specific font name, color, size and other matching properties."
...
steps:
    enable: true
    title_left: "Delete Watermark from DOTX File in .NET"
    content_left: |
    ...
    code: |
        ```cs
        // Search & remove watermark with text formatting from a DOTX document in C#, ASP.NET, VB.NET & .NET Core applications
        // Instantiate Watermarker with input DOTX document
