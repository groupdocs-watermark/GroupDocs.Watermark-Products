...
draft: false
path: "watermark/net/remove/text/vst/"
otherformats: PDF WORD EXCEL VISIO PRESENTATION SPREADSHEET WORKSHEET DOC DOCM DOCX DOT DOTM DOTX EXCEL ODT POT POTM POTX PPS PPSM PPSX PPT PPTM PPTX RTF SXC TXT VDW VDX VSD VSDM VSDX VSS VSSM VSSX VST VSTM VSTX VSX VTX WORD XLAM XLS XLSB XLSM XLSX XLT XLTM XLTX

############################# Head ############################
head_title: "Remove Watermark from VST in C#, ASP.NET, VB.NET"
head_description: ".NET library to find and remove watermark from VST document using smart search within C#, ASP.NET, VB.NET & .NET Core applications using GroupDocs.Watermark APIs for .NET."

############################# Header ############################
title: "Remove Watermark from VST in C# .NET"
description: "Use smart search to find & remove watermark from a VST document with text formatting from within C#, ASP.NET, VB.NET & .NET Core applications. Define a search criterion to search & delete the watermarks based on a specific font name, color, size and other matching properties."
...
steps:
    enable: true
    title_left: "Delete Watermark from VST File in .NET"
    content_left: |
    ...
    code: |
        ```cs
        // Search & remove watermark with text formatting from a VST document in C#, ASP.NET, VB.NET & .NET Core applications
        // Instantiate Watermarker with input VST document
