...
############################# Head ############################
head_title: "Remove Watermark from DOTM in C#, ASP.NET, VB.NET"
head_description: ".NET library to find and remove watermark from DOTM document using smart search within C#, ASP.NET, VB.NET & .NET Core applications using GroupDocs.Watermark APIs for .NET."

############################# Header ############################
title: "Remove Watermark from DOTM in C# .NET"
description: "Use smart search to find & remove watermark from a DOTM document with text formatting from within C#, ASP.NET, VB.NET & .NET Core applications. Define a search criterion to search & delete the watermarks based on a specific font name, color, size and other matching properties."
...
steps:
    ...
    code: |
        ```cs
        // Search & remove watermark with text formatting from a DOTM document in C#, ASP.NET, VB.NET & .NET Core applications
        // Instantiate Watermarker with input DOTM document
