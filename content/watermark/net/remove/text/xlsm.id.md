...
head_title: "Hapus Tanda Air dari XLSM di C#, ASP.NET, VB.NET"
head_description: ".Pustaka .NET untuk menemukan dan menghapus tanda air dari dokumen XLSM menggunakan pencarian cerdas dalam aplikasi C#, ASP.NET, VB.NET & .NET Core menggunakan API GroupDocs.Watermark untuk .NET."

title: "Hapus Tanda Air dari XLSM di C# .NET"
description: "Gunakan pencarian cerdas untuk menemukan & menghapus tanda air dari dokumen XLSM dengan pemformatan teks dari dalam aplikasi C#, ASP.NET, VB.NET & .NET Core. Tentukan kriteria pencarian untuk mencari & menghapus tanda air berdasarkan nama font tertentu, warna, ukuran dan properti lain yang cocok."
...
steps:
    enable: true
    title_left: "Hapus Tanda Air dari File XLSM di .NET"
    content_left: |
    ...
    code: |
        ```cs
        // Cari & hapus tanda air dengan pemformatan teks dari dokumen XLSM di aplikasi C#, ASP.NET, VB.NET & .NET Core
        // Instansiasi Watermarker dengan memasukkan dokumen XLSM
