...
steps:
    enable: true
    title: "Программно удалите водяные знаки из Pptx документов с помощью .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** позволяет разработчикам .NET программно удалять водяные знаки из различных Pptx документов. В этом руководстве описан процесс:
    ...
    code:
      ...
      content: |
        ...
        // Создайте экземпляр документа Watermarker, передав PPTX
