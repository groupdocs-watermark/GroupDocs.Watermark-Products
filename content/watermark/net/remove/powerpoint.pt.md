...
steps:
    enable: true
    title: "Remover marcas d'água de Powerpoint documentos usando .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** simplifica a tarefa de remover marcas d'água de documentos comerciais. Capacite seu aplicativo .NET integrando nossa biblioteca e siga estas etapas simples:
      ...
      1. **Watermarker**, com o documento Powerpoint. Nossa API suporta o processamento de documentos fornecidos como um fluxo ou um caminho local.
    ...
    code:
      ...
      content: |
        ...
        // Forneça uma instância Watermarker para o documento Powerpoint documento fonte
