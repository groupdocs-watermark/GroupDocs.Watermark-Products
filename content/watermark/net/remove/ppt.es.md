...
steps:
    enable: true
    title: "Eliminar marcas de agua mediante programación de documentos Ppt usando .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** permite a los desarrolladores de .NET eliminar mediante programación marcas de agua de varios documentos Ppt. Esta guía describe el proceso:
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Eliminar marca de agua de imagen en el documento PPT

        // Crear una instancia de Watermarker pasando el documento PPT
