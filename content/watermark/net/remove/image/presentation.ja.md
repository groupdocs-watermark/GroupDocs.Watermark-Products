...
head_title: "C＃.NETのプレゼンテーションから画像透かしを削除します"
head_description: ".GroupDocs.Watermark API for .NETを使用したC＃、ASP.NET、VB.NET、および.NET Coreアプリケーション内のスマート検索を使用して、PRESENTATIONドキュメントから画像の透かしを検索して削除するNETライブラリ."

title: "C＃のプレゼンテーションから画像透かしを削除します"
description: "スマート検索を使用して、C＃、ASP.NET、VB.NET、および.NETCoreアプリケーション内のPRESENTATIONドキュメントから画像透かしを見つけて削除します。ドキュメントから指定された透かしを検索および削除するための検索基準を定義します."
...
steps:
    ...
    code: |
        ```cs
        // C＃、ASP.NET、VB.NET、および.NETCoreアプリケーションのPRESENTATIONドキュメントから画像透かしを検索して削除します
