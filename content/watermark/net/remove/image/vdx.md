...
############################# Head ############################
head_title: "Remove Image Watermark from VDX in C# .NET"
head_description: ".NET library to find and remove image watermark from VDX document using smart search within C#, ASP.NET, VB.NET & .NET Core applications using GroupDocs.Watermark APIs for .NET."

############################# Header ############################
title: "Remove Image Watermark from VDX in C#"
description: "Use smart search to find & remove image watermark from a VDX document from within C#, ASP.NET, VB.NET & .NET Core applications. Define a search criterion to search & delete the specified watermarks from the document."
...
steps:
    ...
    code: |
        ```cs
        // Search & remove image watermark with from a VDX document in C#, ASP.NET, VB.NET & .NET Core applications
        // Instantiate Watermarker with input VDX document
