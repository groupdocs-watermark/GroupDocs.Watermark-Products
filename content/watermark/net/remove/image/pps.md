...
############################# Head ############################
head_title: "Remove Image Watermark from PPS in C# .NET"
head_description: ".NET library to find and remove image watermark from PPS document using smart search within C#, ASP.NET, VB.NET & .NET Core applications using GroupDocs.Watermark APIs for .NET."

############################# Header ############################
title: "Remove Image Watermark from PPS in C#"
description: "Use smart search to find & remove image watermark from a PPS document from within C#, ASP.NET, VB.NET & .NET Core applications. Define a search criterion to search & delete the specified watermarks from the document."
...
steps:
    ...
    code: |
        ```cs
        // Search & remove image watermark with from a PPS document in C#, ASP.NET, VB.NET & .NET Core applications
        // Instantiate Watermarker with input PPS document
