...
steps:
    enable: true
    title: "Programmgesteuertes Entfernen von Wasserzeichen aus Doc Dokumenten mit .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** ermöglicht es .NET Entwicklern, Wasserzeichen programmgesteuert aus verschiedenen Doc Dokumenten zu entfernen. In diesem Handbuch wird der Prozess beschrieben:
    ...
    code:
      ...
      content: |
        ...
        // Instantiieren Sie einen Wassermarker, der ein DOC Dokument übergibt
