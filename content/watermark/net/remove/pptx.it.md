...
steps:
    enable: true
    title: "Rimuovi le filigrane a livello di codice dai documenti Pptx usando .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** consente agli .NET sviluppatori di rimuovere programmaticamente le filigrane da vari documenti Pptx. Questa guida illustra il processo:
    ...
    code:
      ...
      content: |
        ...
        // Crea un'istanza di Watermarker che passa il documento PPTX
