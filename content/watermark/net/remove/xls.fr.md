...
steps:
    enable: true
    title: "Supprimez les filigranes des documents Xls par programmation à l'aide de .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** permet à .NET développeurs de supprimer par programmation les filigranes de divers documents Xls. Ce guide décrit le processus :
    ...
    code:
      ...
      content: |
        ...
        // Instanciez un filigrane en transmettant le document XLS
