...
############################# Head ############################
head_title: "Supprimez les filigranes dans les feuilles de calcul Excel XLS"
head_description: "Supprimez efficacement les filigranes de XLS documents à l'aide de notre API C# .NET, garantissant des fichiers propres et d'aspect professionnel."

############################# Header ############################
title: "Supprimer le filigrane dans XLS feuilles de calcul en utilisant C# .NET" 
description: "Utilisez l'API GroupDocs.Watermark for .NET C# pour supprimer ou modifier efficacement les filigranes des fichiers XLS, ce qui est idéal pour conserver une mise en forme impeccable des documents."
...
about:
    ...
    content: |
       La bibliothèque GroupDocs.Watermark for .NET C# propose des outils robustes pour gérer les filigranes dans les documents XLS. Qu'il s'agisse de simples suppressions ou de modifications complexes, cette API permet aux développeurs de préserver l'esthétique et l'intégrité des documents, en répondant aux besoins commerciaux, financiers et d'analyse des données.

############################# Steps ############################
steps:
    enable: true
    title: "Supprimez par programme les filigranes des documents Xls à l'aide de .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** permet aux développeurs .NET de supprimer par programme les filigranes de divers documents Xls. Ce guide décrit le processus :
      
      1. Lancez le flux de travail en fournissant votre fichier Xls comme argument au constructeur de classe **Watermarker**. Le fichier peut être fourni sous forme de flux d'octets, de flux de fichiers ou de référence à un emplacement de disque local.
    ...
    code:
      ...
      content: |
        ...
        // Instancier Watermarker en passant le document XLS
...
more_formats:
    enable: true
    title: "Gestion du fichier XLS avec suppression des filigranes avec .NET"
    exclude: "XLS"
    description: "Découvrez les fonctionnalités de l'API GroupDocs.Watermark for .NET C# pour gérer et supprimer les filigranes des fichiers XLS, améliorant ainsi la sécurité et la présentation des documents sans compromettre la qualité."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
