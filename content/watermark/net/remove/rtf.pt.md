...
steps:
    enable: true
    title: "Remova programaticamente marcas d'água de Rtf documentos usando .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** capacita .NET desenvolvedores a removerem programaticamente marcas d'água de vários documentos Rtf. Este guia descreve o processo:
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Remover marca d'água da imagem no documento RTF

        // Instanciar o Watermarker passando o documento RTF
