...
steps:
    enable: true
    title: ".NET を使用して Docx ドキュメントからウォーターマークをプログラムで削除する"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** は .NET 開発者がさまざまな Docx ドキュメントからウォーターマークをプログラムで削除できるようにします。このガイドではプロセスの概要を説明します。
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // DOCX ドキュメントの画像ウォーターマークを削除

        // DOCX ドキュメントを渡すウォーターマーカーをインスタンス化
