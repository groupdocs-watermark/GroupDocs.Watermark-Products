...
############################# Head ############################
head_title: "C# .NET 用于移除 PowerPoint 水印的 API"
head_description: "使用我们的 C# .NET API 高效去除 PowerPoint 张幻灯片上的水印，确保演示清晰且专业。"

############################# Header ############################
title: "使用 C# .NET 移除 PPTX 水印" 
description: "利用 GroupDocs.Watermark for .NET C# API 有效移除 PPTX 文件中的水印，非常适合保持演示文稿的完整性和视觉吸引力。"
...
steps:
    enable: true
    title: "使用 .NET 以编程方式从 Pptx 文档中删除水印"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** 使 .NET 开发人员能够以编程方式从各种 Pptx 文档中删除水印。本指南概述了该过程：
...
more_formats:
    ...
    exclude: "PPTX"
    description: "探索 GroupDocs.Watermark for .NET C# API 如何帮助您管理和移除 PPTX 文件中的水印，确保演示具有影响力和专业性。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
