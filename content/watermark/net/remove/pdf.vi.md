...
steps:
    enable: true
    title: "Xóa hình mờ theo chương trình từ Pdf Tài liệu bằng cách sử dụng .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** trao quyền cho .NET nhà phát triển xóa hình mờ theo chương trình khỏi các tài liệu Pdf khác nhau. Hướng dẫn này phác thảo quy trình:
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Xóa hình mờ hình ảnh trong tài liệu PDF

        // Thực hiện Watermarker đi qua tài liệu PDF
