...
############################# Head ############################
head_title: "Suppression du filigrane de présentation pour PPT"
head_description: "Supprimez efficacement les filigranes du diaporama de présentation grâce à l'API C# .NET, garantissant des présentations claires et professionnelles."

############################# Header ############################
title: "PPT Suppression du filigrane de présentation C# .NET" 
description: "Utilisez l'API GroupDocs.Watermark for .NET C# pour supprimer efficacement les filigranes des fichiers PPT, ce qui est idéal pour préserver l'intégrité et l'attrait visuel de vos présentations."
...
steps:
    enable: true
    title: "Supprimez les filigranes des documents Ppt par programmation à l'aide de .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** permet à .NET développeurs de supprimer par programmation les filigranes de divers documents Ppt. Ce guide décrit le processus :
    ...
    code:
      ...
      content: |
        ...
        // Instanciez un filigrane en transmettant le document PPT
...
more_formats:
    ...
    exclude: "PPT"
    description: "Découvrez comment l'API GroupDocs.Watermark for .NET C# peut vous aider à gérer et à supprimer les filigranes des fichiers PPT, garantissant ainsi des présentations professionnelles et percutantes."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
