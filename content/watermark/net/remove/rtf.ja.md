...
steps:
    enable: true
    title: ".NET を使用してプログラムで Rtf ドキュメントからウォーターマークを削除する"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** を使用すると、.NET の開発者はさまざまな Rtf ドキュメントからウォーターマークをプログラムで削除できます。このガイドでは、プロセスの概要を説明します。
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // RTF ドキュメント内の画像の透かしを削除する

        // RTF ドキュメントを渡す Watermarker をインスタンス化します
