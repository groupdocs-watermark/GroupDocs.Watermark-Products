...
steps:
    enable: true
    title: "Програмне видалення водяних знаків з Pdf документів за допомогою .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** дає можливість розробникам .NET програмно видаляти водяні знаки з різних Pdf документів. У цьому посібнику описано процес:
    ...
    code:
      ...
      content: |
        ...
        // Принциповувати водяний маркер, який передає документ PDF
