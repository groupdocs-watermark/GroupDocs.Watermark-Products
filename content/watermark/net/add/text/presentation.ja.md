...
head_title: "C＃、ASP.NET、VB.NETのプレゼンテーションにテキスト透かしを追加する"
head_description: ".GroupDocs.Watermark API for .NETを使用して、C＃、ASP.NET、VB.NET、および.NETCoreアプリケーションのPRESENTATIONファイルにテキストウォーターマークを追加するNETライブラリ."

title: "C＃.NETのプレゼンテーションにテキスト透かしを追加する"
description: "C＃、ASP.NET、VB.NET、および.NETCoreアプリケーションのPRESENTATIONファイルにテキスト透かしを追加します。必要に応じて、透かしのサイズ、フォントタイプ、回転角度、およびドキュメントページ上の透かしの位置を管理します。"
...
steps:
    enable: true
    title_left: ".NETのプレゼンテーションファイルにテキスト透かしを追加"
    content_left: |
    ...
    code: |
        ```cs
        // C＃、ASP.NET、VB.NET、および.NETCoreアプリケーションのPRESENTATIONにテキスト透かしを追加します
