...
############################# Head ############################
head_title: "Add Text Watermark to DOCX in C#, ASP.NET, VB.NET"
head_description: ".NET library to add text watermark to DOCX file in C#, ASP.NET, VB.NET & .NET Core applications using GroupDocs.Watermark APIs for .NET."

############################# Header ############################
title: "Add Text Watermark to DOCX in C# .NET"
description: "Adding text watermark to DOCX file in C#, ASP.NET, VB.NET & .NET Core applications. Manage the watermark size, font type, rotation angle and position of the watermark on the document pages, as you may need."
...
steps:
    enable: true
    title_left: "Add Text Watermark to DOCX File in .NET"
    content_left: |
    ...
    code: |
        ```cs
        // Add text watermark to DOCX in C#, ASP.NET, VB.NET & .NET Core applications
        // Instantiate Watermarker with input DOCX document
