...
head_title: "Tambahkan Tanda Air Teks ke VSTX di C#, ASP.NET, VB.NET"
head_description: ".Pustaka .NET untuk menambahkan tanda air teks ke file VSTX di aplikasi C#, ASP.NET, VB.NET & .NET Core menggunakan API GroupDocs.Watermark untuk .NET."

title: "Tambahkan Tanda Air Teks ke VSTX di C# .NET"
description: "Menambahkan watermark teks ke file VSTX di aplikasi C#, ASP.NET, VB.NET & .NET Core. Kelola ukuran tanda air, jenis font, sudut rotasi, dan posisi tanda air pada halaman dokumen, sesuai kebutuhan Anda."
...
steps:
    enable: true
    title_left: "Tambahkan Tanda Air Teks ke File VSTX di .NET"
    content_left: |
    ...
    code: |
        ```cs
        // Tambahkan tanda air teks ke VSTX di aplikasi C#, ASP.NET, VB.NET & .NET Core
        // Instansiasi Watermarker dengan memasukkan dokumen VSTX
