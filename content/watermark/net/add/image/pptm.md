...
############################# Head ############################
head_title: "Add Image Watermark to PPTM in C#, ASP.NET, VB.NET"
head_description: ".NET library to add image watermark to PPTM file in C#, ASP.NET, VB.NET & .NET Core applications using GroupDocs.Watermark APIs for .NET."

############################# Header ############################
title: "Add Image Watermark to PPTM in C# .NET"
description: "Adding image watermark to PPTM file in C#, ASP.NET, VB.NET & .NET Core applications. Add BMP, PNG, GIF & JPEG image watermarks to the documents. Also manage the watermark size, alignment, rotation angle and position of the watermark on the document pages, as you may need."
...
steps:
    enable: true
    title_left: "Add Image Watermark to PPTM File in .NET"
    content_left: |
    ...
    code: |
        ```cs
        // Add image watermark to PPTM in C#, ASP.NET, VB.NET & .NET Core applications
        // Instantiate Watermarker with input PPTM document
