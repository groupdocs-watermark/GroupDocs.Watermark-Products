...
############################# Head ############################
head_title: "Search Image Watermarks from XLTM in C# ASP.NET VB.NET"
head_description: ".NET library to search image watermarks from XLTM document using smart search features within C#, ASP.NET, VB.NET & .NET Core applications using GroupDocs.Watermark APIs for .NET."

############################# Header ############################
title: "Search Image Watermarks from XLTM in C#"
description: "Use smart search to find all possible image watermarks from XLTM file from within C#, ASP.NET, VB.NET & .NET Core applications. Define search criteria tp find all matching image watermarks from the whole or specific pages of the source document."
...
steps:
    enable: true
    title_left: "Search Watermarks from XLTM in .NET"
    content_left: |
    ...
    code: |
        ```cs
        // Search possible IMAGE watermarks in XLTM document using C#, ASP.NET, VB.NET & .NET Core.
        // Instantiate Watermarker with input XLTM document
