...
############################# Head ############################
head_title: "Search Image Watermarks from PPTM in C# ASP.NET VB.NET"
head_description: ".NET library to search image watermarks from PPTM document using smart search features within C#, ASP.NET, VB.NET & .NET Core applications using GroupDocs.Watermark APIs for .NET."

############################# Header ############################
title: "Search Image Watermarks from PPTM in C#"
description: "Use smart search to find all possible image watermarks from PPTM file from within C#, ASP.NET, VB.NET & .NET Core applications. Define search criteria tp find all matching image watermarks from the whole or specific pages of the source document."
...
steps:
    ...
    code: |
        ```cs
        // Search possible IMAGE watermarks in PPTM document using C#, ASP.NET, VB.NET & .NET Core.
        // Instantiate Watermarker with input PPTM document
