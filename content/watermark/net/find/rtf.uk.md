...
############################# Head ############################
head_title: "Виявлення прихованих водяних знаків у документах RTF"
...
############################# Header ############################
title: "Виявлення та керування прихованими водяними знаками у документах RTF" 
description: "Швидко виявляйте та керуйте прихованими водяними знаками за допомогою GroupDocs.Watermark for .NET."
...
steps:
    ...
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** пропонує надійне рішення для програмного пошуку водяних знаків у різних форматах ділових документів. Інтегруйте наш пакет у свої програми .NET, щоб надати їм можливості пошуку водяних знаків.
      ...
      1. Щоб скористатися функціями нашої бібліотеки, створіть екземпляр класу **Watermarker** і надайте шлях до файлу Rtf, потік файлів або потік байтів як вхідні дані. Ця дія завантажує документ для аналізу водяних знаків.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Знайти водяні знаки зображень у RTF

        // Побудуйте Watermarker, передаючи шлях RTF
...
more_formats:
    enable: true
    title: "Виявлення водяних знаків у кількох форматах"
    exclude: "RTF"
