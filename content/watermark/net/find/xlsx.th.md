...
steps:
    enable: true
    title: "ค้นหาลายน้ำ Xlsx ได้อย่างมีประสิทธิภาพด้วย .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** นำเสนอโซลูชันที่แข็งแกร่งสำหรับการค้นหาลายน้ำตามโปรแกรมภายในรูปแบบเอกสารทางธุรกิจต่างๆรวมแพ็คเกจของเราเข้ากับแอปพลิเคชัน .NET ของคุณเพื่อเพิ่มพลังให้กับพวกเขาด้วยความสามารถในการค้นหาลายน้ำ
      ...
      1. **Watermarker** และให้เส้นทางไฟล์ Xlsx สตรีมไฟล์ หรือสตรีมไบต์เป็นอินพุตการกระทำนี้โหลดเอกสารสำหรับการวิเคราะห์ลายน้ำ
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // ค้นหาลายน้ำรูปภาพที่วางไว้ใน XLSX

        // สร้างเครื่องหมายน้ำที่ผ่านเส้นทาง XLSX
