...
steps:
    enable: true
    title: "Temukan Tanda Air Docx secara Efisien dengan .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** menawarkan solusi tangguh untuk menemukan tanda air secara terprogram dalam berbagai format dokumen bisnis. Integrasikan paket kami ke dalam aplikasi .NET Anda untuk memberdayakannya dengan kemampuan menemukan tanda air.
      ...
      1. Untuk mengeksploitasi fungsionalitas perpustakaan kami, buat instance kelas **Watermarker** dan berikan jalur file Docx, aliran file, atau aliran byte sebagai input. Tindakan ini memuat dokumen untuk analisis tanda air.
    ...
    code:
      ...
      content: |
        ...
        // Bangunlah Watermarker dengan melewati jalur DOCX
