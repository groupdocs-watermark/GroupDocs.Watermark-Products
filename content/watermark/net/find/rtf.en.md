...
############################# Head ############################
head_title: "Detect Hidden Watermarks in RTF Documents"
head_description: "Detect hidden watermarks within documents effortlessly with GroupDocs.Watermark for .NET."

############################# Header ############################
title: "Detect and Manage Hidden Watermarks in RTF Documents" 
description: "Quickly detect and manage hidden watermarks with GroupDocs.Watermark for .NET."
...
about:
    ...
    content: |
       GroupDocs.Watermark for .NET offers a robust solution for managing watermarks using .NET. Easily generate, edit, find, and remove watermarks from various document formats such as PDF, Microsoft Word, Excel, and more. Integrate watermark management into your applications via GroupDocs.Watermark for .NET easily.

############################# Steps ############################
steps:
    enable: true
    title: "Efficiently Find Rtf Watermarks with .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** offers a robust solution for programmatically finding watermarks within various business document formats. Integrate our package into your .NET applications to empower them with watermark finding capabilities.
      ...
      1. To exploit the functionalities of our library, instantiate the **Watermarker** class and provide the Rtf file path, file stream, or byte stream as input. This action loads the document for watermark analysis.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Find image watermarks placed in RTF

        // Construct Watermarker passing RTF path
...
more_formats:
    enable: true
    title: "Detect Watermarks Across Multiple Formats"
    exclude: "RTF"
    description: "Effortlessly identify and manage watermarks across a wide range of supported file formats."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
