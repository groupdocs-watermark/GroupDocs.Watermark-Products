...
steps:
    enable: true
    title: "Trouvez efficacement Xls filigranes avec .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** offre une solution robuste pour rechercher par programmation des filigranes dans différents formats de documents commerciaux. Intégrez notre package à vos .NET applications pour les doter de fonctionnalités de recherche de filigranes.
      ...
      1. **Watermarker** et fournissez le chemin de fichier Xls, le flux de fichiers ou le flux d'octets en entrée. Cette action charge le document pour analyse des filigranes.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Rechercher les filigranes d'une image placés dans XLS

        // Construire un filigrane en passant par le chemin XLS
