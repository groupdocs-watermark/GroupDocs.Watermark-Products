...
steps:
    enable: true
    title: "Encuentre Rtf marcas de agua de manera eficiente con .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** ofrece una solución sólida para encontrar marcas de agua mediante programación en varios formatos de documentos empresariales. Integre nuestro paquete en sus .NET aplicaciones para dotarlas de funciones de búsqueda de marcas de agua.
      ...
      1. **Watermarker** y proporcione la ruta del archivo, el flujo de archivos o el flujo de bytes Rtf como entrada. Esta acción carga el documento para el análisis de las marcas de agua.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Busca marcas de agua de imágenes colocadas en RTF

        // Construye un marcador de agua que pase por el camino RTF
