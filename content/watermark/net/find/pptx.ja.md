...
steps:
    enable: true
    title: ".NET で Pptx 個のウォーターマークを効率的に検索"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)**は、さまざまなビジネス文書形式のウォーターマークをプログラムで検索するための堅牢なソリューションです。当社のパッケージをお使いの .NET アプリケーションに統合すると、ウォーターマーク検索機能が強化されます。
      ...
      1. **Watermarker**クラスをインスタンス化し、Pptx ファイルパス、ファイルストリーム、またはバイトストリームを入力として指定します。このアクションにより、ウォーターマーク分析用のドキュメントが読み込まれます。
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // PPTX にある画像のウォーターマークを検索

        // PPTX パスを通過するウォーターマーカーを作成
