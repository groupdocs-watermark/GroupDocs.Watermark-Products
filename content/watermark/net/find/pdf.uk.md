...
############################# Head ############################
head_title: "Розкрийте PDF документів Приховані водяні знаки"
head_description: "Легко розкривайте приховані водяні знаки в документах за допомогою GroupDocs.Watermark for .NET."

############################# Header ############################
title: "Миттєво розкрийте PDF документів Приховані водяні знаки" 
...
about:
    enable: true
    title: "Близько GroupDocs.Watermark for .NET"
    link: "/watermark/net/"
...
steps:
    enable: true
    title: "Ефективно знайдіть водяні знаки Pdf за допомогою .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** пропонує надійне рішення для програмного пошуку водяних знаків у різних форматах ділових документів. Інтегруйте наш пакет у свої програми .NET, щоб надати їм можливості пошуку водяних знаків.
      ...
      1. Щоб скористатися функціями нашої бібліотеки, створіть екземпляр класу **Watermarker** і надайте шлях до файлу Pdf, потік файлів або потік байтів як вхідні дані. Ця дія завантажує документ для аналізу водяних знаків.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Знайти водяні знаки зображень у PDF

        // Побудуйте Watermarker, передаючи шлях PDF
...
more_formats:
    enable: true
    title: "Відкрийте водяні знаки у підтримуваних форматах"
    exclude: "PDF"
