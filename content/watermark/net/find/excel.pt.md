...
steps:
    enable: true
    title: "Encontre marcas d'água em arquivos Excel usando .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** agiliza o processo de localização de marcas d'água em documentos comerciais. Integre nosso pacote em seus aplicativos .NET para desbloquear suas vantagens.
      ...
      1. Para aproveitar os recursos de nossa biblioteca, carregue o arquivo Excel em uma instância de classe **Watermarker**. Você pode fornecer um caminho de arquivo, fluxo de arquivo ou fluxo de bytes.
    ...
    code:
      ...
      content: |
        ...
        // Crie Watermarker com caminho EXCEL
