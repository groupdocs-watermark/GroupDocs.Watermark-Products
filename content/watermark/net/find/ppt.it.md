...
steps:
    enable: true
    title: "Trova in modo efficiente Ppt filigrane con .NET"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/net/)** offre una soluzione robusta per la ricerca programmatica delle filigrane all'interno di vari formati di documenti aziendali. Integra il nostro pacchetto nelle tue .NET applicazioni per potenziarle con funzionalità di ricerca delle filigrane.
      ...
      1. **Watermarker** e fornisci il percorso del file Ppt, il flusso di file o il flusso di byte come input. Questa azione carica il documento per l'analisi della filigrana.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Trova le filigrane delle immagini inserite in PPT
