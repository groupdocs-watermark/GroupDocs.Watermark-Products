...
############################# Head ############################
head_title: "Edite Pdf marcas d'água com GroupDocs.Watermark"
head_description: "Edite Pdf marcas d'água em Pdf arquivos usando GroupDocs.Watermark for .NET Framework. Adapte-se às suas necessidades de documentos com facilidade."

############################# Header ############################
title: "Edite marcas d'água em Pdf: .NET Adaptabilidade" 
description: "Adapte-se perfeitamente às suas necessidades de documentos com o GroupDocs.Watermark for .NET Framework. Edite marcas d'água em vários formatos com facilidade."
...
about:
    ...
    content: |
       **Edite marca d'água em PDF s:** Proteja seu conteúdo em vários formatos com o GroupDocs.Watermark for .NET Framework. Adapte-se perfeitamente às suas necessidades de documentos com nossas ferramentas versáteis.

############################# Steps ############################
steps:
    enable: true
    title: "Edite programaticamente marcas d'água em documentos Pdf com a API .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** fornece aos desenvolvedores do .NET uma API robusta para manipular marcas d'água programaticamente em diversos documentos do Pdf. Este guia descreve o processo:
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Edite a marca d'água da imagem no documento PDF
...
more_formats:
    enable: true
    title: "Ajuste marcas d'água em vários formatos"
    exclude: "PDF"
    description: "Proteja seu conteúdo em vários formatos de documentos com o GroupDocs.Watermark for .NET Framework."
    items: 
        # format loop 1
