...
############################# Head ############################
head_title: "Solution sécurisée d'édition de filigranes Xlsx"
head_description: "Assurez une édition sécurisée des filigranes Xlsx avec le composant GroupDocs.Watermark for .NET. Protégez votre contenu et votre marque en toute confiance."

############################# Header ############################
title: "Édition sécurisée des filigranes Xlsx : .NET Assurance" 
description: "Assurez la sécurité des documents et la protection de la marque avec le composant GroupDocs.Watermark for .NET. Modifiez vos filigranes en toute sécurité et en toute confiance."
...
about:
    ...
    content: |
       **Xlsx Outils d'édition des filigranes :** Optimisez l'édition de vos filigranes dans .NET projets avec GroupDocs.Watermark. Simplifiez vos processus métier et concentrez-vous sur votre contenu tout en garantissant la sécurité des documents sans effort.
...
more_formats:
    enable: true
    title: "Autres formats Édition de filigranes"
    exclude: "XLSX"
    description: "Assurez la sécurité des documents et la protection de la marque avec le composant GroupDocs.Watermark for .NET."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
