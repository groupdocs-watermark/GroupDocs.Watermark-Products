...
############################# Head ############################
head_title: "Modifica le filigrane in formato Doc con facilità"
head_description: "Modifica le filigrane Doc senza problemi con l'API GroupDocs.Watermark for .NET. Personalizza i tuoi documenti con sicurezza ed efficienza."

############################# Header ############################
title: "Modifica facilmente Doc Watermark con .NET" 
description: "Semplifica la gestione delle filigrane e proteggi i tuoi documenti con l'API GroupDocs.Watermark for .NET. Ottieni versatilità ed efficienza nel tuo flusso di lavoro."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Scarica il pacchetto da Nuget"
      link: "https://releases.groupdocs.com/watermark/net/"
      
############################# About ############################
about:
    enable: true
    title: "GroupDocs.Watermark for .NET Struttura"
    link: "/watermark/net/"
    link_title: "Scopri di più"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       **Modifica le filigrane con facilità:** Semplifica la gestione delle filigrane su Doc documenti con la nostra soluzione intuitiva per .NET. Concentrati sui tuoi contenuti garantendo al contempo la sicurezza e l'integrità dei documenti senza alcuno sforzo.

############################# Steps ############################
steps:
    enable: true
    title: "Modifica a livello di codice le filigrane nei documenti Doc con l'API .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** fornisce agli sviluppatori di .NET una solida API per manipolare a livello di codice le filigrane all'interno di diversi documenti Doc. Questa guida descrive il processo:
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Modifica la filigrana dell'immagine nel documento DOC
...
more_formats:
    enable: true
    title: "Gestisci le filigrane con facilità in altri formati"
    exclude: "DOC"
    description: "Semplifica la modifica della filigrana in diversi formati di documento utilizzando GroupDocs.Watermark for .NET."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
