...
steps:
    enable: true
    title: "Modifiez par programmation les filigranes dans les documents Pptx avec l'API .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** fournit à .NET développeurs une API robuste pour manipuler par programmation les filigranes dans divers Pptx documents. Ce guide décrit le processus :
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Modifier le filigrane de l'image dans PPTX doc
