...
############################# Head ############################
head_title: "Modifier Pptx Watermarks Solutions "
head_description: "Modifiez les filigranes Pptx selon vos besoins avec la solution GroupDocs.Watermark for .NET. Améliorez vos fichiers avec précision."

############################# Header ############################
title: "Solution flexible .NET pour l'édition de filigranes Pptx" 
description: "Modifiez votre filigrane à l'aide de notre solution GroupDocs.Watermark for .NET pour répondre à vos besoins spécifiques. Améliorez vos documents commerciaux en toute simplicité."
...
about:
    ...
    content: |
       **Modifiez Pptx filigranes dans vos solutions :** Adaptez les solutions de filigrane à vos besoins spécifiques avec GroupDocs.Watermark for .NET développeurs. Améliorez la présence de votre marque tout en garantissant la sécurité des documents en toute simplicité.

############################# Steps ############################
steps:
    enable: true
    title: "Modifiez par programme les filigranes dans les documents Pptx avec l'API .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** fournit aux développeurs .NET une API robuste pour manipuler par programmation les filigranes dans divers documents Pptx. Ce guide décrit le processus :
      
      1. Lancez le flux de travail en fournissant votre fichier Pptx comme argument au constructeur de classe **Watermarker**. Le fichier peut être fourni sous forme de flux d'octets, de flux de fichiers ou de référence à un emplacement de disque local.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Modifier le filigrane de l'image dans le document PPTX
...
more_formats:
    enable: true
    title: "Tailor Watermark dans d'autres formats"
    exclude: "PPTX"
    description: "Modifiez le filigrane de vos solutions pour répondre à vos besoins spécifiques avec GroupDocs.Watermark for .NET."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
