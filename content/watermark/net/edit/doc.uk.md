...
############################# Head ############################
head_title: "Легко редагуйте водяні знаки у форматі Doc"
head_description: "Редагуйте Doc водяні знаки без проблем за допомогою GroupDocs.Watermark for .NET API. Налаштуйте документи з упевненістю та ефективністю."

############################# Header ############################
title: "Легко редагуйте Doc водяні знаки за допомогою .NET" 
description: "Спростіть керування водяними знаками та захистіть свої документи за допомогою GroupDocs.Watermark for .NET API. Досягніть універсальності та ефективності робочого процесу."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Завантажити пакунок з Nuget"
      link: "https://releases.groupdocs.com/watermark/net/"
      
############################# About ############################
about:
    enable: true
    title: "GroupDocs.Watermark for .NET Рамка"
    link: "/watermark/net/"
    link_title: "Дізнатися більше"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       **Легко редагуйте водяні знаки:** Спростіть керування водяними знаками у Doc документах за допомогою нашого .NET зручного рішення. Зосередьтеся на своєму вмісті, забезпечуючи безпеку та цілісність документів без особливих зусиль.

############################# Steps ############################
steps:
    enable: true
    title: "Програмне редагування водяних знаків у документах Doc за допомогою API .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** надає розробникам .NET надійний API для програмного керування водяними знаками в різноманітних документах Doc. Цей посібник описує процес:
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Редагувати водяний знак зображення в документі DOC
...
more_formats:
    enable: true
    title: "Легко керуйте водяними знаками в інших форматах"
    exclude: "DOC"
    description: "Спростіть редагування водяних знаків у різних форматах документів за допомогою GroupDocs.Watermark for .NET."
    items: 
        # format loop 1
