...
############################# Head ############################
head_title: "Ppt 개의 워터마크를 손쉽게 편집"
head_description: "GroupDocs.Watermark for .NET 라이브러리로 Ppt 워터마크를 손쉽게 업데이트하세요.문서 무결성과 보안을 원활하게 유지합니다."

############################# Header ############################
title: "Ppt 개의 워터마크를 손쉽게 편집: .NET 컨트롤" 
description: "GroupDocs.Watermark for .NET Library를 사용하여 문서 무결성과 보안을 손쉽게 유지할 수 있습니다.워터마크를 정밀하고 제어하여 편집하세요."
...
steps:
    enable: true
    title: ".NET API를 사용하여 Ppt 문서의 워터마크를 프로그래밍 방식으로 편집"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** 는 .NET 개발자에게 다양한 Ppt 문서 내에서 워터마크를 프로그래밍 방식으로 조작하기 위한 강력한 API를 제공합니다. 이 가이드에서는 프로세스를 간략하게 설명합니다.
...
more_formats:
    enable: true
    title: "다른 형식의 워터마크를 손쉽게 업데이트"
    exclude: "PPT"
    description: "GroupDocs.Watermark for .NET Library를 사용하여 문서 무결성과 보안을 손쉽게 유지할 수 있습니다."
    items: 
        # format loop 1
        - name: "워터마크 PDF"
          format: "PDF"
