...
steps:
    enable: true
    title: "Chỉnh sửa hình mờ theo chương trình trong tài liệu Pdf bằng API .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** cung cấp cho .NET nhà phát triển một API mạnh mẽ để thao tác hình mờ theo chương trình trong các tài liệu Pdf khác nhau. Hướng dẫn này phác thảo quy trình:
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Chỉnh sửa hình mờ hình ảnh trong PDF doc
