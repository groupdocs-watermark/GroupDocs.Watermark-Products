...
############################# Head ############################
head_title: "GroupDocs.Watermark 으로 Pdf 개의 워터마크 편집"
head_description: "GroupDocs.Watermark for .NET 프레임워크를 사용하여 Pdf 파일의 Pdf 워터마크를 편집합니다.문서 요구 사항에 맞게 쉽게 조정할 수 있습니다."

############################# Header ############################
title: "Pdf: .NET 적응성에서 워터마크 편집" 
description: "GroupDocs.Watermark for .NET Framework를 사용하여 문서 요구 사항에 원활하게 적응할 수 있습니다.여러 형식의 워터마크를 쉽게 편집할 수 있습니다."
...
steps:
    enable: true
    title: ".NET API를 사용하여 Pdf 문서의 워터마크를 프로그래밍 방식으로 편집"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** 는 .NET 개발자에게 다양한 Pdf 문서 내에서 워터마크를 프로그래밍 방식으로 조작하기 위한 강력한 API를 제공합니다. 이 가이드에서는 프로세스를 간략하게 설명합니다.
...
more_formats:
    enable: true
    title: "다양한 형식의 워터마크 조정"
    exclude: "PDF"
    description: "GroupDocs.Watermark for .NET Framework를 사용하여 다양한 문서 형식의 콘텐츠를 보호하세요."
    items: 
        # format loop 1
        - name: "워터마크 PDF"
          format: "PDF"
