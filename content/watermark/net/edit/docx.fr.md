...
steps:
    enable: true
    title: "Modifiez par programme les filigranes dans les documents Docx avec l'API .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** fournit aux développeurs .NET une API robuste pour manipuler par programmation les filigranes dans divers documents Docx. Ce guide décrit le processus :
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Modifier le filigrane de l'image dans le document DOCX
