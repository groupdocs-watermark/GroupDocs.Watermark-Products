...
steps:
    enable: true
    title: "Edite las marcas de agua en Powerpoint documentos con .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** permite a .NET desarrolladores editar sin esfuerzo las marcas de agua de varios Powerpoint documentos. Esta es una guía simplificada sobre cómo usar nuestra API en tu aplicación:
    ...
    code:
      ...
      content: |
        ...
        // Haga que Watermarker proporcione el archivo POWERPOINT
