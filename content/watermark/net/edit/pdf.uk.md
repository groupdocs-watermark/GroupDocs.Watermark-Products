...
############################# Head ############################
head_title: "Редагувати Pdf водяні знаки за допомогою GroupDocs.Watermark"
head_description: "Редагувати Pdf водяні знаки в Pdf файлах за допомогою GroupDocs.Watermark for .NET Framework. Легко адаптуйтеся до ваших потреб у документі."

############################# Header ############################
title: "Редагувати водяні знаки в Pdf: .NET Адаптивність" 
description: "Плавно адаптуйтеся до потреб вашого документа за допомогою GroupDocs.Watermark for .NET Framework. Легко редагуйте водяні знаки в різних форматах."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Безкоштовний пакет Nuget"
...
about:
    ...
    content: |
       **Редагувати водяний знак за PDF с:** Захистіть свій вміст у кількох форматах за допомогою GroupDocs.Watermark for .NET Framework. Плавно адаптуйтеся до потреб ваших документів за допомогою наших універсальних інструментів.

############################# Steps ############################
steps:
    enable: true
    title: "Програмне редагування водяних знаків у документах Pdf за допомогою API .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** надає розробникам .NET надійний API для програмного керування водяними знаками в різних Pdf документах. У цьому посібнику описано процес:
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Редагування водяного знака зображення у документі PDF
...
more_formats:
    enable: true
    title: "Налаштування водяних знаків у декількох форматах"
    exclude: "PDF"
    description: "Захистіть свій вміст у різних форматах документів за допомогою GroupDocs.Watermark for .NET Framework."
    items: 
        # format loop 1
