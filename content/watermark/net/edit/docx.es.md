...
############################# Head ############################
head_title: "Edición de marcas de agua en Docx archivos"
head_description: "Edite marcas de agua en Docx archivos con GroupDocs.Watermark for .NET aplicaciones. Mejore la autenticidad de los documentos sin esfuerzo."

############################# Header ############################
title: "Edición de Docx marcas de agua en archivos: .NET Versatilidad" 
description: "Personalice sus documentos con confianza con GroupDocs.Watermark for .NET aplicaciones. Edite marcas de agua en varios formatos de archivo sin esfuerzo."
...
about:
    ...
    content: |
       **Edite marcas de agua en Docx archivos:** Edite sin problemas marcas de agua en varios formatos de archivo con GroupDocs.Watermark for .NET aplicaciones. Personalice sus documentos con confianza y eficiencia.

############################# Steps ############################
steps:
    enable: true
    title: "Edite marcas de agua mediante programación en documentos Docx con la API .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** proporciona a los desarrolladores de .NET una API sólida para manipular mediante programación marcas de agua dentro de diversos documentos Docx. Esta guía describe el proceso:
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Editar marca de agua de imagen en el documento DOCX
...
more_formats:
    enable: true
    title: "Edición de marcas de agua en archivos"
    exclude: "DOCX"
    description: "Edite sin problemas marcas de agua en varios formatos de archivo con aplicaciones impulsadas por GroupDocs.Watermark for .NET."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
