...
############################# Head ############################
head_title: "安全 Xlsx 水印编辑解决方案"
head_description: "确保使用 GroupDocs.Watermark for .NET 组件编辑 Xlsx 个水印的安全。放心地保护您的内容和品牌。"

############################# Header ############################
title: "安全 Xlsx 水印编辑：.NET 保障" 
description: "使用 GroupDocs.Watermark for .NET 组件确保文档安全和品牌保护。放心地安全地编辑您的水印。"
...
about:
    enable: true
    title: "GroupDocs.Watermark for .NET 解决方案"
    link: "/watermark/net/"
    link_title: "了解更多"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       **Xlsx 水印编辑工具：** 使用 GroupDocs.Watermark 优化 .NET 项目中的水印编辑。简化业务流程，专注于内容，同时毫不费力地确保文档安全。

############################# Steps ############################
steps:
    enable: true
    title: "使用 .NET API 以编程方式编辑 Xlsx 文档中的水印"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** 为 .NET 开发人员提供强大的 API，用于以编程方式操作各种 Xlsx 文档中的水印。本指南概述了该过程：
...
more_formats:
    ...
    title: "其他格式水印编辑"
    exclude: "XLSX"
    description: "使用 GroupDocs.Watermark for .NET 组件确保文档安全和品牌保护。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
