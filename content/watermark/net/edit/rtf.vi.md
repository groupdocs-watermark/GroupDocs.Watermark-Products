...
############################# Head ############################
head_title: "Chỉnh sửa hình mờ trong Rtf Tài liệu"
head_description: "Đạt được thương hiệu tài liệu Rtf đẹp mắt với GroupDocs.Watermark for .NET SDK. Chỉnh sửa hình mờ của bạn đảm bảo an ninh."

############################# Header ############################
title: "Chỉnh sửa hình mờ được đánh bóng Rtf: .NET Sự tinh tế" 
description: "Đạt được thương hiệu tài liệu tinh vi với GroupDocs.Watermark for .NET SDK. Chỉnh sửa hình mờ tài liệu của bạn một cách chính xác và tự tin."
...
about:
    ...
    content: |
       **Chỉnh sửa hình mờ được đánh bóng:** Đạt được thương hiệu tài liệu Rtf tinh vi với GroupDocs.Watermark for .NET SDK. Đánh bóng tài liệu của bạn với độ chính xác và tự tin, đảm bảo tính nhất quán và bảo vệ thương hiệu.
...
more_formats:
    enable: true
    title: "Xử lý định dạng khác"
    exclude: "RTF"
    description: "Chỉnh sửa hình mờ tài liệu theo những cách tinh vi với GroupDocs.Watermark for .NET SDK."
    items: 
        # format loop 1
        - name: "Hình mờ PDF"
          format: "PDF"
