...
############################# Head ############################
head_title: "Pdf のウォーターマークを GroupDocs.Watermark で編集"
head_description: "GroupDocs.Watermark for .NET フレームワークを使用して Pdf ファイルの Pdf ウォーターマークを編集します。文書のニーズに合わせて簡単に調整できます。"

############################# Header ############################
title: "Pdf のウォーターマークの編集:.NET の適応性" 
description: "GroupDocs.Watermark for .NET Frameworkでドキュメントのニーズにシームレスに対応します。複数の形式のウォーターマークを簡単に編集できます。"
...
about:
    ...
    content: |
       **PDF 秒でウォーターマークを編集:** GroupDocs.Watermark for .NET Frameworkで複数の形式のコンテンツを保護しましょう。当社の多彩なツールで、文書のニーズにシームレスに対応できます。

############################# Steps ############################
steps:
    enable: true
    title: ".NET API を使用して、Pdf ドキュメントのウォーターマークをプログラムで編集する"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** は、.NET の開発者に、さまざまな Pdf ドキュメント内のウォーターマークをプログラムで操作するための堅牢な API を提供します。このガイドでは、プロセスの概要を説明します。
...
more_formats:
    enable: true
    title: "複数の形式のウォーターマークを調整"
    exclude: "PDF"
    description: "GroupDocs.Watermark for .NET Frameworkを使用して、さまざまなドキュメント形式のコンテンツを保護します。"
    items: 
        # format loop 1
        - name: "ウォーターマーク PDF"
          format: "PDF"
