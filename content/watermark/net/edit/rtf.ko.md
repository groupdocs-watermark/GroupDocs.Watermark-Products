...
############################# Head ############################
head_title: "Rtf 문서의 워터마크 편집"
head_description: "GroupDocs.Watermark for .NET SDK로 세련된 Rtf 문서 브랜딩을 달성하세요.워터마크를 편집하여 보안을 강화하세요."

############################# Header ############################
title: "세련된 Rtf 워터마크 편집: .NET 정교함" 
description: "GroupDocs.Watermark for .NET SDK로 정교한 문서 브랜딩을 달성하세요.정확하고 자신 있게 문서 워터마크를 편집하세요."
...
about:
    ...
    content: |
       **세련된 워터마크 편집:** GroupDocs.Watermark for .NET SDK로 정교한 Rtf 문서 브랜딩을 달성하세요.정확하고 자신 있게 문서를 다듬어 브랜드 일관성과 보호를 보장하세요.

############################# Steps ############################
steps:
    enable: true
    title: ".NET API를 사용하여 Rtf 문서의 워터마크를 프로그래밍 방식으로 편집"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)**는 .NET 개발자에게 다양한 Rtf 문서 내에서 워터마크를 프로그래밍 방식으로 조작하기 위한 강력한 API를 제공합니다.이 가이드에서는 프로세스를 간략하게 설명합니다.
...
more_formats:
    ...
    title: "기타 형식 처리"
    exclude: "RTF"
    description: "GroupDocs.Watermark for .NET SDK를 사용하여 정교한 방식으로 문서 워터마크를 편집할 수 있습니다."
    items: 
        # format loop 1
        - name: "워터마크 PDF"
          format: "PDF"
