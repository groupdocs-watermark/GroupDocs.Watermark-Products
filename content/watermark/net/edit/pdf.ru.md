...
steps:
    enable: true
    title: "Программно редактируйте водяные знаки в Pdf документах с помощью API .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** предоставляет .NET разработчикам надежный API для программного управления водяными знаками в различных Pdf документах. В этом руководстве описан процесс:
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Отредактируйте водяной знак изображения в PDF doc
