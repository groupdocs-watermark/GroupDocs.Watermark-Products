...
steps:
    enable: true
    title: "Chỉnh sửa hình mờ trong Powerpoint tài liệu bằng .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** trao quyền cho .NET nhà phát triển dễ dàng chỉnh sửa hình mờ trong các tài liệu Powerpoint khác nhau. Dưới đây là hướng dẫn đơn giản về cách sử dụng API của chúng tôi trong ứng dụng của bạn:
    ...
    code:
      ...
      content: |
        ...
        // Tạo Watermarker cung cấp tệp POWERPOINT
