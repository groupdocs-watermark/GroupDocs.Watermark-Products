...
steps:
    enable: true
    title: "Edite mediante programación marcas de agua en Ppt documentos con la API .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** proporciona a .NET desarrolladores una API sólida para manipular mediante programación las marcas de agua en diversos Ppt documentos. Esta guía describe el proceso:
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Editar la marca de agua de la imagen en PPT doc
