...
steps:
    enable: true
    title: "Edite marcas d'água programaticamente em Ppt documentos com a API .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** fornece a .NET desenvolvedores uma API robusta para manipular programaticamente marcas d'água em diversos Ppt documentos. Este guia descreve o processo:
