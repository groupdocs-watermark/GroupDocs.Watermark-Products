...
steps:
    enable: true
    title: "Edite marcas d'água em Excel documentos usando .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** capacita .NET desenvolvedores a editar marcas d'água sem esforço em vários Excel documentos. Aqui está um guia simplificado de como usar nossa API em seu aplicativo:
    ...
    code:
      ...
      content: |
        ...
        // Faça com que o Watermarker forneça o arquivo EXCEL
