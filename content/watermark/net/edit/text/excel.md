...
############################# Head ############################
head_title: "Edit Text Watermark in EXCEL in C#, ASP.NET, VB.NET"
head_description: ".NET library to edit a found text watermark in a EXCEL file in C#, ASP.NET, VB.NET & .NET Core applications using GroupDocs.Watermark APIs for .NET."

############################# Header ############################
title: "Edit Text Watermark in EXCEL in C# .NET"
description: "Find & modify a found text watermark in a EXCEL document with formatting within C#, ASP.NET, VB.NET & .NET Core applications. Manage the watermark size, font type, rotation angle and position of the watermark on the document pages, as you may need."
...
steps:
    enable: true
    title_left: "Edit Text Watermark in EXCEL File in .NET"
    content_left: |
    ...
    code: |
        ```cs
        // Find & replace text watermark with formatting in a EXCEL in C#, ASP.NET, VB.NET & .NET Core applications
        // Instantiate Watermarker with input EXCEL document
