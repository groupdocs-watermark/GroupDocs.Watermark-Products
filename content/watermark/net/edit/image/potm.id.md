...
head_title: "Edit Tanda Air Gambar dalam POTM di C#, ASP.NET, VB.NET"
head_description: ".Pustaka .NET untuk mengedit tanda air gambar yang ditemukan dalam file POTM di aplikasi C#, ASP.NET, VB.NET & .NET Core menggunakan API GroupDocs.Watermark untuk .NET."

title: "Edit Tanda Air Gambar dalam POTM di C# .NET"
description: "Temukan & ubah tanda air gambar yang ditemukan dalam dokumen POTM dalam aplikasi C#, ASP.NET, VB.NET & .NET Core. Tambahkan tanda air gambar BMP, PNG, GIF & JPEG ke dokumen. Juga kelola ukuran tanda air, jenis font, sudut rotasi, dan posisi tanda air pada halaman dokumen, sesuai kebutuhan Anda."
...
steps:
    enable: true
    title_left: "Edit Tanda Air Gambar dalam File POTM di .NET"
    content_left: |
    ...
    code: |
        ```cs
        // Temukan & ganti tanda air gambar dalam POTM di aplikasi C#, ASP.NET, VB.NET & .NET Core
        // Instansiasi Watermarker dengan memasukkan dokumen POTM
