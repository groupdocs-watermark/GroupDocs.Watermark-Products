...
############################# Head ############################
head_title: "Edit Image Watermark in VSX in C#, ASP.NET, VB.NET"
head_description: ".NET library to edit a found image watermark in a VSX file in C#, ASP.NET, VB.NET & .NET Core applications using GroupDocs.Watermark APIs for .NET."

############################# Header ############################
title: "Edit Image Watermark in VSX in C# .NET"
description: "Find & modify a found image watermark in a VSX document within C#, ASP.NET, VB.NET & .NET Core applications. Add BMP, PNG, GIF & JPEG image watermarks to the documents. Also manage the watermark size, font type, rotation angle and position of the watermark on the document pages, as you may need."
...
steps:
    enable: true
    title_left: "Edit Image Watermark in VSX File in .NET"
    content_left: |
    ...
    code: |
        ```cs
        // Find & replace image watermark in a VSX in C#, ASP.NET, VB.NET & .NET Core applications
        // Instantiate Watermarker with input VSX document
