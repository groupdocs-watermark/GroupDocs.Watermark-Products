...
steps:
    enable: true
    title: "Programmgesteuertes Bearbeiten von Wasserzeichen in Pptx Dokumenten mit der .NET API"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** bietet .NET Entwicklern eine robuste API zur programmgesteuerten Manipulation von Wasserzeichen in diversen Pptx Dokumenten. Dieses Handbuch beschreibt den Prozess:
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Bildwasserzeichen in PPTX doc bearbeiten
