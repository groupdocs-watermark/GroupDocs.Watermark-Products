...
steps:
    enable: true
    title: "Edite programaticamente marcas d'água em documentos Xls com a API .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** fornece aos desenvolvedores do .NET uma API robusta para manipular marcas d'água programaticamente em diversos documentos do Xls. Este guia descreve o processo:
