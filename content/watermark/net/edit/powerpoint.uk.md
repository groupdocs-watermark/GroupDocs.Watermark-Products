...
steps:
    enable: true
    title: "Редагування водяних знаків у документах Powerpoint за допомогою .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** дає можливість розробникам .NET без особливих зусиль редагувати водяні знаки в різних Powerpoint документах. Ось спрощений посібник, як використовувати наш API у вашій програмі:
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Редагувати POWERPOINT текстовий водяний знак

        // Зробіть Watermarker, що надає файл POWERPOINT
