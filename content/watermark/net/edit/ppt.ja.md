...
############################# Head ############################
head_title: "Ppt のウォーターマークを簡単に編集"
head_description: "GroupDocs.Watermark for .NET ライブラリで Ppt ウォーターマークを簡単に更新できます。文書の整合性とセキュリティをシームレスに維持できます。"

############################# Header ############################
title: "Ppt ウォーターマークを簡単に編集:.NET コントロール" 
description: "GroupDocs.Watermark for .NET Libraryを使用すると、文書の整合性とセキュリティを簡単に維持できます。ウォーターマークを正確かつコントロールしながら編集できます。"
...
about:
    ...
    content: |
       **Ppt ウォーターマークを簡単に編集:** GroupDocs.Watermark for .NET .NET ライブラリを使用すると、文書の整合性とセキュリティを簡単に維持できます。さまざまなファイルタイプのウォーターマークを正確かつ制御しながら編集できます。

############################# Steps ############################
steps:
    enable: true
    title: ".NET API を使用して、Ppt ドキュメントのウォーターマークをプログラムで編集する"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** は、.NET の開発者に、さまざまな Ppt ドキュメント内のウォーターマークをプログラムで操作するための堅牢な API を提供します。このガイドでは、プロセスの概要を説明します。
...
more_formats:
    enable: true
    title: "ウォーターマークを他のフォーマットでも簡単に更新"
    exclude: "PPT"
    description: "GroupDocs.Watermark for .NET Libraryを使用すると、文書の整合性とセキュリティを簡単に維持できます。"
    items: 
        # format loop 1
        - name: "ウォーターマーク PDF"
          format: "PDF"
