...
steps:
    enable: true
    title: ".NET 을 사용하여 Word 문서의 워터마크 편집"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)**는 .NET 개발자가 다양한 Word 문서 내에서 워터마크를 손쉽게 편집할 수 있도록 합니다.다음은 애플리케이션에서 API를 사용하는 방법에 대한 간단한 가이드입니다.
