...
############################# Head ############################
head_title: "Modifier les filigranes Pdf avec GroupDocs.Watermark"
head_description: "Modifiez Pdf filigranes dans Pdf fichiers à l'aide de GroupDocs.Watermark for .NET Framework. Adaptez-vous facilement à vos besoins en matière de documents."

############################# Header ############################
title: "Modifier les filigranes dans Pdf : .NET Adaptabilité" 
description: "Adaptez-vous parfaitement à vos besoins en matière de documents grâce à GroupDocs.Watermark for .NET Framework. Modifiez facilement les filigranes dans plusieurs formats."
...
about:
    ...
    content: |
       **Modifiez le filigrane en PDF s :** Protégez votre contenu dans de nombreux formats avec GroupDocs.Watermark for .NET Framework. Adaptez-vous parfaitement à vos besoins en matière de documents grâce à nos outils polyvalents.

############################# Steps ############################
steps:
    enable: true
    title: "Modifiez par programme les filigranes dans les documents Pdf avec l'API .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** fournit aux développeurs .NET une API robuste pour manipuler par programmation les filigranes dans divers documents Pdf. Ce guide décrit le processus :
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Modifier le filigrane de l'image dans le document PDF
...
more_formats:
    enable: true
    title: "Régler les filigranes dans plusieurs formats"
    exclude: "PDF"
    description: "Protégez votre contenu dans différents formats de documents avec GroupDocs.Watermark for .NET Framework."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
