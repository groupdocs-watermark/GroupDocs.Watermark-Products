...
steps:
    enable: true
    title: "Programmgesteuertes Bearbeiten von Wasserzeichen in Docx Dokumenten mit der .NET API"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** bietet .NET Entwicklern eine robuste API zur programmgesteuerten Manipulation von Wasserzeichen in diversen Docx Dokumenten. Dieses Handbuch beschreibt den Prozess:
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Bildwasserzeichen in DOCX doc bearbeiten
