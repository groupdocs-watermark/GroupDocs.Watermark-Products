...
############################# Head ############################
head_title: "Docx 개 파일의 워터마크 편집"
head_description: "GroupDocs.Watermark for .NET 개의 애플리케이션을 사용하여 Docx 개 파일의 워터마크를 편집합니다.문서 인증을 손쉽게 강화할 수 있습니다."

############################# Header ############################
title: "파일 전체에서 Docx 개의 워터마크 편집: .NET 다용성" 
description: "GroupDocs.Watermark for .NET 애플리케이션을 사용하여 안심하고 문서를 사용자 정의하십시오.다양한 파일 형식의 워터마크를 손쉽게 편집할 수 있습니다."
...
about:
    ...
    content: |
       **Docx 개 파일의 워터마크 편집:** GroupDocs.Watermark for .NET 개의 애플리케이션을 사용하여 다양한 파일 형식의 워터마크를 원활하게 편집할 수 있습니다.문서를 자신 있고 효율적으로 사용자 지정할 수 있습니다.

############################# Steps ############################
steps:
    enable: true
    title: ".NET API를 사용하여 Docx 문서의 워터마크를 프로그래밍 방식으로 편집"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** 는 .NET 개발자에게 다양한 Docx 문서 내에서 워터마크를 프로그래밍 방식으로 조작하기 위한 강력한 API를 제공합니다. 이 가이드에서는 프로세스를 간략하게 설명합니다.
...
more_formats:
    enable: true
    title: "파일 전반의 워터마크 편집"
    exclude: "DOCX"
    description: "GroupDocs.Watermark for .NET 기반 애플리케이션을 사용하여 여러 파일 형식에서 워터마크를 원활하게 편집할 수 있습니다."
    items: 
        # format loop 1
        - name: "워터마크 PDF"
          format: "PDF"
