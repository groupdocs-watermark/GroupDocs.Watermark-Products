...
############################# Head ############################
head_title: "Edite marcas d'água no formato Doc com facilidade"
head_description: "Edite Doc marcas d'água sem problemas com a API GroupDocs.Watermark for .NET. Personalize seus documentos com confiança e eficiência."

############################# Header ############################
title: "Edite Doc marcas d'água com .NET facilmente" 
description: "Simplifique o gerenciamento de marcas d'água e proteja seus documentos com a API GroupDocs.Watermark for .NET. Obtenha versatilidade e eficiência em seu fluxo de trabalho."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Baixe o pacote de Nuget"
      link: "https://releases.groupdocs.com/watermark/net/"
      
############################# About ############################
about:
    enable: true
    title: "Estrutura GroupDocs.Watermark for .NET"
    link: "/watermark/net/"
    link_title: "Saiba mais"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       **Edite marcas d'água com facilidade:** Simplifique o gerenciamento de marcas d'água em Doc documentos com nossa solução amigável para .NET. Concentre-se em seu conteúdo e, ao mesmo tempo, garanta a segurança e a integridade dos documentos sem esforço.
...
more_formats:
    enable: true
    title: "Gerencie marcas d'água com facilidade em outros formatos"
    exclude: "DOC"
    description: "Simplifique a edição de marcas d'água em diversos formatos de documentos usando GroupDocs.Watermark for .NET."
    items: 
        # format loop 1
