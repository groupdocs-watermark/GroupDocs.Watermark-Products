...
steps:
    enable: true
    title: "Chỉnh sửa hình mờ trong tài liệu Pptx theo chương trình bằng API .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** cung cấp cho các nhà phát triển .NET một API mạnh mẽ để xử lý các hình mờ theo chương trình trong các tài liệu Pptx đa dạng. Hướng dẫn này phác thảo quá trình:
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Chỉnh sửa hình mờ trong tài liệu PPTX
