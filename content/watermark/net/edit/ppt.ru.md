...
############################# Head ############################
head_title: "Легко редактируйте Ppt водяные знаки"
head_description: "С легкостью обновляйте водяные знаки Ppt с помощью библиотеки GroupDocs.Watermark for .NET. Обеспечьте целостность и безопасность документов без проблем."

############################# Header ############################
title: "Легко редактируйте водяные знаки Ppt: управление .NET" 
description: "Библиотека GroupDocs.Watermark for .NET позволяет без труда обеспечивать целостность и безопасность документов. Редактируйте водяные знаки точно и контролируемо."
...
about:
    ...
    content: |
       **Без труда редактируйте водяные знаки Ppt:** Библиотека GroupDocs.Watermark for .NET .NET позволяет легко сохранять целостность и безопасность документов. Точно и контролируемо редактируйте водяные знаки в разных типах файлов.

############################# Steps ############################
steps:
    enable: true
    title: "Программное редактирование водяных знаков в документах Ppt с помощью API .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** предоставляет разработчикам .NET надежный API для программного управления водяными знаками в различных документах Ppt. В этом руководстве описан процесс:
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Изменить водяной знак изображения в документе PPT
...
more_formats:
    enable: true
    title: "Легко обновляйте водяные знаки в других форматах"
    exclude: "PPT"
    description: "Библиотека GroupDocs.Watermark for .NET позволяет без труда обеспечивать целостность и безопасность документов."
    items: 
        # format loop 1
