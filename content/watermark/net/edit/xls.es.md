...
steps:
    enable: true
    title: "Edite marcas de agua mediante programación en documentos Xls con la API .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** proporciona a los desarrolladores de .NET una API sólida para manipular mediante programación marcas de agua dentro de diversos documentos Xls. Esta guía describe el proceso:
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Editar marca de agua de imagen en el documento XLS
