...
steps:
    enable: true
    title: "Modifiez les filigranes dans Excel documents à l'aide de .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** permet à .NET développeurs de modifier sans effort les filigranes de divers documents Excel. Voici un guide simplifié expliquant comment utiliser notre API dans votre application :
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Modifier le filigrane du texte EXCEL

        // Make Watermarker fournissant le fichier EXCEL
