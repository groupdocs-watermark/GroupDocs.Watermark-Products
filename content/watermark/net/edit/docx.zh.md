...
############################# Head ############################
head_title: "在 Docx 个文件中编辑水印"
head_description: "使用 GroupDocs.Watermark for .NET 个应用程序编辑 Docx 个文件上的水印。毫不费力地增强文档的真实性。"

############################# Header ############################
title: "编辑文件中的 Docx 个水印：.NET 多功能性" 
description: "使用 GroupDocs.Watermark for .NET 个应用程序放心地自定义您的文档。轻松编辑各种文件格式的水印。"
...
about:
    ...
    content: |
       **编辑 Docx 个文件上的水印：** 使用 GroupDocs.Watermark for .NET 个应用程序无缝编辑各种文件格式的水印。自信而高效地自定义您的文档。

############################# Steps ############################
steps:
    enable: true
    title: "使用 .NET API 以编程方式编辑 Docx 个文档中的水印"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** 为 .NET 开发人员提供了一个强大的 API，用于以编程方式操作各种 Docx 文档中的水印。本指南概述了流程：
...
more_formats:
    ...
    title: "编辑文件间的水印"
    exclude: "DOCX"
    description: "使用由 GroupDocs.Watermark for .NET 提供支持的应用程序，跨多种文件格式无缝编辑水印。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
