...
steps:
    enable: true
    title: "Программно редактируйте водяные знаки в Rtf документах с помощью API .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** предоставляет .NET разработчикам надежный API для программного управления водяными знаками в различных Rtf документах. В этом руководстве описан процесс:
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Отредактируйте водяной знак изображения в RTF doc
