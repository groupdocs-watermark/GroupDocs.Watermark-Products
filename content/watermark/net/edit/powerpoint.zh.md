...
steps:
    enable: true
    title: "使用 .NET 编辑 Powerpoint 个文档中的水印"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** 使 .NET 开发人员能够毫不费力地编辑各种 Powerpoint 文档中的水印。以下是如何在您的应用程序中使用我们的 API 的简化指南：
    ...
    code:
      ...
      content: |
        ...
        // 让 Watermarker 提供 POWERPOINT 个文件
