...
steps:
    ...
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** надає розробникам .NET надійний API для програмного керування водяними знаками в різноманітних документах Docx. Цей посібник описує процес:
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Редагувати водяний знак зображення в документі DOCX
