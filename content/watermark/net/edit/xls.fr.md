...
############################# Head ############################
head_title: "Modification simplifiée du filigrane Xls"
head_description: "Simplifiez l'édition des filigranes Xls dans vos projets .NET avec GroupDocs.Watermark. Concentrez-vous sur votre contenu."

############################# Header ############################
title: "Édition simplifiée des filigranes Xls : optimisation .NET" 
description: "Modifiez et optimisez vos filigranes dans .NET projets avec GroupDocs.Watermark. Simplifiez votre flux de travail et concentrez-vous sur votre contenu sans effort."
...
about:
    ...
    content: |
       **Modifier Xls filigranes :** Optimisez le contrôle de vos filigranes dans .NET projets avec GroupDocs.Watermark. Simplifiez votre flux de travail et concentrez-vous sur votre contenu tout en garantissant la sécurité des documents sans effort.

############################# Steps ############################
steps:
    enable: true
    title: "Modifiez par programme les filigranes dans les documents Xls avec l'API .NET"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** fournit aux développeurs .NET une API robuste pour manipuler par programmation les filigranes dans divers documents Xls. Ce guide décrit le processus :
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Modifier le filigrane de l'image dans le document XLS
...
more_formats:
    enable: true
    title: "Contrôle simplifié des filigranes dans d'autres formats"
    exclude: "XLS"
    description: "Optimisez le contrôle de vos filigranes dans .NET projets avec GroupDocs.Watermark."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
