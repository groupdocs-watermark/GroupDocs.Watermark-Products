...
steps:
    enable: true
    title: ".NET を使用して Powerpoint ドキュメントのウォーターマークを編集"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** を使用すると、.NET 開発者はさまざまな Powerpoint ドキュメント内のウォーターマークを簡単に編集できます。アプリケーションで API を使用する方法を簡略化したガイドは次のとおりです。
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // POWERPOINT テキストウォーターマークを編集

        // POWERPOINT ファイルを提供するウォーターマーカーを作成
