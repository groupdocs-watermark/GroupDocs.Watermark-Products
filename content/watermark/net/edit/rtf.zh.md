...
steps:
    enable: true
    title: "使用 .NET API 以编程方式编辑 Rtf 个文档中的水印"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** 为 .NET 开发人员提供了一个强大的 API，用于以编程方式操作各种 Rtf 文档中的水印。本指南概述了流程：
