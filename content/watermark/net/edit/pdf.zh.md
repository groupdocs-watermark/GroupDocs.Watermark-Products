...
############################# Head ############################
head_title: "使用 GroupDocs.Watermark 编辑 Pdf 个水印"
head_description: "使用 GroupDocs.Watermark for .NET 框架编辑 Pdf 个文件中的 Pdf 个水印。轻松适应您的文档需求。"

############################# Header ############################
title: "编辑 Pdf 中的水印：.NET 适应性" 
description: "使用 GroupDocs.Watermark for .NET 框架无缝适应您的文档需求。轻松编辑多种格式的水印。"
...
about:
    ...
    content: |
       **在 PDF s 中编辑水印：** 使用 GroupDocs.Watermark for .NET 框架保护多种格式的内容。使用我们的多功能工具无缝适应您的文档需求。
...
more_formats:
    ...
    title: "调整多种格式的水印"
    exclude: "PDF"
    description: "使用 GroupDocs.Watermark for .NET 框架保护您的各种文档格式的内容。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
