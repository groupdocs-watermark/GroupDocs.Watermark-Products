...
steps:
    enable: true
    title: "Programmatically Edit Watermarks in Rtf Documents with the .NET API"
    content: |
      **[GroupDocs.Watermark for .NET](https://products.groupdocs.com/watermark/net/)** furnishes .NET developers with a robust API for programmatically manipulating watermarks within diverse Rtf documents. This guide outlines the process:
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Edit image watermark in RTF doc
