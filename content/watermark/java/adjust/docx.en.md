...
############################# Header ############################
title: "Adjust DOCX Watermarks: Seamless Customization" 
description: "Seamlessly customize your documents with our efficient watermark editing tool. Enhance your brand image effortlessly."
...
about:
    ...
    content: |
       **Edit Watermarks**: Seamlessly customize your documents with our powerful editing tools. Whether it's adjusting placement or altering content, achieve your desired watermarking effects effortlessly.
...
steps:
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Adjust DOCX image watermark

        // Instantiate Watermarker with DOCX
...
more_features:
  enable: true
  title: "Advanced DOCX Watermark Management for Java Applications"
  ...
  features:
    ...
    # feature loop
    - title: "Leveraging DOCX Native Document Features"
...
more_formats:
    enable: true
    title: "Modify Watermarks in many formats using GroupDocs.Watermark for Java"
    exclude: "DOCX"
    description: "Seamlessly edit watermarks in multiple document formats. Customize your documents effortlessly while ensuring protection and authenticity."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
