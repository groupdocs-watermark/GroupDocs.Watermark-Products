...
############################# Head ############################
head_title: "Adjust DOC Watermarks Professionally - GroupDocs.Watermark"
head_description: "Manage and customize watermarks professionally with GroupDocs.Watermark. Secure your documents with confidence."

############################# Header ############################
title: "Adjust DOC Watermarks: Professional Assurance" 
description: "Ensure professional standards with our watermark management solution. Safeguard your documents with reliability."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Download package from Maven"
...
about:
    ...
    content: |
       **Manage Watermarks**: Our professional watermark management solution provides assurance in safeguarding your documents. Simplify your workflow with efficient tools for adding, editing, and removing watermarks.

############################# Steps ############################
steps:
    enable: true
    title: "Adjust Doc document watermarks using Java"
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)** allows Java developers to easily adjust watermarks in many documents using their applications. Here's a quick guide:
      ...
      1. Firstly, you need to pass Doc file as parameter of the **Watermarker** class constructor. Provide byte or file stream or a local disk path.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Adjust DOC image watermark

        // Instantiate Watermarker with DOC
...
more_features:
  enable: true
  title: "Advanced DOC Watermark Management for Java Applications"
  ...
  features:
    ...
    # feature loop
    - title: "Leveraging DOC Native Document Features"
...
more_formats:
    enable: true
    title: "Edit Watermarks in other formats via GroupDocs.Watermark for Java"
    exclude: "DOC"
    description: "Simplify watermark management across diverse document formats. Our solution offers efficient tools for adding, editing, and removing watermarks with ease."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
