...
steps:
    enable: true
    title: "Отрегулируйте водяные знаки документа Pptx, используя Java"
    content: |
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Отрегулируйте водяной знак изображения PPTX

        // Создайте экземпляр водяного маркера с помощью PPTX
