...
head_description: "ขัดเอกสารของคุณด้วยความแม่นยำโดยใช้ GroupDocs.Watermark ปรับและอัปเดตลายน้ำได้อย่างง่ายดาย"
...
steps:
    ...
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)** ช่วยให้นักพัฒนา Java ปรับลายน้ำในเอกสารจำนวนมากได้อย่างง่ายดายโดยใช้แอปพลิเคชันของตน คำแนะนำโดยย่อ:
      ...
      1. ประการแรก คุณต้องส่งไฟล์ Rtf เป็นพารามิเตอร์ของตัวสร้างคลาส **Watermarker** ระบุไบต์หรือสตรีมไฟล์หรือเส้นทางของดิสก์ในเครื่อง
    ...
    code:
      ...
      content: |
        ...
        // สร้างอินสแตนซ์ Watermarker ด้วย RTF
