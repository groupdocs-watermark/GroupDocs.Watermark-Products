...
############################# Head ############################
head_title: "DOCX ドキュメントのウォーターマークを調整-GroupDocs.Watermark"
head_description: "GroupDocs.Watermark を使用して、さまざまなドキュメント形式のウォーターマークを効率的に編集できます。文書の信頼性を高めます。"

############################# Header ############################
title: "DOCX ウォーターマークの調整:シームレスなカスタマイズ" 
description: "効率的なウォーターマーク編集ツールでドキュメントをシームレスにカスタマイズできます。ブランドイメージを簡単に強化できます。"
...
about:
    ...
    content: |
       **ウォーターマークの編集**: パワフルな編集ツールでドキュメントをシームレスにカスタマイズできます。配置の調整でもコンテンツの変更でも、お望みの透かし効果を簡単に実現できます。
...
more_features:
  enable: true
  title: "Java アプリケーション用の高度な DOCX ウォーターマーク管理"
...
more_formats:
    enable: true
    title: "GroupDocs.Watermark for Java を使用してさまざまな形式のウォーターマークを変更"
    exclude: "DOCX"
    description: "複数のドキュメント形式のウォーターマークをシームレスに編集できます。保護と信頼性を確保しながら、文書を簡単にカスタマイズできます。"
    items: 
        # format loop 1
        - name: "ウォーターマーク PDF"
          format: "PDF"
