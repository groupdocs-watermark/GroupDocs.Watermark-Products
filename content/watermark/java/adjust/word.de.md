...
steps:
    enable: true
    title: "Passen Sie Wasserzeichen in Word Dokumenten mit Java an"
    content: |
    ...
    code:
      ...
      content: |
        ...
        // WORD Textwasserzeichen anpassen

        // Instanziieren Sie das Wasserzeichen mit dem Eingabedokument WORD
