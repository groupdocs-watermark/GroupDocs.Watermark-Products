...
steps:
    enable: true
    title: "Налаштування водяних знаків у документах Excel за допомогою Java"
    content: |
    ...
    code:
      ...
      content: |
        ...
        // Налаштування EXCEL текстового водяного знака

        // Створіть водяний маркер із введеним документом EXCEL
