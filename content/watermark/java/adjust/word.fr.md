...
############################# Head ############################
head_title: "Réglez Word filigranes sans effort - GroupDocs.Watermark"
head_description: "Ajustez facilement les filigranes dans différents formats de documents à l'aide de GroupDocs.Watermark. Renforcez la sécurité de vos documents."

############################# Header ############################
title: "Réglez Word filigranes : sécurisez sans effort" 
description: "Sécurisez vos documents sans effort grâce à nos puissantes fonctionnalités de modification des filigranes. Protégez votre contenu en toute confiance."
...
about:
    ...
    content: |
       **Modifier les filigranes** : GroupDocs.Watermark permet aux utilisateurs de modifier facilement les filigranes dans différents formats de documents. Grâce à un contrôle précis et à des options polyvalentes, personnalisez vos documents en toute confiance.

############################# Steps ############################
steps:
    enable: true
    title: "Ajustez les filigranes dans les documents Word avec Java"
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)** permet aux développeurs Java d'ajuster facilement les filigranes de texte dans leurs applications en mettant en œuvre quelques étapes simples :
      ...
      1. Chargez votre fichier Word dans l'objet principal de notre API appelé **Watermarker**. Vous pouvez fournir le fichier pour un traitement ultérieur sous forme de flux ou de chemin sur un disque local.
    ...
    code:
      ...
      content: |
        ...
        // Ajuster le filigrane de texte WORD

        // Instancier Watermarker avec le document d'entrée WORD
...
more_features:
  enable: true
  title: "Approfondissement du réglage du filigrane WORD"
  ...
  features:
    ...
    # feature loop
    - title: "Utiliser les fonctionnalités natives du document WORD"
...
more_formats:
    enable: true
    title: "Ajustez les filigranes à l'aide de GroupDocs.Watermark for Java pour les formats courants"
    exclude: "WORD"
    description: "GroupDocs.Watermark permet une modification fluide des filigranes dans différents formats. Personnalisez votre stratégie de filigrane pour répondre à vos besoins spécifiques."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
