...
############################# Head ############################
head_title: "调整 RTF-GroupDocs.Watermark 中的水印"
head_description: "使用 GroupDocs.Watermark 精确地润色您的文档。轻松调整和更新水印。"

############################# Header ############################
title: "完善您的 RTF 个文档：水印编辑" 
description: "使用我们全面的水印编辑功能完善您的文档。精确地完善您的内容。"
...
more_features:
  enable: true
  title: "适用于 Java 应用程序的高级 RTF 水印管理"
...
more_formats:
    enable: true
    title: "使用 GroupDocs.Watermark for Java 的其他格式的波兰文稿水印"
    exclude: "RTF"
    description: "使用我们全面的水印编辑功能精确地完善您的文档。毫不费力地增强文档真实性。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
