...
steps:
    ...
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)** permite que os desenvolvedores do Java ajustem facilmente marcas d'água em muitos documentos usando seus aplicativos. Aqui está um guia rápido:
      ...
      1. Primeiramente, você precisa passar o arquivo Xls como parâmetro do construtor da classe **Watermarker**. Forneça fluxo de bytes ou arquivos ou um caminho de disco local.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Ajustar marca d'água da imagem XLS

        // Instancie Watermarker com XLS
