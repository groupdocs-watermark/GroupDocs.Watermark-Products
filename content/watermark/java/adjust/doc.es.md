...
############################# Head ############################
head_title: "Ajuste DOC marcas de agua de forma profesional - GroupDocs.Watermark"
head_description: "Gestione y personalice las marcas de agua de forma profesional con GroupDocs.Watermark. Proteja sus documentos con confianza."

############################# Header ############################
title: "Ajustar DOC marcas de agua: garantía profesional" 
description: "Garantice los estándares profesionales con nuestra solución de gestión de marcas de agua. Proteja sus documentos de forma fiable."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Descargar el paquete desde Maven"
...
steps:
    enable: true
    title: "Ajuste las marcas de agua de los documentos Doc con Java"
    content: |
    ...
    code:
      ...
      content: |
        ...
        // Crea una instancia de Watermarker con DOC
...
more_features:
  enable: true
  title: "Administración avanzada de marcas de agua DOC para aplicaciones Java"
  ...
  features:
    ...
    # feature loop
    - title: "Aprovechar las funciones de los documentos nativos de DOC"
...
more_formats:
    enable: true
    title: "Edita marcas de agua en otros formatos mediante GroupDocs.Watermark for Java"
    exclude: "DOC"
    description: "Simplifique la administración de marcas de agua en diversos formatos de documentos. Nuestra solución ofrece herramientas eficaces para añadir, editar y eliminar marcas de agua con facilidad."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
