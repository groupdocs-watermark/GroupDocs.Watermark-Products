...
############################# Head ############################
head_title: "DOC Wasserzeichen professionell anpassen - GroupDocs.Watermark"
head_description: "Verwalte und passe Wasserzeichen professionell an mit GroupDocs.Watermark. Schützen Sie Ihre Dokumente mit Zuversicht."

############################# Header ############################
title: "Passen Sie DOC Wasserzeichen an: Professional Assurance" 
description: "Stellen Sie mit unserer Wasserzeichen-Management-Lösung professionelle Standards sicher. Schützen Sie Ihre Dokumente zuverlässig."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Paket von Maven herunterladen"
...
about:
    ...
    content: |
       **Wasserzeichen verwalten**: Unsere professionelle Wasserzeichen-Management-Lösung bietet Sicherheit beim Schutz Ihrer Dokumente. Vereinfachen Sie Ihren Arbeitsablauf mit effizienten Tools zum Hinzufügen, Bearbeiten und Entfernen von Wasserzeichen.

############################# Steps ############################
steps:
    enable: true
    title: "Passen Sie die Wasserzeichen des Dokuments Doc mit Java an"
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)** ermöglicht Java-Entwicklern die einfache Anpassung von Wasserzeichen in vielen Dokumenten mithilfe ihrer Anwendungen. Hier ist eine Kurzanleitung:
      ...
      1. Zunächst müssen Sie die Datei Doc als Parameter des Klassenkonstruktors **Watermarker** übergeben. Geben Sie einen Byte- oder Dateistream oder einen lokalen Festplattenpfad an.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Passen Sie das Bildwasserzeichen DOC an

        // Instanziieren Sie Watermarker mit DOC
...
more_features:
  enable: true
  title: "Erweitertes DOC Wasserzeichenmanagement für Java Anwendungen"
  ...
  features:
    ...
    # feature loop
    - title: "Nutzung der Funktionen von DOC nativen Dokumenten"
...
more_formats:
    enable: true
    title: "Bearbeiten Sie Wasserzeichen in anderen Formaten über GroupDocs.Watermark for Java"
    exclude: "DOC"
    description: "Vereinfachen Sie die Verwaltung von Wasserzeichen in verschiedenen Dokumentenformaten. Unsere Lösung bietet effiziente Tools zum einfachen Hinzufügen, Bearbeiten und Entfernen von Wasserzeichen."
    items: 
        # format loop 1
