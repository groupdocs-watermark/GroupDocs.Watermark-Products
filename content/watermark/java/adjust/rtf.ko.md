...
############################# Head ############################
head_title: "RTF - GroupDocs.Watermark 에서 워터마크를 조정하세요"
head_description: "GroupDocs.Watermark 를 사용하여 문서를 정밀하게 다듬을 수 있습니다.워터마크를 손쉽게 조정하고 업데이트할 수 있습니다."

############################# Header ############################
title: "RTF 문서 다듬기: 워터마크 편집" 
description: "포괄적인 워터마크 편집 기능으로 문서를 다듬을 수 있습니다.콘텐츠를 정밀하게 다듬으세요."
...
about:
    ...
    content: |
       **문서 다듬기**: 포괄적인 워터마크 편집 기능을 통해 문서를 정밀하게 수정할 수 있습니다.사소한 조정부터 전체 변환에 이르기까지 손쉽게 세련된 결과를 얻을 수 있습니다.

############################# Steps ############################
steps:
    enable: true
    title: "Java 을(를) 사용하여 Rtf 문서 워터마크 조정"
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)** 를 사용하면 Java 개발자가 애플리케이션을 사용하여 많은 문서에서 워터마크를 쉽게 조정할 수 있습니다. 빠른 가이드는 다음과 같습니다.
      ...
      1. 먼저, **Watermarker** 클래스 생성자의 매개변수로 Rtf 파일을 전달해야 합니다. 바이트나 파일 스트림 또는 로컬 디스크 경로를 제공합니다.
    ...
    code:
      ...
      content: |
        ...
        // RTF 을 사용하여 Watermarker 를 인스턴스화합니다.
...
more_features:
  enable: true
  title: "Java 애플리케이션을 위한 고급 RTF 워터마크 관리"
...
more_formats:
    enable: true
    title: "폴란드어 문서 GroupDocs.Watermark for Java 를 사용한 다른 형식의 워터마크"
    exclude: "RTF"
    description: "포괄적인 워터마크 편집 기능을 사용하여 문서를 정밀하게 수정하십시오.문서 신뢰성을 손쉽게 향상시키세요."
    items: 
        # format loop 1
        - name: "워터마크 PDF"
          format: "PDF"
