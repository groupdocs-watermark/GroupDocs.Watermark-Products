...
############################# Head ############################
head_title: "Điều chỉnh hình mờ trong DOCX Tài liệu - GroupDocs.Watermark"
head_description: "Chỉnh sửa hình mờ hiệu quả trên các định dạng tài liệu khác nhau bằng cách sử dụng GroupDocs.Watermark. Nâng cao tính xác thực của tài liệu."

############################# Header ############################
title: "Điều chỉnh hình mờ DOCX: Tùy chỉnh liền mạch" 
description: "Tùy chỉnh liền mạch tài liệu của bạn với công cụ chỉnh sửa hình mờ hiệu quả của chúng tôi. Nâng cao hình ảnh thương hiệu của bạn một cách dễ dàng."
...
about:
    ...
    content: |
       **Chỉnh sửa hình màu**: Tùy chỉnh liền mạch tài liệu của bạn với các công cụ chỉnh sửa mạnh mẽ của chúng tôi. Cho dù đó là điều chỉnh vị trí hoặc thay đổi nội dung, hãy đạt được hiệu ứng hình mờ mong muốn của bạn một cách dễ dàng.
...
more_features:
  enable: true
  title: "Quản lý hình mờ nâng cao DOCX cho Java Ứng dụng"
  ...
  features:
    ...
    # feature loop
    - title: "Tận dụng các tính năng tài liệu gốc DOCX"
...
more_formats:
    enable: true
    title: "Sửa đổi hình mờ ở nhiều định dạng bằng GroupDocs.Watermark for Java"
    exclude: "DOCX"
    description: "Chỉnh sửa hình mờ liền mạch ở nhiều định dạng tài liệu. Tùy chỉnh tài liệu của bạn một cách dễ dàng trong khi đảm bảo sự bảo vệ và tính xác thực."
    items: 
        # format loop 1
        - name: "Hình mờ PDF"
          format: "PDF"
