...
steps:
    enable: true
    title: "Отрегулируйте водяные знаки документа Xls, используя Java"
    content: |
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Отрегулируйте водяной знак изображения XLS

        // Создайте экземпляр водяного маркера с помощью XLS
