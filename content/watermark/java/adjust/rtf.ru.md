...
############################# Head ############################
head_title: "Настройте водяной знак в RTF - GroupDocs.Watermark"
head_description: "Точно отполируйте документы с помощью GroupDocs.Watermark. Легко настраивайте и обновляйте водяные знаки."

############################# Header ############################
title: "Отполируйте ваши RTF документы: редактирование водяных знаков" 
description: "Усовершенствуйте свои документы с помощью наших комплексных возможностей редактирования водяных знаков. Тщательно отполируйте содержимое."
...
steps:
    enable: true
    title: "Отрегулируйте водяные знаки документа Rtf, используя Java"
    content: |
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Отрегулируйте водяной знак изображения RTF

        // Создайте экземпляр водяного маркера с помощью RTF
...
more_features:
  enable: true
  title: "Расширенное управление водяными знаками RTF для приложений Java"
  ...
  features:
    ...
    # feature loop
    - title: "Использование встроенных функций документов RTF"
...
more_formats:
    enable: true
    title: "Водяные знаки польских документов в других форматах с GroupDocs.Watermark for Java"
    exclude: "RTF"
    description: "Уточняйте свои документы с высокой точностью, используя наши комплексные возможности редактирования водяных знаков. Повышайте подлинность документов без особых усилий."
    items: 
        # format loop 1
