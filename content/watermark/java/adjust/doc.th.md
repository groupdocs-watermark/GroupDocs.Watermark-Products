...
############################# Head ############################
head_title: "ปรับลายน้ำ DOC อย่างมืออาชีพ - GroupDocs.Watermark"
head_description: "จัดการและปรับแต่งลายน้ำอย่างมืออาชีพด้วย GroupDocs.Watermark รักษาความปลอดภัยเอกสารของคุณด้วยความมั่นใจ"

############################# Header ############################
title: "ปรับลายน้ำ DOC: การประกันระดับมืออาชีพ" 
description: "รับรองมาตรฐานระดับมืออาชีพด้วยโซลูชันการจัดการลายน้ำของเราปกป้องเอกสารของคุณด้วยความน่าเชื่อถือ"
...
header_actions:
  ...
  items:
    #  loop
    - title: "ดาวน์โหลดแพ็คเกจจาก Maven"
...
about:
    ...
    content: |
       **จัดการลายน้ำ**: โซลูชันการจัดการลายน้ำระดับมืออาชีพของเราให้ความมั่นใจในการปกป้องเอกสารของคุณลดความซับซ้อนของเวิร์กโฟลว์ของคุณด้วยเครื่องมือที่มีประสิทธิภาพสำหรับการเพิ่ม แก้ไข และลบลายน้ำ

############################# Steps ############################
steps:
    enable: true
    title: "ปรับลายน้ำเอกสาร Doc โดยใช้ Java"
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)** ช่วยให้นักพัฒนา Java ปรับลายน้ำในเอกสารจำนวนมากได้อย่างง่ายดายโดยใช้แอปพลิเคชันของตน คำแนะนำโดยย่อ:
      ...
      1. ประการแรก คุณต้องส่งไฟล์ Doc เป็นพารามิเตอร์ของตัวสร้างคลาส **Watermarker** ระบุไบต์หรือสตรีมไฟล์หรือเส้นทางของดิสก์ในเครื่อง
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // ปรับลายน้ำรูปภาพ DOC

        // สร้างอินสแตนซ์ Watermarker ด้วย DOC
...
more_features:
  enable: true
  title: "การจัดการลายน้ำ DOC ขั้นสูงสำหรับการใช้งาน Java"
  ...
  features:
    ...
    # feature loop
    - title: "ใช้ประโยชน์จากคุณลักษณะเอกสารดั้งเดิม DOC"
...
more_formats:
    enable: true
    title: "แก้ไขลายน้ำในรูปแบบอื่นผ่าน GroupDocs.Watermark for Java"
    exclude: "DOC"
    description: "ลดความซับซ้อนในการจัดการลายน้ำในรูปแบบเอกสารที่หลากหลายโซลูชันของเรานำเสนอเครื่องมือที่มีประสิทธิภาพสำหรับการเพิ่ม แก้ไข และลบลายน้ำได้อย่างง่ายดาย"
    items: 
        # format loop 1
        - name: "ลายน้ำ PDF"
          format: "PDF"
