...
############################# Head ############################
head_title: "Профессионально настройте водяные знаки DOC - GroupDocs.Watermark"
head_description: "Профессионально управляйте водяными знаками и настраивайте их с помощью GroupDocs.Watermark. Уверенно защищайте свои документы."

############################# Header ############################
title: "Отрегулируйте водяные знаки DOC: профессиональная гарантия" 
description: "Обеспечьте профессиональные стандарты с помощью нашего решения по управлению водяными знаками. Надежно защитите свои документы."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Загрузите пакет от Maven"
...
about:
    ...
    content: |
       **Управление водяными знаками**: наше профессиональное решение по управлению водяными знаками обеспечивает безопасность ваших документов. Упростите рабочий процесс с помощью эффективных инструментов для добавления, редактирования и удаления водяных знаков.

############################# Steps ############################
steps:
    enable: true
    title: "Настройте водяные знаки документа Doc, используя Java"
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)** позволяет разработчикам Java легко настраивать водяные знаки во многих документах с помощью своих приложений. Вот краткое руководство:
      ...
      1. Во-первых, вам необходимо передать файл Doc в качестве параметра конструктора класса **Watermarker**. Укажите поток байтов или файлов или путь к локальному диску.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Настройте водяной знак изображения DOC

        // Создайте экземпляр Watermarker с помощью DOC
...
more_features:
  enable: true
  title: "Расширенное управление водяными знаками DOC для приложений Java"
  ...
  features:
    ...
    # feature loop
    - title: "Использование встроенных функций документов DOC"
...
more_formats:
    enable: true
    title: "Редактирование водяных знаков в других форматах с помощью GroupDocs.Watermark for Java"
    exclude: "DOC"
    description: "Упростите управление водяными знаками в различных форматах документов. Наше решение предлагает эффективные инструменты для простого добавления, редактирования и удаления водяных знаков."
    items: 
        # format loop 1
