...
steps:
    enable: true
    title: "Настройте водяные знаки в документах Word с помощью Java"
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)** позволяет разработчикам Java легко настраивать текстовые водяные знаки в своих приложениях, выполнив несколько простых шагов:
      ...
      1. Загрузите файл Word в основной объект нашего API под названием **Watermarker**. Вы можете предоставить файл для дальнейшей обработки в виде потока или пути на локальном диске.
    ...
    code:
      ...
      content: |
        ...
        // Настройте текстовый водяной знак WORD

        // Создайте экземпляр Watermarker с помощью входного документа WORD
