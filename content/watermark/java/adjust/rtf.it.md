...
############################# Head ############################
head_title: "Regola la filigrana in RTF - GroupDocs.Watermark"
head_description: "Lucida i tuoi documenti con precisione usando GroupDocs.Watermark. Regola e aggiorna facilmente le filigrane."

############################# Header ############################
title: "Perfeziona i tuoi RTF documenti: modifica della filigrana" 
description: "Perfeziona i tuoi documenti con le nostre funzionalità complete di modifica delle filigrane. Perfeziona i tuoi contenuti con precisione."
...
about:
    ...
    content: |
       **Perfeziona i tuoi documenti**: le nostre funzionalità complete di modifica delle filigrane ti consentono di perfezionare i tuoi documenti con precisione. Da piccole regolazioni a trasformazioni complete, ottieni risultati impeccabili senza sforzo.

############################# Steps ############################
steps:
    enable: true
    title: "Modifica le filigrane dei documenti Rtf utilizzando Java"
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)** consente agli sviluppatori di Java di modificare facilmente le filigrane in molti documenti utilizzando le loro applicazioni. Ecco una guida rapida:
      ...
      1. Innanzitutto, devi passare il file Rtf come parametro del costruttore della classe **Watermarker**. Fornire flusso di byte o file o un percorso del disco locale.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Regola la filigrana dell'immagine RTF

        // Crea un'istanza di Watermarker con RTF
...
more_features:
  enable: true
  title: "Gestione avanzata della filigrana RTF per le applicazioni Java"
  ...
  features:
    ...
    # feature loop
    - title: "Sfruttamento delle funzionalità native dei documenti RTF"
...
more_formats:
    enable: true
    title: "Filigrane dei documenti polacchi in altri formati con GroupDocs.Watermark for Java"
    exclude: "RTF"
    description: "Perfeziona i tuoi documenti con precisione utilizzando le nostre funzionalità complete di modifica delle filigrane. Migliora l'autenticità dei documenti con facilità."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
