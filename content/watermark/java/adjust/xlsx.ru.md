...
steps:
    enable: true
    title: "Отрегулируйте водяные знаки документа Xlsx, используя Java"
    content: |
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Отрегулируйте водяной знак изображения XLSX

        // Создайте экземпляр водяного маркера с помощью XLSX
