...
############################# Head ############################
head_title: "Passen Sie Wasserzeichen in PDF - GroupDocs.Watermark an"
head_description: "Passen Sie mit GroupDocs.Watermark mühelos Wasserzeichen für verschiedene Dokumenttypen an und verfeinern Sie sie. Stellen Sie die Glaubwürdigkeit des Dokuments sicher."

############################# Header ############################
title: "PDF Wasserzeichen anpassen: Vielseitiger Schutz" 
description: "Schützen Sie Ihre Inhalte in verschiedenen Formaten mit unseren vielseitigen Funktionen zur Anpassung von Wasserzeichen. Passen Sie sich nahtlos an Ihre Bedürfnisse an."
...
about:
    ...
    content: |
       **Wasserzeichen anpassen**: Schützen Sie Ihre Inhalte in verschiedenen Dokumentformaten mit unseren vielseitigen Funktionen zur Anpassung von Wasserzeichen. Passen Sie Ihre Wasserzeichen-Strategie mühelos an Ihre spezifischen Anforderungen an.

############################# Steps ############################
steps:
    enable: true
    title: "Passen Sie die Wasserzeichen des Dokuments Pdf mit Java an"
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)** ermöglicht Java-Entwicklern die einfache Anpassung von Wasserzeichen in vielen Dokumenten mithilfe ihrer Anwendungen. Hier ist eine Kurzanleitung:
      ...
      1. Zunächst müssen Sie die Datei Pdf als Parameter des Klassenkonstruktors **Watermarker** übergeben. Geben Sie einen Byte- oder Dateistream oder einen lokalen Festplattenpfad an.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Passen Sie das Bildwasserzeichen PDF an

        // Instanziieren Sie Watermarker mit PDF
...
more_features:
  enable: true
  title: "Erweitertes PDF Wasserzeichenmanagement für Java Anwendungen"
  ...
  features:
    ...
    # feature loop
    - title: "Nutzung der Funktionen von PDF nativen Dokumenten"
...
more_formats:
    enable: true
    title: "Verwalte Wasserzeichen in gängigen Formaten mit GroupDocs.Watermark for Java"
    exclude: "PDF"
    description: "Schützen Sie Ihre Inhalte in verschiedenen Formaten mit unseren vielseitigen Funktionen zur Anpassung von Wasserzeichen. Passen Sie sich nahtlos an Ihre Bedürfnisse an."
    items: 
        # format loop 1
