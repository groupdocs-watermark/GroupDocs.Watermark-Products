...
############################# Head ############################
head_title: "Ajuster les filigranes dans PDF - GroupDocs.Watermark"
head_description: "Ajustez et affinez les filigranes sur différents types de documents sans effort avec GroupDocs.Watermark. Garantissez la crédibilité des documents."

############################# Header ############################
title: "Ajustez PDF les filigranes : protection polyvalente" 
description: "Protégez votre contenu dans différents formats grâce à nos fonctionnalités polyvalentes de réglage des filigranes. Adaptez-vous parfaitement à vos besoins."
...
about:
    ...
    content: |
       **Ajuster les filigranes** : protégez votre contenu dans différents formats de documents grâce à nos fonctionnalités polyvalentes de réglage des filigranes. Personnalisez facilement votre stratégie de filigrane pour répondre à vos besoins spécifiques.

############################# Steps ############################
steps:
    enable: true
    title: "Ajustez les filigranes de document Pdf à l'aide de Java"
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)** permet aux développeurs Java d'ajuster facilement les filigranes dans de nombreux documents à l'aide de leurs applications. Voici un guide rapide :
      ...
      1. Tout d'abord, vous devez passer le fichier Pdf comme paramètre du constructeur de classe **Watermarker**. Fournissez un flux d’octets ou de fichiers ou un chemin de disque local.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Ajuster le filigrane de l'image PDF

        // Instancier Watermarker avec PDF
...
more_features:
  enable: true
  title: "Gestion avancée des filigranes PDF pour Java applications"
  ...
  features:
    ...
    # feature loop
    - title: "Tirer parti des fonctionnalités natives des documents PDF"
...
more_formats:
    enable: true
    title: "Gérez les filigranes dans les formats courants avec GroupDocs.Watermark for Java"
    exclude: "PDF"
    description: "Protégez votre contenu dans différents formats grâce à nos fonctionnalités polyvalentes de réglage des filigranes. Adaptez-vous parfaitement à vos besoins."
    items: 
        # format loop 1
