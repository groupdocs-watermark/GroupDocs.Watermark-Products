...
head_description: "ปรับปรุงกระบวนการจัดการลายน้ำของคุณด้วย GroupDocs.Watermarkลดความซับซ้อนในการป้องกันเอกสารและการสร้างแบรนด์"
...
steps:
    ...
    code:
      ...
      content: |
        ...
        // สร้างเครื่องหมายน้ำทันทีด้วย XLSX
