...
head_title: "Edit Tanda Air Teks di XLT di Jawa"
head_description: "Pustaka Java untuk mengedit tanda air teks yang ditemukan dalam file XLT di aplikasi Java menggunakan GroupDocs.Watermark API untuk Java."

title: "Edit Tanda Air Teks di XLT di Jawa"
description: "Cari & ubah tanda air teks yang ditemukan dalam dokumen XLT dengan pemformatan dalam aplikasi Java & J2SE. Kelola ukuran tanda air, jenis font, sudut rotasi, dan posisi tanda air pada halaman dokumen, sesuai kebutuhan Anda."
...
steps:
    enable: true
    title_left: "Edit Tanda Air Teks dalam File XLT di Jawa"
    content_left: |
    ...
    code: |
        ```cs
        // Temukan & perbarui tanda air teks dengan pemformatan dalam XLT di aplikasi Java
        // Instansiasi Watermarker dengan memasukkan dokumen XLT
