...
head_title: "JavaのXLTでテキスト透かしを編集する"
head_description: "GroupDocs.Watermark API for Javaを使用して、JavaアプリケーションのXLTファイルで見つかったテキスト透かしを編集するJavaライブラリ."

title: "JavaのXLTでテキスト透かしを編集する"
description: "XLTドキュメントで見つかったテキスト透かしをJavaおよびJ2SEアプリケーション内でフォーマットして検索および変更します。必要に応じて、透かしのサイズ、フォントタイプ、回転角度、およびドキュメントページ上の透かしの位置を管理します。"
...
steps:
    enable: true
    title_left: "JavaのXLTファイルでテキスト透かしを編集する"
    content_left: |
    ...
    code: |
        ```cs
        //JavaアプリケーションのXLTでフォーマットされたテキスト透かしを検索して更新します
