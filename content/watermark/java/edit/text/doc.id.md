...
head_title: "Edit Tanda Air Teks di DOC di Jawa"
head_description: "Pustaka Java untuk mengedit tanda air teks yang ditemukan dalam file DOC di aplikasi Java menggunakan GroupDocs.Watermark API untuk Java."

title: "Edit Tanda Air Teks di DOC di Jawa"
description: "Cari & ubah tanda air teks yang ditemukan dalam dokumen DOC dengan pemformatan dalam aplikasi Java & J2SE. Kelola ukuran tanda air, jenis font, sudut rotasi, dan posisi tanda air pada halaman dokumen, sesuai kebutuhan Anda."
...
steps:
    ...
    code: |
        ```cs
        // Temukan & perbarui tanda air teks dengan pemformatan dalam DOC di aplikasi Java
        // Instansiasi Watermarker dengan memasukkan dokumen DOC
