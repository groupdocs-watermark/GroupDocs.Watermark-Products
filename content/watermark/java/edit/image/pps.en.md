...
############################# Head ############################
head_title: "Edit Image Watermark in PPS using Java"
head_description: "Java library to edit a found image watermark in a PPS file in Java & J2SE applications using GroupDocs.Watermark APIs for Java."

############################# Header ############################
title: "Edit Image Watermark in PPS with Java"
description: "Find & modify a found image watermark in a PPS document within Java & J2SE applications. Add BMP, PNG, GIF & JPEG image watermarks to the documents. Also manage the watermark size, font type, rotation angle and position of the watermark on the document pages, as you may need."
...
steps:
    enable: true
    title_left: "Edit Image Watermarks in PPS File in Java"
    content_left: |
    ...
    code: |
        ```cs
        // Find & replace image watermark in a PPS in Java applications
        // Instantiate Watermarker with input PPS document
