...
############################# Head ############################
head_title: "Edit Image Watermark in VSS using Java"
head_description: "Java library to edit a found image watermark in a VSS file in Java & J2SE applications using GroupDocs.Watermark APIs for Java."

############################# Header ############################
title: "Edit Image Watermark in VSS with Java"
description: "Find & modify a found image watermark in a VSS document within Java & J2SE applications. Add BMP, PNG, GIF & JPEG image watermarks to the documents. Also manage the watermark size, font type, rotation angle and position of the watermark on the document pages, as you may need."
...
steps:
    enable: true
    title_left: "Edit Image Watermarks in VSS File in Java"
    content_left: |
    ...
    code: |
        ```cs
        // Find & replace image watermark in a VSS in Java applications
        // Instantiate Watermarker with input VSS document
