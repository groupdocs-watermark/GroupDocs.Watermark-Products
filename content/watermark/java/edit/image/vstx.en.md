...
############################# Head ############################
head_title: "Edit Image Watermark in VSTX using Java"
head_description: "Java library to edit a found image watermark in a VSTX file in Java & J2SE applications using GroupDocs.Watermark APIs for Java."

############################# Header ############################
title: "Edit Image Watermark in VSTX with Java"
description: "Find & modify a found image watermark in a VSTX document within Java & J2SE applications. Add BMP, PNG, GIF & JPEG image watermarks to the documents. Also manage the watermark size, font type, rotation angle and position of the watermark on the document pages, as you may need."
...
steps:
    enable: true
    title_left: "Edit Image Watermarks in VSTX File in Java"
    content_left: |
    ...
    code: |
        ```cs
        // Find & replace image watermark in a VSTX in Java applications
        // Instantiate Watermarker with input VSTX document
