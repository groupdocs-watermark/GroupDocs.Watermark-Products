...
steps:
    enable: true
    title: "고급 기술: Java 을(를) 통해 Jpg 문서에 워터마크 추가"
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)** 를 사용하여 Jpg 문서에 대한 고급 워터마킹 기술 탐색
      
      1. **Watermarker** 클래스를 초기화하여 워터마킹 프로세스를 시작하세요. 이 기본 단계는 워터마크로 Jpg 문서를 향상시키기 위한 단계를 설정합니다. Jpg 파일을 생성자에 경로 또는 스트림 객체로 제공합니다.
