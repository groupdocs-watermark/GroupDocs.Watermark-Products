...
steps:
    enable: true
    title: "Kỹ thuật nâng cao: Thêm hình mờ vào tài liệu Pdf thông qua Java"
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)**
      
      1. **Watermarker**. Bước cơ bản này tạo tiền đề cho việc nâng cao Pdf tài liệu bằng hình mờ. Cung cấp tệp Pdf cho hàm tạo, dưới dạng đường dẫn hoặc đối tượng luồng.
