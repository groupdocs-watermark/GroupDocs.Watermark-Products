...
############################# Head ############################
head_title: "使用 Java 水印保护 PDF"
head_description: "使用 Java 应用强大、可自定义的水印，增强 PDF 文档安全性。"

############################# Header ############################
title: "Java 水印集成 PDF" 
description: "利用 Java 在 PDF 个文档中实现高级水印。非常适合保护官方记录、法律文件和敏感信息。"
...
about:
    ...
    content: |
       GroupDocs.Watermark for Java 专为 Java 名开发人员量身定制，他们希望通过有效的水印来增强 PDF 个文档的安全性。该API有助于嵌入可见和不可见的水印，以防止未经授权的共享并确保文档的真实性。功能包括创建自定义水印、精确定位以及基于文档内容或安全级别的条件水印。GroupDocs.Watermark 支持与 Java 8 及更高版本的无缝集成，非常适合文档完整性至关重要的政府、法律和公司环境。

############################# Steps ############################
steps:
    enable: true
    title: "高级技术：通过 Java 添加水印到 Pdf 文档"
    content: |
      使用 **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)** 探索 Pdf 文档的高级水印技术
      
      1. 通过初始化 **Watermarker** 类来启动水印过程。这一基础步骤为增强带有水印的 Pdf 文档奠定了基础。将 Pdf 文件作为路径或流对象提供给构造函数。
...
more_formats:
    enable: true
    title: "使用 Java 为 PDF 个文档加水印"
    exclude: "PDF"
    description: "利用 Java 有效地向 PDF 添加水印。使用量身定制的水印解决方案确保您的官方文件的机密性和完整性。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
