...
steps:
    enable: true
    title: "Techniques avancées : ajout de filigranes aux documents Pdf via Java"
    content: |
      Explorer les techniques avancées de filigrane pour les documents Pdf avec **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)**
