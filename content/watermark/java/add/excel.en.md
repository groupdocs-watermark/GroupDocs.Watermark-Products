...
############################# Header ############################
title: "Add Watermark for MS Excel Spreadsheets via Java" 
...
steps:
    enable: true
    title: "Add text watermark to Excel via Java"
    content: |
      ...
      1. Instantiate **Watermarker** with Excel file
