...
steps:
    enable: true
    title: "Передовые методы: добавление водяных знаков к Jpeg документам с помощью Java"
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)**
      
      1. **Watermarker**. Этот основополагающий шаг закладывает основу для добавления водяных знаков в Jpeg документов. Предоставьте конструктору файл Jpeg в виде пути или объекта потока.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Добавить водяной знак изображения в JPEG
