...
############################# Head ############################
head_title: "Java Filigranes pour RTF documents"
head_description: "Utilisez Java pour insérer des filigranes dans les fichiers RTF, améliorant ainsi la sécurité et le professionnalisme des documents."

############################# Header ############################
title: "Protégez RTF documents avec Java filigranes" 
description: "Intégrez des filigranes de manière fluide dans RTF documents à l'aide de Java. Idéal pour sécuriser les informations sensibles dans les environnements professionnels Word."
...
steps:
    enable: true
    title: "Techniques avancées : ajout de filigranes à Rtf documents via Java"
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)**
      
      1. **Watermarker**. Cette étape fondamentale ouvre la voie à l'amélioration des documents Rtf avec des filigranes. Fournissez le fichier Rtf au constructeur, sous forme de chemin ou d'objet de flux.
...
more_formats:
    enable: true
    title: "Améliorer la sécurité MS Word RTF avec Java"
    exclude: "RTF"
    description: "Appliquez un filigrane avancé aux fichiers RTF à l'aide de Java, afin de garantir l'intégrité et la conformité des documents dans Microsoft Word et d'autres applications de traitement de texte."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
