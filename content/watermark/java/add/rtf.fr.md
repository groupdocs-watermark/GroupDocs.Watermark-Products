...
steps:
    enable: true
    title: "Techniques avancées : ajout de filigranes aux documents Rtf via Java"
    content: |
      Explorer les techniques avancées de filigrane pour les documents Rtf avec **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)**
