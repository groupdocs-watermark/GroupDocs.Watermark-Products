...
steps:
    enable: true
    title: "Teknik Lanjutan: Menambahkan Watermark ke Docx Dokumen melalui Java"
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)**
      
      1. **Watermarker**. Langkah dasar ini menetapkan panggung untuk meningkatkan Docx dokumen dengan tanda air. Berikan file Docx ke konstruktor, baik sebagai jalur atau objek aliran.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Tambahkan watermark gambar ke DOCX
