...
steps:
    enable: true
    title: "Técnicas avançadas: Adicionar marcas d'água a Doc documentos via Java"
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)**
      
      1. **Watermarker**. Essa etapa fundamental prepara o terreno para aprimorar Doc documentos com marcas d'água. Forneça o arquivo Doc ao construtor, seja como um caminho ou um objeto de fluxo.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Adicionar marca d'água de imagem a DOC
