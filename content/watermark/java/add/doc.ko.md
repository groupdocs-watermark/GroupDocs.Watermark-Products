...
steps:
    enable: true
    title: "고급 기법: Java 을 통해 Doc 문서에 워터마크 추가"
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)**가 포함된 Doc 문서에 대한 고급 워터마킹 기법 살펴보기
      
      1. **Watermarker** 클래스를 초기화하여 워터마킹 프로세스를 시작하십시오.이 기본 단계는 Doc 문서에 워터마크를 추가하기 위한 단계를 설정합니다.Doc 파일을 경로 또는 스트림 객체로 생성자에 제공하십시오.
