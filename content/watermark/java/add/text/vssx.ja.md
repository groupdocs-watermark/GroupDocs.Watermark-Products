...
head_title: "JavaのVSSXにテキスト透かしを追加"
head_description: "GroupDocs.Watermark API for Javaを使用して、JavaおよびJ2SEアプリケーションのVSSXファイルにテキスト透かしを追加するJavaライブラリ"

title: "JavaのVSSXにテキスト透かしを追加"
description: "JavaおよびJ2SEアプリケーションのVSSXファイルにテキスト透かしを追加します。必要に応じて、透かしのサイズ、フォントタイプ、回転角度、およびドキュメントページ上の透かしの位置を管理します。"
...
steps:
    enable: true
    title_left: "JavaのVSSXファイルにテキスト透かしを追加する"
    content_left: |
