...
head_title: "JavaのVSSにテキスト透かしを追加する"
head_description: "GroupDocs.Watermark APIforJavaを使用してJavaおよびJ2SEアプリケーションのVSSファイルにテキスト透かしを追加するJavaライブラリ"

title: "JavaのVSSにテキスト透かしを追加する"
description: "JavaおよびJ2SEアプリケーションのVSSファイルにテキスト透かしを追加します。必要に応じて、透かしのサイズ、フォントタイプ、回転角度、およびドキュメントページ上の透かしの位置を管理します。"
...
steps:
    enable: true
    title_left: "JavaのVSSファイルにテキスト透かしを追加"
    content_left: |
