...
head_title: "JavaでPDFにテキスト透かしを追加"
head_description: "GroupDocs.Watermark APIforJavaを使用してJavaおよびJ2SEアプリケーションのPDFファイルにテキスト透かしを追加するJavaライブラリ"

title: "JavaでPDFにテキスト透かしを追加"
description: "JavaおよびJ2SEアプリケーションのPDFファイルにテキスト透かしを追加します。必要に応じて、透かしのサイズ、フォントタイプ、回転角度、およびドキュメントページ上の透かしの位置を管理します。"
...
steps:
    enable: true
    title_left: "JavaでPDFファイルにテキスト透かしを追加"
    content_left: |
