...
############################# Head ############################
head_title: "Add Text Watermark to ODT using Java"
head_description: "Java library to add text watermark to ODT file in Java & J2SE applications using GroupDocs.Watermark API for Java"

############################# Header ############################
title: "Add Text Watermark to ODT in Java"
description: "Adding text watermark to ODT file in Java & J2SE applications. Manage the watermark size, font type, rotation angle and position of the watermark on the document pages, as you may need."
...
steps:
    enable: true
    title_left: "Add Text Watermark to ODT File via Java"
    content_left: |
    ...
    code: |
        ```cs
        // Add text watermark to ODT in Java
        // Instantiate Watermarker with input ODT document
