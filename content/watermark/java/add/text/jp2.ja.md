...
head_title: "JavaでJP2にテキスト透かしを追加"
head_description: "GroupDocs.Watermark API for Javaを使用して、JavaおよびJ2SEアプリケーションのJP2ファイルにテキスト透かしを追加するJavaライブラリ"

title: "JavaでJP2にテキスト透かしを追加"
description: "JavaおよびJ2SEアプリケーションのJP2ファイルにテキスト透かしを追加します。必要に応じて、透かしのサイズ、フォントタイプ、回転角度、およびドキュメントページ上の透かしの位置を管理します。"
...
steps:
    enable: true
    title_left: "JavaのJP2ファイルにテキスト透かしを追加する"
    content_left: |
