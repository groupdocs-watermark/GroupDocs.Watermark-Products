...
head_title: "Javaのプレゼンテーションにテキスト透かしを追加"
head_description: "GroupDocs.Watermark API for Javaを使用して、JavaおよびJ2SEアプリケーションのPRESENTATIONファイルにテキストウォーターマークを追加するJavaライブラリ"

title: "Javaのプレゼンテーションにテキスト透かしを追加"
description: "JavaおよびJ2SEアプリケーションのPRESENTATIONファイルにテキスト透かしを追加します。必要に応じて、透かしのサイズ、フォントタイプ、回転角度、およびドキュメントページ上の透かしの位置を管理します。"
...
steps:
    enable: true
    title_left: "Javaのプレゼンテーションファイルにテキスト透かしを追加"
    content_left: |
    ...
    code: |
        ```cs
        //JavaのPRESENTATIONにテキスト透かしを追加します
