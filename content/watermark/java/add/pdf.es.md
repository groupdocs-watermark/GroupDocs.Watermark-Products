...
steps:
    enable: true
    title: "Técnicas avanzadas: agregar marcas de agua a Pdf documentos mediante Java"
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)**
      
      1. **Watermarker**. Este paso fundamental sienta las bases para mejorar Pdf documentos con marcas de agua. Proporcione el archivo Pdf al constructor, ya sea como una ruta o un objeto de flujo.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Añadir marca de agua de imagen a PDF
