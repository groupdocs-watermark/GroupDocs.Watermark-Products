...
############################# Head ############################
head_title: "Genera marcas de agua para DOC con Java"
head_description: "Agregue, edite y administre de manera eficiente marcas de agua en DOC archivos con Java. Ideal para proteger documentos."

############################# Header ############################
title: "Java Marcas de agua para DOC archivos" 
description: "Descubra cómo Java desarrolladores pueden utilizar GroupDocs.Watermark para insertar, modificar y eliminar marcas de agua en DOC documentos de forma rápida y sencilla."
...
steps:
    enable: true
    title: "Técnicas avanzadas: agregar marcas de agua a Doc documentos mediante Java"
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)**
      
      1. **Watermarker**. Este paso fundamental sienta las bases para mejorar Doc documentos con marcas de agua. Proporcione el archivo Doc al constructor, ya sea como una ruta o un objeto de flujo.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Añadir marca de agua de imagen a DOC
...
more_formats:
    enable: true
    title: "Añadir marcas de agua a DOC archivos con Java"
    exclude: "DOC"
    description: "Aproveche Java para aplicar marcas de agua versátiles en DOC archivos. Ideal para aplicaciones que requieren la seguridad de los documentos y la protección de los derechos de autor."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
