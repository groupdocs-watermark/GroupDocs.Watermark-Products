...
steps:
    ...
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)**
      ...
      1. **Watermarker**. Questo passaggio fondamentale pone le basi per migliorare i documenti Pdf con filigrane. Fornisci il file Pdf al costruttore, come percorso o oggetto stream.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Aggiungi filigrana dell'immagine a PDF
