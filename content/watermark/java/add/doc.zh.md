...
############################# Head ############################
head_title: "使用 Java 为 DOC 生成水印"
head_description: "使用 Java 高效添加、编辑和管理 DOC 文件中的水印。非常适合保护文件。"

############################# Header ############################
title: "Java 为 DOC 个文件添加水印" 
description: "探索 Java 开发人员如何利用 GroupDocs.Watermark 快速轻松地在 DOC 文档中插入、修改和删除水印。"
...
about:
    ...
    content: |
       GroupDocs.Watermark for Java 为 Java 开发人员提供了一组强大的工具，用于在 DOC 文件中添加、删除、搜索和管理水印。此 API 使您可以轻松地将全面的水印功能集成到任何 Java 应用程序中，从而支持各种文档管理任务。无论您是需要保护知识产权、确保文档真实性还是防止未经授权的共享，GroupDocs.Watermark 都能为您提供必要的工具。它支持文本和图像水印，并提供广泛的自定义选项，例如调整不透明度、旋转和缩放以适应各种用例。与支持 Java 8 或更高版本的所有主要操作系统兼容。
...
more_formats:
    enable: true
    title: "使用 Java 为 DOC 个文件加水印"
    exclude: "DOC"
    description: "利用 Java 在 DOC 个文件上应用多功能水印。非常适合需要文档安全和版权保护的应用程序。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
