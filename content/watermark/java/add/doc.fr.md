...
############################# Head ############################
head_title: "Générez des filigranes pour DOC avec Java"
head_description: "Ajoutez, modifiez et gérez efficacement des filigranes dans DOC fichiers à l'aide de Java. Idéal pour sécuriser des documents."

############################# Header ############################
title: "Java Filigrane pour DOC fichiers" 
description: "Découvrez comment Java développeurs peuvent utiliser GroupDocs.Watermark pour insérer, modifier et supprimer des filigranes dans DOC documents rapidement et sans effort."
...
steps:
    enable: true
    title: "Techniques avancées : ajout de filigranes à Doc documents via Java"
    content: |
      **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)**
      
      1. **Watermarker**. Cette étape fondamentale ouvre la voie à l'amélioration des documents Doc avec des filigranes. Fournissez le fichier Doc au constructeur, sous forme de chemin ou d'objet de flux.
...
more_formats:
    enable: true
    title: "Filigrane DOC fichiers à l'aide de Java"
    exclude: "DOC"
    description: "Tirez parti de Java pour appliquer des filigranes polyvalents aux fichiers DOC. Idéal pour les applications nécessitant la sécurité des documents et la protection des droits d'auteur."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
