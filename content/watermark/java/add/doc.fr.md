...
steps:
    enable: true
    title: "Techniques avancées : ajout de filigranes aux documents Doc via Java"
    content: |
      Explorer les techniques avancées de filigrane pour les documents Doc avec **[GroupDocs.Watermark for Java](https://products.groupdocs.com/watermark/java/)**
