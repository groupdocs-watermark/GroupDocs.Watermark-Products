...
############################# Head ############################
head_title: "Java Watermarks for WEBP Images"
head_description: "Harness Java to inject watermarks into WEBP images, fortifying copyrights and media security."

############################# Header ############################
title: "Custom WEBP Watermarking with Java" 
description: "Implement Java to create and manage watermarks in WEBP images, ensuring optimal protection and branding for digital content creators."
...
more_formats:
    enable: true
    title: "Securing WEBP Files with Java"
    exclude: "WEBP"
    description: "Apply advanced, discreet watermarks to WEBP images using Java. Tailor watermark attributes to protect and enhance digital copyrights efficiently."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
