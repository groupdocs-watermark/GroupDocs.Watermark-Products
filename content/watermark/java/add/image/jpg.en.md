...
############################# Head ############################
head_title: "Java GroupDocs.Watermark - Watermark Files JPG with images"
head_description: "Java library to add image watermark to JPG file in Java, J2SE 7.0 (1.7) or above applications using GroupDocs.Watermark for Java."

############################# Header ############################
title: "Add Image Watermark to JPG in Java" 
description: "Adding image watermark to JPG files for Java J2SE applications. Add BMP, PNG, GIF, and JPEG images as watermarks to your documents. You can also manage the watermark's size, alignment, rotation angle, and position on the document pages as per your requirements."
...
steps:
    enable: true
    title: "How to add image watermark in JPG documents using Java"
    content: |
      ...
      1. Instantiate **Watermarker** with input JPG document
    ...
    code:
      ...
      content: |
        ...
        try (Comparer comparer = new Comparer("source.jpg") 
        {
            ...
            final Path resultPath = comparer.compare("result.jpg"); 
