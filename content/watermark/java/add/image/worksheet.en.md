...
############################# Head ############################
head_title: "Java GroupDocs.Watermark - Watermark Files WORKSHEET with images"
head_description: "Java library to add image watermark to WORKSHEET file in Java, J2SE 7.0 (1.7) or above applications using GroupDocs.Watermark for Java."

############################# Header ############################
title: "Add Image Watermark to WORKSHEET in Java" 
description: "Adding image watermark to WORKSHEET files for Java J2SE applications. Add BMP, PNG, GIF, and JPEG images as watermarks to your documents. You can also manage the watermark's size, alignment, rotation angle, and position on the document pages as per your requirements."
...
steps:
    enable: true
    title: "How to add image watermark in WORKSHEET documents using Java"
    content: |
      ...
      1. Instantiate **Watermarker** with input WORKSHEET document
    ...
    code:
      ...
      content: |
        ...
        try (Comparer comparer = new Comparer("source.worksheet") 
        {
            // Set up watermark options
        	comparer.add("target1.worksheet");
            comparer.add("target2.worksheet");

            // Get result file protected by watermark
            final Path resultPath = comparer.compare("result.worksheet"); 
