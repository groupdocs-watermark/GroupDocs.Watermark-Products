...
head_title: "JavaのWEBPに画像透かしを追加する"
head_description: "Java用のGroupDocs.WatermarkAPIを使用して、JavaおよびJ2SEアプリケーションのWEBPファイルに画像透かしを追加するJavaライブラリ."

title: "JavaのWEBPに画像透かしを追加する"
description: "JavaおよびJ2SEアプリケーションのWEBPファイルに画像透かしを追加します。ドキュメントにBMP、PNG、GIF、JPEG画像の透かしを追加します。また、必要に応じて、透かしのサイズ、配置、回転角度、およびドキュメントページ上の透かしの位置を管理します。"
...
steps:
    enable: true
    title_left: "JavaのWEBPファイルに画像透かしを追加する"
    content_left: |
