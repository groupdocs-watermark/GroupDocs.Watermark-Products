...
head_title: "JavaのVSTに画像透かしを追加"
head_description: "GroupDocs.Watermark APIforJavaを使用してJavaおよびJ2SEアプリケーションのVSTファイルに画像の透かしを追加するJavaライブラリ."

title: "JavaのVSTに画像透かしを追加"
description: "JavaおよびJ2SEアプリケーションのVSTファイルに画像透かしを追加します。ドキュメントにBMP、PNG、GIF、JPEG画像の透かしを追加します。また、必要に応じて、透かしのサイズ、配置、回転角度、およびドキュメントページ上の透かしの位置を管理します。"
...
steps:
    enable: true
    title_left: "JavaのVSTファイルに画像透かしを追加"
    content_left: |
