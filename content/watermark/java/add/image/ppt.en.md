...
############################# Head ############################
head_title: "Java GroupDocs.Watermark - Watermark Files PPT with images"
head_description: "Java library to add image watermark to PPT file in Java, J2SE 7.0 (1.7) or above applications using GroupDocs.Watermark for Java."

############################# Header ############################
title: "Add Image Watermark to PPT in Java" 
description: "Adding image watermark to PPT files for Java J2SE applications. Add BMP, PNG, GIF, and JPEG images as watermarks to your documents. You can also manage the watermark's size, alignment, rotation angle, and position on the document pages as per your requirements."
...
steps:
    enable: true
    title: "How to add image watermark in PPT documents using Java"
    content: |
      ...
      1. Instantiate **Watermarker** with input PPT document
