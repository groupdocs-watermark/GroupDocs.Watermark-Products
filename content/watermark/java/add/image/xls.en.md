...
############################# Head ############################
head_title: "Add Image Watermark to XLS in Java"
head_description: "Java library to add image watermark to XLS file in Java & J2SE applications using GroupDocs.Watermark APIs for Java."

############################# Header ############################
title: "Add Image Watermark to XLS using Java"
description: "Adding image watermark to XLS file in Java & J2SE applications. Add BMP, PNG, GIF & JPEG image watermarks to the documents. Also manage the watermark size, alignment, rotation angle and position of the watermark on the document pages, as you may need."
...
steps:
    enable: true
    title_left: "Add Image Watermark to XLS File via Java"
    content_left: |
    ...
    code: |
        ```cs
        // Add image watermark to XLS in Java applications
        // Instantiate Watermarker with input XLS document
