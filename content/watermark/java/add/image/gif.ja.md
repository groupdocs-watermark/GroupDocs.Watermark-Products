...
head_title: "JavaのGIFに画像透かしを追加する"
head_description: "Java用のGroupDocs.WatermarkAPIを使用して、JavaおよびJ2SEアプリケーションのGIFファイルに画像透かしを追加するJavaライブラリ."

title: "JavaのGIFに画像透かしを追加する"
description: "JavaおよびJ2SEアプリケーションのGIFファイルに画像透かしを追加します。ドキュメントにBMP、PNG、GIF、JPEG画像の透かしを追加します。また、必要に応じて、透かしのサイズ、配置、回転角度、およびドキュメントページ上の透かしの位置を管理します。"
...
steps:
    enable: true
    title_left: "JavaのGIFファイルに画像透かしを追加する"
    content_left: |
        ...
        * 力GIFドキュメントを使用して* Watermarker* をインスタンス化します。
    ...
    code: |
        ```cs
        //JavaアプリケーションのGIFに画像透かしを追加します
        //入力GIFドキュメントを使用してウォーターマーカーをインスタンス化します
