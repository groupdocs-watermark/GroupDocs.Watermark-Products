...
############################# Head ############################
head_title: "Java GroupDocs.Watermark - Watermark Files JP2 with images"
head_description: "Java library to add image watermark to JP2 file in Java, J2SE 7.0 (1.7) or above applications using GroupDocs.Watermark for Java."

############################# Header ############################
title: "Add Image Watermark to JP2 in Java" 
description: "Adding image watermark to JP2 files for Java J2SE applications. Add BMP, PNG, GIF, and JPEG images as watermarks to your documents. You can also manage the watermark's size, alignment, rotation angle, and position on the document pages as per your requirements."
...
steps:
    enable: true
    title: "How to add image watermark in JP2 documents using Java"
    content: |
      ...
      1. Instantiate **Watermarker** with input JP2 document
    ...
    code:
      ...
      content: |
        ...
        try (Comparer comparer = new Comparer("source.jp2") 
        {
            // Set up watermark options
        	comparer.add("target1.jp2");
            comparer.add("target2.jp2");

            // Get result file protected by watermark
            final Path resultPath = comparer.compare("result.jp2"); 
