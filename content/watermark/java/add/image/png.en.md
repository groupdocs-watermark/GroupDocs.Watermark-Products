...
############################# Head ############################
head_title: "Java GroupDocs.Watermark - Watermark Files PNG with images"
head_description: "Java library to add image watermark to PNG file in Java, J2SE 7.0 (1.7) or above applications using GroupDocs.Watermark for Java."

############################# Header ############################
title: "Add Image Watermark to PNG in Java" 
description: "Adding image watermark to PNG files for Java J2SE applications. Add BMP, PNG, GIF, and JPEG images as watermarks to your documents. You can also manage the watermark's size, alignment, rotation angle, and position on the document pages as per your requirements."
...
steps:
    enable: true
    title: "How to add image watermark in PNG documents using Java"
    content: |
      ...
      1. Instantiate **Watermarker** with input PNG document
    ...
    code:
      ...
      content: |
        ...
        try (Comparer comparer = new Comparer("source.png") 
        {
            ...
            final Path resultPath = comparer.compare("result.png"); 
