...
############################# Head ############################
head_title: "Remove Watermark from PRESENTATION in Java"
head_description: "Java library to find and remove watermark from PRESENTATION document using smart search within Java applications using GroupDocs.Watermark APIs for Java."

############################# Header ############################
title: "Remove Watermark from PRESENTATION in Java"
description: "Use smart search to find & remove watermark from a PRESENTATION document with text formatting from within Java & J2SE applications. Define a search criterion to search & delete the watermarks based on a specific font name, color, size and other matching properties."
...
steps:
    ...
    code: |
        ```cs
        // Search & remove watermark from a PRESENTATION document in Java applications
        // Instantiate Watermarker with input PRESENTATION document
