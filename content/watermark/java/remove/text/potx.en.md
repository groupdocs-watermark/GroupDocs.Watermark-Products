...
############################# Head ############################
head_title: "Remove Watermark from POTX in Java"
head_description: "Java library to find and remove watermark from POTX document using smart search within Java applications using GroupDocs.Watermark APIs for Java."

############################# Header ############################
title: "Remove Watermark from POTX in Java"
description: "Use smart search to find & remove watermark from a POTX document with text formatting from within Java & J2SE applications. Define a search criterion to search & delete the watermarks based on a specific font name, color, size and other matching properties."
...
steps:
    enable: true
    title_left: "Delete Watermark from POTX File in Java"
    content_left: |
    ...
    code: |
        ```cs
        // Search & remove watermark from a POTX document in Java applications
        // Instantiate Watermarker with input POTX document
