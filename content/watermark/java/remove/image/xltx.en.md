...
############################# Head ############################
head_title: "Remove Image Watermark from XLTX with Java"
head_description: "Java library to find and remove image watermark from XLTX document using smart search within Java & J2SE applications using GroupDocs.Watermark APIs for Java."

############################# Header ############################
title: "Remove Image Watermark from XLTX using Java"
description: "Use smart search to find & remove image watermark from a XLTX document from within Java & J2SE applications. Define a search criterion to search & delete the specified watermarks from the document."
...
steps:
    enable: true
    title_left: "Delete Watermark from XLTX File in Java"
    content_left: |
    ...
    code: |
        ```cs
        // Search & remove image watermark from a XLTX document in Java applications
        // Instantiate Watermarker with input XLTX document
