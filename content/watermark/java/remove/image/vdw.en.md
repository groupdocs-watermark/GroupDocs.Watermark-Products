...
############################# Head ############################
head_title: "Remove Image Watermark from VDW with Java"
head_description: "Java library to find and remove image watermark from VDW document using smart search within Java & J2SE applications using GroupDocs.Watermark APIs for Java."

############################# Header ############################
title: "Remove Image Watermark from VDW using Java"
description: "Use smart search to find & remove image watermark from a VDW document from within Java & J2SE applications. Define a search criterion to search & delete the specified watermarks from the document."
...
steps:
    ...
    code: |
        ```cs
        // Search & remove image watermark from a VDW document in Java applications
        // Instantiate Watermarker with input VDW document
