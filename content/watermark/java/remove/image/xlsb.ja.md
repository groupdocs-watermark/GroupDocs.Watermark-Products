...
head_title: "JavaのXLSBから画像透かしを削除する"
head_description: "GroupDocs.Watermark APIforJavaを使用したJavaおよびJ2SEアプリケーション内のスマート検索を使用してXLSBドキュメントから画像透かしを検索および削除するJavaライブラリ."

title: "JavaのXLSBから画像透かしを削除する"
description: "スマート検索を使用して、JavaおよびJ2SEアプリケーション内のXLSBドキュメントから画像透かしを見つけて削除します。ドキュメントから指定された透かしを検索および削除するための検索基準を定義します."
...
steps:
    ...
    code: |
        ```cs
        //JavaアプリケーションでXLSBドキュメントから画像透かしを検索して削除します
