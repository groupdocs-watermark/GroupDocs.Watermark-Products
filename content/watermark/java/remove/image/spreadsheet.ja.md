...
head_title: "Javaのスプレッドシートから画像透かしを削除する"
head_description: "GroupDocs.Watermark API for Javaを使用したJavaおよびJ2SEアプリケーション内のスマート検索を使用して、SPREADSHEETドキュメントから画像の透かしを検索して削除するJavaライブラリ."

title: "Javaのスプレッドシートから画像透かしを削除する"
description: "スマート検索を使用して、JavaおよびJ2SEアプリケーション内のSPREADSHEETドキュメントから画像透かしを見つけて削除します。ドキュメントから指定された透かしを検索および削除するための検索基準を定義します."
...
steps:
    ...
    code: |
        ```cs
        //JavaアプリケーションでSPREADSHEETドキュメントから画像透かしを検索して削除します
