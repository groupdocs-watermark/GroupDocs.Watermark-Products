...
steps:
    enable: true
    title: "Limpar marcas d'água de documentos Docx usando Java"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/java/)** simplifica o processo de limpeza de marcas d'água de seus documentos comerciais nos aplicativos Java. Integre nossa biblioteca e siga estas etapas:
      ...
      1. Comece inicializando a classe **Watermarker** com seu documento Docx. A API aceita o documento como um fluxo ou como um caminho de arquivo local para processamento.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Limpar marca d’água de imagem do documento DOCX
