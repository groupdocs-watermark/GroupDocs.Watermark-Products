...
head_description: "Optimize your XLS documents by efficiently removing watermarks with our Java API, ensuring data clarity and visual appeal."
...
about:
    ...
    content: |
       The GroupDocs.Watermark for Java Java library empowers users to manipulate watermarks in XLSX documents seamlessly. This tool provides extensive capabilities to remove or alter watermarks without disrupting the document's integrity, ideal for maintaining the professionalism of business and accounting documents.
...
more_formats:
    ...
    exclude: "XLSX"
    description: "Explore the functionality of the GroupDocs.Watermark Java API for removing and managing watermarks in XLSX files, ensuring unobstructed visibility of important data."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
