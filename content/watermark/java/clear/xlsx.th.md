...
steps:
    ...
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/java/)** ช่วยลดขั้นตอนการล้างลายน้ำจากเอกสารทางธุรกิจของคุณภายใน Java แอปพลิเคชันรวมห้องสมุดของเราและทำตามขั้นตอนเหล่านี้:
      ...
      1. **Watermarker** ด้วยเอกสาร Xlsx ของคุณAPI ยอมรับเอกสารทั้งเป็นสตรีมหรือเส้นทางไฟล์ภายในสำหรับการประมวลผล
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // ล้างลายน้ำรูปภาพ XLSX เอกสาร

        // ส่งเส้นทางเอกสาร XLSX ไปยังผู้สร้างเครื่องหมายน้ำ
