...
steps:
    enable: true
    title: "Очистите Powerpoint документы от водяных знаков, используя Java"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/java/)** позволяет легко очистить деловые документы от ранее добавленных водяных знаков. Расширьте возможности своего приложения Java, установив нашу библиотеку, и сделайте это за несколько простых шагов:
      ...
      1. **Watermarker** с документом Powerpoint. Наш API поддерживает передачу документа для обработки в виде потока или локального пути.
    ...
    code:
      ...
      content: |
        ...
        // Водяной знак с открытым текстом в документе Powerpoint
