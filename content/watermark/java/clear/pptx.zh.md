...
############################# Head ############################
head_title: "Java 用于清除 PowerPoint PPTX 中水印的 API"
head_description: "利用我们的 Java API 专业地清除 PPTX 个文件中的水印，确保您的 PowerPoint 演示文稿清晰而有影响力。"

############################# Header ############################
title: "Java PowerPoint 删除水印" 
...
steps:
    ...
    code:
      ...
      content: |
        ...
        // 将 PPTX 文档路径传递给 Watermarker 构造函数
...
more_formats:
    ...
    exclude: "PPTX"
    description: "探索 GroupDocs.Watermark for Java API 在管理和删除 PPTX 文档中的水印方面的功能，帮助您交付干净、无标记的演示文稿。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
