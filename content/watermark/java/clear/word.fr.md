...
steps:
    enable: true
    title: "Supprimer les filigranes des documents Word à l'aide de Java"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/java/)** facilite la suppression des filigranes précédemment ajoutés dans les documents professionnels. Renforcez votre application Java en installant notre bibliothèque et faites-le en quelques étapes simples :
      ...
      1. Tout d’abord, instanciez la classe principale appelée **Watermarker** avec le document Word. Notre API prend en charge la transmission d'un document à traiter sous forme de flux ou de chemin local.
    ...
    code:
      ...
      content: |
        ...
        // Effacer le filigrane de texte dans le document Word
