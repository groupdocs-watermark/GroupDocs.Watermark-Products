...
steps:
    enable: true
    title: "Xóa hình mờ khỏi tài liệu Xls bằng cách sử dụng Java"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/java/)** đơn giản hóa quy trình xóa hình mờ khỏi tài liệu doanh nghiệp của bạn trong ứng dụng Java. Tích hợp thư viện của chúng tôi và làm theo các bước sau:
      ...
      1. Bắt đầu bằng cách khởi tạo lớp **Watermarker** bằng tài liệu Xls của bạn. API chấp nhận tài liệu dưới dạng luồng hoặc đường dẫn tệp cục bộ để xử lý.
    ...
    code:
      ...
      content: |
        ...
        // Truyền đường dẫn tài liệu XLS tới hàm tạo Watermarker
