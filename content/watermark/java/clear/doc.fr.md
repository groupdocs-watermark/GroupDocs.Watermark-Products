...
steps:
    ...
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/java/)** simplifie le processus de suppression des filigranes de vos documents professionnels dans les applications Java. Intégrez notre bibliothèque et suivez ces étapes :
      ...
      1. Commencez par initialiser la classe **Watermarker** avec votre document Doc. L'API accepte le document sous forme de flux ou de chemin de fichier local pour le traitement.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Effacer le filigrane de l'image DOC document

        // Transmettez le chemin du document DOC au constructeur Watermarker
