...
steps:
    ...
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/java/)** facilita a limpeza de marcas d'água adicionadas anteriormente em documentos comerciais. Capacite seu aplicativo Java instalando nossa biblioteca e faça isso em algumas etapas simples:
      ...
      1. Primeiro de tudo, instancie a classe principal chamada **Watermarker** com o documento Excel. Nossa API suporta a passagem de um documento para ser processado como fluxo ou caminho local.
    ...
    code:
      ...
      content: |
        ...
        // Marca d'água de texto simples no documento Excel
