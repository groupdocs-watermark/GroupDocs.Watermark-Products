...
head_title: "Cari Tanda Air dari SPREADSHEET di Jawa"
head_description: "Pustaka Java untuk mencari tanda air dari dokumen SPREADSHEET menggunakan fitur pencarian pintar dalam aplikasi Java menggunakan GroupDocs.API Watermark untuk Java."

title: "Cari Tanda Air dari SPREADSHEET di Jawa"
description: "Gunakan pencarian cerdas untuk menemukan semua kemungkinan tanda air dari file SPREADSHEET dari dalam aplikasi Java & J2SE. Tentukan kriteria pencarian berdasarkan teks, ekspresi reguler (RegEx), gambar, hyperlink, karakter, dan objek pencarian yang berbeda untuk menemukan tanda air dari seluruh atau halaman tertentu dari dokumen sumber."
...
steps:
    ...
    code: |
        ```cs
        // mencari kemungkinan tanda air dalam dokumen SPREADSHEET menggunakan Java.
        // Instansiasi Watermarker dengan memasukkan dokumen SPREADSHEET
