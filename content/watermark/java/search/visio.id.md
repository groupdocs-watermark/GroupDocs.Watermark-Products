...
head_title: "Cari Tanda Air dari VISIO di Jawa"
head_description: "Pustaka Java untuk mencari tanda air dari dokumen VISIO menggunakan fitur pencarian pintar dalam aplikasi Java menggunakan GroupDocs.API Watermark untuk Java."

title: "Cari Tanda Air dari VISIO di Jawa"
...
steps:
    ...
    code: |
        ```cs
        // mencari kemungkinan tanda air dalam dokumen VISIO menggunakan Java.
        // Instansiasi Watermarker dengan memasukkan dokumen VISIO
