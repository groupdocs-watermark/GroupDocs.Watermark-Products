...
############################# Head ############################
head_title: "Empower PDF Processing with Watermark Search"
head_description: "Empower yourself to efficiently search and manage watermarks across diverse document formats with GroupDocs.Watermark for Java."

############################# Header ############################
title: "Enhance Productivity with PDF Documents Watermark Search" 
description: "Enhance your productivity by harnessing GroupDocs.Watermark for Java powerful search features for PDF watermark management."
...
steps:
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Search image watermarks in PDF document

        // Compose Watermarker passing PDF document
...
more_formats:
    enable: true
    title: "Streamline Your Workflow with Watermark Search"
    exclude: "PDF"
    description: "Streamline your workflow with GroupDocs.Watermark for Java advanced search capabilities for managing watermarks in different file formats."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
