...
steps:
    ...
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/java/)** simplifie le processus de localisation des filigranes dans les documents commerciaux. Installez notre package dans vos applications Java pour profiter de ses avantages.
      ...
      1. Pour utiliser les fonctionnalités de notre bibliothèque, chargez le fichier Pptx dans une instance de la classe **Watermarker**. Vous pouvez fournir un chemin de fichier, un flux de fichiers ou un flux d'octets.
    ...
    code:
      ...
      content: |
        ...
        // Composer Watermarker en passant le document PPTX
