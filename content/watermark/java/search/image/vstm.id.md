...
head_title: "Cari Tanda Air Gambar dari VSTM di Jawa"
head_description: "Pustaka Java untuk mencari tanda air gambar dari dokumen VSTM menggunakan fitur pencarian cerdas dalam aplikasi Java & J2SE menggunakan GroupDocs.API Watermark untuk Java."

title: "Cari Tanda Air Gambar dari VSTM di Jawa"
description: "Gunakan pencarian cerdas untuk menemukan semua kemungkinan tanda air gambar dari file VSTM dari dalam aplikasi Java & J2SE. Tentukan kriteria pencarian untuk menemukan semua tanda air gambar yang cocok dari seluruh atau halaman tertentu dari dokumen sumber."
...
steps:
    enable: true
    title_left: "Cari Tanda Air dari VSTM di Jawa"
    content_left: |
    ...
    code: |
        ```cs
        // mencari kemungkinan tanda air GAMBAR dalam dokumen VSTM menggunakan Java.
        // Instansiasi Watermarker dengan memasukkan dokumen VSTM
