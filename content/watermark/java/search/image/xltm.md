...
############################# Head ############################
head_title: "Search Image Watermarks from XLTM in Java"
head_description: "Java library to search image watermarks from XLTM document using smart search features within Java & J2SE applications using GroupDocs.Watermark APIs for Java."

############################# Header ############################
title: "Search Image Watermarks from XLTM in Java"
description: "Use smart search to find all possible image watermarks from XLTM file from within Java & J2SE applications. Define search criteria to find all matching image watermarks from the whole or specific pages of the source document."
...
steps:
    enable: true
    title_left: "Search Watermarks from XLTM in Java"
    content_left: |
    ...
    code: |
        ```cs
        // search possible IMAGE watermarks in XLTM document using Java.
        // Instantiate Watermarker with input XLTM document
