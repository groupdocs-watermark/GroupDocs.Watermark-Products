...
head_title: "Cari Tanda Air Gambar dari WORD di Jawa"
head_description: "Pustaka Java untuk mencari tanda air gambar dari dokumen WORD menggunakan fitur pencarian cerdas dalam aplikasi Java & J2SE menggunakan GroupDocs.API Watermark untuk Java."

title: "Cari Tanda Air Gambar dari WORD di Jawa"
description: "Gunakan pencarian cerdas untuk menemukan semua kemungkinan tanda air gambar dari file WORD dari dalam aplikasi Java & J2SE. Tentukan kriteria pencarian untuk menemukan semua tanda air gambar yang cocok dari seluruh atau halaman tertentu dari dokumen sumber."
...
steps:
    enable: true
    title_left: "Cari Tanda Air dari WORD di Jawa"
    content_left: |
    ...
    code: |
        ```cs
        // mencari kemungkinan tanda air GAMBAR dalam dokumen WORD menggunakan Java.
        // Instansiasi Watermarker dengan memasukkan dokumen WORD
