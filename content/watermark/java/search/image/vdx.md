...
############################# Head ############################
head_title: "Search Image Watermarks from VDX in Java"
head_description: "Java library to search image watermarks from VDX document using smart search features within Java & J2SE applications using GroupDocs.Watermark APIs for Java."

############################# Header ############################
title: "Search Image Watermarks from VDX in Java"
description: "Use smart search to find all possible image watermarks from VDX file from within Java & J2SE applications. Define search criteria to find all matching image watermarks from the whole or specific pages of the source document."
...
steps:
    enable: true
    title_left: "Search Watermarks from VDX in Java"
    content_left: |
    ...
    code: |
        ```cs
        // search possible IMAGE watermarks in VDX document using Java.
        // Instantiate Watermarker with input VDX document
