...
head_title: "Cari Tanda Air Gambar dari VISIO di Jawa"
head_description: "Pustaka Java untuk mencari tanda air gambar dari dokumen VISIO menggunakan fitur pencarian cerdas dalam aplikasi Java & J2SE menggunakan GroupDocs.API Watermark untuk Java."

title: "Cari Tanda Air Gambar dari VISIO di Jawa"
description: "Gunakan pencarian cerdas untuk menemukan semua kemungkinan tanda air gambar dari file VISIO dari dalam aplikasi Java & J2SE. Tentukan kriteria pencarian untuk menemukan semua tanda air gambar yang cocok dari seluruh atau halaman tertentu dari dokumen sumber."
...
steps:
    enable: true
    title_left: "Cari Tanda Air dari VISIO di Jawa"
    content_left: |
    ...
    code: |
        ```cs
        // mencari kemungkinan tanda air GAMBAR dalam dokumen VISIO menggunakan Java.
        // Instansiasi Watermarker dengan memasukkan dokumen VISIO
