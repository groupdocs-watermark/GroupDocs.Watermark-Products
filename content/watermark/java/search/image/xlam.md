...
############################# Head ############################
head_title: "Search Image Watermarks from XLAM in Java"
head_description: "Java library to search image watermarks from XLAM document using smart search features within Java & J2SE applications using GroupDocs.Watermark APIs for Java."

############################# Header ############################
title: "Search Image Watermarks from XLAM in Java"
description: "Use smart search to find all possible image watermarks from XLAM file from within Java & J2SE applications. Define search criteria to find all matching image watermarks from the whole or specific pages of the source document."
...
steps:
    enable: true
    title_left: "Search Watermarks from XLAM in Java"
    content_left: |
    ...
    code: |
        ```cs
        // search possible IMAGE watermarks in XLAM document using Java.
        // Instantiate Watermarker with input XLAM document
