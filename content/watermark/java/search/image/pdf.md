...
############################# Head ############################
head_title: "Search Image Watermarks from PDF in Java"
head_description: "Java library to search image watermarks from PDF document using smart search features within Java & J2SE applications using GroupDocs.Watermark APIs for Java."

############################# Header ############################
title: "Search Image Watermarks from PDF in Java"
description: "Use smart search to find all possible image watermarks from PDF file from within Java & J2SE applications. Define search criteria to find all matching image watermarks from the whole or specific pages of the source document."
...
steps:
    enable: true
    title_left: "Search Watermarks from PDF in Java"
    content_left: |
    ...
    code: |
        ```cs
        // search possible IMAGE watermarks in PDF document using Java.
        // Instantiate Watermarker with input PDF document
