...
############################# Head ############################
head_title: "Search Image Watermarks from POTX in Java"
head_description: "Java library to search image watermarks from POTX document using smart search features within Java & J2SE applications using GroupDocs.Watermark APIs for Java."

############################# Header ############################
title: "Search Image Watermarks from POTX in Java"
description: "Use smart search to find all possible image watermarks from POTX file from within Java & J2SE applications. Define search criteria to find all matching image watermarks from the whole or specific pages of the source document."
...
steps:
    enable: true
    title_left: "Search Watermarks from POTX in Java"
    content_left: |
    ...
    code: |
        ```cs
        // Search possible IMAGE watermarks in POTX document using Java.
        // Instantiate Watermarker with input POTX document
