...
############################# Head ############################
head_title: "Search Image Watermarks from XLTX in Java"
head_description: "Java library to search image watermarks from XLTX document using smart search features within Java & J2SE applications using GroupDocs.Watermark APIs for Java."

############################# Header ############################
title: "Search Image Watermarks from XLTX in Java"
description: "Use smart search to find all possible image watermarks from XLTX file from within Java & J2SE applications. Define search criteria to find all matching image watermarks from the whole or specific pages of the source document."
...
steps:
    ...
    code: |
        ```cs
        // Search possible IMAGE watermarks in XLTX document using Java.
        // Instantiate Watermarker with input XLTX document
