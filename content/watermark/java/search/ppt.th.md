...
steps:
    enable: true
    title: "Ppt ค้นหาลายน้ำผ่าน Java"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/java/)** ลดความซับซ้อนของกระบวนการค้นหาลายน้ำภายในเอกสารทางธุรกิจ ติดตั้งแพ็คเกจของเราลงในแอปพลิเคชัน Java ของคุณเพื่อใช้ประโยชน์จากแพ็คเกจนี้
      ...
      1. หากต้องการใช้คุณสมบัติไลบรารีของเรา ให้โหลดไฟล์ Ppt ลงในอินสแตนซ์ของคลาส **Watermarker** คุณสามารถระบุเส้นทางของไฟล์ สตรีมไฟล์ หรือสตรีมไบต์ได้
    ...
    code:
      ...
      content: |
        ...
        // เขียน Watermarker ผ่านเอกสาร PPT
