...
steps:
    enable: true
    title: "Pptx Búsqueda de marcas de agua mediante Java"
    content: |
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Busca marcas de agua de imágenes en el documento PPTX

        // Redacte un documento Watermarker que pase PPTX
