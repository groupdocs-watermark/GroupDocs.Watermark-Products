...
############################# Head ############################
head_title: "使用水印搜索加强 PDF 处理"
head_description: "使用 GroupDocs.Watermark for Java 让自己能够高效地搜索和管理各种文档格式的水印。"

############################# Header ############################
title: "使用 PDF 个文档水印搜索提高工作效率" 
description: "利用 GroupDocs.Watermark for Java 强大的搜索功能进行 PDF 水印管理，提高工作效率。"
...
more_formats:
    ...
    title: "使用水印搜索简化工作流程"
    exclude: "PDF"
    description: "使用 GroupDocs.Watermark for Java 高级搜索功能来管理不同文件格式的水印，简化您的工作流程。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
