...
############################# Head ############################
head_title: "Discover RTF Documents Watermark Search"
head_description: "Discover the essence of GroupDocs.Watermark for Java powerful search capabilities for effective watermark management across different document types."

############################# Header ############################
title: "Empower RTF Documents Watermark Search Process" 
...
steps:
    enable: true
    title: "Rtf Watermarks Search via Java"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/java/)** simplifies the process of locating watermarks within business documents. Install our package into your Java applications to take advantage of its benefits.
      ...
      1. To utilize our library features, load the Rtf file into an instance of the **Watermarker** class. You can provide a file path, file stream, or byte stream.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Search image watermarks in RTF document

        // Compose Watermarker passing RTF document
