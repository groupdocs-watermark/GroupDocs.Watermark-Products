...
############################# Head ############################
head_title: "Découvrez DOC Watermark Search : une technologie qui change la donne"
head_description: "Découvrez le potentiel révolutionnaire des fonctionnalités de recherche avancée de G GroupDocs.Watermark for Java pour gérer les filigranes dans différents types de documents."

############################# Header ############################
title: "Optimisez votre efficacité grâce à la recherche par filigrane dans DOC documents" 
description: "Optimisez l'efficacité de votre flux de travail grâce à GroupDocs.Watermark for Java fonctionnalités innovantes de recherche de filigranes."
...
about:
    enable: true
    title: "Obtenir des informations GroupDocs.Watermark for Java"
    link: "/watermark/java/"
...
steps:
    enable: true
    title: "Doc Recherche de filigranes via Java"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/java/)** simplifie le processus de localisation des filigranes dans les documents commerciaux. Installez notre package dans vos applications Java pour profiter de ses avantages.
      ...
      1. Pour utiliser les fonctionnalités de notre bibliothèque, chargez le fichier Doc dans une instance de la classe **Watermarker**. Vous pouvez fournir un chemin de fichier, un flux de fichiers ou un flux d'octets.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Rechercher des filigranes d'image dans le document DOC

        // Composer Watermarker en passant le document DOC
...
more_formats:
    ...
    exclude: "DOC"
    description: "Donnez-vous les moyens de rechercher et de gérer des filigranes dans différents formats de fichiers grâce à GroupDocs.Watermark for Java fonctionnalités avancées."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
