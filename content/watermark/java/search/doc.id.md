...
steps:
    enable: true
    title: "Doc Pencarian Tanda Air melalui Java"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/java/)** menyederhanakan proses pencarian tanda air dalam dokumen bisnis. Instal paket kami ke aplikasi Java Anda untuk memanfaatkan manfaatnya.
      ...
      1. Untuk memanfaatkan fitur perpustakaan kami, muat file Doc ke dalam instance kelas **Watermarker**. Anda dapat memberikan jalur file, aliran file, atau aliran byte.
    ...
    code:
      ...
      content: |
        ...
        // Tulis dokumen Watermarker dengan meneruskan DOC
