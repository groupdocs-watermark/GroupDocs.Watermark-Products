...
############################# Head ############################
head_title: "Search PPTX Document Watermark"
...
steps:
    enable: true
    title: "Search for Pptx files image watermarks via Java"
    content: |
      ...
      1. Pass Pptx document **Watermarker** as a constructor argument
