...
steps:
    ...
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/java/)** полегшує пошук водяних знаків, уже розміщених у бізнес-документах. Завантажте наш пакет і додайте його до своєї програми Java, щоб скористатися його перевагами.
      ...
      1. Щоб скористатися функціями нашої бібліотеки, вам потрібно завантажити файл Word до екземпляра класу **Watermarker**. Можна надати лише шлях до файлу, потік файлів або потік байтів.
    ...
    code:
      ...
      content: |
        ...
        // Отримайте екземпляр Watermarker для документа WORD
