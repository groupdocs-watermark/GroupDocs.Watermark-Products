...
steps:
    ...
    code: |
        ```cs
        // Search possible watermarks in WORD document using Java.
        // Instantiate Watermarker with input WORD document
