...
steps:
    ...
    code: |
        ```cs
        // Search possible watermarks in VSTX document using Java.
        // Instantiate Watermarker with input VSTX document
