...
############################# Head ############################
head_title: "Search Watermarks from POT in Java"
head_description: "Java library to search watermarks from POT document using smart search features within Java applications using GroupDocs.Watermark APIs for Java."

############################# Header ############################
title: "Search Watermarks from POT in Java"
description: "Use smart search to find all possible watermarks from POT file from within Java & J2SE applications. Define search criteria based on text, regular expressions (RegEx), images, hyperlinks, characters and different search objects to find watermarks from the whole or specific pages of the source document."
...
steps:
    ...
    code: |
        ```cs
        // Search possible watermarks in POT document using Java.
        // Instantiate Watermarker with input POT document
