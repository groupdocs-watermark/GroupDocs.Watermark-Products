...
steps:
    ...
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/java/)** facilite la recherche de filigranes déjà placés dans des documents professionnels. Téléchargez notre package et impliquez-le dans votre application Java pour profiter de ses avantages.
      ...
      1. Afin d'utiliser les fonctionnalités de notre bibliothèque, vous devez charger le fichier Powerpoint dans l'instance de classe **Watermarker**. Il est possible de fournir simplement un chemin de fichier, un flux de fichiers ou un flux d'octets.
    ...
    code:
      ...
      content: |
        ...
        // Obtenez l'instance Watermarker pour le document POWERPOINT
