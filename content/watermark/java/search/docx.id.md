...
head_title: "Cari Tanda Air dari DOCX di Jawa"
head_description: "Pustaka Java untuk mencari tanda air dari dokumen DOCX menggunakan fitur pencarian pintar dalam aplikasi Java menggunakan GroupDocs.API Watermark untuk Java."

title: "Cari Tanda Air dari DOCX di Jawa"
...
steps:
    ...
    code: |
        ```cs
        // mencari kemungkinan tanda air dalam dokumen DOCX menggunakan Java.
        // Instansiasi Watermarker dengan memasukkan dokumen DOCX
