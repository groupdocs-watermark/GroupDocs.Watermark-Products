...
steps:
    enable: true
    title: "Pesquise marcas d'água em arquivos Powerpoint usando Java"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/java/)** facilita a pesquisa de marcas d'água já colocadas em documentos comerciais. Baixe nosso pacote e envolva-o em seu aplicativo Java para aproveitar seus benefícios.
      ...
      1. Para usar os recursos de nossa biblioteca, você precisa carregar o arquivo Powerpoint na instância da classe **Watermarker**. É possível fornecer apenas um caminho de arquivo, fluxo de arquivo ou fluxo de bytes.
    ...
    code:
      ...
      content: |
        ...
        // Pesquise marcas d'água de texto no documento POWERPOINT
