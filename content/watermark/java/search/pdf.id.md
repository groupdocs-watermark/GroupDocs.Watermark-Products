...
############################# Head ############################
head_title: "Memberdayakan PDF Pemrosesan dengan Pencarian Watermark"
head_description: "Berdayakan diri Anda untuk mencari dan mengelola tanda air secara efisien di berbagai format dokumen dengan GroupDocs.Watermark for Java."

############################# Header ############################
title: "Tingkatkan Produktivitas dengan PDF Pencarian Watermark Dokumen" 
description: "Tingkatkan produktivitas Anda dengan memanfaatkan GroupDocs.Watermark for Java fitur pencarian canggih untuk pengelolaan tanda air PDF."
...
more_formats:
    enable: true
    title: "Sederhanakan Alur Kerja Anda dengan Pencarian Watermark"
    exclude: "PDF"
    description: "Sederhanakan alur kerja Anda dengan kemampuan pencarian lanjutan GroupDocs.Watermark for Java untuk mengelola tanda air dalam format file yang berbeda."
    items: 
        # format loop 1
        - name: "Tanda air PDF"
          format: "PDF"
