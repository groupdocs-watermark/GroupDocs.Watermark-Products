...
steps:
    enable: true
    title: "Java 을(를) 사용하여 Word 파일에서 워터마크를 검색하세요."
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/java/)** 를 사용하면 비즈니스 문서에 이미 배치된 워터마크를 쉽게 검색할 수 있습니다. 패키지를 다운로드하고 이를 Java 애플리케이션에 포함시켜 그 이점을 활용하세요.
      ...
      1. 우리의 라이브러리 기능을 사용하려면 Word 파일을 **Watermarker** 클래스 인스턴스에 로드해야 합니다. 파일 경로, 파일 스트림 또는 바이트 스트림만 제공할 수 있습니다.
    ...
    code:
      ...
      content: |
        ...
        // WORD 문서에 대한 Watermarker 인스턴스 가져오기
