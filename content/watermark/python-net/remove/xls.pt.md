...
############################# Head ############################
head_title: "Remova Marcas d'Água de Arquivos Excel XLS"
head_description: "Limpe rapidamente marcas d'água de planilhas XLS usando nossa API Python para dados limpos e profissionais."

############################# Header ############################
title: "Excluir Marcas d'Água em Planilhas XLS com Python" 
description: "Use a API GroupDocs.Watermark for Python via .NET para remover ou editar marcas d'água em planilhas XLS e mantenha seus dados com uma aparência nítida."
...
about:
    ...
    content: |
       A biblioteca GroupDocs.Watermark for Python via .NET oferece tudo o que você precisa para gerenciar marcas d'água em planilhas XLS. Remova, edite ou ajuste marcas d'água para manter seus dados claros e profissionais.

############################# Steps ############################
steps:
    enable: true
    title: "Remova Marcas d'Água de Arquivos Xls em Python"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** permite que desenvolvedores Python removam marcas d'água rapidamente de arquivos Xls. Veja como fazer:
      
      1. Comece passando seu arquivo Xls para o construtor **Watermarker**. Você pode usar um caminho de arquivo, stream de bytes ou stream de arquivo.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Remover marca d'água de um arquivo XLS
        import groupdocs.watermark as gw
        import groupdocs.watermark.search.searchcriteria as gwss

        # Crie uma instância de Watermarker com seu arquivo XLS
...
more_formats:
    enable: true
    title: "Limpe Marcas d'Água de Planilhas XLS em Python"
    exclude: "XLS"
    description: "Saiba como a API GroupDocs.Watermark for Python via .NET pode ajudá-lo a remover marcas d'água de planilhas XLS para uma melhor apresentação dos dados."
    items: 
        # format loop 1
