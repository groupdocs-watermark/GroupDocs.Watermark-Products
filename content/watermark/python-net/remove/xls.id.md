...
############################# Head ############################
head_title: "Hapus Watermark dari File Excel XLS"
head_description: "Dengan cepat menghapus watermark dari spreadsheet XLS menggunakan API Python kami untuk data yang bersih dan profesional."

############################# Header ############################
title: "Hapus Watermark dalam Spreadsheet XLS dengan Python" 
description: "Gunakan API GroupDocs.Watermark for Python via .NET untuk menghapus atau mengedit watermark di spreadsheet XLS dan menjaga data Anda tetap tajam."
...
about:
    ...
    content: |
       Perpustakaan GroupDocs.Watermark for Python via .NET memberi Anda semua alat yang diperlukan untuk mengelola watermark dalam spreadsheet XLS. Hapus, edit, atau sesuaikan watermark untuk menjaga data Anda tetap jelas dan profesional.

############################# Steps ############################
steps:
    enable: true
    title: "Hapus Watermark dari File Xls dalam Python"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** memungkinkan pengembang Python dengan cepat menghapus watermark dari file Xls. Berikut adalah cara melakukannya:
      
      1. Mulai dengan meneruskan file Xls Anda ke konstruktor **Watermarker**. Anda dapat menggunakan jalur file, aliran byte, atau aliran file.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Hapus watermark gambar dari file XLS
        import groupdocs.watermark as gw
        import groupdocs.watermark.search.searchcriteria as gwss

        # Buat instance Watermarker dengan file XLS Anda
...
more_formats:
    enable: true
    title: "Hapus Watermark dari Spreadsheet XLS dalam Python"
    exclude: "XLS"
    description: "Pelajari bagaimana API GroupDocs.Watermark for Python via .NET dapat membantu Anda menghapus watermark dari spreadsheet XLS untuk presentasi data yang lebih baik."
    items: 
        # format loop 1
        - name: "Tanda air PDF"
          format: "PDF"
