...
############################# Head ############################
head_title: "Añadir Marcas de Agua a PPTX con Python"
head_description: "Proteja sus presentaciones PPTX añadiendo marcas de agua en Python."

############################# Header ############################
title: "Marcas de Agua Avanzadas de Python para PPTX" 
description: "Utilice Python para añadir marcas de agua fuertes a archivos PPTX—ideales para negocios y educación."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET es una solución completa de Python para marcar archivos PPTX. Añada texto, logotipos o gráficos como marcas de agua, y ajuste su transparencia, tamaño y posición. Perfecto para quien necesita proteger sus presentaciones, GroupDocs.Watermark mantiene sus diapositivas seguras y con buena apariencia.

############################# Steps ############################
steps:
    enable: true
    title: "Añada Marcas de Agua a Archivos Pptx Rápidamente"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Una poderosa biblioteca de Python que le permite añadir marcas de agua a sus documentos.
      ...
      1. **Clase Principal: Watermarker.** Comience creando un objeto **Watermarker**. Proporciónelo su archivo Pptx, ya sea como un camino de archivo o como un flujo, para empezar.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Añadir una marca de agua de imagen a un archivo PPTX
        ...
        with gw.Watermarker("input.pptx") as watermarker:
            ...
            # Guarde el archivo PPTX con la marca de agua
...
more_formats:
    enable: true
    title: "Marcas de Agua Python para Archivos PPTX"
    exclude: "PPTX"
    description: "Añada marcas de agua a archivos PPTX en Python para mantener sus presentaciones a salvo de compartición o copias."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
