...
############################# Head ############################
head_title: "Ajoutez des filigranes à XLSX avec Python"
head_description: "Utilisez Python pour ajouter des filigranes aux fichiers XLSX et protéger vos documents Excel."

############################# Header ############################
title: "Protégez les feuilles XLSX avec des filigranes Python" 
description: "Ajoutez des filigranes personnalisés aux fichiers XLSX en Python—parfait pour des données sensibles et professionnelles."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET est une solution Python pour ajouter et gérer des filigranes dans les fichiers XLSX. Ajoutez des filigranes textuels ou d'image, automatisez le filigranage en fonction des propriétés des fichiers, et gardez vos documents Excel sécurisés et professionnels. GroupDocs.Watermark prend en charge toutes les fonctionnalités modernes de Python.

############################# Steps ############################
steps:
    enable: true
    title: "Ajoutez rapidement des filigranes aux fichiers Xlsx"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Une bibliothèque puissante Python qui vous permet d'ajouter des filigranes à vos documents.
      ...
      1. **Classe principale : Watermarker.** Commencez par créer un objet **Watermarker**. Donnez-lui votre fichier Xlsx, soit en tant que chemin de fichier soit en tant que flux, pour commencer.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ajoutez un filigrane image à un fichier XLSX
        ...
        with gw.Watermarker("input.xlsx") as watermarker:
            ...
            # Enregistrez le fichier XLSX avec le filigrane
...
more_formats:
    enable: true
    title: "Ajoutez des filigranes à XLSX avec Python"
    exclude: "XLSX"
    description: "Utilisez Python pour ajouter des filigranes sécurisés et avancés aux fichiers XLSX et protéger vos données Excel."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
