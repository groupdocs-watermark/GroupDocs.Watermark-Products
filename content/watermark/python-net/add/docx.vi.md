...
############################# Head ############################
head_title: "Watermark Python cho tệp DOCX"
head_description: "Thêm watermark vào các tệp DOCX trong Python để giữ cho tài liệu Word của bạn an toàn."

############################# Header ############################
title: "Bảo vệ DOCX với Watermark Python" 
description: "Áp dụng watermark nâng cao cho các tệp DOCX trong Python—tuyệt vời cho việc bảo vệ tài liệu Word của bạn trong bất kỳ ngành nào."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET mang đến khả năng watermark mạnh mẽ cho các tệp DOCX. Dễ dàng thêm các watermark có thể mở rộng, di chuyển và hòa vào tài liệu của bạn. Sử dụng nó cho các tệp hợp pháp, kinh doanh hoặc bí mật, và chọn từ các watermark văn bản hoặc hình ảnh với vị trí linh hoạt. GroupDocs.Watermark hỗ trợ các tính năng mới nhất của Python để bảo vệ tài liệu hàng đầu.

############################# Steps ############################
steps:
    enable: true
    title: "Nhanh chóng thêm Watermark vào tệp Docx"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Một thư viện Python mạnh mẽ cho phép bạn thêm watermark vào tài liệu của bạn.
      ...
      1. **Lớp chính: Watermarker.** Bắt đầu bằng cách tạo một đối tượng **Watermarker**. Cung cấp cho nó tệp Docx của bạn, dưới dạng đường dẫn tệp hoặc luồng, để bắt đầu.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Thêm một hình ảnh làm watermark vào một tệp DOCX
...
more_formats:
    enable: true
    title: "Thêm Watermark vào DOCX bằng Python"
    exclude: "DOCX"
    description: "Tìm hiểu cách thêm watermark bảo mật, tùy chỉnh vào các tệp DOCX trong Python để đảm bảo an toàn tài liệu và kiểm soát bản quyền."
    items: 
        # format loop 1
        - name: "Hình mờ PDF"
          format: "PDF"
