...
############################# Head ############################
head_title: "Tambahkan Watermark ke WEBP dengan Python"
head_description: "Gunakan Python untuk menambahkan watermark ke gambar WEBP untuk perlindungan yang kuat."

############################# Header ############################
title: "Buat Watermark untuk WEBP dengan Python" 
description: "Tambahkan watermark kustom ke file WEBP dalam Python—bagus untuk seniman dan kreator konten."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET memungkinkan Anda menambahkan watermark ke gambar WEBP dalam Python. Gunakan teks, logo, atau tanda tangan digital, dan sesuaikan tampilannya agar sesuai dengan kebutuhan Anda. Sempurna untuk siapa pun yang membagikan gambar secara online, GroupDocs.Watermark menjaga karya Anda aman dan terlihat hebat.

############################# Steps ############################
steps:
    enable: true
    title: "Tambahkan Watermark ke File Webp dengan Cepat"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Sebuah pustaka Python yang kuat yang memungkinkan Anda menambahkan watermark ke dokumen.
      ...
      1. **Kelas Utama: Watermarker.** Mulailah dengan membuat objek **Watermarker**. Berikan file Webp Anda, baik sebagai jalur file atau stream, untuk memulai.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Tambahkan watermark gambar ke file WEBP
        ...
        with gw.Watermarker("input.webp") as watermarker:
            ...
            # Simpan file WEBP dengan watermark
...
more_formats:
    enable: true
    title: "Lindungi Gambar WEBP dengan Watermark Python"
    exclude: "WEBP"
    description: "Tambahkan watermark lanjutan yang kustom ke gambar WEBP dalam Python untuk melindungi karya kreatif Anda."
    items: 
        # format loop 1
        - name: "Tanda air PDF"
          format: "PDF"
