...
############################# Head ############################
head_title: "Marcas de Agua Python para Documentos PDF"
head_description: "Añada marcas de agua a archivos PDF en Python para proteger sus documentos importantes."

############################# Header ############################
title: "Proteja PDF con Marcas de Agua de Python" 
description: "Utilice Python para añadir marcas de agua a archivos PDF—ideales para documentos legales, financieros y oficiales."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET es una API de Python para añadir marcas de agua a archivos PDF. Personalice el texto, las imágenes y la colocación de su marca de agua para adaptarse a cualquier documento. Úselo para marcar contratos, informes o archivos confidenciales, y mantenga sus PDFs seguros y profesionales. GroupDocs.Watermark admite transparencia, rotación y superposición para un marcado avanzado.

############################# Steps ############################
steps:
    enable: true
    title: "Añada Marcas de Agua a Archivos Pdf Rápidamente"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Una poderosa biblioteca de Python que le permite añadir marcas de agua a sus documentos.
      ...
      1. **Clase Principal: Watermarker.** Comience creando un objeto **Watermarker**. Proporciónelo su archivo Pdf, ya sea como un camino de archivo o como un flujo, para empezar.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Añadir una marca de agua de imagen a un archivo PDF
        ...
        with gw.Watermarker("input.pdf") as watermarker:
            ...
            # Guarde el archivo PDF con la marca de agua
...
more_formats:
    enable: true
    title: "Asegure Archivos PDF con Marcas de Agua Python"
    exclude: "PDF"
    description: "Añada marcas de agua personalizadas a archivos PDF en Python para proteger sus documentos sensibles y oficiales."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
