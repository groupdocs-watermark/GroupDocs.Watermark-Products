...
############################# Head ############################
head_title: "Ajoutez des filigranes à WEBP avec Python"
head_description: "Utilisez Python pour ajouter des filigranes aux images WEBP pour une protection forte."

############################# Header ############################
title: "Créez des filigranes pour WEBP avec Python" 
description: "Ajoutez des filigranes personnalisés aux fichiers WEBP en Python—idéal pour les artistes et créateurs de contenu."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET vous permet d'ajouter des filigranes aux images WEBP en Python. Utilisez du texte, des logos ou des signatures numériques, et ajustez leur apparence pour répondre à vos besoins. Parfait pour quiconque partage des images en ligne, GroupDocs.Watermark garde votre travail en sécurité et attrayant.

############################# Steps ############################
steps:
    enable: true
    title: "Ajoutez rapidement des filigranes aux fichiers Webp"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Une bibliothèque puissante Python qui vous permet d'ajouter des filigranes à vos documents.
      ...
      1. **Classe principale : Watermarker.** Commencez par créer un objet **Watermarker**. Donnez-lui votre fichier Webp, soit en tant que chemin de fichier soit en tant que flux, pour commencer.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ajoutez un filigrane image à un fichier WEBP
        ...
        with gw.Watermarker("input.webp") as watermarker:
            ...
            # Enregistrez le fichier WEBP avec le filigrane
...
more_formats:
    enable: true
    title: "Protégez les images WEBP avec des filigranes Python"
    exclude: "WEBP"
    description: "Ajoutez des filigranes avancés et personnalisés aux images WEBP en Python pour protéger votre travail créatif."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
