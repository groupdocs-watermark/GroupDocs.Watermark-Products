...
############################# Head ############################
head_title: "Marcas de Agua Python para Documentos RTF"
head_description: "Añada marcas de agua a archivos RTF en Python para mantener seguros sus documentos de Word."

############################# Header ############################
title: "Proteja RTF con Marcas de Agua de Python" 
description: "Utilice Python para añadir marcas de agua seguras y personalizadas a archivos RTF—geniales para documentos de Word sensibles."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET le proporciona herramientas avanzadas para añadir marcas de agua a documentos RTF en Python. Utilice marcas visibles u transparentes y ajuste su fuente, color, tamaño y posición. Perfecto para archivos legales, empresariales o confidenciales, GroupDocs.Watermark ayuda a prevenir copias y ediciones.

############################# Steps ############################
steps:
    enable: true
    title: "Añada Marcas de Agua a Archivos Rtf Rápidamente"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Una poderosa biblioteca de Python que le permite añadir marcas de agua a sus documentos.
      ...
      1. **Clase Principal: Watermarker.** Comience creando un objeto **Watermarker**. Proporciónelo su archivo Rtf, ya sea como un camino de archivo o como un flujo, para empezar.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Añadir una marca de agua de imagen a un archivo RTF
        ...
        with gw.Watermarker("input.rtf") as watermarker:
            ...
            # Guarde el archivo RTF con la marca de agua
...
more_formats:
    enable: true
    title: "Añadir Marcas de Agua a RTF con Python"
    exclude: "RTF"
    description: "Utilice Python para añadir marcas de agua fuertes y sutiles a archivos RTF para una mejor seguridad documental."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
