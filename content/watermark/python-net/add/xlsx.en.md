...
############################# Head ############################
head_title: "Add Watermarks to XLSX with Python"
head_description: "Use Python to add watermarks to XLSX files and protect your Excel documents."

############################# Header ############################
title: "Protect XLSX Sheets with Python" 
description: "Add custom watermarks to XLSX files in Python—perfect for business and sensitive data."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET is a Python solution for adding and managing watermarks in XLSX files. Add text or image watermarks, automate watermarking based on file properties, and keep your Excel documents safe and professional. GroupDocs.Watermark supports all modern Python features.

############################# Steps ############################
steps:
    enable: true
    title: "Quickly Add Watermarks to Xlsx Files"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** A powerful Python library that lets you add watermarks to your documents with ease.
      ...
      1. **Main Class: Watermarker.** Start by creating a **Watermarker** object. Give it your Xlsx file, either as a file path or a stream, to get started.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Add an image watermark to a XLSX file
        ...
        with gw.Watermarker("input.xlsx") as watermarker:
            ...
            # Save the XLSX file with the watermark
...
more_formats:
    enable: true
    title: "Add Watermarks to XLSX with Python"
    exclude: "XLSX"
    description: "Use Python to add secure, advanced watermarks to XLSX files and protect your Excel data."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
