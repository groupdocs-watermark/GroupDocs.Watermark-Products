...
############################# Head ############################
head_title: "Водяные знаки для файлов DOC с помощью Python"
head_description: "Добавляйте водяные знаки к файлам DOC в Python, чтобы защитить и организовать ваши документы."

############################# Header ############################
title: "Защитите DOC с помощью водяных знаков Python" 
description: "Используйте Python для добавления защищенных водяных знаков в файлы DOC—идеально для юридических, бизнес- и конфиденциальных документов."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET позволяет добавлять водяные знаки к файлам DOC в Python. Вставляйте текстовые или изображенческие водяные знаки, настраивайте их прозрачность, цвет и положение, и добавляйте такую информацию, как даты, логотипы или конфиденциальные печати. Этот инструмент идеально подходит для юридических, бизнес- и конфиденциальных документов и работает безупречно в средах Python. GroupDocs.Watermark — надежный способ защитить и подтвердить ваши файлы Word.

############################# Steps ############################
steps:
    enable: true
    title: "Быстро добавьте водяные знаки в файлы Doc"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Мощная библиотека Python для добавления водяных знаков в ваши документы.
      ...
      1. **Основной класс: Watermarker.** Начните с создания объекта **Watermarker**. Передайте в него ваш файл Doc, либо в виде пути, либо в виде потока, чтобы приступить к работе.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Добавьте изображение-подпись в файл DOC
...
more_formats:
    enable: true
    title: "Водяные знаки Python для файлов Word"
    exclude: "DOC"
    description: "Используйте Python для добавления пользовательских водяных знаков к файлам DOC, чтобы защитить и подтвердить ваши документы Word."
    items: 
        # format loop 1
