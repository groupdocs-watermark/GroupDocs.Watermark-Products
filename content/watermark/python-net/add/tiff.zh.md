...
############################# Head ############################
head_title: "使用 Python 为 TIFF 添加水印"
head_description: "创建并添加水印到 TIFF 图像中，使用 Python 保护您的数字文件。"

############################# Header ############################
title: "为 TIFF 创建水印与 Python" 
description: "在 Python 中为 TIFF 文件添加强大的自定义水印——非常适合数字档案和摄影师。"
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET 是一个 Python 工具包，用于向 TIFF 文件添加水印。选择文本或图像水印，设置其不透明度、大小和位置，帮您保护图像。借助水印分层和智能格式化等功能，GroupDocs.Watermark 是任何需要保护其图像集合的用户的必备工具。

############################# Steps ############################
steps:
    enable: true
    title: "快速向 Tiff 文件添加水印"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** 一个强大的 Python 库，可以帮助您轻松向文档添加水印。
      
      1. **主要类：Watermarker.** 首先创建一个 **Watermarker** 对象。将您的 Tiff 文件作为文件路径或流传递给它，以便开始。
...
more_formats:
    enable: true
    title: "使用 Python 水印保护 TIFF 图像"
    exclude: "TIFF"
    description: "在 Python 中管理 TIFF 文件中的水印，确保您的图像安全，受您控制。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
