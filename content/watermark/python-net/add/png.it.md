...
############################# Head ############################
head_title: "Proteggi PNG con watermark Python"
head_description: "Aggiungi watermark a immagini PNG in Python per diritti d'autore e sicurezza."

############################# Header ############################
title: "Watermarking Python per immagini PNG" 
description: "Usa Python per aggiungere watermark avanzati a immagini PNG—ottimo per artisti e designer."
...
about:
    ...
    content: |
       GroupDocs.Watermark è un toolkit Python per aggiungere watermark a immagini PNG. Aggiungi watermark trasparenti o solidi, posizionali ovunque e mantieni le tue immagini al sicuro. Con GroupDocs.Watermark, puoi utilizzare testo o immagini come watermark e controllare il loro aspetto per progetti personali o professionali.

############################# Steps ############################
steps:
    enable: true
    title: "Aggiungi rapidamente watermark ai file Png"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Una potente libreria Python che ti consente di aggiungere watermark ai tuoi documenti.
      ...
      1. **Classe principale: Watermarker.** Inizia creando un oggetto **Watermarker**. Fornisci il tuo file Png, sia come percorso di file che come stream.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Aggiungi un watermark immagine a un file PNG
        ...
        with gw.Watermarker("input.png") as watermarker:
            ...
            # Salva il file PNG con il watermark
...
more_formats:
    enable: true
    title: "Aggiungi watermark a PNG con Python"
    exclude: "PNG"
    description: "Usa Python per aggiungere watermark sottili o bold a immagini PNG per una protezione flessibile dei diritti d'autore."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
