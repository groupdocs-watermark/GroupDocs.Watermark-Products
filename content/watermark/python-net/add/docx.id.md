...
############################# Head ############################
head_title: "Python Watermarking untuk File DOCX"
head_description: "Tambahkan watermark ke file DOCX dalam Python untuk menjaga dokumen Word Anda tetap aman."

############################# Header ############################
title: "Amankan DOCX dengan Watermark Python" 
description: "Terapkan watermark lanjutan ke file DOCX dalam Python—bagus untuk melindungi dokumen Word Anda di industri mana pun."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET menghadirkan watermarking yang kuat untuk file DOCX. Mudah menambahkan watermark yang dapat skala, bergerak, dan menyatu dengan dokumen Anda. Gunakan untuk file hukum, bisnis, atau rahasia, dan pilih antara watermark teks atau gambar dengan penempatan fleksibel. GroupDocs.Watermark mendukung fitur Python terbaru untuk perlindungan dokumen yang luar biasa.

############################# Steps ############################
steps:
    enable: true
    title: "Tambahkan Watermark ke File Docx dengan Cepat"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Sebuah pustaka Python yang kuat yang memungkinkan Anda menambahkan watermark ke dokumen.
      ...
      1. **Kelas Utama: Watermarker.** Mulailah dengan membuat objek **Watermarker**. Berikan file Docx Anda, baik sebagai jalur file atau stream, untuk memulai.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Tambahkan watermark gambar ke file DOCX
        ...
        with gw.Watermarker("input.docx") as watermarker:
            ...
            # Simpan file DOCX dengan watermark
...
more_formats:
    enable: true
    title: "Tambahkan Watermark ke DOCX dengan Python"
    exclude: "DOCX"
    description: "Pelajari cara menambahkan watermark yang aman dan kustom ke file DOCX dalam Python untuk keamanan dokumen yang lebih baik dan kontrol hak cipta."
    items: 
        # format loop 1
        - name: "Tanda air PDF"
          format: "PDF"
