...
############################# Head ############################
head_title: "Aggiungi watermark Python a immagini TIF"
head_description: "Usa Python per aggiungere watermark a immagini TIF e proteggere le tue foto."

############################# Header ############################
title: "Watermarking avanzato per TIF con Python" 
description: "Aggiungi watermark di alta qualità a immagini TIF in Python—ideale per fotografi e archivisti."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET è un toolkit Python per watermarkare immagini TIF. Aggiungi watermark di testo o immagine, regola il loro aspetto e mantieni le tue immagini ad alta risoluzione al sicuro. Con l'elaborazione batch e posizionamenti intelligenti, GroupDocs.Watermark è perfetto per chiunque debba proteggere numerose immagini contemporaneamente.

############################# Steps ############################
steps:
    enable: true
    title: "Aggiungi rapidamente watermark ai file Tif"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Una potente libreria Python che ti consente di aggiungere watermark ai tuoi documenti.
      ...
      1. **Classe principale: Watermarker.** Inizia creando un oggetto **Watermarker**. Fornisci il tuo file Tif, sia come percorso di file che come stream.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Aggiungi un watermark immagine a un file TIF
        ...
        with gw.Watermarker("input.tif") as watermarker:
            ...
            # Salva il file TIF con il watermark
...
more_formats:
    enable: true
    title: "Proteggi immagini TIF con watermark Python"
    exclude: "TIF"
    description: "Aggiungi watermark personalizzati a immagini TIF in Python per prevenire la copiatura e mantenere il tuo lavoro sicuro."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
