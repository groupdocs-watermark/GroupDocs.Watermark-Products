...
############################# Head ############################
head_title: "Додайте водяні знаки Python до TIF зображень"
head_description: "Використовуйте Python для додавання водяних знаків до TIF зображень та захисту ваших фотографій."

############################# Header ############################
title: "Розширене водяний знак для TIF за допомогою Python" 
description: "Додавайте водяні знаки високої якості до TIF зображень у Python — чудово для фотографів та архівістів."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET — це Python набір інструментів для водяного знакування TIF зображень. Додавайте текстові або графічні водяні знаки, налаштовуйте їх вигляд та зберігайте ваші зображення високої роздільної здатності в безпеці. Завдяки пакетній обробці та розумному розміщенню GroupDocs.Watermark ідеально підходить для тих, хто потребує захистити велику кількість зображень одночасно.

############################# Steps ############################
steps:
    enable: true
    title: "Швидко додайте водяні знаки до файлів Tif"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Потужна бібліотека Python для додавання водяних знаків до ваших документів.
      ...
      1. **Головний клас: Watermarker.** Почніть з створення об'єкта **Watermarker**. Задайте йому ваш файл Tif, або у вигляді шляху до файлу, або потоку, щоб розпочати.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Додайте водяний знак до файлу TIF
        ...
        with gw.Watermarker("input.tif") as watermarker:
            ...
            # Збережіть файл TIF з водяним знаком
...
more_formats:
    enable: true
    title: "Захистіть TIF зображення з водяними знаками Python"
    exclude: "TIF"
    description: "Додайте користувацькі водяні знаки до TIF зображень у Python, щоб запобігти копіюванню та зберегти вашу роботу в безпеці."
    items: 
        # format loop 1
