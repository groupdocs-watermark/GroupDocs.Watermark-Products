...
############################# Head ############################
head_title: "PythonのJPG画像に透かしを追加"
head_description: "PythonでJPGの画像に透かしを追加し、デジタル写真を保護します。"

############################# Header ############################
title: "PythonによるJPG画像の保護" 
description: "Pythonを使用してJPG画像に強力な透かしを追加します。著作権や所有権に最適です。"
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NETは、PythonでJPG画像に透かしを追加することを可能にします。テキスト、ロゴ、またはグラフィックを画像の任意の場所に配置し、外観をニーズに合わせて調整します。個人またはビジネス用途での写真を保護するために、GroupDocs.Watermarkを使用して画像を安全に保ちましょう。

############################# Steps ############################
steps:
    enable: true
    title: "Jpgファイルに透かしを素早く追加する"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** あなたの文書に透かしを追加する強力なPythonライブラリです。
      
      1. **メインクラス: Watermarker.** 最初に、**Watermarker**オブジェクトを作成します。Jpgファイルをファイルパスまたはストリームとして渡して開始します。
...
more_formats:
    enable: true
    title: "PythonによるJPGへの透かし"
    exclude: "JPG"
    description: "Pythonを使って、JPG画像に可視または隠れた透かしを追加し、セキュアで認識可能なコンテンツを提供します。"
    items: 
        # format loop 1
        - name: "ウォーターマーク PDF"
          format: "PDF"
