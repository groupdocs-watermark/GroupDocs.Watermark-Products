...
############################# Head ############################
head_title: "Marcação d'Água Python para Imagens JPG"
head_description: "Adicione marcas d'água a imagens JPG em Python para proteger suas fotos digitais."

############################# Header ############################
title: "Proteja Imagens JPG com Python" 
description: "Use Python para adicionar marcas d'água fortes a imagens JPG—ideal para direitos autorais e propriedade."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET permite que você adicione marcas d'água a imagens JPG em Python. Coloque texto, logotipos ou gráficos em qualquer lugar na sua imagem e ajuste sua aparência para atender a suas necessidades. Proteja suas fotos para uso pessoal ou empresarial com GroupDocs.Watermark, e mantenha suas imagens seguras contra cópias.

############################# Steps ############################
steps:
    enable: true
    title: "Adicione Marcas d'Água a Arquivos Jpg Rapidamente"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Uma poderosa biblioteca Python que permite adicionar marcas d'água aos seus documentos.
      ...
      1. **Classe Principal: Watermarker.** Comece criando um objeto **Watermarker**. Forneça o seu arquivo Jpg como um caminho de arquivo ou um stream para começar.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Adicione uma marca d'água de imagem a um arquivo JPG
        ...
        with gw.Watermarker("input.jpg") as watermarker:
            ...
            # Salve o arquivo JPG com a marca d'água
...
more_formats:
    enable: true
    title: "Adicione Marcas d'Água a JPG com Python"
    exclude: "JPG"
    description: "Use Python para adicionar marcas d'água visíveis ou ocultas a imagens JPG para conteúdo seguro e reconhecível."
    items: 
        # format loop 1
