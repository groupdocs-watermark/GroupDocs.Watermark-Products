...
############################# Head ############################
head_title: "Wasserzeichen für DOC-Dateien mit Python"
head_description: "Fügen Sie Wasserzeichen zu DOC-Dateien in Python hinzu, um Ihre Word-Dokumente sicher und organisiert zu halten."

############################# Header ############################
title: "Schützen Sie DOC mit Python-Wasserzeichen" 
description: "Verwenden Sie Python, um sichere Wasserzeichen zu DOC-Dateien hinzuzufügen – ideal für rechtliche, geschäftliche und vertrauliche Word-Dokumente."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET ermöglicht es Ihnen, Wasserzeichen zu DOC-Dateien in Python hinzuzufügen. Fügen Sie Text- oder Bildwasserzeichen hinzu, passen Sie deren Opazität, Farbe und Position an und fügen Sie Details wie Daten, Logos oder vertrauliche Stempel hinzu. Dieses Tool eignet sich hervorragend für rechtliche, geschäftliche und sensible Dokumente und funktioniert reibungslos in Python-Umgebungen. GroupDocs.Watermark ist eine zuverlässige Möglichkeit, Ihre Word-Dateien sicher und authentisch zu halten.

############################# Steps ############################
steps:
    enable: true
    title: "Wasserzeichen schnell zu Doc-Dateien hinzufügen"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Eine leistungsstarke Python-Bibliothek, die es Ihnen ermöglicht, Wasserzeichen zu Ihren Dokumenten hinzuzufügen.
      ...
      1. **Hauptklasse: Watermarker.** Beginnen Sie mit der Erstellung eines **Watermarker**-Objekts. Geben Sie Ihre Doc-Datei entweder als Dateipfad oder Stream an, um zu beginnen.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Fügen Sie ein Bildwasserzeichen zu einer DOC-Datei hinzu
        ...
        with gw.Watermarker("input.doc") as watermarker:
            ...
            # Speichern Sie die DOC-Datei mit dem Wasserzeichen
...
more_formats:
    enable: true
    title: "Python Wasserzeichen für Word-Dateien"
    exclude: "DOC"
    description: "Verwenden Sie Python, um benutzerdefinierte Wasserzeichen zu DOC-Dateien hinzuzufügen, damit Sie Ihre Word-Dokumente schützen und überprüfen können."
    items: 
        # format loop 1
