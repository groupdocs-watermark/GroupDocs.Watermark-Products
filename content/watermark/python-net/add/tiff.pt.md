...
############################# Head ############################
head_title: "Adicione Marcas d'Água a TIFF com Python"
head_description: "Crie e adicione marcas d'água a imagens TIFF em Python para proteger seus arquivos digitais."

############################# Header ############################
title: "Crie Marcas d'Água para TIFF com Python" 
description: "Adicione marcas d'água fortes e personalizadas a arquivos TIFF em Python—ideal para arquivos digitais e fotógrafos."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET é um kit de ferramentas Python para adicionar marcas d'água a arquivos TIFF. Escolha marcas de texto ou imagem, defina sua opacidade, tamanho e posição e mantenha suas imagens seguras. Com recursos como sobreposição de marcas d'água e formatação inteligente, GroupDocs.Watermark é indispensável para quem precisa proteger suas coleções de imagens.

############################# Steps ############################
steps:
    enable: true
    title: "Adicione Marcas d'Água a Arquivos Tiff Rapidamente"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Uma poderosa biblioteca Python que permite adicionar marcas d'água aos seus documentos.
      ...
      1. **Classe Principal: Watermarker.** Comece criando um objeto **Watermarker**. Forneça o seu arquivo Tiff como um caminho de arquivo ou um stream para começar.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Adicione uma marca d'água de imagem a um arquivo TIFF
        ...
        with gw.Watermarker("input.tiff") as watermarker:
            ...
            # Salve o arquivo TIFF com a marca d'água
...
more_formats:
    enable: true
    title: "Proteja Imagens TIFF com Marcas d'Água Python"
    exclude: "TIFF"
    description: "Adicione e gerencie marcas d'água em arquivos TIFF em Python para manter suas imagens seguras e sob seu controle."
    items: 
        # format loop 1
