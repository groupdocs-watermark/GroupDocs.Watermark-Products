...
############################# Head ############################
head_title: "Python로 PPTX에 워터마크 추가하기"
head_description: "Python에서 PPTX 프레젠테이션에 워터마크를 추가하여 보호하세요."

############################# Header ############################
title: "Python의 PPTX에 대한 고급 워터마킹" 
description: "Python를 사용하여 PPTX 파일에 강력한 워터마크를 추가하세요. 비즈니스와 교육에 적합합니다."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET은 PPTX 파일에 워터마크를 추가하기 위한 완전한 Python 솔루션입니다. 워터마크로 텍스트, 로고 또는 그래픽을 추가하고 투명도, 크기 및 위치를 조정하세요. 프레젠테이션을 보호해야 하는 누구에게나 적합하며, GroupDocs.Watermark은 슬라이드를 안전하고 보기 좋게 유지합니다.

############################# Steps ############################
steps:
    enable: true
    title: "Pptx 파일에 워터마크 빠르게 추가하기"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** 문서에 워터마크를 추가할 수 있는 강력한 Python 라이브러리입니다.
      ...
      1. **주 클래스: Watermarker.** 먼저 **Watermarker** 객체를 생성합니다. 시작하려면 Pptx 파일을 파일 경로나 스트림으로 전달하세요.
...
more_formats:
    enable: true
    title: "Python의 PPTX 파일에 워터마크 추가하기"
    exclude: "PPTX"
    description: "Python를 사용하여 PPTX 파일에 워터마크를 추가하여 프레젠테이션을 공유하거나 복사하는 것을 방지하세요."
    items: 
        # format loop 1
        - name: "워터마크 PDF"
          format: "PDF"
