...
############################# Head ############################
head_title: "Python 为 PowerPoint 文件添加水印"
head_description: "在 Python 中向 PowerPoint 文件添加动态水印，以保护您的演示文稿。"

############################# Header ############################
title: "使用 Python 水印保护 PPT" 
description: "使用 Python 为 PowerPoint 演示文稿添加自定义水印——非常适合商业和教育。"
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET 使您能够在 Python 中为 PowerPoint (PPT) 文件添加水印。向幻灯片添加可见或隐形的标记，自定义其样式、大小和颜色。非常适合在商业或学校环境中保护您的演示文稿，GroupDocs.Watermark 兼容所有主要的 Python 版本。

############################# Steps ############################
steps:
    enable: true
    title: "快速向 Ppt 文件添加水印"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** 一个强大的 Python 库，可以帮助您轻松向文档添加水印。
      
      1. **主要类：Watermarker.** 首先创建一个 **Watermarker** 对象。将您的 Ppt 文件作为文件路径或流传递给它，以便开始。
...
more_formats:
    enable: true
    title: "使用 Python 水印保护 PPT 文件"
    exclude: "PPT"
    description: "在 Python 中为 PowerPoint 文件添加高级水印，以防止滥用并保护您的内容。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
