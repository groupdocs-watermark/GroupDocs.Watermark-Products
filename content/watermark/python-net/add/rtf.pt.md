...
############################# Head ############################
head_title: "Marcação d'Água Python para Documentos RTF"
head_description: "Adicione marcas d'água a arquivos RTF em Python para manter seus documentos do Word seguros."

############################# Header ############################
title: "Proteja RTF com Marcas d'Água Python" 
description: "Use Python para adicionar marcas d'água seguras e personalizadas a arquivos RTF—ótimo para documentos do Word sensíveis."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET oferece ferramentas avançadas para adicionar marcas d'água a documentos RTF em Python. Use marcas visíveis ou transparentes e ajuste sua fonte, cor, tamanho e posição. Perfeito para arquivos legais, empresariais ou confidenciais, GroupDocs.Watermark ajuda a prevenir cópias e edições.

############################# Steps ############################
steps:
    enable: true
    title: "Adicione Marcas d'Água a Arquivos Rtf Rapidamente"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Uma poderosa biblioteca Python que permite adicionar marcas d'água aos seus documentos.
      ...
      1. **Classe Principal: Watermarker.** Comece criando um objeto **Watermarker**. Forneça o seu arquivo Rtf como um caminho de arquivo ou um stream para começar.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Adicione uma marca d'água de imagem a um arquivo RTF
        ...
        with gw.Watermarker("input.rtf") as watermarker:
            ...
            # Salve o arquivo RTF com a marca d'água
...
more_formats:
    enable: true
    title: "Adicione Marcas d'Água a RTF com Python"
    exclude: "RTF"
    description: "Use Python para adicionar marcas d'água fortes e sutis a arquivos RTF para melhor segurança de documentos."
    items: 
        # format loop 1
