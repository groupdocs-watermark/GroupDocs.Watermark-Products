...
############################# Head ############################
head_title: "Add Watermarks to WEBP with Python"
head_description: "Use Python to add watermarks to WEBP images for strong protection."

############################# Header ############################
title: "Create Watermarks for WEBP with Python" 
description: "Add custom watermarks to WEBP files in Python—great for artists and content creators."
...
steps:
    enable: true
    title: "Quickly Add Watermarks to Webp Files"
    content: |
...
more_formats:
    enable: true
    title: "Protect WEBP Images with Python Watermarks"
    exclude: "WEBP"
    description: "Add advanced, custom watermarks to WEBP images in Python to protect your creative work."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
