...
############################# Head ############################
head_title: "Marcas de Agua en Archivos DOC con Python"
head_description: "Añada marcas de agua a archivos DOC en Python para mantener sus documentos de Word seguros y organizados."

############################# Header ############################
title: "Proteja DOC con Marcas de Agua de Python" 
description: "Utilice Python para añadir marcas de agua seguras a archivos DOC—ideales para documentos legales, empresariales y confidenciales."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET le permite añadir marcas de agua a archivos DOC en Python. Inserte marcas de agua de texto o imagen, ajuste su opacidad, color y posición, e incluya detalles como fechas, logotipos o sellos de confidencialidad. Esta herramienta es perfecta para documentos legales, empresariales y sensibles, y funciona sin problemas en entornos Python. GroupDocs.Watermark es una forma confiable de mantener sus archivos de Word seguros y auténticos.

############################# Steps ############################
steps:
    enable: true
    title: "Añada Marcas de Agua a Archivos Doc Rápidamente"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Una poderosa biblioteca de Python que le permite añadir marcas de agua a sus documentos.
      ...
      1. **Clase Principal: Watermarker.** Comience creando un objeto **Watermarker**. Proporciónelo su archivo Doc, ya sea como un camino de archivo o como un flujo, para empezar.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Añadir una marca de agua de imagen a un archivo DOC
        ...
        with gw.Watermarker("input.doc") as watermarker:
            ...
            # Guarde el archivo DOC con la marca de agua
...
more_formats:
    enable: true
    title: "Marcas de Agua Python para Archivos de Word"
    exclude: "DOC"
    description: "Utilice Python para añadir marcas de agua personalizadas a archivos DOC, ayudándole a proteger y verificar sus documentos de Word."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
