...
############################# Head ############################
head_title: "Python 为 PDF 文档添加水印"
head_description: "在 Python 中为 PDF 文件添加水印，以保护您的重要文档。"

############################# Header ############################
title: "使用 Python 水印保护 PDF" 
description: "使用 Python 为 PDF 文件添加水印——非常适合法律、金融和官方文档。"
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET 是一个 Python API，用于向 PDF 文件添加水印。自定义您的水印文本、图像和位置，以适应任何文档。用于标记合同、报告或机密文件，保持您的 PDF 安全且专业。GroupDocs.Watermark 支持透明度、旋转和分层，适用于高级水印处理。

############################# Steps ############################
steps:
    enable: true
    title: "快速向 Pdf 文件添加水印"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** 一个强大的 Python 库，可以帮助您轻松向文档添加水印。
      
      1. **主要类：Watermarker.** 首先创建一个 **Watermarker** 对象。将您的 Pdf 文件作为文件路径或流传递给它，以便开始。
...
more_formats:
    enable: true
    title: "使用 Python 水印保护 PDF 文件"
    exclude: "PDF"
    description: "使用 Python 为 PDF 文件添加自定义水印，以保护您的敏感和官方文档。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
