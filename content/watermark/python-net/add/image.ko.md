...
############################# Head ############################
head_title: "Python로 이미지에 워터마크 추가"
head_description: "Python로 이미지에 워터마크를 추가하는 방법을 배우세요. 품질 손실 없이 사진을 보호하세요."

############################# Header ############################
title: "Python로 간편한 이미지 워터마킹" 
description: "우리의 Python 도구를 사용하여 이미지를 빠르게 워터마크합니다. 사진에서 디지털 아트까지 다양한 형식을 지원합니다."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET는 Python으로 이미지에 워터마크를 추가할 수 있게 해줍니다. JPEG, PNG, BMP, TIFF 등을 지원합니다. 필요에 따라 워터마크의 투명도, 크기 및 위치를 변경할 수 있습니다. 원본 품질을 유지하면서 이미지를 보호하거나 브랜드를 추가할 수 있습니다.
...
steps:
    ...
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/)**는 다양한 비즈니스 파일 형식에 워터마크를 추가하는 경우를 간편하게 만들어주는 라이브러리입니다. Python에서 문서에 워터마크를 빠르게 추가하려면 다음 단계를 따르십시오:
      ...
      1. **워터마킹 시작하기:** **Watermarker** 클래스의 인스턴스를 생성하는 것으로 시작합니다. 생성자에 워터마크를 추가할 Image 파일을 경로 또는 스트림으로 전달하여 엽니다.
...
more_formats:
    enable: true
    title: "Python으로 이미지에 워터마크 추가"
    exclude: "IMAGE"
    description: "우리의 Python 도구 키트를 사용하여 다양한 이미지 형식에 워터마크를 빠르고 쉽게 추가하세요."
    items: 
        # format loop 1
        - name: "워터마크 PDF"
          format: "PDF"
