...
############################# Head ############################
head_title: "Filigranage Python pour fichiers DOCX"
head_description: "Ajoutez des filigranes aux fichiers DOCX en Python pour garder vos documents Word sécurisés."

############################# Header ############################
title: "Sécurisez DOCX avec des filigranes Python" 
description: "Appliquez un filigranage avancé aux fichiers DOCX en Python—parfait pour protéger vos documents Word dans tous les secteurs."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET apporte un filigranage puissant aux fichiers DOCX. Ajoutez facilement des filigranes qui s'adaptent, se déplacent et se fondent dans votre document. Utilisez-le pour des fichiers légaux, commerciaux ou confidentiels, et choisissez parmi des filigranes textuels ou d'image avec un placement flexible. GroupDocs.Watermark prend en charge les dernières fonctionnalités Python pour une protection optimale des documents.

############################# Steps ############################
steps:
    enable: true
    title: "Ajoutez rapidement des filigranes aux fichiers Docx"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Une bibliothèque puissante Python qui vous permet d'ajouter des filigranes à vos documents.
      ...
      1. **Classe principale : Watermarker.** Commencez par créer un objet **Watermarker**. Donnez-lui votre fichier Docx, soit en tant que chemin de fichier soit en tant que flux, pour commencer.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ajoutez un filigrane image à un fichier DOCX
        ...
        with gw.Watermarker("input.docx") as watermarker:
            ...
            # Enregistrez le fichier DOCX avec le filigrane
...
more_formats:
    enable: true
    title: "Ajoutez des filigranes à DOCX avec Python"
    exclude: "DOCX"
    description: "Apprenez à ajouter des filigranes sécurisés et personnalisés aux fichiers DOCX en Python pour une meilleure sécurité des documents et un contrôle des droits d'auteur."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
