...
############################# Head ############################
head_title: "Add Watermarks to PPTX with Python"
head_description: "Protect your PPTX presentations by adding watermarks in Python."

############################# Header ############################
title: "Advanced Python Watermarking for PPTX" 
description: "Use Python to add strong watermarks to PPTX files—ideal for business and education."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET is a complete Python solution for watermarking PPTX files. Add text, logos, or graphics as watermarks, and adjust their transparency, size, and position. Great for anyone who needs to protect their presentations, GroupDocs.Watermark keeps your slides secure and looking good.

############################# Steps ############################
steps:
    enable: true
    title: "Quickly Add Watermarks to Pptx Files"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** A powerful Python library that lets you add watermarks to your documents with ease.
      ...
      1. **Main Class: Watermarker.** Start by creating a **Watermarker** object. Give it your Pptx file, either as a file path or a stream, to get started.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Add an image watermark to a PPTX file
        ...
        with gw.Watermarker("input.pptx") as watermarker:
            ...
            # Save the PPTX file with the watermark
...
more_formats:
    enable: true
    title: "Python Watermarking for PPTX Files"
    exclude: "PPTX"
    description: "Add watermarks to PPTX files in Python to keep your presentations safe from sharing or copying."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
