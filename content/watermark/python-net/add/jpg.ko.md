...
############################# Head ############################
head_title: "Python의 JPG 이미지 워터마킹"
head_description: "Python로 JPG 이미지에 워터마크를 추가하여 디지털 사진을 보호하세요."

############################# Header ############################
title: "Python를 사용한 JPG 이미지 보호" 
description: "Python를 사용하여 JPG 이미지에 강력한 워터마크를 추가하세요. 저작권 및 소유권 보호에 이상적입니다."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET를 사용하면 Python에서 JPG 이미지에 워터마크를 추가할 수 있습니다. 이미지의 어느 위치에든 텍스트, 로고 또는 그래픽을 배치하고 필요에 맞게 모양을 조정하세요. 개인적 또는 비즈니스 용도로 사진을 보호하는 데 적합한 GroupDocs.Watermark을 사용하여 이미지를 안전하게 유지하세요.

############################# Steps ############################
steps:
    enable: true
    title: "Jpg 파일에 워터마크 빠르게 추가하기"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** 문서에 워터마크를 추가할 수 있는 강력한 Python 라이브러리입니다.
      ...
      1. **주 클래스: Watermarker.** 먼저 **Watermarker** 객체를 생성합니다. 시작하려면 Jpg 파일을 파일 경로나 스트림으로 전달하세요.
...
more_formats:
    enable: true
    title: "Python로 JPG에 워터마크 추가하기"
    exclude: "JPG"
    description: "Python를 사용하여 JPG 이미지에 가시적 또는 숨겨진 워터마크를 추가하여 안전하고 인지 가능한 콘텐츠를 생성하세요."
    items: 
        # format loop 1
        - name: "워터마크 PDF"
          format: "PDF"
