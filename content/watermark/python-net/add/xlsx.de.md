...
############################# Head ############################
head_title: "Fügen Sie Wasserzeichen zu XLSX mit Python hinzu"
head_description: "Verwenden Sie Python, um Wasserzeichen zu XLSX-Dateien hinzuzufügen und Ihre Excel-Dokumente zu schützen."

############################# Header ############################
title: "Schützen Sie XLSX-Tabellen mit Python" 
description: "Fügen Sie benutzerdefinierte Wasserzeichen zu XLSX-Dateien in Python hinzu - perfekt für geschäftliche und sensible Daten."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET ist eine Python-Lösung zum Hinzufügen und Verwalten von Wasserzeichen in XLSX-Dateien. Fügen Sie Text- oder Bildwasserzeichen hinzu, automatisieren Sie das Wasserzeichnen basierend auf Dateieigenschaften und halten Sie Ihre Excel-Dokumente sicher und professionell. GroupDocs.Watermark unterstützt alle modernen Python-Funktionen.

############################# Steps ############################
steps:
    enable: true
    title: "Wasserzeichen schnell zu Xlsx-Dateien hinzufügen"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Eine leistungsstarke Python-Bibliothek, die es Ihnen ermöglicht, Wasserzeichen zu Ihren Dokumenten hinzuzufügen.
      ...
      1. **Hauptklasse: Watermarker.** Beginnen Sie mit der Erstellung eines **Watermarker**-Objekts. Geben Sie Ihre Xlsx-Datei entweder als Dateipfad oder Stream an, um zu beginnen.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Fügen Sie ein Bildwasserzeichen zu einer XLSX-Datei hinzu
        ...
        with gw.Watermarker("input.xlsx") as watermarker:
            ...
            # Speichern Sie die XLSX-Datei mit dem Wasserzeichen
...
more_formats:
    enable: true
    title: "Fügen Sie Wasserzeichen zu XLSX mit Python hinzu"
    exclude: "XLSX"
    description: "Verwenden Sie Python, um sichere, fortschrittliche Wasserzeichen zu XLSX-Dateien hinzuzufügen und Ihre Excel-Daten zu schützen."
    items: 
        # format loop 1
