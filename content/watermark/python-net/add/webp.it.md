...
############################# Head ############################
head_title: "Aggiungi watermark a WEBP con Python"
head_description: "Usa Python per aggiungere watermark a immagini WEBP per una forte protezione."

############################# Header ############################
title: "Crea watermark per WEBP con Python" 
description: "Aggiungi watermark personalizzati a file WEBP in Python—ottimo per artisti e creatori di contenuti."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET ti consente di aggiungere watermark a immagini WEBP in Python. Usa testo, loghi o firme digitali e regola il loro aspetto in base alle tue esigenze. Perfetto per chiunque condivida immagini online, GroupDocs.Watermark mantiene il tuo lavoro al sicuro e dall'aspetto professionale.

############################# Steps ############################
steps:
    enable: true
    title: "Aggiungi rapidamente watermark ai file Webp"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Una potente libreria Python che ti consente di aggiungere watermark ai tuoi documenti.
      ...
      1. **Classe principale: Watermarker.** Inizia creando un oggetto **Watermarker**. Fornisci il tuo file Webp, sia come percorso di file che come stream.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Aggiungi un watermark immagine a un file WEBP
        ...
        with gw.Watermarker("input.webp") as watermarker:
            ...
            # Salva il file WEBP con il watermark
...
more_formats:
    enable: true
    title: "Proteggi le immagini WEBP con watermark Python"
    exclude: "WEBP"
    description: "Aggiungi watermark avanzati e personalizzati a immagini WEBP in Python per proteggere il tuo lavoro creativo."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
