...
############################# Head ############################
head_title: "Proteja Imagens JPEG com Marcas d'Água Python"
head_description: "Adicione marcas d'água a imagens JPEG em Python para manter suas fotos seguras."

############################# Header ############################
title: "Marcação d'Água Avançada Python para JPEG" 
description: "Use Python para adicionar marcas d'água flexíveis e seguras a imagens JPEG—perfeito para artistas e fotógrafos."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET fornece as ferramentas para marcar imagens JPEG em Python. Adicione texto, logotipos ou padrões, e ajuste a aparência para que sua marca d'água se encaixe bem. Ótimo para quem precisa proteger suas imagens online, GroupDocs.Watermark mantém seu trabalho seguro sem comprometer a qualidade da imagem.

############################# Steps ############################
steps:
    enable: true
    title: "Adicione Marcas d'Água a Arquivos Jpeg Rapidamente"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Uma poderosa biblioteca Python que permite adicionar marcas d'água aos seus documentos.
      ...
      1. **Classe Principal: Watermarker.** Comece criando um objeto **Watermarker**. Forneça o seu arquivo Jpeg como um caminho de arquivo ou um stream para começar.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Adicione uma marca d'água de imagem a um arquivo JPEG
        ...
        with gw.Watermarker("input.jpeg") as watermarker:
            ...
            # Salve o arquivo JPEG com a marca d'água
...
more_formats:
    enable: true
    title: "Marcação d'Água Python para Imagens JPEG"
    exclude: "JPEG"
    description: "Adicione e gerencie marcas d'água em imagens JPEG com Python para proteger seu conteúdo digital."
    items: 
        # format loop 1
