...
############################# Head ############################
head_title: "Fügen Sie Wasserzeichen zu TIFF mit Python hinzu"
head_description: "Erstellen und fügen Sie Wasserzeichen zu TIFF-Bildern in Python hinzu, um Ihre digitalen Dateien zu schützen."

############################# Header ############################
title: "Wasserzeichen für TIFF mit Python erstellen" 
description: "Fügen Sie starke, benutzerdefinierte Wasserzeichen zu TIFF-Dateien in Python hinzu - ideal für digitale Archive und Fotografen."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET ist ein Python-Toolkit zum Hinzufügen von Wasserzeichen zu TIFF-Dateien. Wählen Sie Text- oder Bildwasserzeichen, stellen Sie deren Opazität, Größe und Position ein und halten Sie Ihre Bilder sicher. Mit Funktionen wie Wasserzeichen-Schichtung und intelligenter Formatierung ist GroupDocs.Watermark ein Muss für jeden, der seine Sammlungen schützen muss.

############################# Steps ############################
steps:
    enable: true
    title: "Wasserzeichen schnell zu Tiff-Dateien hinzufügen"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Eine leistungsstarke Python-Bibliothek, die es Ihnen ermöglicht, Wasserzeichen zu Ihren Dokumenten hinzuzufügen.
      ...
      1. **Hauptklasse: Watermarker.** Beginnen Sie mit der Erstellung eines **Watermarker**-Objekts. Geben Sie Ihre Tiff-Datei entweder als Dateipfad oder Stream an, um zu beginnen.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Fügen Sie ein Bildwasserzeichen zu einer TIFF-Datei hinzu
        ...
        with gw.Watermarker("input.tiff") as watermarker:
            ...
            # Speichern Sie die TIFF-Datei mit dem Wasserzeichen
...
more_formats:
    enable: true
    title: "Sichern Sie TIFF-Bilder mit Python-Wasserzeichen"
    exclude: "TIFF"
    description: "Fügen Sie Wasserzeichen in TIFF-Dateien mit Python hinzu, um Ihre Bilder sicher zu halten und unter Ihrer Kontrolle zu behalten."
    items: 
        # format loop 1
