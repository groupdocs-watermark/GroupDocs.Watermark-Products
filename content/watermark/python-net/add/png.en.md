...
############################# Head ############################
head_title: "Protect PNG with Python Watermarks"
head_description: "Add watermarks to PNG images in Python for copyright and security."

############################# Header ############################
title: "Python Watermarking for PNG Images" 
description: "Use Python to add advanced watermarks to PNG images—great for artists and designers."
...
about:
    ...
    content: |
       GroupDocs.Watermark is a Python toolkit for adding watermarks to PNG images. Add transparent or solid watermarks, position them anywhere, and keep your images safe from copying. With GroupDocs.Watermark, you can use text or images as watermarks and control their look for personal or professional projects.

############################# Steps ############################
steps:
    enable: true
    title: "Quickly Add Watermarks to Png Files"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** A powerful Python library that lets you add watermarks to your documents with ease.
      ...
      1. **Main Class: Watermarker.** Start by creating a **Watermarker** object. Give it your Png file, either as a file path or a stream, to get started.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Add an image watermark to a PNG file
        ...
        with gw.Watermarker("input.png") as watermarker:
            ...
            # Save the PNG file with the watermark
...
more_formats:
    enable: true
    title: "Add Watermarks to PNG with Python"
    exclude: "PNG"
    description: "Use Python to add subtle or bold watermarks to PNG images for flexible copyright protection."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
