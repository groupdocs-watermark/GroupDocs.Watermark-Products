...
############################# Head ############################
head_title: "Python Wasserzeichen für PDF-Dokumente"
head_description: "Fügen Sie Wasserzeichen zu PDF-Dateien in Python hinzu, um Ihre wichtigen Dokumente zu schützen."

############################# Header ############################
title: "Schützen Sie PDF mit Python-Wasserzeichen" 
description: "Verwenden Sie Python, um Wasserzeichen zu PDF-Dateien hinzuzufügen - ideal für rechtliche, finanzielle und offizielle Dokumente."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET ist eine Python-API zum Hinzufügen von Wasserzeichen zu PDF-Dateien. Passen Sie den Text, die Bilder und die Platzierung Ihres Wasserzeichens an, um jedem Dokument gerecht zu werden. Verwenden Sie es, um Verträge, Berichte oder vertrauliche Dateien zu kennzeichnen und Ihre PDFs sicher und professionell zu halten. GroupDocs.Watermark unterstützt Transparenz, Drehung und Schichtung für fortgeschrittenes Wasserzeichen.

############################# Steps ############################
steps:
    enable: true
    title: "Wasserzeichen schnell zu Pdf-Dateien hinzufügen"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Eine leistungsstarke Python-Bibliothek, die es Ihnen ermöglicht, Wasserzeichen zu Ihren Dokumenten hinzuzufügen.
      ...
      1. **Hauptklasse: Watermarker.** Beginnen Sie mit der Erstellung eines **Watermarker**-Objekts. Geben Sie Ihre Pdf-Datei entweder als Dateipfad oder Stream an, um zu beginnen.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Fügen Sie ein Bildwasserzeichen zu einer PDF-Datei hinzu
        ...
        with gw.Watermarker("input.pdf") as watermarker:
            ...
            # Speichern Sie die PDF-Datei mit dem Wasserzeichen
...
more_formats:
    enable: true
    title: "Sichern Sie PDF-Dateien mit Python-Wasserzeichen"
    exclude: "PDF"
    description: "Fügen Sie benutzerdefinierte Wasserzeichen zu PDF-Dateien in Python hinzu, um Ihre sensiblen und offiziellen Dokumente zu schützen."
    items: 
        # format loop 1
