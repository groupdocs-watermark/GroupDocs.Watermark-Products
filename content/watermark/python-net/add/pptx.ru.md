...
############################# Head ############################
head_title: "Добавьте водяные знаки к PPTX с помощью Python"
head_description: "Защитите свои презентации PPTX, добавляя водяные знаки в Python."

############################# Header ############################
title: "Продвинутое добавление водяных знаков Python для PPTX" 
description: "Используйте Python для добавления надежных водяных знаков к файлам PPTX—идеально подходит для бизнеса и образования."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET — это полное решение на Python для добавления водяных знаков к файлам PPTX. Добавляйте текст, логотипы или графику в качестве водяных знаков и настраивайте их непрозрачность, размер и положение. Отлично подходит для защиты ваших презентаций, GroupDocs.Watermark сохраняет ваши слайды в безопасности и в ухоженном виде.

############################# Steps ############################
steps:
    enable: true
    title: "Быстро добавьте водяные знаки в файлы Pptx"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Мощная библиотека Python для добавления водяных знаков в ваши документы.
      ...
      1. **Основной класс: Watermarker.** Начните с создания объекта **Watermarker**. Передайте в него ваш файл Pptx, либо в виде пути, либо в виде потока, чтобы приступить к работе.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Добавьте изображение-подпись в файл PPTX
        ...
        with gw.Watermarker("input.pptx") as watermarker:
            ...
            # Сохраните файл PPTX с подписью
...
more_formats:
    enable: true
    title: "Python Водяные знаки для файлов PPTX"
    exclude: "PPTX"
    description: "Добавляйте водяные знаки к файлам PPTX в Python, чтобы сохранить ваши презентации в безопасности от распространения или копирования."
    items: 
        # format loop 1
