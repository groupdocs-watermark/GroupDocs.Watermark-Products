...
############################# Head ############################
head_title: "Filigranes Python pour les fichiers PowerPoint"
head_description: "Ajoutez des filigranes dynamiques aux fichiers PowerPoint en Python pour garder vos présentations sécurisées."

############################# Header ############################
title: "Protégez PPT avec des filigranes Python" 
description: "Utilisez Python pour ajouter des filigranes personnalisés aux présentations PowerPoint—idéal pour les affaires et l'éducation."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET vous permet d'ajouter des filigranes aux fichiers PowerPoint (PPT) en Python. Ajoutez des marques visibles ou invisibles à vos diapositives, et personnalisez leur style, taille et couleur. Parfait pour garder vos présentations sécurisées dans un contexte professionnel ou scolaire, GroupDocs.Watermark fonctionne avec toutes les principales versions de Python.

############################# Steps ############################
steps:
    enable: true
    title: "Ajoutez rapidement des filigranes aux fichiers Ppt"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Une bibliothèque puissante Python qui vous permet d'ajouter des filigranes à vos documents.
      ...
      1. **Classe principale : Watermarker.** Commencez par créer un objet **Watermarker**. Donnez-lui votre fichier Ppt, soit en tant que chemin de fichier soit en tant que flux, pour commencer.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ajoutez un filigrane image à un fichier PPT
        ...
        with gw.Watermarker("input.ppt") as watermarker:
            ...
            # Enregistrez le fichier PPT avec le filigrane
...
more_formats:
    enable: true
    title: "Sécurisez les fichiers PPT avec des filigranes Python"
    exclude: "PPT"
    description: "Ajoutez des filigranes avancés aux fichiers PowerPoint en Python pour empêcher les abus et protéger votre contenu."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
