...
############################# Head ############################
head_title: "Python 为 JPG 图像添加水印"
head_description: "使用 Python 为 JPG 图像添加水印，以保护您的数字照片。"

############################# Header ############################
title: "使用 Python 保护 JPG 图像" 
description: "使用 Python 为 JPG 图像添加强大的水印——非常适合版权和所有权。"
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET 使您能够在 Python 中为 JPG 图像添加水印。将文本、徽标或图形放置在图像上的任何地方，并根据需要调整其外观。使用 GroupDocs.Watermark 保护您的个人或商业照片，并保持图像不被复制。

############################# Steps ############################
steps:
    enable: true
    title: "快速向 Jpg 文件添加水印"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** 一个强大的 Python 库，可以帮助您轻松向文档添加水印。
      
      1. **主要类：Watermarker.** 首先创建一个 **Watermarker** 对象。将您的 Jpg 文件作为文件路径或流传递给它，以便开始。
...
more_formats:
    enable: true
    title: "使用 Python 为 JPG 添加水印"
    exclude: "JPG"
    description: "使用 Python 为 JPG 图像添加可见或隐形的水印，以保护安全且易于识别的内容。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
