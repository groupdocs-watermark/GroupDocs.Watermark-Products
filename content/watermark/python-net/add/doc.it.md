...
############################# Head ############################
head_title: "Watermark per file DOC con Python"
head_description: "Aggiungi watermark a file DOC in Python per mantenere i tuoi documenti Word sicuri e organizzati."

############################# Header ############################
title: "Proteggi DOC con watermark Python" 
description: "Usa Python per aggiungere watermark sicuri a file DOC—ideale per documenti Word legali, aziendali e confidenziali."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET ti consente di aggiungere watermark a file DOC in Python. Inserisci watermark di testo o immagine, regola la loro opacità, colore e posizione, e includi dettagli come date, loghi o timbri confidenziali. Questo strumento è perfetto per documenti legali, aziendali e sensibili, e funziona senza problemi negli ambienti Python. GroupDocs.Watermark è un modo affidabile per mantenere i tuoi file Word sicuri e autentici.

############################# Steps ############################
steps:
    enable: true
    title: "Aggiungi rapidamente watermark ai file Doc"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Una potente libreria Python che ti consente di aggiungere watermark ai tuoi documenti.
      ...
      1. **Classe principale: Watermarker.** Inizia creando un oggetto **Watermarker**. Fornisci il tuo file Doc, sia come percorso di file che come stream.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Aggiungi un watermark immagine a un file DOC
        ...
        with gw.Watermarker("input.doc") as watermarker:
            ...
            # Salva il file DOC con il watermark
...
more_formats:
    enable: true
    title: "Watermark Python per file Word"
    exclude: "DOC"
    description: "Usa Python per aggiungere watermark personalizzati a file DOC, aiutandoti a proteggere e verificare i tuoi documenti Word."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
