...
############################# Head ############################
head_title: "Python로 WEBP에 워터마크 추가하기"
head_description: "Python를 사용하여 WEBP 이미지에 워터마크를 추가하여 강력한 보호를 제공합니다."

############################# Header ############################
title: "Python로 WEBP를 위한 워터마크 생성하기" 
description: "Python를 사용하여 WEBP 파일에 사용자 정의 워터마크를 추가하세요. 아티스트와 콘텐츠 제작자에게 적합합니다."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET를 사용하면 Python에서 WEBP 이미지에 워터마크를 추가할 수 있습니다. 텍스트, 로고 또는 디지털 서명을 사용하고, 필요에 맞게 모양을 조정하세요. 온라인에서 이미지를 공유하는 모든 사람에게 적합하며, GroupDocs.Watermark은 작업을 안전하게 유지하면서도 매력적으로 만들 수 있습니다.

############################# Steps ############################
steps:
    enable: true
    title: "Webp 파일에 워터마크 빠르게 추가하기"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** 문서에 워터마크를 추가할 수 있는 강력한 Python 라이브러리입니다.
      ...
      1. **주 클래스: Watermarker.** 먼저 **Watermarker** 객체를 생성합니다. 시작하려면 Webp 파일을 파일 경로나 스트림으로 전달하세요.
...
more_formats:
    enable: true
    title: "Python로 WEBP 이미지 보호를 위한 워터마크"
    exclude: "WEBP"
    description: "Python에서 WEBP 이미지에 고급 워터마크를 추가하여 창작 작업을 보호하세요."
    items: 
        # format loop 1
        - name: "워터마크 PDF"
          format: "PDF"
