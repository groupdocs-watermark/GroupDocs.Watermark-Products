...
############################# Head ############################
head_title: "Aggiungi watermark a XLSX con Python"
head_description: "Usa Python per aggiungere watermark a file XLSX e proteggere i tuoi documenti Excel."

############################# Header ############################
title: "Proteggi fogli XLSX con watermark Python" 
description: "Aggiungi watermark personalizzati a file XLSX in Python—perfetto per dati aziendali e sensibili."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET è una soluzione Python per aggiungere e gestire watermark in file XLSX. Aggiungi watermark di testo o immagine, automatizza il watermarking in base alle proprietà del file e mantieni i tuoi documenti Excel sicuri e professionali. GroupDocs.Watermark supporta tutte le funzionalità moderne Python.

############################# Steps ############################
steps:
    enable: true
    title: "Aggiungi rapidamente watermark ai file Xlsx"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Una potente libreria Python che ti consente di aggiungere watermark ai tuoi documenti.
      ...
      1. **Classe principale: Watermarker.** Inizia creando un oggetto **Watermarker**. Fornisci il tuo file Xlsx, sia come percorso di file che come stream.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Aggiungi un watermark immagine a un file XLSX
        ...
        with gw.Watermarker("input.xlsx") as watermarker:
            ...
            # Salva il file XLSX con il watermark
...
more_formats:
    enable: true
    title: "Aggiungi watermark a XLSX con Python"
    exclude: "XLSX"
    description: "Usa Python per aggiungere watermark sicuri e avanzati a file XLSX e proteggere i tuoi dati Excel."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
