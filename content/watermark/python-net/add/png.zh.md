...
############################# Head ############################
head_title: "使用 Python 水印保护 PNG"
head_description: "在 Python 中为 PNG 图像添加水印，以保护版权和安全。"

############################# Header ############################
title: "Python 为 PNG 图像添加水印" 
description: "使用 Python 为 PNG 图像添加高级水印——非常适合艺术家和设计师。"
...
about:
    ...
    content: |
       GroupDocs.Watermark 是一个 Python 工具包，用于向 PNG 图像添加水印。添加透明或实心水印，将其放置在任意位置，保持图像安全，防止复制。借助 GroupDocs.Watermark，您可以使用文本或图像作为水印，控制其外观，以便用于个人或专业项目。

############################# Steps ############################
steps:
    enable: true
    title: "快速向 Png 文件添加水印"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** 一个强大的 Python 库，可以帮助您轻松向文档添加水印。
      
      1. **主要类：Watermarker.** 首先创建一个 **Watermarker** 对象。将您的 Png 文件作为文件路径或流传递给它，以便开始。
...
more_formats:
    enable: true
    title: "使用 Python 为 PNG 添加水印"
    exclude: "PNG"
    description: "使用 Python 为 PNG 图像添加细腻或醒目的水印，以实现灵活的版权保护。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
