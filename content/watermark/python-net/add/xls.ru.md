...
############################# Head ############################
head_title: "Добавление водяных знаков к XLS с Python"
head_description: "Используйте Python для добавления и управления водяными знаками в файлах XLS для повышения безопасности Excel."

############################# Header ############################
title: "Создайте водяные знаки Python для файлов XLS" 
description: "Добавляйте водяные знаки к таблицам XLS в Python—отлично подходит для защиты финансовых и личных данных."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET позволяет добавлять водяные знаки к файлам XLS в Python. Используйте видимые или скрытые метки и настраивайте их внешний вид в соответствии с вашими потребностями. Отлично подходит для защиты финансовых данных или данных клиентов, GroupDocs.Watermark работает со всеми средами Python.

############################# Steps ############################
steps:
    enable: true
    title: "Быстро добавьте водяные знаки в файлы Xls"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Мощная библиотека Python для добавления водяных знаков в ваши документы.
      ...
      1. **Основной класс: Watermarker.** Начните с создания объекта **Watermarker**. Передайте в него ваш файл Xls, либо в виде пути, либо в виде потока, чтобы приступить к работе.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Добавьте изображение-подпись в файл XLS
...
more_formats:
    enable: true
    title: "Добавление водяных знаков к XLS с помощью Python"
    exclude: "XLS"
    description: "Используйте Python для добавления пользовательских водяных знаков к файлам XLS и защиты своих данных в Excel."
    items: 
        # format loop 1
