...
############################# Head ############################
head_title: "Додайте водяні знаки до XLS за допомогою Python"
head_description: "Використовуйте Python для додавання та керування водяними знаками в XLS файлах для кращої безпеки Excel."

############################# Header ############################
title: "Створіть водяні знаки Python для файлів XLS" 
description: "Додайте водяні знаки до XLS таблиць у Python — чудово для захисту фінансових або особистих даних."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET дозволяє вам додавати водяні знаки до XLS файлів у Python. Використовуйте видимі або приховані знаки, та налаштовуйте їх вигляд на ваш смак. Чудово підходить для захисту фінансових або клієнтських даних, GroupDocs.Watermark працює в усіх середовищах Python.

############################# Steps ############################
steps:
    enable: true
    title: "Швидко додайте водяні знаки до файлів Xls"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Потужна бібліотека Python для додавання водяних знаків до ваших документів.
      ...
      1. **Головний клас: Watermarker.** Почніть з створення об'єкта **Watermarker**. Задайте йому ваш файл Xls, або у вигляді шляху до файлу, або потоку, щоб розпочати.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Додайте водяний знак до файлу XLS
        ...
        with gw.Watermarker("input.xls") as watermarker:
            ...
            # Збережіть файл XLS з водяним знаком
...
more_formats:
    enable: true
    title: "Додайте водяні знаки до XLS за допомогою Python"
    exclude: "XLS"
    description: "Використовуйте Python для додавання користувацьких водяних знаків до XLS файлів, щоб зберегти ваші дані Excel в безпеці."
    items: 
        # format loop 1
