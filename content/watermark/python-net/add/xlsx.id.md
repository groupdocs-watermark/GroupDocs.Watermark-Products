...
############################# Head ############################
head_title: "Tambahkan Watermark ke XLSX dengan Python"
head_description: "Gunakan Python untuk menambahkan watermark ke file XLSX dan melindungi dokumen Excel Anda."

############################# Header ############################
title: "Lindungi Lembar XLSX dengan Watermark Python" 
description: "Tambahkan watermark kustom ke file XLSX dalam Python—sempurna untuk data bisnis dan sensitif."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET adalah solusi Python untuk menambahkan dan mengelola watermark di file XLSX. Tambahkan watermark teks atau gambar, otomatisasi watermark berdasarkan properti file, dan jaga dokumen Excel Anda tetap aman dan profesional. GroupDocs.Watermark mendukung semua fitur modern Python.

############################# Steps ############################
steps:
    enable: true
    title: "Tambahkan Watermark ke File Xlsx dengan Cepat"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Sebuah pustaka Python yang kuat yang memungkinkan Anda menambahkan watermark ke dokumen.
      ...
      1. **Kelas Utama: Watermarker.** Mulailah dengan membuat objek **Watermarker**. Berikan file Xlsx Anda, baik sebagai jalur file atau stream, untuk memulai.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Tambahkan watermark gambar ke file XLSX
        ...
        with gw.Watermarker("input.xlsx") as watermarker:
            ...
            # Simpan file XLSX dengan watermark
...
more_formats:
    enable: true
    title: "Tambahkan Watermark ke XLSX dengan Python"
    exclude: "XLSX"
    description: "Gunakan Python untuk menambahkan watermark yang aman dan lanjutan ke file XLSX dan melindungi data Excel Anda."
    items: 
        # format loop 1
        - name: "Tanda air PDF"
          format: "PDF"
