...
############################# Head ############################
head_title: "Adicione Marcas d'Água a WEBP com Python"
head_description: "Use Python para adicionar marcas d'água a imagens WEBP para proteção forte."

############################# Header ############################
title: "Crie Marcas d'Água para WEBP com Python" 
description: "Adicione marcas d'água personalizadas a arquivos WEBP em Python—ótimo para artistas e criadores de conteúdo."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET permite que você adicione marcas d'água a imagens WEBP em Python. Use texto, logotipos ou assinaturas digitais e ajuste a aparência para atender às suas necessidades. Perfeito para quem compartilha imagens online, GroupDocs.Watermark mantém seu trabalho seguro e visualmente atraente.

############################# Steps ############################
steps:
    enable: true
    title: "Adicione Marcas d'Água a Arquivos Webp Rapidamente"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Uma poderosa biblioteca Python que permite adicionar marcas d'água aos seus documentos.
      ...
      1. **Classe Principal: Watermarker.** Comece criando um objeto **Watermarker**. Forneça o seu arquivo Webp como um caminho de arquivo ou um stream para começar.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Adicione uma marca d'água de imagem a um arquivo WEBP
        ...
        with gw.Watermarker("input.webp") as watermarker:
            ...
            # Salve o arquivo WEBP com a marca d'água
...
more_formats:
    enable: true
    title: "Proteja Imagens WEBP com Marcas d'Água Python"
    exclude: "WEBP"
    description: "Adicione marcas d'água avançadas e personalizadas a imagens WEBP em Python para proteger seu trabalho criativo."
    items: 
        # format loop 1
