...
############################# Head ############################
head_title: "Adicione Marcas d'Água a XLS com Python"
head_description: "Use Python para adicionar e gerenciar marcas d'água em arquivos XLS para melhor segurança no Excel."

############################# Header ############################
title: "Crie Marcas d'Água Python para Arquivos XLS" 
description: "Adicione marcas d'água a planilhas XLS em Python—ótimo para proteger dados financeiros e pessoais."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET permite que você adicione marcas d'água a arquivos XLS em Python. Use marcas visíveis ou ocultas e personalize sua aparência para atender às suas necessidades. Ótimo para manter dados financeiros ou de clientes seguros, GroupDocs.Watermark funciona com todos os ambientes Python.

############################# Steps ############################
steps:
    enable: true
    title: "Adicione Marcas d'Água a Arquivos Xls Rapidamente"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Uma poderosa biblioteca Python que permite adicionar marcas d'água aos seus documentos.
      ...
      1. **Classe Principal: Watermarker.** Comece criando um objeto **Watermarker**. Forneça o seu arquivo Xls como um caminho de arquivo ou um stream para começar.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Adicione uma marca d'água de imagem a um arquivo XLS
        ...
        with gw.Watermarker("input.xls") as watermarker:
            ...
            # Salve o arquivo XLS com a marca d'água
...
more_formats:
    enable: true
    title: "Adicione Marcas d'Água a XLS com Python"
    exclude: "XLS"
    description: "Use Python para adicionar marcas d'água personalizadas a arquivos XLS e manter seus dados do Excel seguros."
    items: 
        # format loop 1
