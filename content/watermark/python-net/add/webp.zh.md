...
############################# Head ############################
head_title: "使用 Python 为 WEBP 添加水印"
head_description: "使用 Python 向 WEBP 图像添加水印，以提供强有力的保护。"

############################# Header ############################
title: "为 WEBP 创建水印与 Python" 
description: "在 Python 中为 WEBP 文件添加自定义水印——非常适合艺术家和内容创作者。"
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET 让您在 Python 中为 WEBP 图像添加水印。使用文本、徽标或数字签名，并调整其外观以符合您的需求。非常适合任何在线分享图像的人，GroupDocs.Watermark 确保您的作品安全且外观出色。

############################# Steps ############################
steps:
    enable: true
    title: "快速向 Webp 文件添加水印"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** 一个强大的 Python 库，可以帮助您轻松向文档添加水印。
      
      1. **主要类：Watermarker.** 首先创建一个 **Watermarker** 对象。将您的 Webp 文件作为文件路径或流传递给它，以便开始。
...
more_formats:
    enable: true
    title: "使用 Python 水印保护 WEBP 图像"
    exclude: "WEBP"
    description: "在 Python 中为 WEBP 图像添加先进的自定义水印，以保护您的创意作品。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
