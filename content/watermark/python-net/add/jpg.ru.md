...
############################# Head ############################
head_title: "Водяные знаки Python для изображений JPG"
head_description: "Добавьте водяные знаки к изображениям JPG в Python, чтобы защитить свои цифровые фотографии."

############################# Header ############################
title: "Защитите изображения JPG с помощью Python" 
description: "Используйте Python для добавления надежных водяных знаков к изображениям JPG—идеально подходит для защиты авторских прав и собственности."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET позволяет добавлять водяные знаки к изображениям JPG в Python. Размещайте текст, логотипы или графику в любом месте изображения и настраивайте их внешний вид в соответствии с вашими потребностями. Защитите свои фотографии для личного или делового использования с помощью GroupDocs.Watermark и сохраняйте ваши изображения в безопасности от копирования.

############################# Steps ############################
steps:
    enable: true
    title: "Быстро добавьте водяные знаки в файлы Jpg"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Мощная библиотека Python для добавления водяных знаков в ваши документы.
      ...
      1. **Основной класс: Watermarker.** Начните с создания объекта **Watermarker**. Передайте в него ваш файл Jpg, либо в виде пути, либо в виде потока, чтобы приступить к работе.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Добавьте изображение-подпись в файл JPG
...
more_formats:
    enable: true
    title: "Добавление водяных знаков к JPG с помощью Python"
    exclude: "JPG"
    description: "Используйте Python для добавления видимых или скрытых водяных знаков к изображениям JPG для безопасного и узнаваемого контента."
    items: 
        # format loop 1
