...
############################# Head ############################
head_title: "Додайте водяні знаки до XLSX за допомогою Python"
head_description: "Використовуйте Python для додавання водяних знаків до XLSX файлів і захисту ваших документів Excel."

############################# Header ############################
title: "Захистіть XLSX таблиці з водяними знаками Python" 
description: "Додавайте користувацькі водяні знаки до XLSX файлів у Python — ідеально для бізнесу та чутливих даних."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET — це Python рішення для додавання та управління водяними знаками в XLSX файлах. Додавайте текстові або графічні водяні знаки, автоматизуйте водяні знаки на основі властивостей файлу та зберігайте ваші документи Excel в безпеці та професійному вигляді. GroupDocs.Watermark підтримує всі сучасні функції Python.

############################# Steps ############################
steps:
    enable: true
    title: "Швидко додайте водяні знаки до файлів Xlsx"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Потужна бібліотека Python для додавання водяних знаків до ваших документів.
      ...
      1. **Головний клас: Watermarker.** Почніть з створення об'єкта **Watermarker**. Задайте йому ваш файл Xlsx, або у вигляді шляху до файлу, або потоку, щоб розпочати.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Додайте водяний знак до файлу XLSX
        ...
        with gw.Watermarker("input.xlsx") as watermarker:
            ...
            # Збережіть файл XLSX з водяним знаком
...
more_formats:
    enable: true
    title: "Додайте водяні знаки до XLSX за допомогою Python"
    exclude: "XLSX"
    description: "Використовуйте Python для додавання надійних, розширених водяних знаків до XLSX файлів і захисту ваших даних Excel."
    items: 
        # format loop 1
