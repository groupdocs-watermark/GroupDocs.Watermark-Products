...
############################# Head ############################
head_title: "Protégez les images JPEG avec des filigranes Python"
head_description: "Ajoutez des filigranes aux images JPEG en Python pour garder vos images sécurisées."

############################# Header ############################
title: "Filigranage avancé Python pour JPEG" 
description: "Utilisez Python pour ajouter des filigranes flexibles et sécurisés aux images JPEG—parfait pour artistes et photographes."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET vous donne les outils pour appliquer un filigrane aux images JPEG en Python. Ajoutez du texte, des logos ou des motifs, et ajustez leur apparence pour que votre filigrane s'intègre parfaitement. Idéal pour quiconque doit protéger ses images en ligne, GroupDocs.Watermark garde votre travail en sécurité sans diminuer la qualité de l'image.

############################# Steps ############################
steps:
    enable: true
    title: "Ajoutez rapidement des filigranes aux fichiers Jpeg"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Une bibliothèque puissante Python qui vous permet d'ajouter des filigranes à vos documents.
      ...
      1. **Classe principale : Watermarker.** Commencez par créer un objet **Watermarker**. Donnez-lui votre fichier Jpeg, soit en tant que chemin de fichier soit en tant que flux, pour commencer.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ajoutez un filigrane image à un fichier JPEG
        ...
        with gw.Watermarker("input.jpeg") as watermarker:
            ...
            # Enregistrez le fichier JPEG avec le filigrane
...
more_formats:
    enable: true
    title: "Filigranage Python pour les images JPEG"
    exclude: "JPEG"
    description: "Ajoutez et gérez des filigranes dans des images JPEG avec Python pour protéger votre contenu numérique."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
