...
############################# Head ############################
head_title: "Python Filigranage pour les documents RTF"
head_description: "Ajoutez des filigranes aux fichiers RTF en Python pour garder vos documents Word sécurisés."

############################# Header ############################
title: "Protégez RTF avec des filigranes Python" 
description: "Utilisez Python pour ajouter des filigranes sécurisés et personnalisés aux fichiers RTF—parfait pour des documents Word sensibles."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET vous offre des outils avancés pour ajouter des filigranes aux documents RTF en Python. Utilisez des marques visibles ou transparentes, et ajustez leur police, couleur, taille et position. Parfait pour des fichiers légaux, commerciaux ou confidentiels, GroupDocs.Watermark aide à prévenir la copie et l'édition.

############################# Steps ############################
steps:
    enable: true
    title: "Ajoutez rapidement des filigranes aux fichiers Rtf"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Une bibliothèque puissante Python qui vous permet d'ajouter des filigranes à vos documents.
      ...
      1. **Classe principale : Watermarker.** Commencez par créer un objet **Watermarker**. Donnez-lui votre fichier Rtf, soit en tant que chemin de fichier soit en tant que flux, pour commencer.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ajoutez un filigrane image à un fichier RTF
        ...
        with gw.Watermarker("input.rtf") as watermarker:
            ...
            # Enregistrez le fichier RTF avec le filigrane
...
more_formats:
    enable: true
    title: "Ajoutez des filigranes à RTF avec Python"
    exclude: "RTF"
    description: "Utilisez Python pour ajouter des filigranes puissants et subtils aux fichiers RTF pour une meilleure sécurité documentaire."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
