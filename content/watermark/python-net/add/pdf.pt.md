...
############################# Head ############################
head_title: "Marcação d'Água Python para Documentos PDF"
head_description: "Adicione marcas d'água a arquivos PDF em Python para proteger seus documentos importantes."

############################# Header ############################
title: "Proteja PDF com Marcas d'Água Python" 
description: "Use Python para adicionar marcas d'água a arquivos PDF—ideal para documentos legais, financeiros e oficiais."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET é uma API Python para adicionar marcas d'água a arquivos PDF. Personalize o texto, imagens e posicionamento da sua marca d'água para se ajustar a qualquer documento. Use para marcar contratos, relatórios ou arquivos confidenciais, e mantenha seus PDFs seguros e profissionais. GroupDocs.Watermark suporta transparência, rotação e camadas para marcação d'água avançada.

############################# Steps ############################
steps:
    enable: true
    title: "Adicione Marcas d'Água a Arquivos Pdf Rapidamente"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Uma poderosa biblioteca Python que permite adicionar marcas d'água aos seus documentos.
      ...
      1. **Classe Principal: Watermarker.** Comece criando um objeto **Watermarker**. Forneça o seu arquivo Pdf como um caminho de arquivo ou um stream para começar.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Adicione uma marca d'água de imagem a um arquivo PDF
        ...
        with gw.Watermarker("input.pdf") as watermarker:
            ...
            # Salve o arquivo PDF com a marca d'água
...
more_formats:
    enable: true
    title: "Proteja Arquivos PDF com Marcas d'Água Python"
    exclude: "PDF"
    description: "Adicione marcas d'água personalizadas a arquivos PDF em Python para proteger seus documentos sensíveis e oficiais."
    items: 
        # format loop 1
