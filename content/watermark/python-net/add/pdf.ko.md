...
############################# Head ############################
head_title: "Python의 PDF 문서용 워터마크"
head_description: "Python에서 PDF 파일에 워터마크를 추가하여 중요한 문서를 보호하세요."

############################# Header ############################
title: "Python 워터마크로 PDF 보호하기" 
description: "Python를 사용하여 PDF 파일에 워터마크를 추가하세요. 법률, 금융 및 공식 문서에 이상적입니다."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET은 PDF 파일에 워터마크를 추가하기 위한 Python API입니다. 문서에 맞게 워터마크의 텍스트, 이미지 및 배치를 사용자 정의하세요. 계약서, 보고서 또는 기밀 파일을 표시하고 PDF를 안전하고 전문적으로 유지하는 데 사용하세요. GroupDocs.Watermark은 투명성, 회전 및 레이어링을 지원하여 고급 워터마킹이 가능합니다.

############################# Steps ############################
steps:
    enable: true
    title: "Pdf 파일에 워터마크 빠르게 추가하기"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** 문서에 워터마크를 추가할 수 있는 강력한 Python 라이브러리입니다.
      ...
      1. **주 클래스: Watermarker.** 먼저 **Watermarker** 객체를 생성합니다. 시작하려면 Pdf 파일을 파일 경로나 스트림으로 전달하세요.
...
more_formats:
    enable: true
    title: "Python의 PDF 파일 보안을 위한 워터마크"
    exclude: "PDF"
    description: "Python를 사용하여 PDF 파일에 사용자 정의 워터마크를 추가하여 민감하고 공식 문서를 보호하세요."
    items: 
        # format loop 1
        - name: "워터마크 PDF"
          format: "PDF"
