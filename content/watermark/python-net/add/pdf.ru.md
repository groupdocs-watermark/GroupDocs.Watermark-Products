...
############################# Head ############################
head_title: "Водяные знаки Python для документов PDF"
head_description: "Добавляйте водяные знаки к файлам PDF в Python, чтобы защитить ваши важные документы."

############################# Header ############################
title: "Защитите PDF с помощью водяных знаков Python" 
description: "Используйте Python для добавления водяных знаков к файлам PDF—идеально подходит для юридических, финансовых и официальных документов."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET — это Python API для добавления водяных знаков к файлам PDF. Настройте текст, изображения и расположение вашего водяного знака, чтобы он подходил для любого документа. Используйте его для маркировки контрактов, отчетов или конфиденциальных файлов, и сохраняйте ваши PDF-документы защищенными и профессиональными. GroupDocs.Watermark поддерживает прозрачность, поворот и наложение для продвинутого добавления водяных знаков.

############################# Steps ############################
steps:
    enable: true
    title: "Быстро добавьте водяные знаки в файлы Pdf"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Мощная библиотека Python для добавления водяных знаков в ваши документы.
      ...
      1. **Основной класс: Watermarker.** Начните с создания объекта **Watermarker**. Передайте в него ваш файл Pdf, либо в виде пути, либо в виде потока, чтобы приступить к работе.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Добавьте изображение-подпись в файл PDF
...
more_formats:
    enable: true
    title: "Защитите файлы PDF с помощью водяных знаков Python"
    exclude: "PDF"
    description: "Добавляйте пользовательские водяные знаки к файлам PDF в Python, чтобы защитить ваши конфиденциальные и официальные документы."
    items: 
        # format loop 1
