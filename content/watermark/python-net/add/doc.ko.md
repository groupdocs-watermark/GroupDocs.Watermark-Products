...
############################# Head ############################
head_title: "Python로 DOC 파일에 워터마크 추가하기"
head_description: "Python에서 DOC 파일에 워터마크를 추가하여 워드 문서를 안전하고 정리된 상태로 유지하세요."

############################# Header ############################
title: "Python의 워터마크로 DOC 보호하기" 
description: "Python를 사용하여 DOC 파일에 안전한 워터마크를 추가하세요. 법률, 비즈니스 및 기밀 문서에 적합합니다."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET를 사용하면 Python에서 DOC 파일에 워터마크를 추가할 수 있습니다. 텍스트 또는 이미지 워터마크를 삽입하고 투명도, 색상 및 위치를 조정하며 날짜, 로고 또는 기밀 스탬프와 같은 세부정보를 포함할 수 있습니다. 이 도구는 법률, 비즈니스 및 민감한 문서에 적합하며 Python 환경에서 원활하게 작동합니다. GroupDocs.Watermark은 워드 파일을 안전하고 진정성 있게 유지하는 신뢰할 수 있는 방법입니다.

############################# Steps ############################
steps:
    enable: true
    title: "Doc 파일에 워터마크 빠르게 추가하기"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** 문서에 워터마크를 추가할 수 있는 강력한 Python 라이브러리입니다.
      ...
      1. **주 클래스: Watermarker.** 먼저 **Watermarker** 객체를 생성합니다. 시작하려면 Doc 파일을 파일 경로나 스트림으로 전달하세요.
...
more_formats:
    enable: true
    title: "Python의 워드 파일을 위한 워터마킹"
    exclude: "DOC"
    description: "Python를 사용하여 DOC 파일에 사용자 정의 워터마크를 추가하여 워드 문서를 보호하고 검증하세요."
    items: 
        # format loop 1
        - name: "워터마크 PDF"
          format: "PDF"
