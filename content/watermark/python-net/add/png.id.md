...
############################# Head ############################
head_title: "Lindungi PNG dengan Watermark Python"
head_description: "Tambahkan watermark ke gambar PNG dalam Python untuk melindungi hak cipta dan keamanan."

############################# Header ############################
title: "Python Watermarking untuk Gambar PNG" 
description: "Gunakan Python untuk menambahkan watermark lanjutan ke gambar PNG—bagus untuk seniman dan desainer."
...
about:
    ...
    content: |
       GroupDocs.Watermark adalah toolkit Python untuk menambahkan watermark ke gambar PNG. Tambahkan watermark transparan atau solid, posisikan di mana saja, dan jaga agar gambar Anda aman dari penyalinan. Dengan GroupDocs.Watermark, Anda dapat menggunakan teks atau gambar sebagai watermark dan mengontrol tampilannya untuk proyek pribadi atau profesional.

############################# Steps ############################
steps:
    enable: true
    title: "Tambahkan Watermark ke File Png dengan Cepat"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Sebuah pustaka Python yang kuat yang memungkinkan Anda menambahkan watermark ke dokumen.
      ...
      1. **Kelas Utama: Watermarker.** Mulailah dengan membuat objek **Watermarker**. Berikan file Png Anda, baik sebagai jalur file atau stream, untuk memulai.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Tambahkan watermark gambar ke file PNG
        ...
        with gw.Watermarker("input.png") as watermarker:
            ...
            # Simpan file PNG dengan watermark
...
more_formats:
    enable: true
    title: "Tambahkan Watermark ke PNG dengan Python"
    exclude: "PNG"
    description: "Gunakan Python untuk menambahkan watermark halus atau mencolok ke gambar PNG untuk perlindungan hak cipta yang fleksibel."
    items: 
        # format loop 1
        - name: "Tanda air PDF"
          format: "PDF"
