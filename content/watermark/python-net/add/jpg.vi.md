...
############################# Head ############################
head_title: "Watermark Python cho hình ảnh JPG"
head_description: "Thêm watermark vào hình ảnh JPG trong Python để bảo vệ ảnh kỹ thuật số của bạn."

############################# Header ############################
title: "Bảo vệ hình ảnh JPG với Python" 
description: "Sử dụng Python để thêm watermark mạnh mẽ vào hình ảnh JPG—lý tưởng cho việc bản quyền và quyền sở hữu."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET cho phép bạn thêm watermark vào hình ảnh JPG trong Python. Đặt văn bản, logo hoặc đồ họa ở bất kỳ đâu trên hình ảnh của bạn và điều chỉnh diện mạo của chúng để phù hợp với nhu cầu của bạn. Bảo vệ ảnh của bạn cho mục đích cá nhân hoặc kinh doanh với GroupDocs.Watermark, và giữ cho hình ảnh của bạn an toàn khỏi việc sao chép.

############################# Steps ############################
steps:
    enable: true
    title: "Nhanh chóng thêm Watermark vào tệp Jpg"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Một thư viện Python mạnh mẽ cho phép bạn thêm watermark vào tài liệu của bạn.
      ...
      1. **Lớp chính: Watermarker.** Bắt đầu bằng cách tạo một đối tượng **Watermarker**. Cung cấp cho nó tệp Jpg của bạn, dưới dạng đường dẫn tệp hoặc luồng, để bắt đầu.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Thêm một hình ảnh làm watermark vào một tệp JPG
...
more_formats:
    enable: true
    title: "Thêm Watermark vào JPG bằng Python"
    exclude: "JPG"
    description: "Sử dụng Python để thêm watermark rõ ràng hoặc ẩn vào hình ảnh JPG cho nội dung an toàn, dễ nhận diện."
    items: 
        # format loop 1
        - name: "Hình mờ PDF"
          format: "PDF"
