...
############################# Head ############################
head_title: "使用 Python 为 PPTX 添加水印"
head_description: "通过在 Python 中添加水印来保护您的 PPTX 演示文稿。"

############################# Header ############################
title: "为 PPTX 提供高级 Python 水印" 
description: "使用 Python 为 PPTX 文件添加强大的水印——非常适合商业和教育。"
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET 是一个完整的 Python 解决方案，可以为 PPTX 文件添加水印。添加文本、徽标或图形作为水印，并调整透明度、大小和位置。非常适用于需要保护演示文稿的用户，GroupDocs.Watermark 确保您的幻灯片安全且外观美观。

############################# Steps ############################
steps:
    enable: true
    title: "快速向 Pptx 文件添加水印"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** 一个强大的 Python 库，可以帮助您轻松向文档添加水印。
      
      1. **主要类：Watermarker.** 首先创建一个 **Watermarker** 对象。将您的 Pptx 文件作为文件路径或流传递给它，以便开始。
...
more_formats:
    enable: true
    title: "Python 为 PPTX 文件添加水印"
    exclude: "PPTX"
    description: "使用 Python 为 PPTX 文件添加水印，以防止共享或复制您的演示文稿。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
