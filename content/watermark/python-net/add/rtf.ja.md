...
############################# Head ############################
head_title: "PythonによるRTF文書の透かし"
head_description: "PythonでRTFファイルに透かしを追加し、Word文書を安全に保ちます。"

############################# Header ############################
title: "PythonによるRTFの保護" 
description: "Pythonで安全でカスタムな透かしをRTFファイルに追加することができます。機密のWord文書に最適です。"
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NETは、PythonでRTF文書に透かしを追加するための高度なツールを提供します。見えるまたは透明なマークを使用し、それらのフォント、色、サイズ、位置を調整します。法的、ビジネス、機密ファイルに最適で、GroupDocs.Watermarkはコピーや編集を防ぎます。

############################# Steps ############################
steps:
    enable: true
    title: "Rtfファイルに透かしを素早く追加する"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** あなたの文書に透かしを追加する強力なPythonライブラリです。
      
      1. **メインクラス: Watermarker.** 最初に、**Watermarker**オブジェクトを作成します。Rtfファイルをファイルパスまたはストリームとして渡して開始します。
...
more_formats:
    enable: true
    title: "PythonによるRTFへの透かし"
    exclude: "RTF"
    description: "Pythonを使用して強力または微細な透かしをRTFファイルに追加し、文書のセキュリティを向上させます。"
    items: 
        # format loop 1
        - name: "ウォーターマーク PDF"
          format: "PDF"
