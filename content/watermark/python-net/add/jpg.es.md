...
############################# Head ############################
head_title: "Marcas de Agua Python para Imágenes JPG"
head_description: "Añada marcas de agua a imágenes JPG en Python para proteger sus fotos digitales."

############################# Header ############################
title: "Proteja Imágenes JPG con Python" 
description: "Utilice Python para añadir fuertes marcas de agua a imágenes JPG—ideales para derechos de autor y propiedad."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET le permite añadir marcas de agua a imágenes JPG en Python. Coloque texto, logotipos o gráficos en cualquier parte de su imagen, y ajuste su apariencia según sus necesidades. Proteja sus fotos para uso personal o empresarial con GroupDocs.Watermark, y mantenga sus imágenes a salvo de copias.

############################# Steps ############################
steps:
    enable: true
    title: "Añada Marcas de Agua a Archivos Jpg Rápidamente"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Una poderosa biblioteca de Python que le permite añadir marcas de agua a sus documentos.
      ...
      1. **Clase Principal: Watermarker.** Comience creando un objeto **Watermarker**. Proporciónelo su archivo Jpg, ya sea como un camino de archivo o como un flujo, para empezar.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Añadir una marca de agua de imagen a un archivo JPG
        ...
        with gw.Watermarker("input.jpg") as watermarker:
            ...
            # Guarde el archivo JPG con la marca de agua
...
more_formats:
    enable: true
    title: "Añadir Marcas de Agua a JPG con Python"
    exclude: "JPG"
    description: "Utilice Python para añadir marcas de agua visibles u ocultas a imágenes JPG para un contenido seguro y reconocible."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
