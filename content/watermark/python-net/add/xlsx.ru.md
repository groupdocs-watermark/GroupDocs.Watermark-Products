...
############################# Head ############################
head_title: "Добавление водяных знаков к XLSX с Python"
head_description: "Используйте Python для добавления водяных знаков к файлам XLSX и защиты ваших Excel документов."

############################# Header ############################
title: "Защитите листы XLSX с помощью водяных знаков Python" 
description: "Добавьте пользовательские водяные знаки к файлам XLSX в Python—отлично подходит для бизнеса и конфиденциальных данных."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET — это решение Python для добавления и управления водяными знаками в файлах XLSX. Добавляйте текстовые или графические водяные знаки, автоматизируйте процесс добавления водяных знаков на основе свойств файла и защищайте свои документы Excel безопасно и профессионально. GroupDocs.Watermark поддерживает все современные функции Python.

############################# Steps ############################
steps:
    enable: true
    title: "Быстро добавьте водяные знаки в файлы Xlsx"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Мощная библиотека Python для добавления водяных знаков в ваши документы.
      ...
      1. **Основной класс: Watermarker.** Начните с создания объекта **Watermarker**. Передайте в него ваш файл Xlsx, либо в виде пути, либо в виде потока, чтобы приступить к работе.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Добавьте изображение-подпись в файл XLSX
        ...
        with gw.Watermarker("input.xlsx") as watermarker:
            ...
            # Сохраните файл XLSX с подписью
...
more_formats:
    enable: true
    title: "Добавление водяных знаков к XLSX с Python"
    exclude: "XLSX"
    description: "Используйте Python для добавления защищенных, продвинутых водяных знаков к файлам XLSX и защиты своих данных в Excel."
    items: 
        # format loop 1
