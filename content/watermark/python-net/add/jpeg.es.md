...
############################# Head ############################
head_title: "Proteja Imágenes JPEG con Marcas de Agua Python"
head_description: "Añada marcas de agua a imágenes JPEG en Python para mantener sus fotos seguras."

############################# Header ############################
title: "Marcas de Agua Avanzadas de Python para JPEG" 
description: "Utilice Python para añadir marcas de agua flexibles y seguras a imágenes JPEG—perfecto para artistas y fotógrafos."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET le proporciona las herramientas para marcar imágenes JPEG en Python. Añada texto, logotipos o patrones, y ajuste su apariencia para que su marca de agua se integre perfectamente. Ideal para cualquier persona que necesite proteger sus imágenes en línea, GroupDocs.Watermark mantiene su trabajo seguro sin reducir la calidad de la imagen.

############################# Steps ############################
steps:
    enable: true
    title: "Añada Marcas de Agua a Archivos Jpeg Rápidamente"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Una poderosa biblioteca de Python que le permite añadir marcas de agua a sus documentos.
      ...
      1. **Clase Principal: Watermarker.** Comience creando un objeto **Watermarker**. Proporciónelo su archivo Jpeg, ya sea como un camino de archivo o como un flujo, para empezar.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Añadir una marca de agua de imagen a un archivo JPEG
        ...
        with gw.Watermarker("input.jpeg") as watermarker:
            ...
            # Guarde el archivo JPEG con la marca de agua
...
more_formats:
    enable: true
    title: "Marcas de Agua Python para Imágenes JPEG"
    exclude: "JPEG"
    description: "Añada y gestione marcas de agua en imágenes JPEG con Python para proteger su contenido digital."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
