...
############################# Head ############################
head_title: "Python Watermarking for DOCX Files"
head_description: "Add watermarks to DOCX files in Python to keep your Word documents secure."

############################# Header ############################
title: "Secure DOCX with Python Watermarks" 
description: "Apply advanced watermarking to DOCX files in Python—great for protecting your Word documents in any industry."
...
steps:
    enable: true
    title: "Quickly Add Watermarks to Docx Files"
    content: |
...
more_formats:
    enable: true
    title: "Add Watermarks to DOCX with Python"
    exclude: "DOCX"
    description: "Learn how to add secure, custom watermarks to DOCX files in Python for better document safety and copyright control."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
