...
############################# Head ############################
head_title: "Watermark tệp DOC với Python"
head_description: "Thêm watermark vào các tệp DOC trong Python để giữ cho tài liệu Word của bạn an toàn và có tổ chức."

############################# Header ############################
title: "Bảo vệ DOC với Watermark Python" 
description: "Sử dụng Python để thêm watermark bảo mật vào các tệp DOC—lý tưởng cho các tài liệu Word hợp pháp, kinh doanh và bí mật."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET cho phép bạn thêm watermark vào các tệp DOC trong Python. Chèn watermark văn bản hoặc hình ảnh, điều chỉnh độ mờ, màu sắc và vị trí, và bao gồm các chi tiết như ngày tháng, logo hoặc con dấu bí mật. Công cụ này là lựa chọn hoàn hảo cho các tài liệu hợp pháp, kinh doanh và nhạy cảm, và hoạt động suôn sẻ trong môi trường Python. GroupDocs.Watermark là một cách đáng tin cậy để giữ cho các tệp Word của bạn an toàn và xác thực.

############################# Steps ############################
steps:
    enable: true
    title: "Nhanh chóng thêm Watermark vào tệp Doc"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Một thư viện Python mạnh mẽ cho phép bạn thêm watermark vào tài liệu của bạn.
      ...
      1. **Lớp chính: Watermarker.** Bắt đầu bằng cách tạo một đối tượng **Watermarker**. Cung cấp cho nó tệp Doc của bạn, dưới dạng đường dẫn tệp hoặc luồng, để bắt đầu.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Thêm một hình ảnh làm watermark vào một tệp DOC
...
more_formats:
    enable: true
    title: "Watermark Python cho các tệp Word"
    exclude: "DOC"
    description: "Sử dụng Python để thêm watermark tùy chỉnh vào các tệp DOC, giúp bạn bảo vệ và xác minh tài liệu Word của mình."
    items: 
        # format loop 1
        - name: "Hình mờ PDF"
          format: "PDF"
