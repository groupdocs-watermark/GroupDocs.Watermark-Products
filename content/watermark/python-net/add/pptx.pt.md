...
############################# Head ############################
head_title: "Adicione Marcas d'Água a PPTX com Python"
head_description: "Proteja suas apresentações PPTX adicionando marcas d'água em Python."

############################# Header ############################
title: "Marcação d'Água Avançada Python para PPTX" 
description: "Use Python para adicionar marcas d'água fortes a arquivos PPTX—ideal para negócios e educação."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET é uma solução completa Python para marcar arquivos PPTX com marcas d'água. Adicione texto, logotipos ou gráficos como marcas d'água e ajuste sua transparência, tamanho e posição. Ótimo para quem precisa proteger suas apresentações, GroupDocs.Watermark mantém seus slides seguros e visualmente agradáveis.

############################# Steps ############################
steps:
    enable: true
    title: "Adicione Marcas d'Água a Arquivos Pptx Rapidamente"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Uma poderosa biblioteca Python que permite adicionar marcas d'água aos seus documentos.
      ...
      1. **Classe Principal: Watermarker.** Comece criando um objeto **Watermarker**. Forneça o seu arquivo Pptx como um caminho de arquivo ou um stream para começar.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Adicione uma marca d'água de imagem a um arquivo PPTX
        ...
        with gw.Watermarker("input.pptx") as watermarker:
            ...
            # Salve o arquivo PPTX com a marca d'água
...
more_formats:
    enable: true
    title: "Marcação d'Água Python para Arquivos PPTX"
    exclude: "PPTX"
    description: "Adicione marcas d'água a arquivos PPTX em Python para manter suas apresentações seguras contra compartilhamento ou cópia."
    items: 
        # format loop 1
