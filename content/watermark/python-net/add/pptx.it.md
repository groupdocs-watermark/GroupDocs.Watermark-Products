...
############################# Head ############################
head_title: "Aggiungi watermark a PPTX con Python"
head_description: "Proteggi le tue presentazioni PPTX aggiungendo watermark in Python."

############################# Header ############################
title: "Watermarking avanzato Python per PPTX" 
description: "Usa Python per aggiungere watermark forti a file PPTX—ideale per affari e istruzione."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET è una soluzione completa Python per watermarkare file PPTX. Aggiungi testo, loghi o grafiche come watermark e regola la loro trasparenza, dimensione e posizione. Ottimo per chiunque debba proteggere le proprie presentazioni, GroupDocs.Watermark mantiene le tue diapositive sicure e dall'aspetto professionale.

############################# Steps ############################
steps:
    enable: true
    title: "Aggiungi rapidamente watermark ai file Pptx"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Una potente libreria Python che ti consente di aggiungere watermark ai tuoi documenti.
      ...
      1. **Classe principale: Watermarker.** Inizia creando un oggetto **Watermarker**. Fornisci il tuo file Pptx, sia come percorso di file che come stream.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Aggiungi un watermark immagine a un file PPTX
        ...
        with gw.Watermarker("input.pptx") as watermarker:
            ...
            # Salva il file PPTX con il watermark
...
more_formats:
    enable: true
    title: "Watermarking Python per file PPTX"
    exclude: "PPTX"
    description: "Aggiungi watermark a file PPTX in Python per rendere le tue presentazioni sicure da condivisione o copia."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
