...
############################# Head ############################
head_title: "Python로 XLSX에 워터마크 추가하기"
head_description: "Python를 사용하여 XLSX 파일에 워터마크를 추가하여 Excel 문서를 보호하세요."

############################# Header ############################
title: "Python의 XLSX 시트를 보호하기 위한 워터마크" 
description: "Python에서 XLSX 파일에 사용자 정의 워터마크를 추가하세요. 비즈니스 및 민감한 데이터에 적합합니다."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET는 XLSX 파일에 워터마크를 추가하고 관리하기 위한 Python 솔루션입니다. 텍스트 또는 이미지 워터마크를 추가하고 파일 속성을 기반으로 워터마킹을 자동화하여 Excel 문서를 안전하고 전문적으로 유지하세요. GroupDocs.Watermark은 최신 Python 기능을 모두 지원합니다.

############################# Steps ############################
steps:
    enable: true
    title: "Xlsx 파일에 워터마크 빠르게 추가하기"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** 문서에 워터마크를 추가할 수 있는 강력한 Python 라이브러리입니다.
      ...
      1. **주 클래스: Watermarker.** 먼저 **Watermarker** 객체를 생성합니다. 시작하려면 Xlsx 파일을 파일 경로나 스트림으로 전달하세요.
...
more_formats:
    enable: true
    title: "Python로 XLSX에 워터마크 추가하기"
    exclude: "XLSX"
    description: "Python를 사용하여 XLSX 파일에 안전하고 고급 워터마크를 추가하여 Excel 데이터를 보호하세요."
    items: 
        # format loop 1
        - name: "워터마크 PDF"
          format: "PDF"
