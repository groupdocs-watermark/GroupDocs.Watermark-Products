...
############################# Head ############################
head_title: "Python Watermarking untuk Dokumen RTF"
head_description: "Tambahkan watermark ke file RTF dalam Python untuk menjaga dokumen Word Anda tetap aman."

############################# Header ############################
title: "Lindungi RTF dengan Watermark Python" 
description: "Gunakan Python untuk menambahkan watermark yang aman dan kustom ke file RTF—bagus untuk dokumen Word yang sensitif."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET memberi Anda alat lanjutan untuk menambahkan watermark ke dokumen RTF dalam Python. Gunakan tanda terlihat atau transparan, dan sesuaikan font, warna, ukuran, dan posisinya. Sempurna untuk file hukum, bisnis, atau rahasia, GroupDocs.Watermark membantu mencegah penyalinan dan pengeditan.

############################# Steps ############################
steps:
    enable: true
    title: "Tambahkan Watermark ke File Rtf dengan Cepat"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Sebuah pustaka Python yang kuat yang memungkinkan Anda menambahkan watermark ke dokumen.
      ...
      1. **Kelas Utama: Watermarker.** Mulailah dengan membuat objek **Watermarker**. Berikan file Rtf Anda, baik sebagai jalur file atau stream, untuk memulai.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Tambahkan watermark gambar ke file RTF
        ...
        with gw.Watermarker("input.rtf") as watermarker:
            ...
            # Simpan file RTF dengan watermark
...
more_formats:
    enable: true
    title: "Tambahkan Watermark ke RTF dengan Python"
    exclude: "RTF"
    description: "Gunakan Python untuk menambahkan watermark yang kuat dan halus ke file RTF untuk keamanan dokumen yang lebih baik."
    items: 
        # format loop 1
        - name: "Tanda air PDF"
          format: "PDF"
