...
############################# Head ############################
head_title: "Añadir Marcas de Agua a XLS con Python"
head_description: "Utilice Python para añadir y gestionar marcas de agua en archivos XLS para una mejor seguridad en Excel."

############################# Header ############################
title: "Cree Marcas de Agua de Python para Archivos XLS" 
description: "Añada marcas de agua a hojas de cálculo XLS en Python—genial para proteger datos financieros y personales."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET le permite añadir marcas de agua a archivos XLS en Python. Utilice marcas visibles u ocultas y personalice su apariencia para adaptarse a sus necesidades. Ideal para mantener seguros los datos financieros o de clientes, GroupDocs.Watermark funciona en todos los entornos Python.

############################# Steps ############################
steps:
    enable: true
    title: "Añada Marcas de Agua a Archivos Xls Rápidamente"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Una poderosa biblioteca de Python que le permite añadir marcas de agua a sus documentos.
      ...
      1. **Clase Principal: Watermarker.** Comience creando un objeto **Watermarker**. Proporciónelo su archivo Xls, ya sea como un camino de archivo o como un flujo, para empezar.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Añadir una marca de agua de imagen a un archivo XLS
        ...
        with gw.Watermarker("input.xls") as watermarker:
            ...
            # Guarde el archivo XLS con la marca de agua
...
more_formats:
    enable: true
    title: "Añadir Marcas de Agua a XLS con Python"
    exclude: "XLS"
    description: "Utilice Python para añadir marcas de agua personalizadas a archivos XLS y mantener seguros sus datos de Excel."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
