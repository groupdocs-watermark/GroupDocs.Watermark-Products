...
############################# Head ############################
head_title: "Python Watermarking for RTF Documents"
head_description: "Add watermarks to RTF files in Python to keep your Word documents secure."

############################# Header ############################
title: "Protect RTF with Python Watermarks" 
description: "Use Python to add secure, custom watermarks to RTF files—great for sensitive Word documents."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET gives you advanced tools to add watermarks to RTF documents in Python. Use visible or transparent marks, and adjust their font, color, size, and position. Perfect for legal, business, or confidential files, GroupDocs.Watermark helps prevent copying and editing.

############################# Steps ############################
steps:
    enable: true
    title: "Quickly Add Watermarks to Rtf Files"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** A powerful Python library that lets you add watermarks to your documents with ease.
      ...
      1. **Main Class: Watermarker.** Start by creating a **Watermarker** object. Give it your Rtf file, either as a file path or a stream, to get started.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Add an image watermark to a RTF file
        ...
        with gw.Watermarker("input.rtf") as watermarker:
            ...
            # Save the RTF file with the watermark
...
more_formats:
    enable: true
    title: "Add Watermarks to RTF with Python"
    exclude: "RTF"
    description: "Use Python to add strong and subtle watermarks to RTF files for better document security."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
