...
############################# Head ############################
head_title: "Marcação d'Água Python para Arquivos PowerPoint"
head_description: "Adicione marcas d'água dinâmicas a arquivos PowerPoint em Python para manter suas apresentações seguras."

############################# Header ############################
title: "Proteja PPT com Marcas d'Água Python" 
description: "Use Python para adicionar marcas d'água personalizadas a apresentações do PowerPoint—ótimo para negócios e educação."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET permite que você adicione marcas d'água a arquivos PowerPoint (PPT) em Python. Adicione marcas visíveis ou ocultas aos seus slides e personalize seu estilo, tamanho e cor. Perfeito para manter suas apresentações seguras em ambientes de negócios ou escolares, GroupDocs.Watermark funciona com todas as principais versões de Python.

############################# Steps ############################
steps:
    enable: true
    title: "Adicione Marcas d'Água a Arquivos Ppt Rapidamente"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Uma poderosa biblioteca Python que permite adicionar marcas d'água aos seus documentos.
      ...
      1. **Classe Principal: Watermarker.** Comece criando um objeto **Watermarker**. Forneça o seu arquivo Ppt como um caminho de arquivo ou um stream para começar.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Adicione uma marca d'água de imagem a um arquivo PPT
        ...
        with gw.Watermarker("input.ppt") as watermarker:
            ...
            # Salve o arquivo PPT com a marca d'água
...
more_formats:
    enable: true
    title: "Proteja Arquivos PPT com Marcas d'Água Python"
    exclude: "PPT"
    description: "Adicione marcas d'água avançadas a arquivos PowerPoint em Python para prevenir o uso indevido e proteger seu conteúdo."
    items: 
        # format loop 1
