...
############################# Head ############################
head_title: "Додайте водяні знаки до PPTX за допомогою Python"
head_description: "Захистіть свої презентації PPTX, додаючи водяні знаки у Python."

############################# Header ############################
title: "Розширене водяний знак Python для PPTX" 
description: "Використовуйте Python для додавання сильних водяних знаків до PPTX файлів — ідеально для бізнесу та освіти."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET — це повне Python рішення для водяного знакування файлів PPTX. Додавайте текст, логотипи або графіку як водяні знаки, і налаштовуйте їх прозорість, розмір і позицію. Чудово підходить для тих, хто має потребу захистити свої презентації, GroupDocs.Watermark забезпечує безпеку ваших слайдів і їх привабливий вигляд.

############################# Steps ############################
steps:
    enable: true
    title: "Швидко додайте водяні знаки до файлів Pptx"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Потужна бібліотека Python для додавання водяних знаків до ваших документів.
      ...
      1. **Головний клас: Watermarker.** Почніть з створення об'єкта **Watermarker**. Задайте йому ваш файл Pptx, або у вигляді шляху до файлу, або потоку, щоб розпочати.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Додайте водяний знак до файлу PPTX
        ...
        with gw.Watermarker("input.pptx") as watermarker:
            ...
            # Збережіть файл PPTX з водяним знаком
...
more_formats:
    enable: true
    title: "Python Водяні знаки для файлів PPTX"
    exclude: "PPTX"
    description: "Додайте водяні знаки до PPTX файлів у Python, щоб зберегти ваші презентації в безпеці від розповсюдження чи копіювання."
    items: 
        # format loop 1
