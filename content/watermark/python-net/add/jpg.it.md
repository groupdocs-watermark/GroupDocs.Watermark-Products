...
############################# Head ############################
head_title: "Watermarking Python per immagini JPG"
head_description: "Aggiungi watermark a immagini JPG in Python per proteggere le tue foto digitali."

############################# Header ############################
title: "Proteggi le immagini JPG con Python" 
description: "Usa Python per aggiungere forti watermark a immagini JPG—ideale per diritti d'autore e proprietà."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET ti consente di aggiungere watermark a immagini JPG in Python. Posiziona testo, loghi o grafiche ovunque sulla tua immagine e regola il loro aspetto in base alle tue esigenze. Proteggi le tue foto per uso personale o commerciale con GroupDocs.Watermark, e mantieni le tue immagini al sicuro da copie non autorizzate.

############################# Steps ############################
steps:
    enable: true
    title: "Aggiungi rapidamente watermark ai file Jpg"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Una potente libreria Python che ti consente di aggiungere watermark ai tuoi documenti.
      ...
      1. **Classe principale: Watermarker.** Inizia creando un oggetto **Watermarker**. Fornisci il tuo file Jpg, sia come percorso di file che come stream.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Aggiungi un watermark immagine a un file JPG
        ...
        with gw.Watermarker("input.jpg") as watermarker:
            ...
            # Salva il file JPG con il watermark
...
more_formats:
    enable: true
    title: "Aggiungi watermark a JPG con Python"
    exclude: "JPG"
    description: "Usa Python per aggiungere watermark visibili o nascosti a immagini JPG per contenuti sicuri e riconoscibili."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
