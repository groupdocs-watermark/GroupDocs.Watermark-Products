...
############################# Head ############################
head_title: "Añadir Marcas de Agua Python a Imágenes TIF"
head_description: "Utilice Python para añadir marcas de agua a imágenes TIF y proteger sus fotos."

############################# Header ############################
title: "Marcas de Agua Avanzadas para TIF con Python" 
description: "Añada marcas de agua de alta calidad a imágenes TIF en Python—geniales para fotógrafos y archiveros."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET es un kit de herramientas de Python para marcar imágenes TIF. Añada marcas de agua de texto o imagen, ajuste su apariencia y mantenga sus imágenes de alta resolución a salvo. Con procesamiento por lotes y posicionamiento inteligente, GroupDocs.Watermark es perfecto para cualquiera que necesite proteger muchas imágenes a la vez.

############################# Steps ############################
steps:
    enable: true
    title: "Añada Marcas de Agua a Archivos Tif Rápidamente"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Una poderosa biblioteca de Python que le permite añadir marcas de agua a sus documentos.
      ...
      1. **Clase Principal: Watermarker.** Comience creando un objeto **Watermarker**. Proporciónelo su archivo Tif, ya sea como un camino de archivo o como un flujo, para empezar.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Añadir una marca de agua de imagen a un archivo TIF
        ...
        with gw.Watermarker("input.tif") as watermarker:
            ...
            # Guarde el archivo TIF con la marca de agua
...
more_formats:
    enable: true
    title: "Proteja Imágenes TIF con Marcas de Agua Python"
    exclude: "TIF"
    description: "Añada marcas de agua personalizadas a imágenes TIF en Python para prevenir copias y mantener su trabajo seguro."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
