...
############################# Head ############################
head_title: "Add Watermarks to TIFF with Python"
head_description: "Create and add watermarks to TIFF images in Python to protect your digital files."

############################# Header ############################
title: "Create Watermarks for TIFF with Python" 
description: "Add strong, custom watermarks to TIFF files in Python—ideal for digital archives and photographers."
...
steps:
    enable: true
    title: "Quickly Add Watermarks to Tiff Files"
    content: |
...
more_formats:
    enable: true
    title: "Secure TIFF Images with Python Watermarks"
    exclude: "TIFF"
    description: "Add and manage watermarks in TIFF files in Python to keep your images safe and under your control."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
