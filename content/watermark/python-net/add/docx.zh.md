...
############################# Head ############################
head_title: "Python 为 DOCX 文件添加水印"
head_description: "使用 Python 为 DOCX 文件添加水印，以确保您的 Word 文档安全。"

############################# Header ############################
title: "使用 Python 水印保护 DOCX" 
description: "在 Python 中对 DOCX 文件应用高级水印——非常适合保护您在任何行业中的 Word 文档。"
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET 为 DOCX 文件带来强大的水印功能。轻松添加可缩放、可移动并与文档融合的水印。适用于法律、商业或机密文件，您可以选择文本或图像水印，自由放置。GroupDocs.Watermark 支持最新的 Python 功能，以实现一流的文档保护。

############################# Steps ############################
steps:
    enable: true
    title: "快速向 Docx 文件添加水印"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** 一个强大的 Python 库，可以帮助您轻松向文档添加水印。
      
      1. **主要类：Watermarker.** 首先创建一个 **Watermarker** 对象。将您的 Docx 文件作为文件路径或流传递给它，以便开始。
...
more_formats:
    enable: true
    title: "使用 Python 为 DOCX 添加水印"
    exclude: "DOCX"
    description: "了解如何在 Python 中为 DOCX 文件添加安全的自定义水印，以增强文档安全性和版权控制。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
