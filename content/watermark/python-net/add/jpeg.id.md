...
############################# Head ############################
head_title: "Lindungi Gambar JPEG dengan Watermark Python"
head_description: "Tambahkan watermark ke gambar JPEG dalam Python untuk menjaga foto Anda tetap aman dan terjamin."

############################# Header ############################
title: "Advanced Python Watermarking untuk JPEG" 
description: "Gunakan Python untuk menambahkan watermark fleksibel dan aman ke gambar JPEG—sempurna untuk seniman dan fotografer."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET memberi Anda alat untuk menambahkan watermark ke gambar JPEG dalam Python. Tambahkan teks, logo, atau pola, dan sesuaikan tampilannya agar watermark Anda pas. Hebat untuk siapa pun yang perlu melindungi gambar mereka secara online, GroupDocs.Watermark menjaga karya Anda tetap aman tanpa menurunkan kualitas gambar.

############################# Steps ############################
steps:
    enable: true
    title: "Tambahkan Watermark ke File Jpeg dengan Cepat"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Sebuah pustaka Python yang kuat yang memungkinkan Anda menambahkan watermark ke dokumen.
      ...
      1. **Kelas Utama: Watermarker.** Mulailah dengan membuat objek **Watermarker**. Berikan file Jpeg Anda, baik sebagai jalur file atau stream, untuk memulai.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Tambahkan watermark gambar ke file JPEG
        ...
        with gw.Watermarker("input.jpeg") as watermarker:
            ...
            # Simpan file JPEG dengan watermark
...
more_formats:
    enable: true
    title: "Python Watermarking untuk Gambar JPEG"
    exclude: "JPEG"
    description: "Tambahkan dan kelola watermark di gambar JPEG dengan Python untuk melindungi konten digital Anda."
    items: 
        # format loop 1
        - name: "Tanda air PDF"
          format: "PDF"
