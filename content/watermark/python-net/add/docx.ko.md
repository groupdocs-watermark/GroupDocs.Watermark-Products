...
############################# Head ############################
head_title: "Python의 DOCX 파일을 위한 워터마킹"
head_description: "Python에서 DOCX 파일에 워터마크를 추가하여 워드 문서를 안전하게 유지하세요."

############################# Header ############################
title: "Python의 워터마크로 DOCX 보호하기" 
description: "Python에서 DOCX 파일에 고급 워터마킹을 적용하세요. 모든 산업에서 워드 문서를 보호하는 데 훌륭합니다."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET는 DOCX 파일에 강력한 워터마킹을 제공합니다. 문서와 잘 어울리도록 크기, 위치 및 투명도를 쉽게 조정하면서 텍스트 또는 이미지 워터마크를 추가하세요. 법률, 비즈니스 또는 기밀 파일에 사용하기 좋으며 유연한 배치를 가진 텍스트 또는 이미지 워터마크 중에서 선택할 수 있습니다. GroupDocs.Watermark은 최신 Python 기능을 지원하여 최고 수준의 문서 보호를 제공합니다.

############################# Steps ############################
steps:
    enable: true
    title: "Docx 파일에 워터마크 빠르게 추가하기"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** 문서에 워터마크를 추가할 수 있는 강력한 Python 라이브러리입니다.
      ...
      1. **주 클래스: Watermarker.** 먼저 **Watermarker** 객체를 생성합니다. 시작하려면 Docx 파일을 파일 경로나 스트림으로 전달하세요.
...
more_formats:
    enable: true
    title: "Python로 DOCX에 워터마크 추가하기"
    exclude: "DOCX"
    description: "Python를 사용하여 DOCX 파일에 안전하고 사용자 정의된 워터마크를 추가하여 문서 안전성과 저작권 관리를 향상하세요."
    items: 
        # format loop 1
        - name: "워터마크 PDF"
          format: "PDF"
