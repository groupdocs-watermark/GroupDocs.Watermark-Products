...
############################# Head ############################
head_title: "Filigranage Python pour les images JPG"
head_description: "Ajoutez des filigranes aux images JPG en Python pour protéger vos photos numériques."

############################# Header ############################
title: "Protégez les images JPG avec Python" 
description: "Utilisez Python pour ajouter des filigranes forts aux images JPG—idéal pour le droit d'auteur et la propriété."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET vous permet d'ajouter des filigranes aux images JPG en Python. Placez du texte, des logos ou des graphiques n'importe où sur votre image, et ajustez leur apparence pour correspondre à vos besoins. Protégez vos photos à des fins personnelles ou professionnelles avec GroupDocs.Watermark, et gardez vos images à l'abri de la copie.

############################# Steps ############################
steps:
    enable: true
    title: "Ajoutez rapidement des filigranes aux fichiers Jpg"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Une bibliothèque puissante Python qui vous permet d'ajouter des filigranes à vos documents.
      ...
      1. **Classe principale : Watermarker.** Commencez par créer un objet **Watermarker**. Donnez-lui votre fichier Jpg, soit en tant que chemin de fichier soit en tant que flux, pour commencer.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ajoutez un filigrane image à un fichier JPG
        ...
        with gw.Watermarker("input.jpg") as watermarker:
            ...
            # Enregistrez le fichier JPG avec le filigrane
...
more_formats:
    enable: true
    title: "Ajoutez des filigranes à JPG avec Python"
    exclude: "JPG"
    description: "Utilisez Python pour ajouter des filigranes visibles ou invisibles aux images JPG afin de sécuriser un contenu reconnaissable."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
