...
############################# Head ############################
head_title: "Додайте водяні знаки до TIFF за допомогою Python"
head_description: "Створіть і додайте водяні знаки до TIFF зображень у Python, щоб захистити ваші цифрові файли."

############################# Header ############################
title: "Створіть водяні знаки для TIFF за допомогою Python" 
description: "Додавайте сильні, користувацькі водяні знаки до TIFF файлів у Python — ідеально для цифрових архівів і фотографів."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET — це Python набір інструментів для додавання водяних знаків до TIFF файлів. Обирайте текстові або зображеневі водяні знаки, налаштовуйте їх непрозорість, розмір і положення, та зберігайте ваші зображення в безпеці. Завдяки функціям, таким як шари водяних знаків і розумне форматування, GroupDocs.Watermark — це необхідність для будь-кого, хто хоче захистити свою колекцію зображень.

############################# Steps ############################
steps:
    enable: true
    title: "Швидко додайте водяні знаки до файлів Tiff"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Потужна бібліотека Python для додавання водяних знаків до ваших документів.
      ...
      1. **Головний клас: Watermarker.** Почніть з створення об'єкта **Watermarker**. Задайте йому ваш файл Tiff, або у вигляді шляху до файлу, або потоку, щоб розпочати.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Додайте водяний знак до файлу TIFF
        ...
        with gw.Watermarker("input.tiff") as watermarker:
            ...
            # Збережіть файл TIFF з водяним знаком
...
more_formats:
    enable: true
    title: "Забезпечте TIFF зображення з водяними знаками Python"
    exclude: "TIFF"
    description: "Додайте та керуйте водяними знаками в TIFF файлах у Python, щоб зберегти ваші зображення в безпеці та під контролем."
    items: 
        # format loop 1
