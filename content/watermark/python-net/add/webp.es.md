...
############################# Head ############################
head_title: "Añadir Marcas de Agua a WEBP con Python"
head_description: "Utilice Python para añadir marcas de agua a imágenes WEBP para una fuerte protección."

############################# Header ############################
title: "Cree Marcas de Agua para WEBP con Python" 
description: "Añada marcas de agua personalizadas a archivos WEBP en Python—genial para artistas y creadores de contenido."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET le permite añadir marcas de agua a imágenes WEBP en Python. Use texto, logotipos o firmas digitales y ajuste su apariencia para adaptarse a sus necesidades. Perfecto para cualquier persona que comparta imágenes en línea, GroupDocs.Watermark mantiene su trabajo seguro y con buena apariencia.

############################# Steps ############################
steps:
    enable: true
    title: "Añada Marcas de Agua a Archivos Webp Rápidamente"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Una poderosa biblioteca de Python que le permite añadir marcas de agua a sus documentos.
      ...
      1. **Clase Principal: Watermarker.** Comience creando un objeto **Watermarker**. Proporciónelo su archivo Webp, ya sea como un camino de archivo o como un flujo, para empezar.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Añadir una marca de agua de imagen a un archivo WEBP
        ...
        with gw.Watermarker("input.webp") as watermarker:
            ...
            # Guarde el archivo WEBP con la marca de agua
...
more_formats:
    enable: true
    title: "Proteja Imágenes WEBP con Marcas de Agua Python"
    exclude: "WEBP"
    description: "Añada marcas de agua avanzadas y personalizadas a imágenes WEBP en Python para proteger su trabajo creativo."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
