...
head_description: "Add watermarks to JPG images in Python to protect your digital photos."

############################# Header ############################
title: "Protect JPG Images with Python" 
description: "Use Python to add strong watermarks to JPG images—ideal for copyright and ownership."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET lets you add watermarks to JPG images in Python. Place text, logos, or graphics anywhere on your image, and adjust their look to match your needs. Protect your photos for personal or business use with GroupDocs.Watermark, and keep your images safe from copying.

############################# Steps ############################
steps:
    enable: true
    title: "Quickly Add Watermarks to Jpg Files"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** A powerful Python library that lets you add watermarks to your documents with ease.
      ...
      1. **Main Class: Watermarker.** Start by creating a **Watermarker** object. Give it your Jpg file, either as a file path or a stream, to get started.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Add an image watermark to a JPG file
        ...
        with gw.Watermarker("input.jpg") as watermarker:
            ...
            # Save the JPG file with the watermark
...
more_formats:
    enable: true
    title: "Add Watermarks to JPG with Python"
    exclude: "JPG"
    description: "Use Python to add visible or hidden watermarks to JPG images for secure, recognizable content."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
