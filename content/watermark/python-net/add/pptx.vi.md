...
############################# Head ############################
head_title: "Thêm Watermark vào PPTX bằng Python"
head_description: "Bảo vệ các bài thuyết trình PPTX của bạn bằng cách thêm watermark trong Python."

############################# Header ############################
title: "Watermark Python nâng cao cho PPTX" 
description: "Sử dụng Python để thêm watermark mạnh mẽ vào các tệp PPTX—lý tưởng cho doanh nghiệp và giáo dục."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET là một giải pháp hoàn chỉnh Python cho việc watermark các tệp PPTX. Thêm văn bản, logo hoặc đồ họa làm watermark, và điều chỉnh độ trong suốt, kích thước và vị trí của chúng. Tuyệt vời cho bất kỳ ai cần bảo vệ bài thuyết trình của mình, GroupDocs.Watermark giữ cho các trang trình bày của bạn an toàn và đẹp mắt.

############################# Steps ############################
steps:
    enable: true
    title: "Nhanh chóng thêm Watermark vào tệp Pptx"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Một thư viện Python mạnh mẽ cho phép bạn thêm watermark vào tài liệu của bạn.
      ...
      1. **Lớp chính: Watermarker.** Bắt đầu bằng cách tạo một đối tượng **Watermarker**. Cung cấp cho nó tệp Pptx của bạn, dưới dạng đường dẫn tệp hoặc luồng, để bắt đầu.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Thêm một hình ảnh làm watermark vào một tệp PPTX
...
more_formats:
    enable: true
    title: "Watermark Python cho các tệp PPTX"
    exclude: "PPTX"
    description: "Thêm watermark vào các tệp PPTX trong Python để giữ cho các bài thuyết trình của bạn an toàn khỏi việc chia sẻ hoặc sao chép."
    items: 
        # format loop 1
        - name: "Hình mờ PDF"
          format: "PDF"
