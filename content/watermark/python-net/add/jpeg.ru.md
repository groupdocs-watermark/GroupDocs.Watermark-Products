...
############################# Head ############################
head_title: "Защитите изображения JPEG с помощью водяных знаков Python"
head_description: "Добавьте водяные знаки к изображениям JPEG в Python для защиты ваших фотографий."

############################# Header ############################
title: "Продвинутое добавление водяных знаков Python для JPEG" 
description: "Используйте Python для добавления гибких, безопасных водяных знаков к изображениям JPEG—отлично подойдет для художников и фотографов."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET предоставляет инструменты для добавления водяных знаков к изображениям JPEG в Python. Добавляйте текст, логотипы или узоры, и настраивайте их внешний вид так, чтобы ваш водяной знак гармонировал с изображением. Отлично подходит для всех, кому необходимо защищать свои изображения в интернете, GroupDocs.Watermark сохраняет ваши работы в безопасности без снижения качества изображений.

############################# Steps ############################
steps:
    enable: true
    title: "Быстро добавьте водяные знаки в файлы Jpeg"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Мощная библиотека Python для добавления водяных знаков в ваши документы.
      ...
      1. **Основной класс: Watermarker.** Начните с создания объекта **Watermarker**. Передайте в него ваш файл Jpeg, либо в виде пути, либо в виде потока, чтобы приступить к работе.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Добавьте изображение-подпись в файл JPEG
        ...
        with gw.Watermarker("input.jpeg") as watermarker:
            ...
            # Сохраните файл JPEG с подписью
...
more_formats:
    enable: true
    title: "Добавление водяных знаков к изображениям JPEG с помощью Python"
    exclude: "JPEG"
    description: "Добавляйте и управляйте водяными знаками в изображениях JPEG с помощью Python, чтобы защитить свой цифровой контент."
    items: 
        # format loop 1
