...
############################# Head ############################
head_title: "Python의 PowerPoint 파일을 위한 워터마크"
head_description: "Python에서 PowerPoint 파일에 동적 워터마크를 추가하여 프레젠테이션을 안전하게 유지하세요."

############################# Header ############################
title: "Python 워터마크로 PPT 보호하기" 
description: "Python를 사용하여 PowerPoint 프레젠테이션에 사용자 정의 워터마크를 추가하세요. 비즈니스와 교육에 매우 적합합니다."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET을 사용하여 PowerPoint(PPT) 파일에 워터마크를 추가할 수 있습니다. 슬라이드에 가시적 또는 숨겨진 표시를 추가하고 스타일, 크기 및 색상을 조정하세요. 비즈니스나 학교 환경에서 프레젠테이션을 안전하게 유지하는 데 적합하며, 모든 주요 Python 버전과 호환됩니다.

############################# Steps ############################
steps:
    enable: true
    title: "Ppt 파일에 워터마크 빠르게 추가하기"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** 문서에 워터마크를 추가할 수 있는 강력한 Python 라이브러리입니다.
      ...
      1. **주 클래스: Watermarker.** 먼저 **Watermarker** 객체를 생성합니다. 시작하려면 Ppt 파일을 파일 경로나 스트림으로 전달하세요.
...
more_formats:
    enable: true
    title: "Python의 PPT 파일에 대한 보안 워터마크"
    exclude: "PPT"
    description: "Python를 사용하여 PowerPoint 파일에 고급 워터마크를 추가하여 악용을 방지하고 콘텐츠를 보호하세요."
    items: 
        # format loop 1
        - name: "워터마크 PDF"
          format: "PDF"
