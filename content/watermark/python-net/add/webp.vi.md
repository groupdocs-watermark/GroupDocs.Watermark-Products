...
############################# Head ############################
head_title: "Thêm Watermark vào WEBP bằng Python"
head_description: "Sử dụng Python để thêm watermark vào hình ảnh WEBP cho bảo vệ mạnh mẽ."

############################# Header ############################
title: "Tạo Watermark cho WEBP với Python" 
description: "Thêm watermark tùy chỉnh vào các tệp WEBP trong Python—tuyệt vời cho nghệ sĩ và nhà sáng tạo nội dung."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET cho phép bạn thêm watermark vào hình ảnh WEBP trong Python. Sử dụng văn bản, logo hoặc chữ ký số và điều chỉnh diện mạo của chúng để phù hợp với nhu cầu của bạn. Tuyệt vời cho bất kỳ ai chia sẻ hình ảnh trực tuyến, GroupDocs.Watermark giữ cho công việc của bạn an toàn và đẹp mắt.

############################# Steps ############################
steps:
    enable: true
    title: "Nhanh chóng thêm Watermark vào tệp Webp"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Một thư viện Python mạnh mẽ cho phép bạn thêm watermark vào tài liệu của bạn.
      ...
      1. **Lớp chính: Watermarker.** Bắt đầu bằng cách tạo một đối tượng **Watermarker**. Cung cấp cho nó tệp Webp của bạn, dưới dạng đường dẫn tệp hoặc luồng, để bắt đầu.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Thêm một hình ảnh làm watermark vào một tệp WEBP
...
more_formats:
    enable: true
    title: "Bảo vệ hình ảnh WEBP với Watermark Python"
    exclude: "WEBP"
    description: "Thêm watermark nâng cao, tùy chỉnh vào hình ảnh WEBP trong Python để bảo vệ công việc sáng tạo của bạn."
    items: 
        # format loop 1
        - name: "Hình mờ PDF"
          format: "PDF"
