...
############################# Head ############################
head_title: "Python การทำลายน้ำสำหรับเอกสาร RTF"
head_description: "เพิ่มลายน้ำลงในไฟล์ RTF ใน Python เพื่อรักษาความปลอดภัยเอกสาร Word ของคุณ"

############################# Header ############################
title: "ปกป้อง RTF ด้วยลายน้ำ Python" 
description: "ใช้ Python เพิ่มลายน้ำที่ปลอดภัยและกำหนดเองในไฟล์ RTF — ดีเยี่ยมสำหรับเอกสาร Word ที่ละเอียดอ่อน"
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET มอบเครื่องมือขั้นสูงสำหรับการเพิ่มลายน้ำในเอกสาร RTF ใน Python ใช้เครื่องหมายที่มองเห็นได้หรือโปร่งใส และปรับแต่งฟอนต์ สี ขนาด และตำแหน่งของพวกเขา เหมาะสำหรับไฟล์ที่เป็นความลับทางกฎหมาย ธุรกิจ หรือข้อมูลที่ละเอียดอ่อน GroupDocs.Watermark ช่วยป้องกันการคัดลอกและการแก้ไข

############################# Steps ############################
steps:
    enable: true
    title: "เพิ่มลายน้ำลงในไฟล์ Rtf อย่างรวดเร็ว"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** ไลบรารี Python ที่ทรงพลังที่ช่วยให้คุณสามารถเพิ่มลายน้ำลงในเอกสารได้
      ...
      1. **คลาสหลัก: Watermarker.** เริ่มโดยการสร้างวัตถุ **Watermarker** โดยให้ไฟล์ Rtf ของคุณเป็นพาธไฟล์หรือสตรีม
...
more_formats:
    enable: true
    title: "เพิ่มลายน้ำให้กับ RTF ด้วย Python"
    exclude: "RTF"
    description: "ใช้ Python เพิ่มลายน้ำที่เห็นได้ชัดเจนและละเอียดในไฟล์ RTF เพื่อความปลอดภัยของเอกสารที่ดีขึ้น"
    items: 
        # format loop 1
        - name: "ลายน้ำ PDF"
          format: "PDF"
