...
############################# Head ############################
head_title: "Tambahkan Watermark ke XLS dengan Python"
head_description: "Gunakan Python untuk menambahkan dan mengelola watermark di file XLS untuk keamanan Excel yang lebih baik."

############################# Header ############################
title: "Buat Watermark Python untuk File XLS" 
description: "Tambahkan watermark ke spreadsheet XLS dalam Python—bagus untuk melindungi data finansial dan pribadi."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET memungkinkan Anda menambahkan watermark ke file XLS dalam Python. Gunakan tanda terlihat atau tersembunyi, dan sesuaikan tampilannya agar sesuai dengan kebutuhan Anda. Bagus untuk menjaga data finansial atau klien tetap aman, GroupDocs.Watermark bekerja dengan semua lingkungan Python.

############################# Steps ############################
steps:
    enable: true
    title: "Tambahkan Watermark ke File Xls dengan Cepat"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Sebuah pustaka Python yang kuat yang memungkinkan Anda menambahkan watermark ke dokumen.
      ...
      1. **Kelas Utama: Watermarker.** Mulailah dengan membuat objek **Watermarker**. Berikan file Xls Anda, baik sebagai jalur file atau stream, untuk memulai.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Tambahkan watermark gambar ke file XLS
        ...
        with gw.Watermarker("input.xls") as watermarker:
            ...
            # Simpan file XLS dengan watermark
...
more_formats:
    enable: true
    title: "Tambahkan Watermark ke XLS dengan Python"
    exclude: "XLS"
    description: "Gunakan Python untuk menambahkan watermark kustom ke file XLS dan menjaga data Excel Anda tetap aman."
    items: 
        # format loop 1
        - name: "Tanda air PDF"
          format: "PDF"
