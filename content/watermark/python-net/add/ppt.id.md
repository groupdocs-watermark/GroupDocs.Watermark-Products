...
############################# Head ############################
head_title: "Python Watermark untuk File PowerPoint"
head_description: "Tambahkan watermark dinamis ke file PowerPoint dalam Python untuk menjaga presentasi Anda aman."

############################# Header ############################
title: "Lindungi PPT dengan Watermark Python" 
description: "Gunakan Python untuk menambahkan watermark kustom ke presentasi PowerPoint—bagus untuk bisnis dan pendidikan."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET memungkinkan Anda menambahkan watermark ke file PowerPoint (PPT) dalam Python. Tambahkan tanda terlihat atau tersembunyi ke slide Anda, dan sesuaikan gaya, ukuran, dan warnanya. Sempurna untuk menjaga presentasi Anda aman di lingkungan bisnis atau sekolah, GroupDocs.Watermark bekerja dengan semua versi Python utama.

############################# Steps ############################
steps:
    enable: true
    title: "Tambahkan Watermark ke File Ppt dengan Cepat"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Sebuah pustaka Python yang kuat yang memungkinkan Anda menambahkan watermark ke dokumen.
      ...
      1. **Kelas Utama: Watermarker.** Mulailah dengan membuat objek **Watermarker**. Berikan file Ppt Anda, baik sebagai jalur file atau stream, untuk memulai.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Tambahkan watermark gambar ke file PPT
        ...
        with gw.Watermarker("input.ppt") as watermarker:
            ...
            # Simpan file PPT dengan watermark
...
more_formats:
    enable: true
    title: "Amankan File PPT dengan Watermark Python"
    exclude: "PPT"
    description: "Tambahkan watermark lanjutan ke file PowerPoint dalam Python untuk mencegah penyalahgunaan dan melindungi konten Anda."
    items: 
        # format loop 1
        - name: "Tanda air PDF"
          format: "PDF"
