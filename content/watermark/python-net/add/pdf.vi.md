...
############################# Head ############################
head_title: "Watermark Python cho tài liệu PDF"
head_description: "Thêm watermark vào các tệp PDF trong Python để bảo vệ các tài liệu quan trọng của bạn."

############################# Header ############################
title: "Bảo vệ PDF với Watermark Python" 
description: "Sử dụng Python để thêm watermark vào các tệp PDF—lý tưởng cho tài liệu hợp pháp, tài chính và chính thức."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET là một API Python để thêm watermark vào các tệp PDF. Tùy chỉnh văn bản, hình ảnh và vị trí của watermark của bạn để phù hợp với bất kỳ tài liệu nào. Sử dụng nó để đánh dấu các hợp đồng, báo cáo hoặc tài liệu bí mật và giữ cho các PDF của bạn an toàn và chuyên nghiệp. GroupDocs.Watermark hỗ trợ độ trong suốt, xoay và xếp chồng cho watermark nâng cao.

############################# Steps ############################
steps:
    enable: true
    title: "Nhanh chóng thêm Watermark vào tệp Pdf"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** Một thư viện Python mạnh mẽ cho phép bạn thêm watermark vào tài liệu của bạn.
      ...
      1. **Lớp chính: Watermarker.** Bắt đầu bằng cách tạo một đối tượng **Watermarker**. Cung cấp cho nó tệp Pdf của bạn, dưới dạng đường dẫn tệp hoặc luồng, để bắt đầu.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Thêm một hình ảnh làm watermark vào một tệp PDF
...
more_formats:
    enable: true
    title: "Bảo vệ tệp PDF với Watermark Python"
    exclude: "PDF"
    description: "Thêm watermark tùy chỉnh vào các tệp PDF trong Python để bảo vệ các tài liệu nhạy cảm và chính thức của bạn."
    items: 
        # format loop 1
        - name: "Hình mờ PDF"
          format: "PDF"
