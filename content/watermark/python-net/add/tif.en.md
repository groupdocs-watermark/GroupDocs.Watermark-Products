...
############################# Head ############################
head_title: "Add Python Watermarks to TIF Images"
head_description: "Use Python to add watermarks to TIF images and protect your photos."

############################# Header ############################
title: "Advanced Watermarking for TIF with Python" 
description: "Add high-quality watermarks to TIF images in Python—great for photographers and archivists."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET is a Python toolkit for watermarking TIF images. Add text or image watermarks, adjust their look, and keep your high-resolution images safe. With batch processing and smart placement, GroupDocs.Watermark is perfect for anyone who needs to protect lots of images at once.

############################# Steps ############################
steps:
    enable: true
    title: "Quickly Add Watermarks to Tif Files"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/):** A powerful Python library that lets you add watermarks to your documents with ease.
      ...
      1. **Main Class: Watermarker.** Start by creating a **Watermarker** object. Give it your Tif file, either as a file path or a stream, to get started.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Add an image watermark to a TIF file
        ...
        with gw.Watermarker("input.tif") as watermarker:
            ...
            # Save the TIF file with the watermark
...
more_formats:
    enable: true
    title: "Protect TIF Images with Python Watermarks"
    exclude: "TIF"
    description: "Add custom watermarks to TIF images in Python to prevent copying and keep your work safe."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
