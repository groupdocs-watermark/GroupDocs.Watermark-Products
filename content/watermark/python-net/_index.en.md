...
head_description: "Python solution protect business documents with text and image watermarks. Popular formats like PDF, Word, Excel, PowerPoint are supported."

############################# Header ############################
title: "Access to watermarking technology in Python via .NET solutions"
description: "Protect your intellectual property and prevent unauthorized copying with this Python solution. It allows users to easily add watermarks to business documents in various formats, including PDF, Word, Excel, PowerPoint, images etc."
words:
  for: "for"

actions:
  main: "Use PyPi to download for free"
...
code:
  title: "Add watermark to PDF with Python"
  more: "More examples"
...
overview:
  ...
  features:
    # feature loop
    - title: "Python File Watermarking"
      content: "Protect your business documents with GroupDocs.Watermark for Python via .NET. Add text, images, diagrams, or email attachments as watermarks to various file formats."

    # feature loop
    - title: "Customize Watermarks for Your Needs"
      content: "GroupDocs.Watermark for Python via .NET provides extensive customization options for watermarks. Fine-tune text styles (bold, italic, font) and image properties (rotation, etc.) allow to customize documents processing."

    # feature loop
    - title: "Comprehensive Format Support"
      content: "GroupDocs.Watermark for Python via .NET seamlessly integrates with a wide range of file formats, including: PDF, MS Office like Word, Excel, PowerPoint, images such as JPEG, PNG, GIF, BMP, Visio diagrams, emails etc. Empower documents processing to achieve business goals."

    # feature loop
    - title: "Powerful Watermark Search and Update"
      content: "Get and update existing watermarks in watermarked documents. Modify text, style, image content, or remove them entirely. GroupDocs.Watermark for Python via .NET provides wide range of the watermarks processing."

############################# Platforms ############################
platforms:
  enable: true
  title: "Platform independence"
  description: "GroupDocs.Watermark for Python via .NET readily integrates with various operating systems and package managers."
  items:
    # platform loop
    - title: "Windows"
      image: "windows"
...
formats:
  ...
  description: |
    GroupDocs.Watermark for Python via .NET empowers you to process a diverse range of file formats. [Explore the full list](https://docs.groupdocs.com/watermark/python-net/supported-document-formats/).
  groups:
    # group loop
    - color: "green"
      content: |
...
features:
  enable: true
  title: "GroupDocs.Watermark for Python via .NET: Feature Set"
...
code_samples:
  enable: true
  title: "Code samples"
  description: "Dive into code examples showcasing common GroupDocs.Watermark for Python via .NET functionalities"
  items:
    # code sample loop
    - title: "Watermark a Document with an Image"
      content: |
        Leverage GroupDocs.Watermark for Python via .NET to enhance document security by adding image watermarks. Learn more: [Image watermarks](https://docs.groupdocs.com/watermark/python-net/adding-image-watermarks/#add-image-watermark-from-local-file/).
    ...
    - title: "Search and Modify Existing Watermarks"
      content: |
        GroupDocs.Watermark for Python via .NET empowers you to manage document watermarks. Select watermarks, modify their properties. Discover how: [Modify watermarks](https://docs.groupdocs.com/watermark/python-net/modifying-found-watermark-properties/#replacing-text/).
