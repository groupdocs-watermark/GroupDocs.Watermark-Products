...
############################# Head ############################
head_title: "Обнаруживайте водяные знаки в Excel-документах XLSX"
head_description: "Быстро находите скрытые водяные знаки с помощью GroupDocs.Watermark for Python via .NET в документах Excel."

############################# Header ############################
title: "Находите водяные знаки в таблицах XLSX" 
description: "Ищите и управляйте водяными знаками легко с помощью GroupDocs.Watermark for Python via .NET."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Скачайте с PyPi бесплатно"
      link: "https://releases.groupdocs.com/watermark/python-net/"
      
############################# About ############################
about:
    enable: true
    title: "Что может сделать GroupDocs.Watermark for Python via .NET?"
    link: "/watermark/python-net/"
    link_title: "Узнайте больше"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       GroupDocs.Watermark for Python via .NET позволяет просто управлять водяными знаками используя Python. Добавьте его в свои проекты Python, чтобы обнаруживать, обновлять или удалять водяные знаки в различных форматах, таких как Word, Excel и PDF.

############################# Steps ############################
steps:
    enable: true
    title: "Обнаружение водяных знаков Xlsx с использованием Python"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** позволяет эффективно обнаруживать водяные знаки в различных типах бизнес-документов. Добавьте этот инструмент в свой проект на Python, чтобы включить функции определения водяных знаков.
      ...
      1. Для начала инициализируйте класс **Watermarker** и загрузите свой документ Xlsx с помощью пути к файлу, потока файлов или массива байтов. Это подготовит файл к поиску водяных знаков.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ищите текстовые водяные знаки в XLSX
        import groupdocs.watermark as gw
        import groupdocs.watermark.search.searchcriteria as gwss

        # Создайте экземпляр Watermarker с использованием пути к XLSX
...
more_formats:
    enable: true
    title: "Обнаружение водяных знаков в поддерживаемых типах файлов"
    exclude: "XLSX"
    description: "Используйте GroupDocs.Watermark for Python via .NET для обнаружения водяных знаков в различных типах документов."
    items: 
        # format loop 1
