...
############################# Head ############################
head_title: "Find Hidden Watermarks in PPTX Slides"
head_description: "Use GroupDocs.Watermark for Python via .NET to reveal hidden watermarks in presentation files."

############################# Header ############################
title: "Quickly Reveal Watermarks in PPTX Presentations" 
description: "Easily detect and manage watermarks with GroupDocs.Watermark for Python via .NET."
...
steps:
    enable: true
    title: "Easily Detect Pptx Watermarks Using Python"
    content: |
...
more_formats:
    enable: true
    title: "Find Watermarks in All File Types"
    exclude: "PPTX"
    description: "Use GroupDocs.Watermark for Python via .NET to detect watermarks in multiple formats easily."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
