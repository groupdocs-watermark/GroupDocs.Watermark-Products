...
############################# Head ############################
head_title: "Phát hiện Watermark trong các tệp Excel XLSX"
head_description: "Nhanh chóng tìm các watermark ẩn bằng GroupDocs.Watermark for Python via .NET trong các tài liệu Excel."

############################# Header ############################
title: "Tìm Watermark trong các trang tính XLSX" 
description: "Tìm kiếm và xử lý watermark một cách dễ dàng với GroupDocs.Watermark for Python via .NET."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Tải xuống từ PyPi miễn phí"
      link: "https://releases.groupdocs.com/watermark/python-net/"
      
############################# About ############################
about:
    enable: true
    title: "GroupDocs.Watermark for Python via .NET có thể làm gì?"
    link: "/watermark/python-net/"
    link_title: "Tìm hiểu thêm"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       GroupDocs.Watermark for Python via .NET giúp dễ dàng quản lý watermark bằng Python. Thêm vào các dự án Python của bạn để phát hiện, cập nhật hoặc xóa watermark trong nhiều định dạng như Word, Excel và PDF.

############################# Steps ############################
steps:
    enable: true
    title: "Phát hiện Watermark Xlsx Bằng Python"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** giúp phát hiện watermark trong nhiều loại tài liệu thương mại khác nhau. Thêm công cụ này vào dự án Python của bạn để kích hoạt các tính năng phát hiện watermark.
      ...
      1. Đầu tiên, khởi tạo lớp **Watermarker** và tải tài liệu Xlsx của bạn bằng cách sử dụng đường dẫn tập tin, dòng tập tin hoặc mảng byte. Điều này chuẩn bị tệp để tìm kiếm watermark.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Tìm kiếm watermark văn bản trong XLSX
        import groupdocs.watermark as gw
        import groupdocs.watermark.search.searchcriteria as gwss

        # Tạo một instance của Watermarker bằng cách sử dụng đường dẫn đến XLSX
...
more_formats:
    enable: true
    title: "Phát hiện Watermark trong các loại tệp được hỗ trợ"
    exclude: "XLSX"
    description: "Sử dụng GroupDocs.Watermark for Python via .NET để phát hiện watermark trong nhiều loại tài liệu với ease."
    items: 
        # format loop 1
        - name: "Hình mờ PDF"
          format: "PDF"
