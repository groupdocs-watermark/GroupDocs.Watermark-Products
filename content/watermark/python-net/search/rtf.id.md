...
############################# Head ############################
head_title: "Deteksi Watermark di Dokumen RTF"
head_description: "Dengan cepat deteksi watermark dalam dokumen menggunakan GroupDocs.Watermark for Python via .NET."

############################# Header ############################
title: "Deteksi Watermark di Berkas RTF" 
description: "Gunakan GroupDocs.Watermark for Python via .NET untuk dengan mudah menemukan dan mengelola watermark."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Dapatkan paket PyPi"
      link: "https://releases.groupdocs.com/watermark/python-net/"
      
############################# About ############################
about:
    enable: true
    title: "Tentang GroupDocs.Watermark for Python via .NET"
    link: "/watermark/python-net/"
    link_title: "Pelajari selengkapnya"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       GroupDocs.Watermark for Python via .NET menjadikan tugas watermark sederhana dalam Python. Ini bekerja dengan PDF, Word, Excel, dan lainnya. Gunakan dalam aplikasi Python Anda untuk mencari, mengedit, atau menghapus watermark.

############################# Steps ############################
steps:
    enable: true
    title: "Deteksi Watermark Rtf Menggunakan Python"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** memudahkan Anda mendeteksi watermark dalam berbagai jenis dokumen bisnis. Tambahkan alat ini ke proyek Python Anda untuk mengaktifkan fitur deteksi watermark.
      ...
      1. Pertama, inisialisasi kelas **Watermarker** dan muat dokumen Rtf Anda menggunakan jalur file, aliran file, atau array byte. Ini menyiapkan file untuk pencarian watermark.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Cari watermark teks di dalam RTF
        import groupdocs.watermark as gw
        import groupdocs.watermark.search.searchcriteria as gwss

        # Buat instansi Watermarker menggunakan jalur menuju RTF
...
more_formats:
    enable: true
    title: "Format yang Didukung untuk Deteksi Watermark"
    exclude: "RTF"
    description: "Gunakan GroupDocs.Watermark for Python via .NET untuk menemukan dan mengelola watermark di banyak format."
    items: 
        # format loop 1
        - name: "Tanda air PDF"
          format: "PDF"
