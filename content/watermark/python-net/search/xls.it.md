...
############################# Head ############################
head_title: "Trova Filigrane Nascoste nei Fogli XLS"
head_description: "Utilizza GroupDocs.Watermark for Python via .NET per rilevare rapidamente le filigrane nei file di fogli di calcolo."

############################# Header ############################
title: "Rileva e Gestisci le Filigrane nei Fogli XLS" 
description: "Cerca facilmente le filigrane con GroupDocs.Watermark for Python via .NET."
...
about:
    enable: true
    title: "Ulteriori Informazioni su GroupDocs.Watermark for Python via .NET"
    link: "/watermark/python-net/"
    link_title: "Scopri di più"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       GroupDocs.Watermark aiuta gli sviluppatori Python a gestire le filigrane in Python. Usalo per modificare, rimuovere o localizzare filigrane in Excel, Word, PDF e altri formati.

############################# Steps ############################
steps:
    enable: true
    title: "Rileva le Filigrane di Xls Utilizzando Python"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** facilita la rilevazione delle filigrane in diversi tipi di documenti aziendali. Aggiungi questo strumento al tuo progetto Python per abilitare le funzionalità di rilevamento delle filigrane.
      ...
      1. Per iniziare, inizializza la classe **Watermarker** e carica il tuo documento Xls utilizzando un percorso di file, uno stream di file o un array di byte. Questo prepara il file per la ricerca delle filigrane.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Cerca i filigrane di testo all'interno di XLS
        import groupdocs.watermark as gw
        import groupdocs.watermark.search.searchcriteria as gwss

        # Crea un'istanza di Watermarker utilizzando il percorso di XLS
...
more_formats:
    enable: true
    title: "Ricerca di Filigrane tra i Formati"
    exclude: "XLS"
    description: "Trova e gestisci le filigrane in molti formati supportati."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
