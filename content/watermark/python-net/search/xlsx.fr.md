...
############################# Head ############################
head_title: "Détectez des filigranes dans des fichiers Excel XLSX"
head_description: "Trouvez rapidement des filigranes cachés en utilisant GroupDocs.Watermark for Python via .NET dans des documents Excel."

############################# Header ############################
title: "Trouvez des filigranes dans des tableurs XLSX" 
description: "Recherchez et gérez facilement des filigranes avec GroupDocs.Watermark for Python via .NET."
...
about:
    enable: true
    title: "Que peut faire GroupDocs.Watermark for Python via .NET?"
    link: "/watermark/python-net/"
    link_title: "En savoir plus"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       GroupDocs.Watermark for Python via .NET simplifie la gestion des filigranes en utilisant Python. Ajoutez-le à vos projets Python pour détecter, mettre à jour ou supprimer des filigranes dans divers formats comme Word, Excel et PDF.

############################# Steps ############################
steps:
    enable: true
    title: "Détectez les filigranes Xlsx avec Python"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** facilite la détection des filigranes dans différents types de documents professionnels. Ajoutez cet outil à votre projet Python pour activer les fonctionnalités de détection des filigranes.
      ...
      1. Pour commencer, initialisez la classe **Watermarker** et chargez votre document Xlsx à l'aide d'un chemin de fichier, d'un flux de fichiers ou d'un tableau d'octets. Cela prépare le fichier pour la recherche de filigranes.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Recherchez des filigranes de texte dans XLSX
        import groupdocs.watermark as gw
        import groupdocs.watermark.search.searchcriteria as gwss

        # Créez une instance de Watermarker en utilisant le chemin vers XLSX
...
more_formats:
    enable: true
    title: "Détectez des filigranes dans des types de fichiers pris en charge"
    exclude: "XLSX"
    description: "Utilisez GroupDocs.Watermark for Python via .NET pour détecter des filigranes dans différents types de documents avec facilité."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
