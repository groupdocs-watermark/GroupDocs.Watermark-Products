...
############################# Head ############################
head_title: "Detecte Marcas d'Água em Arquivos Excel XLSX"
head_description: "Encontre rapidamente marcas d'água ocultas usando GroupDocs.Watermark for Python via .NET em documentos do Excel."

############################# Header ############################
title: "Encontre Marcas d'Água em Planilhas XLSX" 
description: "Pesquise e gerencie marcas d'água facilmente com GroupDocs.Watermark for Python via .NET."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Baixe do PyPi Gratuitamente"
      link: "https://releases.groupdocs.com/watermark/python-net/"
      
############################# About ############################
about:
    enable: true
    title: "O que o GroupDocs.Watermark for Python via .NET Pode Fazer?"
    link: "/watermark/python-net/"
    link_title: "Saiba mais"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       GroupDocs.Watermark for Python via .NET torna simples gerenciar marcas d'água usando Python. Adicione ao seu projeto Python para detectar, atualizar ou remover marcas d'água em vários formatos como Word, Excel e PDF.

############################# Steps ############################
steps:
    enable: true
    title: "Detecte Marcas d'Água em Xlsx Usando Python"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** facilita a detecção de marcas d'água em diferentes tipos de documentos empresariais. Adicione esta ferramenta ao seu projeto Python para habilitar recursos de detecção de marcas d'água.
      ...
      1. Para começar, inicialize a classe **Watermarker** e carregue seu documento Xlsx utilizando um caminho de arquivo, fluxo de arquivo ou array de bytes. Isso prepara o arquivo para a busca de marcas d'água.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Buscar por marcas d'água de texto dentro de XLSX
        import groupdocs.watermark as gw
        import groupdocs.watermark.search.searchcriteria as gwss

        # Crie uma instância de Watermarker utilizando o caminho para XLSX
...
more_formats:
    enable: true
    title: "Detecte Marcas d'Água em Tipos de Arquivo Suportados"
    exclude: "XLSX"
    description: "Use GroupDocs.Watermark for Python via .NET para detectar marcas d'água em diferentes tipos de documentos com facilidade."
    items: 
        # format loop 1
