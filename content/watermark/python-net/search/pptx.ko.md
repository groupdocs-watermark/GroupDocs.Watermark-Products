...
############################# Head ############################
head_title: "PPTX 슬라이드에서 숨겨진 워터마크 찾기"
head_description: "GroupDocs.Watermark for Python via .NET을 사용하여 발표 파일 내 숨겨진 워터마크를 공개하세요."

############################# Header ############################
title: "PPTX 프레젠테이션에서 워터마크 쉽게 찾아보기" 
description: "GroupDocs.Watermark for Python via .NET을 사용하여 워터마크를 쉽게 감지하고 관리하세요."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET는 Python에서 워터마크를 완벽하게 제어할 수 있게 해 줍니다. PDF, Excel, Word 등 다양한 파일 유형과 함께 작동하며 Python 앱에 매끄럽게 통합됩니다.

############################# Steps ############################
steps:
    enable: true
    title: "Python를 사용하여 Pptx 워터마크 감지"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)**는 다양한 비즈니스 문서에서 워터마크를 감지하는 것을 가능하게 합니다. 이 도구를 Python 프로젝트에 추가하여 워터마크 감지 기능을 활성화하세요.
      ...
      1. Pptx 문서를 파일 경로, 파일 스트림 또는 바이트 배열을 사용하여 로드하기 위해 **Watermarker** 클래스를 초기화합니다. 이로써 워터마크 검색을 위한 파일 준비가 완료됩니다.
    ...
    code:
      ...
      content: |
        ...
        # PPTX의 경로를 사용하여 Watermarker 인스턴스 생성
...
more_formats:
    enable: true
    title: "모든 파일 유형에서 워터마크 찾기"
    exclude: "PPTX"
    description: "GroupDocs.Watermark for Python via .NET을 사용하여 여러 형식에서 워터마크를 쉽게 감지하세요."
    items: 
        # format loop 1
        - name: "워터마크 PDF"
          format: "PDF"
