...
############################# Head ############################
head_title: "查找 PPTX 幻灯片中的隐藏水印"
head_description: "使用 GroupDocs.Watermark for Python via .NET 发现演示文件中的隐形水印。"

############################# Header ############################
title: "快速揭示 PPTX 演示文稿中的水印" 
description: "使用 GroupDocs.Watermark for Python via .NET 轻松检测和管理水印。"
...
about:
    enable: true
    title: "GroupDocs.Watermark for Python via .NET 概述"
    link: "/watermark/python-net/"
    link_title: "了解更多"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       GroupDocs.Watermark for Python via .NET 让您在 Python 中完全控制水印。它支持多种文件类型——PDF、Excel、Word——并与 Python应用程序集成顺畅。

############################# Steps ############################
steps:
    enable: true
    title: "使用 Python 检测 Pptx 水印"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** 使您能够轻松检测各种商业文档中的水印。将此工具添加到您的 Python 项目中，以启用水印检测功能。
      
      1. 首先，初始化 **Watermarker** 类，并使用文件路径、文件流或字节数组加载您的 Pptx 文档。这为水印搜索做好准备。
...
more_formats:
    ...
    title: "在所有文件类型中查找水印"
    exclude: "PPTX"
    description: "使用 GroupDocs.Watermark for Python via .NET 轻松检测多种格式中的水印。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
