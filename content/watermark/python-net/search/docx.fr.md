...
############################# Head ############################
head_title: "Trouvez des filigranes cachés dans les documents DOCX"
head_description: "Utilisez GroupDocs.Watermark for Python via .NET pour détecter facilement des filigranes cachés dans vos fichiers."

############################# Header ############################
title: "Trouvez facilement des filigranes dans les fichiers DOCX" 
description: "Utilisez GroupDocs.Watermark for Python via .NET pour repérer et gérer rapidement des filigranes."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Obtenez le package gratuit PyPi"
      link: "https://releases.groupdocs.com/watermark/python-net/"
      
############################# About ############################
about:
    enable: true
    title: "Découvrez les fonctionnalités de GroupDocs.Watermark for Python via .NET"
    link: "/watermark/python-net/"
    link_title: "En savoir plus"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       GroupDocs.Watermark for Python via .NET vous offre tous les outils nécessaires pour travailler avec des filigranes en Python. Il prend en charge l'ajout, la suppression et la détection de filigranes dans des formats tels que PDF, Word, Excel et autres. Apportez un support de filigrane dans vos applications avec GroupDocs.Watermark for Python via .NET.

############################# Steps ############################
steps:
    enable: true
    title: "Détectez les filigranes Docx avec Python"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** facilite la détection des filigranes dans différents types de documents professionnels. Ajoutez cet outil à votre projet Python pour activer les fonctionnalités de détection des filigranes.
      ...
      1. Pour commencer, initialisez la classe **Watermarker** et chargez votre document Docx à l'aide d'un chemin de fichier, d'un flux de fichiers ou d'un tableau d'octets. Cela prépare le fichier pour la recherche de filigranes.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Recherchez des filigranes de texte dans DOCX
        import groupdocs.watermark as gw
        import groupdocs.watermark.search.searchcriteria as gwss

        # Créez une instance de Watermarker en utilisant le chemin vers DOCX
...
more_formats:
    enable: true
    title: "Travaillez avec des filigranes dans de nombreux formats"
    exclude: "DOCX"
    description: "Détectez et gérez facilement des filigranes dans divers formats de fichiers."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
