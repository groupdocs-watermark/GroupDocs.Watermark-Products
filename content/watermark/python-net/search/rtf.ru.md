...
############################# Head ############################
head_title: "Обнаружьте водяные знаки в документах RTF"
head_description: "Быстро определяйте водяные знаки в документах с помощью GroupDocs.Watermark for Python via .NET."

############################# Header ############################
title: "Обнаружьте водяные знаки в файлах RTF" 
description: "Используйте GroupDocs.Watermark for Python via .NET для легкого поиска и управления водяными знаками."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Получите пакет PyPi"
      link: "https://releases.groupdocs.com/watermark/python-net/"
      
############################# About ############################
about:
    enable: true
    title: "О GroupDocs.Watermark for Python via .NET"
    link: "/watermark/python-net/"
    link_title: "Узнайте больше"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       GroupDocs.Watermark for Python via .NET упрощает задачи, связанные с водяными знаками в Python. Он работает с PDF, Word, Excel и другими форматами. Используйте его в своих приложениях на Python для поиска, редактирования или удаления водяных знаков.

############################# Steps ############################
steps:
    enable: true
    title: "Обнаружение водяных знаков Rtf с использованием Python"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** позволяет эффективно обнаруживать водяные знаки в различных типах бизнес-документов. Добавьте этот инструмент в свой проект на Python, чтобы включить функции определения водяных знаков.
      ...
      1. Для начала инициализируйте класс **Watermarker** и загрузите свой документ Rtf с помощью пути к файлу, потока файлов или массива байтов. Это подготовит файл к поиску водяных знаков.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ищите текстовые водяные знаки в RTF
        import groupdocs.watermark as gw
        import groupdocs.watermark.search.searchcriteria as gwss

        # Создайте экземпляр Watermarker с использованием пути к RTF
...
more_formats:
    enable: true
    title: "Поддерживаемые форматы для обнаружения водяных знаков"
    exclude: "RTF"
    description: "Используйте GroupDocs.Watermark for Python via .NET для поиска и управления водяными знаками в различных форматах."
    items: 
        # format loop 1
