...
############################# Head ############################
head_title: "检测 DOC 文件中的隐藏水印"
head_description: "使用 GroupDocs.Watermark for Python via .NET 轻松找到文档中的隐形水印。"

############################# Header ############################
title: "轻松查找 DOC 文件中的水印" 
description: "使用 GroupDocs.Watermark for Python via .NET 快速检测和管理隐藏的水印。"
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET 帮助您处理水印。您可以在 PDF、Word、Excel 等文档中创建、查找、编辑和删除水印。使用 GroupDocs.Watermark for Python via .NET 为您的 Python 项目添加水印工具。

############################# Steps ############################
steps:
    enable: true
    title: "使用 Python 检测 Doc 水印"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** 使您能够轻松检测各种商业文档中的水印。将此工具添加到您的 Python 项目中，以启用水印检测功能。
      
      1. 首先，初始化 **Watermarker** 类，并使用文件路径、文件流或字节数组加载您的 Doc 文档。这为水印搜索做好准备。
...
more_formats:
    ...
    title: "支持的水印搜索文件格式"
    exclude: "DOC"
    description: "快速查找并处理多种不同文档类型中的水印。"
    items: 
        # format loop 1
        - name: "水印 PDF"
          format: "PDF"
