...
############################# Head ############################
head_title: "Detect Hidden Watermarks in DOC Files"
head_description: "Easily find invisible watermarks in documents using GroupDocs.Watermark for Python via .NET."

############################# Header ############################
title: "Find Watermarks in DOC Files with Ease" 
description: "Use GroupDocs.Watermark for Python via .NET to quickly detect and manage hidden watermarks."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Download the PyPi package"
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET helps you handle watermarks. You can create, find, edit, and delete watermarks in PDFs, Word, Excel, and more. Add watermark tools to your Python projects with GroupDocs.Watermark for Python via .NET.

############################# Steps ############################
steps:
    enable: true
    title: "Easily Detect Doc Watermarks Using Python"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** makes it easy to detect watermarks in different types of business documents. Add this tool to your Python project to enable watermark detection features.
      ...
      1. To begin, initialize the **Watermarker** class and load your Doc document using a file path, file stream, or byte array. This prepares the file for watermark search.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Search for text watermarks inside DOC
        import groupdocs.watermark as gw
        import groupdocs.watermark.search.searchcriteria as gwss

        # Create a Watermarker instance using the path to DOC
...
more_formats:
    enable: true
    title: "Supported File Formats for Watermark Search"
    exclude: "DOC"
    description: "Quickly find and work with watermarks in many different document types."
    items: 
        # format loop 1
        - name: "Watermark PDF"
          format: "PDF"
