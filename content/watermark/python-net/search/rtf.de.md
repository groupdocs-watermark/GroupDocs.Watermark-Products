...
############################# Head ############################
head_title: "Entdecke Wasserzeichen in RTF Dokumenten"
head_description: "Erkenne Wasserzeichen in Dokumenten schnell mit GroupDocs.Watermark for Python via .NET."

############################# Header ############################
title: "Wasserzeichen in RTF Dateien erkennen" 
description: "Verwende GroupDocs.Watermark for Python via .NET, um Wasserzeichen einfach zu finden und zu verwalten."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Hole dir das PyPi-Paket"
      link: "https://releases.groupdocs.com/watermark/python-net/"
      
############################# About ############################
about:
    enable: true
    title: "Über GroupDocs.Watermark for Python via .NET"
    link: "/watermark/python-net/"
    link_title: "Erfahre mehr"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       GroupDocs.Watermark for Python via .NET macht Wasserzeichenaufgaben einfach in Python. Es funktioniert mit PDFs, Word, Excel und mehr. Nutze es in deinen Python-Anwendungen, um Wasserzeichen zu suchen, zu bearbeiten oder zu entfernen.

############################# Steps ############################
steps:
    enable: true
    title: "Rtf Wasserzeichen mit Python erkennen"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** ermöglicht es dir, Wasserzeichen in verschiedenen Geschäftsdokumenten zu erkennen. Integriere dieses Tool in dein Python-Projekt, um die Funktionen zur Wasserzeichenerkennung zu aktivieren.
      ...
      1. Zu Beginn initialisiere die **Watermarker**-Klasse und lade dein Rtf-Dokument mit einem Dateipfad, einem Dateistream oder einem Byte-Array. Dies bereitet die Datei für die Wasserzeichensuche vor.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Suche nach Text-Wasserzeichen in RTF
        import groupdocs.watermark as gw
        import groupdocs.watermark.search.searchcriteria as gwss

        # Erstelle eine Watermarker Instanz mit dem Pfad zu RTF
...
more_formats:
    enable: true
    title: "Unterstützte Formate zur Wasserzeichenerkennung"
    exclude: "RTF"
    description: "Verwende GroupDocs.Watermark for Python via .NET, um Wasserzeichen in vielen Formaten zu finden und zu verwalten."
    items: 
        # format loop 1
