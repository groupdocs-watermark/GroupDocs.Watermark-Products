...
############################# Head ############################
head_title: "ค้นหาลายน้ำซ่อนอยู่ในสไลด์ PPTX"
head_description: "ใช้ GroupDocs.Watermark for Python via .NET เพื่อเปิดเผยลายน้ำที่ซ่อนอยู่ในไฟล์นำเสนอ"

############################# Header ############################
title: "เปิดเผยลายน้ำในสไลด์ PPTX อย่างรวดเร็ว" 
description: "ตรวจจับและจัดการลายน้ำได้อย่างง่ายดายด้วย GroupDocs.Watermark for Python via .NET"
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET ให้คุณควบคุมลายน้ำใน Python ได้อย่างเต็มที่ มันทำงานกับหลายประเภทไฟล์—PDF, Excel, Word—และรวมเข้ากับแอป Python ได้อย่างราบรื่น

############################# Steps ############################
steps:
    enable: true
    title: "ตรวจจับลายน้ำ Pptx ด้วย Python"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** ช่วยให้คุณตรวจจับลายน้ำในเอกสารธุรกิจประเภทต่างๆ ได้อย่างสะดวก เพิ่มเครื่องมือนี้ลงในโครงการ Python ของคุณเพื่อเปิดใช้งานฟีเจอร์การตรวจจับลายน้ำ
      ...
      1. เริ่มต้นโดยการเริ่มต้นคลาส **Watermarker** และโหลดเอกสาร Pptx ของคุณโดยใช้เส้นทางไฟล์, สตรีมไฟล์ หรืออาร์เรย์ของไบต์ ซึ่งจะเตรียมไฟล์สำหรับการค้นหาลายน้ำ
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # ค้นหาลายน้ำข้อความภายใน PPTX
        import groupdocs.watermark as gw
        import groupdocs.watermark.search.searchcriteria as gwss

        # สร้างอินสแตนซ์ Watermarker โดยใช้เส้นทางไปยัง PPTX
...
more_formats:
    enable: true
    title: "ค้นหาลายน้ำในประเภทไฟล์ทั้งหมด"
    exclude: "PPTX"
    description: "ใช้ GroupDocs.Watermark for Python via .NET เพื่อตรวจจับลายน้ำในหลายรูปแบบได้อย่างง่ายดาย"
    items: 
        # format loop 1
        - name: "ลายน้ำ PDF"
          format: "PDF"
