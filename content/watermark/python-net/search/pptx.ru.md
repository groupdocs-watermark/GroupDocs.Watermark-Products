...
############################# Head ############################
head_title: "Находите скрытые водяные знаки в слайдах PPTX"
head_description: "Используйте GroupDocs.Watermark for Python via .NET для выявления скрытых водяных знаков в презентационных файлах."

############################# Header ############################
title: "Быстро выявляйте водяные знаки в презентациях PPTX" 
description: "Легко обнаруживайте и управляйте водяными знаками с помощью GroupDocs.Watermark for Python via .NET."
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET предоставляет полный контроль над водяными знаками в Python. Он работает с множеством типов файлов—PDF, Excel, Word—и интегрируется в приложения Python.

############################# Steps ############################
steps:
    enable: true
    title: "Обнаружение водяных знаков Pptx с использованием Python"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** позволяет эффективно обнаруживать водяные знаки в различных типах бизнес-документов. Добавьте этот инструмент в свой проект на Python, чтобы включить функции определения водяных знаков.
      ...
      1. Для начала инициализируйте класс **Watermarker** и загрузите свой документ Pptx с помощью пути к файлу, потока файлов или массива байтов. Это подготовит файл к поиску водяных знаков.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Ищите текстовые водяные знаки в PPTX
        import groupdocs.watermark as gw
        import groupdocs.watermark.search.searchcriteria as gwss

        # Создайте экземпляр Watermarker с использованием пути к PPTX
...
more_formats:
    enable: true
    title: "Находите водяные знаки во всех типах файлов"
    exclude: "PPTX"
    description: "Используйте GroupDocs.Watermark for Python via .NET для обнаружения водяных знаков в различных форматах легко."
    items: 
        # format loop 1
