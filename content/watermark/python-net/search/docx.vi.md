...
############################# Head ############################
head_title: "Tìm Watermark ẩn trong các tài liệu DOCX"
head_description: "Sử dụng GroupDocs.Watermark for Python via .NET để phát hiện nhanh chóng các watermark ẩn trong các tệp của bạn."

############################# Header ############################
title: "Nhanh chóng tìm Watermark trong các tệp DOCX" 
description: "Sử dụng GroupDocs.Watermark for Python via .NET để phát hiện và xử lý các watermark một cách nhanh chóng."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Nhận miễn phí gói PyPi"
      link: "https://releases.groupdocs.com/watermark/python-net/"
      
############################# About ############################
about:
    enable: true
    title: "Khám phá các tính năng của GroupDocs.Watermark for Python via .NET"
    link: "/watermark/python-net/"
    link_title: "Tìm hiểu thêm"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       GroupDocs.Watermark for Python via .NET cung cấp cho bạn tất cả các công cụ để làm việc với watermark trong Python. Nó hỗ trợ thêm, xóa và phát hiện watermark trong các định dạng như PDF, Word, Excel và nhiều định dạng khác. Đưa sự hỗ trợ watermark vào ứng dụng của bạn với GroupDocs.Watermark for Python via .NET.

############################# Steps ############################
steps:
    enable: true
    title: "Phát hiện Watermark Docx Bằng Python"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** giúp phát hiện watermark trong nhiều loại tài liệu thương mại khác nhau. Thêm công cụ này vào dự án Python của bạn để kích hoạt các tính năng phát hiện watermark.
      ...
      1. Đầu tiên, khởi tạo lớp **Watermarker** và tải tài liệu Docx của bạn bằng cách sử dụng đường dẫn tập tin, dòng tập tin hoặc mảng byte. Điều này chuẩn bị tệp để tìm kiếm watermark.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Tìm kiếm watermark văn bản trong DOCX
        import groupdocs.watermark as gw
        import groupdocs.watermark.search.searchcriteria as gwss

        # Tạo một instance của Watermarker bằng cách sử dụng đường dẫn đến DOCX
...
more_formats:
    enable: true
    title: "Làm việc với Watermark trong nhiều định dạng"
    exclude: "DOCX"
    description: "Nhanh chóng phát hiện và xử lý watermark trong nhiều định dạng tệp khác nhau."
    items: 
        # format loop 1
        - name: "Hình mờ PDF"
          format: "PDF"
