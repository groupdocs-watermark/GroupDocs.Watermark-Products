...
############################# Head ############################
head_title: "Виявлення водяних знаків у презентаціях PPT"
head_description: "Використовуйте GroupDocs.Watermark for Python via .NET для швидкого виявлення водяних знаків у файлах презентацій."

############################# Header ############################
title: "Швидко знаходьте водяні знаки у слайдах PPT" 
description: "Використовуйте GroupDocs.Watermark for Python via .NET для легкого пошуку та управління водяними знаками у презентаціях."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Отримайте безкоштовно з PyPi"
      link: "https://releases.groupdocs.com/watermark/python-net/"
      
############################# About ############################
about:
    enable: true
    title: "Усе про GroupDocs.Watermark for Python via .NET"
    link: "/watermark/python-net/"
    link_title: "Дізнатися більше"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       GroupDocs.Watermark for Python via .NET надає вам інструменти для управління водяними знаками у Python. Працюйте з PDF, Word, Excel та іншими. Шукайте, створюйте або видаляйте водяні знаки у ваших додатках Python легко за допомогою GroupDocs.Watermark for Python via .NET.

############################# Steps ############################
steps:
    enable: true
    title: "Виявлення водяних знаків Ppt за допомогою Python"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** спрощує виявлення водяних знаків у різноманітних ділових документах. Додайте цей інструмент до свого проєкту Python, щоб активувати функції виявлення водяних знаків.
      ...
      1. На початку ініціалізуйте клас **Watermarker** та завантажте свій документ Ppt за допомогою шляху до файлу, потокового файлу або масиву байтів. Це підготує файл для пошуку водяних знаків.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Шукати текстові водяні знаки у PPT
        import groupdocs.watermark as gw
        import groupdocs.watermark.search.searchcriteria as gwss

        # Створіть екземпляр Watermarker, використовуючи шлях до PPT
...
more_formats:
    enable: true
    title: "Виявлення водяних знаків в усіх підтримуваних форматах"
    exclude: "PPT"
    description: "Знайдіть та керуйте водяними знаками у багатьох поширених типах документів."
    items: 
        # format loop 1
