...
############################# Head ############################
head_title: "XLSX Excel 파일에서 워터마크 감지"
head_description: "GroupDocs.Watermark for Python via .NET을 사용하여 Excel 문서 내 숨겨진 워터마크를 빠르게 찾으세요."

############################# Header ############################
title: "XLSX 스프레드시트에서 워터마크 찾기" 
description: "GroupDocs.Watermark for Python via .NET을 사용하여 워터마크를 쉽게 검색하고 처리하세요."
...
header_actions:
  ...
  items:
    #  loop
    - title: "PyPi에서 무료로 다운로드"
      link: "https://releases.groupdocs.com/watermark/python-net/"
      
############################# About ############################
about:
    enable: true
    title: "GroupDocs.Watermark for Python via .NET의 기능은?"
    link: "/watermark/python-net/"
    link_title: "자세히 알아보기"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       GroupDocs.Watermark for Python via .NET은 Python를 사용하여 워터마크를 관리하는 것을 간단하게 만듭니다. 워터마크를 감지, 업데이트 또는 제거하기 위해 Python 프로젝트에 추가하세요.

############################# Steps ############################
steps:
    enable: true
    title: "Python를 사용하여 Xlsx 워터마크 감지"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)**는 다양한 비즈니스 문서에서 워터마크를 감지하는 것을 가능하게 합니다. 이 도구를 Python 프로젝트에 추가하여 워터마크 감지 기능을 활성화하세요.
      ...
      1. Xlsx 문서를 파일 경로, 파일 스트림 또는 바이트 배열을 사용하여 로드하기 위해 **Watermarker** 클래스를 초기화합니다. 이로써 워터마크 검색을 위한 파일 준비가 완료됩니다.
    ...
    code:
      ...
      content: |
        ...
        # XLSX의 경로를 사용하여 Watermarker 인스턴스 생성
...
more_formats:
    enable: true
    title: "지원되는 파일 유형에서 워터마크 감지"
    exclude: "XLSX"
    description: "GroupDocs.Watermark for Python via .NET을 사용하여 다양한 문서 유형에서 워터마크를 손쉽게 감지하세요."
    items: 
        # format loop 1
        - name: "워터마크 PDF"
          format: "PDF"
