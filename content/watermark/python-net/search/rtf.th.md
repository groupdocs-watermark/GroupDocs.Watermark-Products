...
############################# Head ############################
head_title: "ค้นหาลายน้ำในเอกสาร RTF"
head_description: "ตรวจจับลายน้ำในเอกสารอย่างรวดเร็วด้วย GroupDocs.Watermark for Python via .NET"

############################# Header ############################
title: "ตรวจจับลายน้ำในไฟล์ RTF" 
description: "ใช้ GroupDocs.Watermark for Python via .NET เพื่อตรวจจับและจัดการลายน้ำได้อย่างง่ายดาย"
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET ทำให้การทำงานกับลายน้ำใน Python เป็นเรื่องง่าย มันทำงานกับ PDF, Word, Excel, และอื่นๆ ใช้ในแอป Python ของคุณเพื่อค้นหา, แก้ไข, หรือกำจัดลายน้ำ

############################# Steps ############################
steps:
    enable: true
    title: "ตรวจจับลายน้ำ Rtf ด้วย Python"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** ช่วยให้คุณตรวจจับลายน้ำในเอกสารธุรกิจประเภทต่างๆ ได้อย่างสะดวก เพิ่มเครื่องมือนี้ลงในโครงการ Python ของคุณเพื่อเปิดใช้งานฟีเจอร์การตรวจจับลายน้ำ
      ...
      1. เริ่มต้นโดยการเริ่มต้นคลาส **Watermarker** และโหลดเอกสาร Rtf ของคุณโดยใช้เส้นทางไฟล์, สตรีมไฟล์ หรืออาร์เรย์ของไบต์ ซึ่งจะเตรียมไฟล์สำหรับการค้นหาลายน้ำ
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # ค้นหาลายน้ำข้อความภายใน RTF
        import groupdocs.watermark as gw
        import groupdocs.watermark.search.searchcriteria as gwss

        # สร้างอินสแตนซ์ Watermarker โดยใช้เส้นทางไปยัง RTF
...
more_formats:
    enable: true
    title: "รูปแบบที่รองรับสำหรับการตรวจจับลายน้ำ"
    exclude: "RTF"
    description: "ใช้ GroupDocs.Watermark for Python via .NET เพื่อค้นหาและจัดการลายน้ำข้ามรูปแบบหลายประเภท"
    items: 
        # format loop 1
        - name: "ลายน้ำ PDF"
          format: "PDF"
