...
############################# Head ############################
head_title: "Detectar Marcas de Agua en Archivos Excel XLSX"
head_description: "Encuentra rápidamente marcas de agua ocultas usando GroupDocs.Watermark for Python via .NET en documentos de Excel."

############################# Header ############################
title: "Encontrar Marcas de Agua en Hojas XLSX" 
description: "Busca y maneja marcas de agua fácilmente con GroupDocs.Watermark for Python via .NET."
...
about:
    enable: true
    title: "¿Qué Puede Hacer GroupDocs.Watermark for Python via .NET?"
    link: "/watermark/python-net/"
    link_title: "Obtenga más información"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       GroupDocs.Watermark for Python via .NET simplifica la gestión de marcas de agua usando Python. Agrégalo a tus proyectos Python para detectar, actualizar o eliminar marcas de agua en varios formatos como Word, Excel y PDF.

############################# Steps ############################
steps:
    enable: true
    title: "Detectar Marcas de Agua en Xlsx Usando Python"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** facilita la detección de marcas de agua en diferentes tipos de documentos comerciales. Agrega esta herramienta a tu proyecto de Python para habilitar las funciones de detección de marcas de agua.
      ...
      1. Para comenzar, inicializa la clase **Watermarker** y carga tu documento Xlsx utilizando una ruta de archivo, un flujo de archivo o un arreglo de bytes. Esto prepara el archivo para la búsqueda de marcas de agua.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Buscar marcas de agua de texto dentro de XLSX
        import groupdocs.watermark as gw
        import groupdocs.watermark.search.searchcriteria as gwss

        # Crear una instancia de Watermarker utilizando la ruta a XLSX
...
more_formats:
    enable: true
    title: "Detectar Marcas de Agua en Tipos de Archivos Soportados"
    exclude: "XLSX"
    description: "Usa GroupDocs.Watermark for Python via .NET para detectar marcas de agua en diferentes tipos de documentos con facilidad."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
