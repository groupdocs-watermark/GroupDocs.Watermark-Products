...
############################# Head ############################
head_title: "Deteksi Watermark di Berkas Excel XLSX"
head_description: "Dengan cepat temukan watermark tersembunyi menggunakan GroupDocs.Watermark for Python via .NET dalam dokumen Excel."

############################# Header ############################
title: "Temukan Watermark di Spreadsheet XLSX" 
description: "Cari dan tangani watermark dengan mudah menggunakan GroupDocs.Watermark for Python via .NET."
...
about:
    enable: true
    title: "Apa yang Dapat Dilakukan GroupDocs.Watermark for Python via .NET?"
    link: "/watermark/python-net/"
    link_title: "Pelajari selengkapnya"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       GroupDocs.Watermark for Python via .NET memudahkan untuk mengelola watermark menggunakan Python. Tambahkan ke proyek Python Anda untuk mendeteksi, memperbarui, atau menghapus watermark dalam berbagai format seperti Word, Excel, dan PDF.

############################# Steps ############################
steps:
    enable: true
    title: "Deteksi Watermark Xlsx Menggunakan Python"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** memudahkan Anda mendeteksi watermark dalam berbagai jenis dokumen bisnis. Tambahkan alat ini ke proyek Python Anda untuk mengaktifkan fitur deteksi watermark.
      ...
      1. Pertama, inisialisasi kelas **Watermarker** dan muat dokumen Xlsx Anda menggunakan jalur file, aliran file, atau array byte. Ini menyiapkan file untuk pencarian watermark.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Cari watermark teks di dalam XLSX
        import groupdocs.watermark as gw
        import groupdocs.watermark.search.searchcriteria as gwss

        # Buat instansi Watermarker menggunakan jalur menuju XLSX
...
more_formats:
    enable: true
    title: "Deteksi Watermark di Jenis Berkas yang Didukung"
    exclude: "XLSX"
    description: "Gunakan GroupDocs.Watermark for Python via .NET untuk mendeteksi watermark dalam berbagai jenis dokumen dengan mudah."
    items: 
        # format loop 1
        - name: "Tanda air PDF"
          format: "PDF"
