...
head_description: "GroupDocs.Watermark for Python via .NET을 사용하여 파일 내 숨겨진 워터마크를 쉽게 감지하세요."

############################# Header ############################
title: "DOCX 파일에서 워터마크 찾기" 
description: "GroupDocs.Watermark for Python via .NET을 사용하여 워터마크를 빠르게 찾아 처리하세요."
...
header_actions:
  ...
  items:
    #  loop
    - title: "무료 PyPi 패키지 받기"
      link: "https://releases.groupdocs.com/watermark/python-net/"
      
############################# About ############################
about:
    enable: true
    title: "GroupDocs.Watermark for Python via .NET 기능 탐색"
    link: "/watermark/python-net/"
    link_title: "자세히 알아보기"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       GroupDocs.Watermark for Python via .NET는 Python에서 워터마크 작업을 위한 모든 도구를 제공합니다. PDF, Word, Excel 등에서 워터마크를 추가, 제거 및 감지하는 것을 지원합니다. GroupDocs.Watermark for Python via .NET를 사용하여 앱에 워터마크 지원을 가져오세요.

############################# Steps ############################
steps:
    enable: true
    title: "Python를 사용하여 Docx 워터마크 감지"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)**는 다양한 비즈니스 문서에서 워터마크를 감지하는 것을 가능하게 합니다. 이 도구를 Python 프로젝트에 추가하여 워터마크 감지 기능을 활성화하세요.
      ...
      1. Docx 문서를 파일 경로, 파일 스트림 또는 바이트 배열을 사용하여 로드하기 위해 **Watermarker** 클래스를 초기화합니다. 이로써 워터마크 검색을 위한 파일 준비가 완료됩니다.
    ...
    code:
      ...
      content: |
        ...
        # DOCX의 경로를 사용하여 Watermarker 인스턴스 생성
...
more_formats:
    enable: true
    title: "다양한 형식에서 워터마크 작업하기"
    exclude: "DOCX"
    description: "여러 형식에서 워터마크를 쉽게 감지하고 관리하세요."
    items: 
        # format loop 1
        - name: "워터마크 PDF"
          format: "PDF"
