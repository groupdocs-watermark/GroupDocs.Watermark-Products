...
############################# Head ############################
head_title: "ตรวจจับลายน้ำซ่อนอยู่ในไฟล์ DOC"
head_description: "ค้นหาลายน้ำที่มองไม่เห็นในเอกสารโดยใช้ GroupDocs.Watermark for Python via .NET"

############################# Header ############################
title: "ค้นหาลายน้ำในไฟล์ DOC อย่างสะดวก" 
description: "ใช้ GroupDocs.Watermark for Python via .NET เพื่อตรวจจับและจัดการลายน้ำที่ซ่อนอยู่ได้อย่างรวดเร็ว"
...
about:
    ...
    content: |
       GroupDocs.Watermark for Python via .NET ช่วยให้คุณจัดการลายน้ำ คุณสามารถสร้าง, ค้นหา, แก้ไข, และลบลายน้ำใน PDF, Word, Excel และอื่นๆ เพิ่มเครื่องมือลายน้ำลงในโครงการ Python ของคุณด้วย GroupDocs.Watermark for Python via .NET

############################# Steps ############################
steps:
    enable: true
    title: "ตรวจจับลายน้ำ Doc ด้วย Python"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** ช่วยให้คุณตรวจจับลายน้ำในเอกสารธุรกิจประเภทต่างๆ ได้อย่างสะดวก เพิ่มเครื่องมือนี้ลงในโครงการ Python ของคุณเพื่อเปิดใช้งานฟีเจอร์การตรวจจับลายน้ำ
      ...
      1. เริ่มต้นโดยการเริ่มต้นคลาส **Watermarker** และโหลดเอกสาร Doc ของคุณโดยใช้เส้นทางไฟล์, สตรีมไฟล์ หรืออาร์เรย์ของไบต์ ซึ่งจะเตรียมไฟล์สำหรับการค้นหาลายน้ำ
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # ค้นหาลายน้ำข้อความภายใน DOC
        import groupdocs.watermark as gw
        import groupdocs.watermark.search.searchcriteria as gwss

        # สร้างอินสแตนซ์ Watermarker โดยใช้เส้นทางไปยัง DOC
...
more_formats:
    enable: true
    title: "รูปแบบไฟล์ที่รองรับสำหรับการค้นหาลายน้ำ"
    exclude: "DOC"
    description: "ค้นหาและทำงานกับลายน้ำในเอกสารประเภทต่างๆ ได้อย่างรวดเร็ว"
    items: 
        # format loop 1
        - name: "ลายน้ำ PDF"
          format: "PDF"
