...
############################# Head ############################
head_title: "Temukan Watermark Tersembunyi di Sheet XLS"
head_description: "Gunakan GroupDocs.Watermark for Python via .NET untuk cepat mendeteksi watermark dalam berkas spreadsheet."

############################# Header ############################
title: "Deteksi dan Kelola Watermark di Sheet XLS" 
description: "Dengan mudah cari watermark dengan GroupDocs.Watermark for Python via .NET."
...
about:
    enable: true
    title: "Lebih Lanjut tentang GroupDocs.Watermark for Python via .NET"
    link: "/watermark/python-net/"
    link_title: "Pelajari selengkapnya"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       GroupDocs.Watermark membantu pengembang Python mengelola watermark dalam Python. Gunakan untuk mengedit, menghapus, atau menemukan watermark dalam Excel, Word, PDF, dan format lainnya.

############################# Steps ############################
steps:
    enable: true
    title: "Deteksi Watermark Xls Menggunakan Python"
    content: |
      **[GroupDocs.Watermark](https://products.groupdocs.com/watermark/python-net/)** memudahkan Anda mendeteksi watermark dalam berbagai jenis dokumen bisnis. Tambahkan alat ini ke proyek Python Anda untuk mengaktifkan fitur deteksi watermark.
      ...
      1. Pertama, inisialisasi kelas **Watermarker** dan muat dokumen Xls Anda menggunakan jalur file, aliran file, atau array byte. Ini menyiapkan file untuk pencarian watermark.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Cari watermark teks di dalam XLS
        import groupdocs.watermark as gw
        import groupdocs.watermark.search.searchcriteria as gwss

        # Buat instansi Watermarker menggunakan jalur menuju XLS
...
more_formats:
    enable: true
    title: "Pencarian Watermark di Berbagai Format"
    exclude: "XLS"
    description: "Temukan dan kelola watermark dalam banyak format yang berbeda."
    items: 
        # format loop 1
        - name: "Tanda air PDF"
          format: "PDF"
