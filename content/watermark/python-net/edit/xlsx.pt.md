...
############################# Head ############################
head_title: "Edição Confiante de Marcas d'água em Documentos Xlsx"
head_description: "Assegure a segurança do conteúdo e a qualidade profissional com controle de marca d'água em Xlsx usando GroupDocs.Watermark for Python via .NET."

############################# Header ############################
title: "Atualizações Seguras e Simples de Marcas d'água em Xlsx usando Python" 
description: "Capacite seus projetos Python com edição de marcas d'água segura e confiável com GroupDocs.Watermark for Python via .NET."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Adquira no PyPi"
      link: "https://releases.groupdocs.com/watermark/python-net/"
      
############################# About ############################
about:
    enable: true
    title: "GroupDocs.Watermark for Python via .NET Suíte"
...
steps:
    enable: true
    title: "Use a API Python para Modificar Marcas d'água em Documentos Xlsx"
    content: |
      Com **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/)**, desenvolvedores Python podem modificar o conteúdo da marca d'água em diversos documentos Xlsx. Aqui está um guia rápido:
...
more_formats:
    enable: true
    title: "Ferramentas de Marcação d'água Interformatos"
    exclude: "XLSX"
    description: "Proteja e unifique o branding entre tipos de documentos usando os componentes GroupDocs.Watermark for Python via .NET."
    items: 
        # format loop 1
