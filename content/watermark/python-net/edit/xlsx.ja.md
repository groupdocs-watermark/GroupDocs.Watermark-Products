...
############################# Head ############################
head_title: "Xlsxドキュメントにおける自信を持ったウォーターマーク編集"
head_description: "GroupDocs.Watermark for Python via .NETを使用して、Xlsxにおけるウォーターマーク制御でコンテンツのセキュリティとプロフェッショナルな品質を確保します。"

############################# Header ############################
title: "Pythonでの安全で簡単なXlsxウォーターマークの更新" 
description: "GroupDocs.Watermark for Python via .NETを利用して、あなたのPythonプロジェクトに安全で信頼性のあるウォーターマーク編集機能を提供します。"
...
about:
    enable: true
    title: "GroupDocs.Watermark for Python via .NETスイート"
    link: "/watermark/python-net/"
    link_title: "さらに詳しく"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       **スプレッドシート用のウォーターマークカスタマイズ：** Xlsxファイル全体でウォーターマークの可視性とスタイルを自信をもって管理します。

############################# Steps ############################
steps:
    enable: true
    title: "Xlsxドキュメント内のウォーターマークを変更するためのPython APIの使用"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/)**を使用すると、Python開発者はさまざまなXlsxドキュメント内のウォーターマークコンテンツを変更できます。簡単な手順は次のとおりです：
      
      1. **Watermarker**クラスを使用してXlsxドキュメントを読み込み、ファイルパス、メモリストリーム、またはバイト配列を入力として受け入れます。
...
more_formats:
    enable: true
    title: "タイプ間のウォーターマークツール"
    exclude: "XLSX"
    description: "GroupDocs.Watermark for Python via .NETコンポーネントを使用して、ドキュメントタイプ全体でのブランディングを保護し統一します。"
    items: 
        # format loop 1
        - name: "ウォーターマーク PDF"
          format: "PDF"
