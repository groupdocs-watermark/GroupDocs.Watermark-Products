...
############################# Head ############################
head_title: "Docxファイルのカスタムウォーターマーク編集"
head_description: "GroupDocs.Watermark for Python via .NETツールを使用して、ブランディングのニーズに合わせてDocxファイルのウォーターマークコンテンツを調整します。"

############################# Header ############################
title: "あなたのPythonプロジェクトでDocxウォーターマークをカスタマイズ" 
description: "GroupDocs.Watermark for Python via .NETを使用して、さまざまなドキュメントタイプのウォーターマークを編集および管理します。"
subtitle: "GroupDocs.Watermark for Python via .NET APIスイート" 
...
about:
    ...
    content: |
       **柔軟なウォーターマークツール：** GroupDocs.Watermark for Python via .NETを使用して、Pythonワークフロー全体でさまざまなフォーマットのウォーターマークを適応させてパーソナライズします。

############################# Steps ############################
steps:
    enable: true
    title: "Docxドキュメント内のウォーターマークを変更するためのPython APIの使用"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/)**を使用すると、Python開発者はさまざまなDocxドキュメント内のウォーターマークコンテンツを変更できます。簡単な手順は次のとおりです：
      
      1. **Watermarker**クラスを使用してDocxドキュメントを読み込み、ファイルパス、メモリストリーム、またはバイト配列を入力として受け入れます。
...
more_formats:
    enable: true
    title: "他のフォーマットのウォーターマーク制御"
    exclude: "DOCX"
    description: "GroupDocs.Watermark for Python via .NETを使用して、すべてのサポートされるファイルタイプで一貫したウォーターマーク編集ツールを利用します。"
    items: 
        # format loop 1
        - name: "ウォーターマーク PDF"
          format: "PDF"
