...
############################# Head ############################
head_title: "Révisions efficaces de filigranes Xls"
head_description: "Améliorez la protection des données en modifiant les filigranes Xls en utilisant GroupDocs.Watermark pour Python."

############################# Header ############################
title: "Filigranage optimisé Xls pour des projets Python" 
description: "Améliorez la clarté du contenu et l'image de marque à l'aide des capacités de filigrane GroupDocs.Watermark."
subtitle: "Suite GroupDocs.Watermark for Python via .NET" 

header_actions:
  enable: true
  items:
    #  loop
    - title: "Accès gratuit via PyPi"
...
about:
    ...
    content: |
       **Améliorez les filigranes des tableurs :** Renforcez la confiance dans le contenu et la visibilité de la marque dans les tableurs en utilisant les outils de filigrane GroupDocs.Watermark.

############################# Steps ############################
steps:
    enable: true
    title: "Utiliser l'API Python pour modifier des filigranes dans des documents Xls"
    content: |
      Avec **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/)**, les développeurs Python peuvent modifier le contenu des filigranes dans divers documents Xls. Voici un aperçu rapide :
      
      1. Commencez par charger le document Xls à l'aide de la classe **Watermarker**, acceptant les chemins de fichiers, les flux mémoire ou les tableaux d'octets comme entrée.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Mettre à jour le filigrane d'image dans un fichier XLS
        ...
        with gw.Watermarker("input.xls") as watermarker:
            ...
            # Exporter le fichier XLS mis à jour
...
more_formats:
    enable: true
    title: "Filigranage uniforme pour d'autres formats"
    exclude: "XLS"
    description: "Élargissez les capacités de filigranage à tous les formats pris en charge en utilisant GroupDocs.Watermark for Python via .NET."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
