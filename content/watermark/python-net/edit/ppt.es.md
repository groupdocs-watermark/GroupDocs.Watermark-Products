...
############################# Head ############################
head_title: "Edición Rápida y Precisa de Marcas de Agua en Ppt"
head_description: "Acelera la edición de marcas de agua en archivos Ppt utilizando GroupDocs.Watermark for Python via .NET."

############################# Header ############################
title: "Edición Avanzada de Marcas de Agua para Ppt con el Poder de Python" 
description: "Protege y personaliza las diapositivas utilizando la API fácil de integrar de GroupDocs.Watermark for Python via .NET."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Descargar a través de PyPi"
...
steps:
    enable: true
    title: "Usar la API de Python para Modificar Marcas de Agua en Documentos Ppt"
    content: |
      Con **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/)**, los desarrolladores de Python pueden modificar el contenido de marcas de agua en varios documentos Ppt. Aquí hay una guía rápida:
...
more_formats:
    enable: true
    title: "Soporte de Marcas de Agua Multi-Formato"
    exclude: "PPT"
    description: "Aplica flujos de trabajo de marcas de agua similares en otros tipos de documentos con GroupDocs.Watermark for Python via .NET."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
