...
############################# Head ############################
head_title: "Doc 파일의 워터마크를 자신 있게 수정하기"
head_description: "GroupDocs.Watermark for Python via .NET API를 사용하여 Doc 워터마크에 세밀한 변화를 주면서 레이아웃과 브랜딩을 유지하세요."

############################# Header ############################
title: "Python를 사용하여 Doc 파일의 워터마크 업데이트" 
description: "GroupDocs.Watermark for Python via .NET API를 활용하여 파일을 향상시키고 보호하는 원활한 워터마크 편집."
...
header_actions:
  ...
  items:
    #  loop
    - title: "PyPi에서 최신 버전 받기"
      link: "https://releases.groupdocs.com/watermark/python-net/"
      
############################# About ############################
about:
    enable: true
    title: "GroupDocs.Watermark for Python via .NET 플랫폼"
    link: "/watermark/python-net/"
    link_title: "자세히 알아보기"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       **워터마크 편집 간소화:** GroupDocs.Watermark for Python via .NET을 사용하여 Python 애플리케이션 내에서 Doc 파일의 워터마크 관리를 효율적으로 수행하세요.

############################# Steps ############################
steps:
    enable: true
    title: "Python API를 사용하여 Doc 문서에서 워터마크 수정"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/)**를 사용하여 Python 개발자가 다양한 Doc 문서에서 워터마크 내용을 수정할 수 있습니다. 빠른 안내는 다음과 같습니다:
      
      1. **Watermarker** 클래스를 사용하여 Doc 문서를 로드하며, 파일 경로, 메모리 스트림 또는 바이트 배열을 입력으로 받습니다.
...
more_formats:
    enable: true
    title: "크로스 포맷 워터마크 편집"
    exclude: "DOC"
    description: "GroupDocs.Watermark for Python via .NET API를 사용하여 다양한 문서 유형에서 워터마크를 쉽게 수정할 수 있습니다."
    items: 
        # format loop 1
        - name: "워터마크 PDF"
          format: "PDF"
