...
############################# Head ############################
head_title: "Solusi Watermark Kustom untuk Pptx"
head_description: "Modifikasi watermark Pptx sesuai dengan kebutuhan bisnis Anda menggunakan GroupDocs.Watermark for Python via .NET."

############################# Header ############################
title: "Watermark Pptx yang Dapat Disesuaikan dalam Python" 
description: "Tingkatkan fitur watermark di seluruh file bisnis Anda dengan menggunakan GroupDocs.Watermark for Python via .NET."
...
about:
    ...
    content: |
       **Kontrol Watermark yang Disesuaikan:** Sesuaikan penempatan, gaya, dan visibilitas watermark sesuai kebutuhan alur kerja Anda menggunakan GroupDocs.Watermark for Python via .NET.

############################# Steps ############################
steps:
    enable: true
    title: "Gunakan API Python untuk Memodifikasi Watermark dalam Dokumen Pptx"
    content: |
      Dengan **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/)**, pengembang Python dapat memodifikasi konten watermark dalam berbagai dokumen Pptx. Berikut adalah langkah cepat: 
      
      1. Mulailah dengan memuat dokumen Pptx menggunakan kelas **Watermarker**, yang menerima jalur file, arus memori, atau array byte sebagai input.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Perbarui watermark gambar dalam file PPTX
        ...
        with gw.Watermarker("input.pptx") as watermarker:
            ...
            # Ekspor file PPTX yang telah diperbarui
...
more_formats:
    enable: true
    title: "Pengeditan Watermark Kustom di Berbagai Format"
    exclude: "PPTX"
    description: "Edit watermark di berbagai format dengan penyesuaian yang terarah menggunakan GroupDocs.Watermark for Python via .NET."
    items: 
        # format loop 1
        - name: "Tanda air PDF"
          format: "PDF"
