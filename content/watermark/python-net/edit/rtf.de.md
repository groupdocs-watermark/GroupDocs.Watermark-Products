...
############################# Head ############################
head_title: "Professionelle Wasserzeichenbearbeitung in Rtf-Dokumenten"
head_description: "Integrieren Sie ein sauberes und konsistentes Branding in Ihre Rtf-Dokumente mit GroupDocs.Watermark for Python via .NET."

############################# Header ############################
title: "Verfeinerte Rtf-Wasserzeichen für Python-Projekte" 
description: "Bieten Sie mit den Wasserzeichen-Tools von GroupDocs.Watermark for Python via .NET ein markenkonformes und ansprechendes Dokumentenerlebnis."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Erhalten Sie es bei PyPi"
...
steps:
    enable: true
    title: "Verwenden Sie die Python-API zur Modifikation von Wasserzeichen in Rtf-Dokumenten"
    content: |
      Mit **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/)** können Python-Entwickler den Inhalt von Wasserzeichen in verschiedenen Rtf-Dokumenten anpassen. Hier ist eine schnelle Anleitung:
...
more_formats:
    enable: true
    title: "Formatübergreifende Branding-Lösungen"
    exclude: "RTF"
    description: "Halten Sie einen konsistenten Stil über Dateitypen hinweg mit unseren flexiblen Wasserzeichenverwaltungswerkzeugen."
    items: 
        # format loop 1
