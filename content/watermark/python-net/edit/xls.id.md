...
############################# Head ############################
head_title: "Revisi Watermark Xls yang Efisien"
head_description: "Tingkatkan perlindungan data dengan mengedit watermark Xls menggunakan GroupDocs.Watermark untuk Python."

############################# Header ############################
title: "Pengeditan Watermark Xls yang Dioptimalkan untuk Proyek Python" 
description: "Tingkatkan kejelasan konten dan branding menggunakan kemampuan watermark GroupDocs.Watermark."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Akses gratis melalui PyPi"
...
about:
    ...
    content: |
       **Tingkatkan Watermark Spreadsheet:** Tingkatkan kepercayaan konten dan visibilitas merek dalam spreadsheet menggunakan alat watermark GroupDocs.Watermark.

############################# Steps ############################
steps:
    enable: true
    title: "Gunakan API Python untuk Memodifikasi Watermark dalam Dokumen Xls"
    content: |
      Dengan **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/)**, pengembang Python dapat memodifikasi konten watermark dalam berbagai dokumen Xls. Berikut adalah langkah cepat: 
      
      1. Mulailah dengan memuat dokumen Xls menggunakan kelas **Watermarker**, yang menerima jalur file, arus memori, atau array byte sebagai input.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Perbarui watermark gambar dalam file XLS
        ...
        with gw.Watermarker("input.xls") as watermarker:
            ...
            # Ekspor file XLS yang telah diperbarui
...
more_formats:
    enable: true
    title: "Watermark Seragam untuk Format Lain"
    exclude: "XLS"
    description: "Perluas kemampuan watermark ke semua format yang didukung menggunakan GroupDocs.Watermark for Python via .NET."
    items: 
        # format loop 1
        - name: "Tanda air PDF"
          format: "PDF"
