...
############################# Head ############################
head_title: "ปรับเปลี่ยน Watermarks ในไฟล์ Doc อย่างมั่นใจ"
head_description: "ด้วย API GroupDocs.Watermark for Python via .NET คุณสามารถปรับเปลี่ยน watermark ในเอกสาร Doc ได้อย่างแม่นยำในขณะที่รักษารูปแบบและแบรนดิ้ง"

############################# Header ############################
title: "อัพเดต Watermarks ในไฟล์ Doc โดยใช้ Python" 
description: "ปรับปรุงและปกป้องไฟล์ของคุณผ่านการแก้ไข watermark โดยใช้ API GroupDocs.Watermark for Python via .NET อย่างสะดวก"
...
header_actions:
  ...
  items:
    #  loop
    - title: "รับเวอร์ชันล่าสุดจาก PyPi"
      link: "https://releases.groupdocs.com/watermark/python-net/"
      
############################# About ############################
about:
    enable: true
    title: "GroupDocs.Watermark for Python via .NET แพลตฟอร์ม"
    link: "/watermark/python-net/"
    link_title: "เรียนรู้เพิ่มเติม"
    picture: "about_watermark.svg" # 480 X 400
    content: |
       **การแก้ไข Watermark ที่ง่ายดาย:** ใช้ GroupDocs.Watermark for Python via .NET เพื่อเสริมการจัดการ watermark ในไฟล์ Doc ทั่วทั้งแอพพลิเคชัน Python ของคุณ

############################# Steps ############################
steps:
    enable: true
    title: "ใช้ API ของ Python เพื่อปรับเปลี่ยน Watermark ในเอกสาร Doc"
    content: |
      ด้วย **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/)** นักพัฒนา Python สามารถปรับเปลี่ยนเนื้อหา watermark ในเอกสาร Doc ได้อย่างรวดเร็ว นี่คือแนวทางการทำงานอย่างรวดเร็ว:
      
      1. เริ่มต้นด้วยการโหลดเอกสาร Doc โดยใช้คลาส **Watermarker** ซึ่งจะรองรับไฟล์เส้นทาง สตรีมหน่วยความจำ หรืออาร์เรย์ไบต์เป็นข้อมูลนำเข้า
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # อัพเดต watermark รูปภาพในไฟล์ DOC
...
more_formats:
    enable: true
    title: "การแก้ไข Watermark ข้ามรูปแบบ"
    exclude: "DOC"
    description: "ปรับเปลี่ยน watermarks ได้อย่างง่ายดายในหลายประเภทเอกสารด้วย API GroupDocs.Watermark for Python via .NET"
    items: 
        # format loop 1
        - name: "ลายน้ำ PDF"
          format: "PDF"
