...
############################# Head ############################
head_title: "Modifica Marcas de Agua en Archivos Doc con Confianza"
head_description: "Con la API GroupDocs.Watermark for Python via .NET, realiza cambios precisos en las marcas de agua Doc mientras mantienes el diseño y la marca."

############################# Header ############################
title: "Actualiza Marcas de Agua en Archivos Doc Usando Python" 
description: "Mejora y protege tus archivos a través de una edición fluida de marcas de agua usando la API GroupDocs.Watermark for Python via .NET."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Consigue la última versión de PyPi"
...
about:
    ...
    content: |
       **Edición de Marcas de Agua Simplificada:** Usa GroupDocs.Watermark for Python via .NET para optimizar la gestión de marcas de agua en archivos Doc a través de tus aplicaciones Python.

############################# Steps ############################
steps:
    enable: true
    title: "Usar la API de Python para Modificar Marcas de Agua en Documentos Doc"
    content: |
      Con **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/)**, los desarrolladores de Python pueden modificar el contenido de marcas de agua en varios documentos Doc. Aquí hay una guía rápida:
      
      1. Comienza cargando el documento Doc utilizando la clase **Watermarker**, aceptando rutas de archivo, flujos de memoria o matrices de bytes como entrada.
    ...
    code:
      ...
      content: |
        ```python {style=abap}
        # Actualizar la marca de agua de imagen en un archivo DOC
        ...
        with gw.Watermarker("input.doc") as watermarker:
            ...
            # Exportar el archivo DOC actualizado
...
more_formats:
    enable: true
    title: "Edición de Marcas de Agua entre Formatos"
    exclude: "DOC"
    description: "Modifica fácilmente marcas de agua en múltiples tipos de documentos con la API GroupDocs.Watermark for Python via .NET."
    items: 
        # format loop 1
        - name: "Filigrana PDF"
          format: "PDF"
