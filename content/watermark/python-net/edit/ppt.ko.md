...
############################# Head ############################
head_title: "Ppt 워터마크 편집을 빠르고 정확하게"
head_description: "GroupDocs.Watermark for Python via .NET을 사용하여 Ppt 파일에서 워터마크 편집 속도를 높이세요."

############################# Header ############################
title: "Python의 힘으로 Ppt 고급 워터마크 편집" 
description: "GroupDocs.Watermark for Python via .NET 통합 API를 통해 슬라이드를 보호하고 개인화하세요."
...
about:
    ...
    content: |
       **신속한 워터마크 조정:** Python 호환 도구를 사용하여 Ppt 문서에서 실시간으로 워터마크 변경을 수행하세요.

############################# Steps ############################
steps:
    enable: true
    title: "Python API를 사용하여 Ppt 문서에서 워터마크 수정"
    content: |
      **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/)**를 사용하여 Python 개발자가 다양한 Ppt 문서에서 워터마크 내용을 수정할 수 있습니다. 빠른 안내는 다음과 같습니다:
      
      1. **Watermarker** 클래스를 사용하여 Ppt 문서를 로드하며, 파일 경로, 메모리 스트림 또는 바이트 배열을 입력으로 받습니다.
...
more_formats:
    enable: true
    title: "다양한 형식의 워터마크 지원"
    exclude: "PPT"
    description: "GroupDocs.Watermark for Python via .NET을 통해 다른 문서 유형에서 유사한 워터마킹 작업 흐름을 적용하세요."
    items: 
        # format loop 1
        - name: "워터마크 PDF"
          format: "PDF"
