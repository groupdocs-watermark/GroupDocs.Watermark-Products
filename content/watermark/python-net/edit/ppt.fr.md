...
############################# Head ############################
head_title: "Édition rapide et précise des filigranes Ppt"
head_description: "Accélérez votre édition de filigrane dans des fichiers Ppt en utilisant GroupDocs.Watermark for Python via .NET."

############################# Header ############################
title: "Édition avancée de filigranes pour Ppt avec la puissance Python" 
description: "Protégez et personnalisez vos diapositives en utilisant l'API facile à intégrer de GroupDocs.Watermark for Python via .NET."
...
header_actions:
  ...
  items:
    #  loop
    - title: "Téléchargez via PyPi"
      link: "https://releases.groupdocs.com/watermark/python-net/"
      
############################# About ############################
about:
    enable: true
    title: "GroupDocs.Watermark for Python via .NET Bibliothèque"
...
steps:
    enable: true
    title: "Utiliser l'API Python pour modifier des filigranes dans des documents Ppt"
    content: |
      Avec **[GroupDocs.Watermark for Python via .NET](https://products.groupdocs.com/watermark/python-net/)**, les développeurs Python peuvent modifier le contenu des filigranes dans divers documents Ppt. Voici un aperçu rapide :
...
more_formats:
    enable: true
    title: "Support de filigrane multi-formats"
    exclude: "PPT"
    description: "Appliquez des flux de travail similaires de filigranage à d'autres types de documents avec GroupDocs.Watermark for Python via .NET."
    items: 
        # format loop 1
        - name: "Filigrane PDF"
          format: "PDF"
