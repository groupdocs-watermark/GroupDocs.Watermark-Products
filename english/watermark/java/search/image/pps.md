...
############################# Head ############################
head_title: "Search Image Watermarks from PPS in Java"
head_description: "Java library to search image watermarks from PPS document using smart search features within Java & J2SE applications using GroupDocs.Watermark APIs for Java."

############################# Header ############################
title: "Search Image Watermarks from PPS in Java"
description: "Use smart search to find all possible image watermarks from PPS file from within Java & J2SE applications. Define search criteria to find all matching image watermarks from the whole or specific pages of the source document."
...
steps:
    enable: true
    title_left: "Search Watermarks from PPS in Java"
    content_left: |
    ...
    code: |
        ```cs
        // search possible IMAGE watermarks in PPS document using Java.
        // Instantiate Watermarker with input PPS document
