...
############################# Head ############################
head_title: "Search Image Watermarks from VISIO in Java"
head_description: "Java library to search image watermarks from VISIO document using smart search features within Java & J2SE applications using GroupDocs.Watermark APIs for Java."

############################# Header ############################
title: "Search Image Watermarks from VISIO in Java"
description: "Use smart search to find all possible image watermarks from VISIO file from within Java & J2SE applications. Define search criteria to find all matching image watermarks from the whole or specific pages of the source document."
...
steps:
    ...
    code: |
        ```cs
        // search possible IMAGE watermarks in VISIO document using Java.
        // Instantiate Watermarker with input VISIO document
