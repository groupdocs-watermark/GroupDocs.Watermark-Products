...
############################# Head ############################
head_title: "Edit Text Watermark in VTX in Java"
head_description: "Java library to edit a found text watermark in a VTX file in Java applications using GroupDocs.Watermark API for Java."

############################# Header ############################
title: "Edit Text Watermark in VTX in Java"
description: "Search & modify a found text watermark in a VTX document with formatting within Java & J2SE applications. Manage the watermark size, font type, rotation angle and position of the watermark on the document pages, as you may need."
...
steps:
    enable: true
    title_left: "Edit Text Watermark in VTX File in Java"
    content_left: |
    ...
    code: |
        ```cs
        // Find & update text watermark with formatting in a VTX in Java applications
        // Instantiate Watermarker with input VTX document
